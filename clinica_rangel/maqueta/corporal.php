<?php include("head.php"); ?>
  ...
  <div class="con-main-sub-nav clearfix">
      ...
      <ul>
        <li id="sub-act"><a href="corporal.php?seccion=4">Diseño Corporal</a></li>
    ...
    <div class="info">
      <div class="mg-info clearfix">
        <div class="con-section-main con-section-main-s clearfix">
          <div class="main-head-bg"><img src="assets/img/slide-bg-3.png"></div>
          <div class="banda-main-img">
          	<div class="banda-main-img-img">
            	<img src="assets/img/corporal-main-img-2.png" height="392" width="940" alt="">
            	<a href="#sc-info-1" class="an-din-li"><div class="estetica-img-lk1"></div></a>
            	<a href="#sc-info-2" class="an-din-li"><div class="estetica-img-lk2"></div></a>
            	<a href="#sc-info-3" class="an-din-li"><div class="estetica-img-lk3"></div></a>
            	<a href="#sc-info-4" class="an-din-li"><div class="estetica-img-lk4"></div></a>
            </div>
          </div>
          <!--<div class="estetica-main-img">
          	<img src="assets/img/corporal-main-img.png" width="610" height="545" alt="">
            <a href="#sc-info-1" class="an-din-li"><div class="estetica-img-lk1"></div></a>
            <a href="#sc-info-2" class="an-din-li"><div class="estetica-img-lk2"></div></a>
            <a href="#sc-info-3" class="an-din-li"><div class="estetica-img-lk3"></div></a>
            <a href="#sc-info-4" class="an-din-li"><div class="estetica-img-lk4"></div></a>
          ...
          <!--<div class="form-fx">
          	<div class="form-fx-head">
            	<div class="form-fx-head-tx">
              	<h1>30%</h1>
                <h2>DE DESCUENTO</h2>
                <p>en moldeamiento intensivo de 3 semanas</p>
              </div>
            	<div class="form-fx-head-img"><img src="assets/img/form-fx-img.png" width="100" alt=""></div>
            </div>
        ...
        <div class="con-section-head">
        	<h1>Tratamientos de diseño corporal</h1>
        </div>
        ...
        <div class="con-section-info clearfix" id="sc-info-4">
          ...
          <div class="section-var-info">
          	<div class="scroll-wrap">
            	<div class="info-paso no-numb">
                <h1>Moldeamiento corporal</h1>
                <p>¿Sientes que hay algo profundo que te impide llegar al peso que quieres, pero no sabes qué es?. Nosotros identificamos que en todo paciente con sobrepeso existen por lo menos 7 bloqueos neuro endocrinos que son las verdaderas causas que disparan el sobrepeso o impiden adelgazar. ¿Cuáles son los tuyos?</p>
              </div>
            </div>
          </div>
        </div>
        <div class="con-section-info clearfix" id="sc-info-2">
        	<div class="section-var-img">
          	<img src="assets/img/estetica-item-img.jpg" width="380" height="220" alt="">
          </div>
          <div class="section-var-info">
