  ...
  <div class="header">
		<div class="mg-header clearfix">
			<div class="header-logo"><a href="index.php"><img src="assets/img/header-logo.png" height="90" width="288"></a></div>
      ...
      <div class="con-info-head">
				611 4050 - 311 2226260 Bogotá
			</div>
			<div class="con-nav">
				<div class="bt-nav <?php if ($_GET['seccion'] == '6'){echo 'nav-act';}?>"><a href="doctora.php?seccion=6">DRA. ROSALINDA</a></div>
				<div class="bt-nav <?php if ($_GET['seccion'] == '5'){echo 'nav-act';}?>"><a href="lugar.php?seccion=5">SEDE CAMPESTRE</a></div>
				<div class="bt-nav <?php if ($_GET['seccion'] == '4'){echo 'nav-act';}?>"><a href="corporal.php?seccion=4">ESTÉTICA</a></div>
        <div class="bt-nav <?php if ($_GET['seccion'] == '3'){echo 'nav-act';}?>"><a href="tratamiento.php?seccion=3">ADELGAZAR</a></div>
			</div>
