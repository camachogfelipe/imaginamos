<?php include("head.php"); ?>
  ...
  <div class="con-main-sub-nav clearfix">
      ...
      <ul>
        <li id="sub-act"><a href="tratamiento.php?seccion=3">El Tratamiento</a></li>
        <li><a href="alimentacion.php?seccion=3">Tu Alimentación</a></li>
  ...
  <section>
    <div class="info">
      <div class="mg-info clearfix">
          ...
          <div class="main-head-img"><img src="assets/img/tratamiento-main-img-2.png" height="345" width="700" alt=""></div>        
          <div class="con-gal-video">
              ...
              <a href="http://www.youtube.com/watch?v=TM_Nm6ei3wo" class="modal-media">
                <div class="destacado-video">
                  <div class="con-icon-des-v">
                    <div class="img-des-t"><img src="assets/img/video-img.jpg" width="288" height="162" alt=""></div><div class="vn-des-t"></div><div class="icon-des-v"></div>
                  </div>
                </div>
              </a>
            </div>
            <div class="info-video">
              ...
              <p>Conoce tu tipología y los principales bloqueos que te han impedido adelgazar y mantener los resultados.</p>
            </div>
          </div>          
        </div>
        ...
        <div class="con-section-info clearfix">
        	<div class="section-var-img">
          	<img src="assets/img/section-var-img-1.jpg" width="380" height="220" alt="">
          </div>
          <div class="section-var-info">
          	<div class="scroll-wrap">
                ...
                <h1>Desbloquéate</h1>
                <p>Partiendo de un diagnóstico médico profundo, identificamos y tratamos efectivamente los bloqueos fisiológicos, mentales y emocionales que te han llevado al sobrepeso y te han hecho tan difícil adelgazar, hasta ahora.</p>
              </div>
            </div>
          </div>
        </div>
