<?php include("head.php"); ?>
  ...
  <div class="con-main-sub-nav clearfix">
      ...
      <ul>
        <li id="sub-act"><a href="lugar.php?seccion=5">El Lugar</a></li>
        <li><a href="adelgazar.php?seccion=5">Adelgazamiento</a></li>
        <li><a href="desintoxicar.php?seccion=5">Desintoxicación</a></li>
        <li><a href="renacer.php?seccion=5">Renacimiento</a></li>
    ...
    <div class="info">
      <div class="mg-info clearfix">
        <div class="con-section-main clearfix">
              ...
              <a href="http://www.youtube.com/watch?v=TM_Nm6ei3wo" class="modal-media">
                <div class="site-video">
                  <div class="con-icon-site-v">
                    <div class="img-des-t"><img src="assets/img/site-video-img.jpg" width="500" height="300" alt=""></div><div class="vn-des-t"></div><div class="icon-site-v"></div>
                  </div>
                  <div class="site-info"><h1>CONOCE NUESTRA SEDE CAMPESTRE</h1></div>
                </div>
              </a>
            </div>
          </div>
          <div class="con-site-aco">
          	<div class="con-item-aco">
            	<div class="item-aco-head item-aco-act-1"><h1>Adelgazamiento Intensivo</h1></div>
              <div class="item-aco-info">
              	<div class="item-aco-img"><img src="assets/img/acorde-img-1.jpg" width="120" height="163" alt=""></div>
                <div class="item-aco-tx">
                	<p>Escápate y adelgaza aceleradamente por inmersión, de forma segura y natural, mientras desintoxicas tu cuerpo y tu mente.</p>
                  <p class="acor-vn"><a href="adelgazar.php?seccion=5">+ Ver más</a></p>
                </div>
              </div>
            </div>
            <div class="con-item-aco">
        ...
        <div class="con-section-head">
        	<h1>Un lugar mágico que cambiará tu vida</h1>
