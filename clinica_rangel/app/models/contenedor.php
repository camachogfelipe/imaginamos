 ...
 */
class contenedor extends DataMapper {
     ...
     */
    public $pagina_id;
    public $table = 'contenedor';
    public $model = 'contenedor';
    public $primarykey = 'id';
    public $_fields = array('id', 'titulo', 'texto', 'imagen_id', 'pagina_id');
    public $has_one = array(
        'imagen' => array(
            'class' => 'imagen',
            'other_field' => 'contenedor',
            'join_other_as' => 'imagen',
            'join_self_as' => 'contenedor',
    ...
    public $validation = array(
        ...
        'titulo' => array(
            'rules' => array('max_length' => 55, 'required'),
            'label' => 'TITULO',
        ),
        'texto' => array(
            'rules' => array('max_length' => 420000),
            'label' => 'TEXTO',
        ),
        'imagen_id' => array(
