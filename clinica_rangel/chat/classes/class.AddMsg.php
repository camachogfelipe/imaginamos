...
class AddMsg
{
    ...
    public function InsertMessage()
    {
            ...
            $sth = DB::prep("INSERT INTO cms_messaging (msg,user,to_user,type) VALUES(:msg, :user_id, :this_admin,'user')");
	...
	*/
    public function InsertHistory()
    {
            ...
            $sth = DB::prep("INSERT INTO cms_messaging_history (user,from_ip, email, sess, msg, admin, type) VALUES(:user,INET_ATON(:from_ip), :email, :sess,:msg,:this_admin, 'user')");
            $sth->bindParam(":msg", $this->msg, PDO::PARAM_STR);
