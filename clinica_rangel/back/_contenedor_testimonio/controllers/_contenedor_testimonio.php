 ...
 * @author Elbert Tous
 */
class _contenedor_testimonio extends Back_Controller {

    protected $admin_area = true;
    private $model = 'contenedor_testimonio';
    private $name = "contenedor_testimonio";
    ...
    public function index() {
        ...
        $data['title_page'] = "Contenedor Testimonio"; 
        $data['pag'] = 1;
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "380px x 380px",false,true,"span3");
        ...
        $data['form_content'] .= $this->text($obj->texto, "texto", "Descripción", "", $obj->is_rule("texto","required"), "span8", false, true, 360,3,4); 
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "380px x 380px",false,true,"span3");
        ...
        $data['form_content'] .= $this->text("", "texto", "Descripción", "", $obj->is_rule("texto","required"), "span8", false, true, 360,3,4);  
        $data['direct_form'] = $this->name.'/add'; 
        return $this->buildajax($this->name.'/form', $data);
    }
