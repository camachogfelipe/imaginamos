 ...
 * @author rigobcastro
 */
class _contenedor_home extends Back_Controller {

    protected $admin_area = true;
    private $model = 'contenedor';
    private $name = "contenedor_home";
    ...
    public function index() {
        ...
        $data['title_page'] = "Razones para adelgazar"; 
        $data['pag'] = 1;
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->text($obj->texto, "texto", "Descripción", "", false, "span8", true, false, 0,3,4); 
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->text("", "texto", "Descripción", "", false, "span8", true, false, 0,3,4);  
        $data['direct_form'] = $this->name.'/add'; 
        return $this->buildajax($this->name.'/form', $data);
    }
