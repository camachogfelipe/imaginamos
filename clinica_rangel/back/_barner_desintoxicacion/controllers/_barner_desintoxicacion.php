 ...
 * @author Elbert Tous
 */
class _barner_desintoxicacion extends Back_Controller {

    protected $admin_area = true;
    private $model = 'barner';
    private $name = "barner_desintoxicacion";
    private $page_id = false;

    public function __construct() {
        parent::__construct();
        $this->page_id = $this->page_id('desintoxicacion');
    }
    ...
    public function index() {
        ...
        $data['title_page'] = "Baner Desintoxicación";
        $data['pag'] = 1;
    ...
    public function form_edit() {
        $obj = new $this->model();
        $obj->join_related('imagen')->join_related('imagen1')->join_related('imagen2')->get_by_pagina_id($this->page_id);
        $data['form_content'] = "";
        ...
        $data['form_content'] .= $this->imagen($obj->imagen1_id, $obj->imagen1_path, "Imagen", "350px x 430px", false, false, "span4", 1);
		$data['form_content'] .= $this->imagen($obj->imagen2_id, $obj->imagen2_path, "Imagen Texto", "550px x 300px", false, false, "span4", 2);
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "350px x 430px", false, false, "span4", 1);
        $data['form_content'] .= $this->imagen("", NULL,  "Imagen Texto", "550px x 300px", false, false, "span4", 2);
	    $data['direct_form'] = $this->name . '/add';
        return $this->buildajax($this->name . '/form', $data);
    }
    ...
    public function lista() {
        $obj = new $this->model();
        $data['datos'] = $obj->join_related('imagen')->join_related('imagen1')->join_related('imagen2')->get_by_pagina_id($this->page_id);
