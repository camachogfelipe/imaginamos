 ...
 * @author Elbert Tous
 */
class _beneficios_desintoxicacion extends Back_Controller {

    protected $admin_area = true;
    private $model = 'beneficio';
    private $name = "beneficios_desintoxicacion";
    ...
    public function index() {
        ...
        $data['title_page'] = "Beneficios Desintoxicacion"; 
        $data['pag'] = 1;
