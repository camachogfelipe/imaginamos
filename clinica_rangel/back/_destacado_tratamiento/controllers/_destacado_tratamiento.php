 ...
 * @author rigobcastro
 */
class _destacado_tratamiento extends Back_Controller {

    protected $admin_area = true;
    private $model = 'destacado';
    private $name = "destacado_tratamiento";
    private $page_id = false; 

    public function __construct() {
        parent::__construct();
        $this->page_id = $this->page_id('el_tratamiento');
    //    $this->is_link_current = true; 
    }
