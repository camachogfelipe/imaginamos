<header>
                <div class="container">
                    <div class="row">
                        <div class="span3">
                            <div class="main-logo"><a href="<?php echo cms_url('dashboard') ?>"><img alt="Beoro Admin" height="40" width="128" src="<?php echo base_url().'assets/global/img/header-logo.png' ?>" /></a></div>
                        </div>
                        <div class="span5">
                            <nav class="nav-icons">
                                <ul>
...
<!--                                         
                                            ...
                                            <li role="presentation"> <a href="<?php echo cms_url('lineas/lineas') ?>"><font><font>Lineas</font></font></a></li>
                                            -->
                                        </ul>
                                    </li>
                                    <li><a target="_blank"  href="<?php echo base_url(); ?>" class="ptip_s"><span class="ptip_s"></span><i class="icsw16-globe"></i></a></li>
                                    </ul>
                             </nav>
                        </div>
                        <div class="span4">
                            <div class="user-box">
                                <div class="user-box-inner">
                                    <img src="<?php echo back_asset('images/default_avatar.gif') ?>" alt="" class="user-avatar img-avatar">
                                    <div class="user-info"><font><font>
                                        Bienvenido, </font></font><strong><font><font><?php echo isset($current_user['username'])?$current_user['username']:""; ?></font></font></strong>
                                        <ul class="unstyled">
