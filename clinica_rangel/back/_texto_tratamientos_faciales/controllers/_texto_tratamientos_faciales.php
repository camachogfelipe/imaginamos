 ...
 * @author rigobcastro
 */
class _texto_tratamientos_faciales extends Back_Controller {

    protected $admin_area = true;
    private $model = 'texto_principal';
    private $name = "texto_tratamientos_faciales";
    ...
    public function index() {
        ...
        $data['title_page'] = "Texto Principal Tratamientos Faciales"; 
        $data['pag'] = 1;
    ...
    public function form_edit() {
        $obj = new $this->model();
        $obj->get_by_pagina_id($this->page_id);
        $data['form_content'] = "";
        $data['form_content'] .= $this->inputHidden($obj->id, "id", 11); 
        $data['form_content'] .= $this->input($obj->titulo, "titulo", $obj->get_rule("titulo","max_length"), "Titulo", "Maximo ".$obj->get_rule("titulo","max_length")." caracteres",$obj->is_rule("titulo","required"),"span4"); 
...
//        $data['form_content'] .= $this->text("", "texto", "Descripción", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span8", false, true, $obj->get_rule("texto","max_length"),3,4); 
    ...
    public function lista() {
        $obj = new  $this->model();
        $data['datos'] = $obj->get_by_pagina_id($this->page_id);
