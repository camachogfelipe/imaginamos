 ...
 * @author rigobcastro
 */
class _contenedor_alimentacion extends Back_Controller {

    protected $admin_area = true;
    private $model = 'contenedor_alimentacion';
    private $name = "contenedor_alimentacion";
    private $page_id = false; 

    public function __construct() {
        parent::__construct();
        $this->page_id = $this->page_id('tu_alimentacion'); 
    }
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "288px x 130px",false,true,"span3");
        ...
        $data['form_content'] .= $this->input($obj->subtiulo, "subtiulo", $obj->get_rule("subtiulo","max_length"), "Sub-Titulo", "Maximo ".$obj->get_rule("subtiulo","max_length")." caracteres",$obj->is_rule("subtiulo","required"),"span5"); 
        $data['form_content'] .= $this->text($obj->texto, "texto", "Descripción", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span8", true, false, $obj->get_rule("texto","max_length"),3,4); 
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "288px x 130px",false,true,"span3");
        ...
        $data['form_content'] .= $this->input("", "subtiulo", $obj->get_rule("subtiulo","max_length"), "Sub-Titulo", "Maximo ".$obj->get_rule("subtiulo","max_length")." caracteres",$obj->is_rule("subtiulo","required"),"span5"); 
        $data['form_content'] .= $this->text("", "texto", "Descripción", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span8", true, false, $obj->get_rule("texto","max_length"),3,4);  $data['direct_form'] = $this->name.'/add'; 
        return $this->buildajax($this->name.'/form', $data);
    }
