 ...
 * @author rigobcastro
 */
class _contenedor_banda_gastrica extends Back_Controller {

    protected $admin_area = true;
    private $model = 'contenedor';
    private $name = "contenedor_banda_gastrica";
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->input($obj->titulo, "titulo", 55, "Titulo", "Maximo 55 caracteres",true,"span5"); 
        $data['form_content'] .= $this->text($obj->texto, "texto", "Descripción", "Maximo 420 caracteres", false, "span8", false, true, 420,3,4); 
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->input("", "titulo", 55, "Titulo", "Maximo 55 caracteres",true,"span5"); 
        $data['form_content'] .= $this->text("", "texto", "Descripción", "Maximo 420 caracteres", false, "span8", false, true, 420,3,4);  
        $data['direct_form'] = $this->name.'/add'; 
        return $this->buildajax($this->name.'/form', $data);
    }
