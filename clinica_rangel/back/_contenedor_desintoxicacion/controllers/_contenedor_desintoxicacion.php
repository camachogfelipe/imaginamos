 ...
 * @author Elbert Tous
 */
class _contenedor_desintoxicacion extends Back_Controller {

    protected $admin_area = true;
    private $model = 'contenedor';
    private $name = "contenedor_desintoxicacion";
    ...
    public function index() {
        ...
        $data['title_page'] = "Contenedores de Desintoxicacion"; 
        $data['pag'] = 1;
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "380px × 270px",false,true,"span3");
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "380px × 270px",false,true,"span3");
