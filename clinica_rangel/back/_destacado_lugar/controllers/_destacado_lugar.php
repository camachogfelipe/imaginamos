 ...
 * @author Elbert Tous
 */
class _destacado_lugar extends Back_Controller {

    protected $admin_area = true;
    private $model = 'destacado';
    private $name = "destacado_lugar";
    private $page_id = false; 

    public function __construct() {
        parent::__construct();
        $this->page_id = $this->page_id('lugar');
    }
    ...
    public function index() {
        ...
        $data['title_page'] = "Destacados Lugar"; 
        $data['pag'] = 1;
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->input($obj->titulo, "titulo", 33, "Titulo", "Maximo 33 caracteres",true,"span4"); 
        $data['form_content'] .= $this->input($obj->link, "link", 255, "Link", "Maximo 255 caracteres",false,"span4"); 
        $data['form_content'] .= $this->text($obj->texto, "texto", "Descripción", "Maximo 117 caracteres", false, "span8", false, true, 117,3,4); 
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->input("", "titulo", 33, "Titulo", "Maximo 33 caracteres",true,"span4"); 
        $data['form_content'] .= $this->input("", "link", 255, "Link", "Maximo 255 caracteres",false,"span4"); 
        $data['form_content'] .= $this->text("", "texto", "Descripción", "Maximo 117 caracteres", false, "span8",false , true, 117,3,4); 
        $data['direct_form'] = $this->name.'/add'; 
        return $this->buildajax($this->name.'/form', $data);
    }
