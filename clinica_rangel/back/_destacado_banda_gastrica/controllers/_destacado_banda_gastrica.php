 ...
 * @author Elbert Tous
 */
class _destacado_banda_gastrica extends Back_Controller {

    protected $admin_area = true;
    private $model = 'destacado';
    private $name = "destacado_banda_gastrica";
    private $page_id = false; 

    public function __construct() {
        parent::__construct();
        $this->page_id = $this->page_id('banda_gastrica');
    }
    ...
    public function index() {
        ...
        $data['title_page'] = "Destacados Banda Gastrica"; 
        $data['pag'] = 1;
