 ...
 * @author rigobcastro
 */
class _destacado_home extends Back_Controller {

    protected $admin_area = true;
    private $model = 'destacado';
    private $name = "destacado_home";
    ...
    public function index() {
        ...
        $data['title_page'] = "Destacados Home"; 
        $data['pag'] = 1;
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "288px x 130px",false,true,"span2");
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "288px x 130px",false,true,"span2");
