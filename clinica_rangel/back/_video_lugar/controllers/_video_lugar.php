 ...
 * @author Elbert Tous
 */
class _video_lugar extends Back_Controller {

    protected $admin_area = true;
    private $model = 'video';
    private $name = "video_lugar";
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "500px x 300px",false,$obj->is_rule("titulo","required"),"span3");
...
//        $data['form_content'] .= $this->text($obj->texto, "texto", "Texto", "Maximo 117 caracteres", false, "span8", false, true, 117,3,4); 
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "500px x 300px",false,$obj->is_rule("titulo","required"),"span2");
