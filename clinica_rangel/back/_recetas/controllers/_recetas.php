 ...
 * @author rigobcastro
 */
class _recetas extends Back_Controller {

    protected $admin_area = true;
    private $model = 'receta';
    private $name = "recetas";
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->text($obj->texto, "texto", "Descripción", "", $obj->is_rule("texto","required"), "span8", true, false, 0,3,4); 
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "288px x 130px",false,$obj->is_rule("titulo","required"),"span3");
        ...
        $data['form_content'] .= $this->text("", "texto", "Descripción", "", $obj->is_rule("texto","required"), "span8", true, false, 0,3,4);  
        $data['direct_form'] = $this->name.'/add'; 
        return $this->buildajax($this->name.'/form', $data);
    }
