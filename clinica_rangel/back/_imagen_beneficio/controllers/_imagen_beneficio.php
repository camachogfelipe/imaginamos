 ...
 * @author Elbert Tous
 */
class _imagen_beneficio extends Back_Controller {

    protected $admin_area = true;
    private $model = 'imagen_beneficio';
    private $name = "imagen_beneficio";
    ...
    public function index() {
        ...
        $data['title_page'] = "Imagen beneficio"; 
        $data['pag'] = 1;
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "380px x 270px",false,true,"span3");
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "380px x 270px",false,true,"span2");
        $data['direct_form'] = $this->name.'/add'; 
        return $this->buildajax($this->name.'/form', $data);
    }
