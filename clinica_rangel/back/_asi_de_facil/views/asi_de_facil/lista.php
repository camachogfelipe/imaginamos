                            ...
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td class="center" width="100px">
                                     <?php if($datos->result_count() > 4): ?>
                                        <a href="<?php echo cms_url($direct_form) ?>" class="btn btn-danger btn-small logic-delete del_count" data-num="4" data-value="<?php echo $img->id ?>">Eliminar</a>
                                       <?php endif; ?>
                                    </td> 
                                </tr>
                            <?php endforeach; ?>
