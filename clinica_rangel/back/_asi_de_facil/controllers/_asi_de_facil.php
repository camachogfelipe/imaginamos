 ...
 * @author rigobcastro
 */
class _asi_de_facil extends Back_Controller {

    protected $admin_area = true;
    private $model = 'asi_facil';
    private $name = "asi_de_facil";
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "136px x 75px",false,true,"span3");
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "136px x 75px",false,true,"span3");
        ...
        $data['form_content'] .= $this->input("", "link", $obj->get_rule("link","max_length"), "Link", "Maximo ".$obj->get_rule("link","max_length")." caracteres",$obj->is_rule("link","required"),"span5"); 
