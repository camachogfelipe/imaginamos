 ...
 * @author Elbert Tous
 */
class _destacado_renacimiento extends Back_Controller {

    protected $admin_area = true;
    private $model = 'destacado';
    private $name = "destacado_renacimiento";
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "280px x 152px",false,true,"span3");
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "280px x 152px",false,true,"span3");
        ...
        $data['form_content'] .= $this->text("", "texto", "Descripcion", "Maximo 117 caracteres", false, "span8", false, true, 117,3,4); 
        $data['direct_form'] = $this->name.'/add'; 
        return $this->buildajax($this->name.'/form', $data);
    }
    ...
    public function lista() {
     ...
     public function add() {
        ...
        $msg = "";
        $obj = new $this->model();
        if($obj->get()->result_count()<= 2 OR is_numeric($this->_post('id')) ){
            $obj = new $this->model();
         $obj->get_by_id($this->_post('id'));
          ...
          if($pg != false){
           ...
           $error = true;
           $msg = "No se puede agregar mas de 2 items";       
        }
        if ($error)
