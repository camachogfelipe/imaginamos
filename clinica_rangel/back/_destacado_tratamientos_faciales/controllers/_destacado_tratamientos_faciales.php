 ...
 * @author Elbert Tous
 */
class _destacado_tratamientos_faciales extends Back_Controller {

    protected $admin_area = true;
    private $model = 'destacado';
    private $name = "destacado_tratamientos_faciales";
    private $page_id = false; 

    public function __construct() {
        parent::__construct();
        $this->page_id = $this->page_id('tratamientos_faciales');
    }
    ...
    public function index() {
        ...
        $data['title_page'] = "Destacados Tratamietos Faciales"; 
        $data['pag'] = 1;
