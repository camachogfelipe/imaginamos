                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="span2" >Imagen</th>
                                 <th class="span2" >Imagen Texto</th>
                                 <th class="span2" >Imagen Fondo</th>
                        ...
                        <tbody id='table_contet'  >
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td>
                                        <a class="thumbnail img_action_zoom" title="Imagen" href="<?php echo base_url() . $img->imagen1_path ?>">
                                            <img style="height:50px;width:50px" src="<?php echo base_url() . $img->imagen1_path ?>" alt="" />
                                        </a>
                                    </td>
                                    <td>
                                        <a class="thumbnail img_action_zoom" title="Imagen" href="<?php echo base_url() . $img->imagen2_path ?>">
                                            <img style="height:50px;width:50px" src="<?php echo base_url() . $img->imagen2_path ?>" alt="" />
                                        </a>
                                    </td>
                                     <td>
                                        <a class="thumbnail img_action_zoom" title="Imagen Fondo" href="<?php echo base_url() . $img->imagen_path ?>">
