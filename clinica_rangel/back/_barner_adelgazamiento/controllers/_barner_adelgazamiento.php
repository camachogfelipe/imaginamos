 ...
 * @author Elbert Tous
 */
class _barner_adelgazamiento extends Back_Controller {

    protected $admin_area = true;
    private $model = 'barner';
    private $name = "barner_adelgazamiento";
    private $page_id = false;

    public function __construct() {
        parent::__construct();
        $this->page_id = $this->page_id('adelgazamiento');
    }
    ...
    public function index() {
        ...
        $data['title_page'] = "Baner Adelgazamiento";
        $data['pag'] = 1;
