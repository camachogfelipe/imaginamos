...
class destacado extends  DataMapper {
    ...
    public $_fields = array('id','titulo','link','imagen_id');
    ...
    public function get_imagen($join_retale="") {
         $model = new imagen();
         if($join_retale!=""){
         	return $model->join_related($join_retale)->get_by_destacado_id($this->id);
         }else{
         	return $model->get_by_destacado_id($this->id);
         }
    }
    ...
    */
    ...
    public $coments =  array(
                ...
                'imagen_id' => 'imagen|view|label#Titulo#|span#span3#',
);
