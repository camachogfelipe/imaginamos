...
class banner extends  DataMapper {
    ...
    public $_fields = array('id','titulo','subtitulo','link','imagen_id');
    ...
    public function get_imagen($join_retale="") {
         $model = new imagen();
         if($join_retale!=""){
         	return $model->join_related($join_retale)->get_by_banner_id($this->id);
         }else{
         	return $model->get_by_banner_id($this->id);
         }
    }
    ...
    */
    ...
    public $coments =  array(
                ...
                'subtitulo' => 'input|view|label#Sub Titulo#|span#span3#',
                'link' => 'input|view|label#Link#|span#span3#',
