...
class disenador_linea extends  DataMapper {
    ...
    public $table = 'disenador_linea';

    public $model = 'disenador_linea';
    public $primarykey = 'id';
    public $_fields = array('id','linea_id','disenador_id');

    public $has_one =  array(
                'linea' => array(
                  'class' => 'linea',
                  'other_field' => 'disenador_linea',
                  'join_other_as' => 'linea',
                  'join_self_as' => 'disenador_linea',
    ...
    public function get_linea($join_retale="") {
         $model = new linea();
         if($join_retale!=""){
         	return $model->join_related($join_retale)->get_by_disenador_linea_id($this->id);
         }else{
         	return $model->get_by_disenador_linea_id($this->id);
         }
    }
    ...
    public function get_disenador($join_retale="") {
         $model = new disenador();
         if($join_retale!=""){
         	return $model->join_related($join_retale)->get_by_disenador_linea_id($this->id);
         }else{
