...
class municipios extends  DataMapper {
    ...
    public $model = 'municipios';
    public $primarykey = 'id';
    public $_fields = array('id','codigo','nombre','departamento_id');

    public $has_one =  array(
                'departamento' => array(
                  'class' => 'departamento',
                  'other_field' => 'municipios',
                  'join_other_as' => 'departamento',
                  'join_self_as' => 'municipios',
    ...
    public function get_departamento($join_retale="") {
         $model = new departamento();
         if($join_retale!=""){
         	return $model->join_related($join_retale)->get_by_municipios_id($this->id);
         }else{
         	return $model->get_by_municipios_id($this->id);
         }
    }
