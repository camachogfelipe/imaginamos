...
class _categoria_sobres extends Back_Controller {
	protected $admin_area = true;
	public $model = 'categoria_sobre';
	public $name = 'categoria_sobres';
	public $title = 'Sobres de Categoria';
	...
	public function menu() {
		return $this->current_menu['Configuraciones']['Sobres de Categoria'] = cms_url('categoria_sobres');
	}
	...
	public function form_edit() {
		$obj = new $this->model();
		$id = $this->_post('id');
		$obj->join_related('sobre')->join_related('categoria')->get_by_id($id);
		$data['form_content'] = "";
		$data['form_content'] .= $this->inputHidden($obj->id, "id", $obj->get_rule("id","max_length"));
		$var_categoria_id = new categoria_sobre();
		...
		$var_sobre_id = new categoria_sobre();
		$data['form_content'] .= $this->combox($obj->sobre_id,$var_sobre_id->get_sobre_list('titulo'),"sobre_id", "Sobre para Categoria", "", $obj->is_rule("sobre_id","required"), "span3");
	...
	public function lista() {
		$obj = new $this->model();
		$data['datos'] =  $obj->join_related('sobre')->join_related('categoria')->get(); 
