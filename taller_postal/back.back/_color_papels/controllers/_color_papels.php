...
class _color_papels extends Back_Controller {
	protected $admin_area = true;
	public $model = 'color_papel';
	public $name = 'color_papels';
	public $title = 'Color de Papeles';
	...
	public function menu() {
		return $this->current_menu["Configuracion"]['Color de Papeles'] = cms_url('color_papels');
	}
	...
	public function form_edit() {
		...
		$var_papel_id = new color_papel();
		$data['form_content'] .= $this->combox($obj->papel_id,$var_papel_id->get_papel_list("titulo"),"papel_id", "Papel", "", $obj->is_rule("papel_id","required"), "span3");
		$var_color_id = new color_papel();
		$data['form_content'] .= $this->combox($obj->color_id,$var_color_id->get_color_list("titulo"),"color_id", "Color del Papel", "", $obj->is_rule("color_id","required"), "span3");
	...
	public function lista() {
		$obj = new $this->model();
		$data['datos'] =  $obj->join_related('color')->join_related('papel')->get(); 
