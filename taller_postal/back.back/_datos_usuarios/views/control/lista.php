                            ...
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    <td class="nolink ">
                                        ...
                                        <?php echo $img->id;  ?>
                                    </td><td><?php echo $img->nombre;  ?></td><td><?php echo $img->email;  ?></td><td><?php echo $img->direccion;  ?></td><td><?php echo $img->telefono;  ?></td><td><?php echo $img->celular;  ?></td><td>
                                        <?php echo substr(strip_tags($img->comentario),0,120)."...";  ?>
                                    </td><td><?php echo $img->ciudad;  ?></td>
