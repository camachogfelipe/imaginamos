...
class _disenador_lineas extends Back_Controller {
	protected $admin_area = true;
	public $model = 'disenador_linea';
	public $name = 'disenador_lineas';
	public $title = 'Disenador_lineas';
	...
	public function menu() {
		return $this->current_menu['Disenador_lineas'] = cms_url('disenador_lineas');
	}
	...
	public function form_edit() {
		...
		$var_linea_id = new disenador_linea();
		$data['form_content'] .= $this->combox($obj->linea_id,$var_linea_id->get_linea_list(),"linea_id", "Linea", "", $obj->is_rule("linea_id","required"), "span3");
		$var_disenador_id = new disenador_linea();
