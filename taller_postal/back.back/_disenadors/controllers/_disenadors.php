...
class _disenadors extends Back_Controller {
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->text($obj->texto, "texto", "Descripción", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span6", true, false, $obj->get_rule("texto","max_length"),3,4);
	...
	public function lista() {
		$obj = new $this->model();
		$data['datos'] =   $obj->join_related('imagen')->join_related('municipios')->get(); 
