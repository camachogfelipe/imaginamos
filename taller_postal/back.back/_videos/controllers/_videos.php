...
class _videos extends Back_Controller {
	...
	public function menu() {
		return $this->current_menu['Home']['Video Home'] = cms_url('videos');
	}
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->inputHidden($obj->id, "id", $obj->get_rule("id","max_length"));
                $data['form_content'] .= $this->input($obj->link, "link",$obj->get_rule("link","max_length") ,"Link", "Maximo ".$obj->get_rule("link","max_length")." caracteres", $obj->is_rule("link","required"), "span4");
