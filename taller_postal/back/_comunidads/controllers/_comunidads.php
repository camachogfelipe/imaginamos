...
class _comunidads extends Back_Controller {
	protected $admin_area = true;
	public $model = 'comunidad';
	public $name = 'comunidads';
	public $title = 'Texto de Comunidad';
	...
	public function menu() {
		return $this->current_menu['Comunidades y Servivios']['Texto de Comunidad'] = cms_url('comunidads');
	}
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->text($obj->texto, "texto", "Texto", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span10", true, false, $obj->get_rule("texto","max_length"),3,6);
