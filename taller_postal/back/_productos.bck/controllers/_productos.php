...
class _productos extends Back_Controller {
	...
	public function form_edit() {
		...
		$obj->get_by_id($id);
		$data['form_content'] = "";
		$data['form_content'] .= $this->inputHidden($obj->id, "id", $obj->get_rule("id","max_length"));$data['form_content'] .= $this->input($obj->tiutlo, "tiutlo",$obj->get_rule("tiutlo","max_length") ,"Nombre", "Maximo ".$obj->get_rule("tiutlo","max_length")." caracteres", $obj->is_rule("tiutlo","required"), "span3");
$data['form_content'] .= $this->text($obj->texto, "texto", "Descripción", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span3", true, false, $obj->get_rule("texto","max_length"),3,4);
...
$data['form_content'] .= $this->combox($obj->disenador_id,$var_disenador_id->get_disenador_list(),"disenador_id", "Diseñador", "", $obj->is_rule("disenador_id","required"), "span3");
