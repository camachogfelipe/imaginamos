...
class _cantidads extends Back_Controller {
	protected $admin_area = true;
	public $model = 'cantidad';
	public $name = 'cantidads';
	public $title = 'Rango de Cantidades';
	...
	public function menu() {
		return $this->current_menu['Configuraciones']['Rango de Cantidades'] = cms_url('cantidads');
	}
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->input($obj->inico, "inico",$obj->get_rule("inico","max_length") ,"Inicio de Rango", "Maximo ".$obj->get_rule("inico","max_length")." caracteres", $obj->is_rule("inico","required"), "span3");
		$data['form_content'] .= $this->input($obj->fin, "fin",$obj->get_rule("fin","max_length") ,"Fin de Rango", "Maximo ".$obj->get_rule("fin","max_length")." caracteres", $obj->is_rule("fin","required"), "span3");
