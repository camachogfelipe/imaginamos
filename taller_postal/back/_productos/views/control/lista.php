                        ...
                        <tbody id='table_contet'  >
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td><?php echo $img->tiutlo;  ?></td>
                                    <td>
                                        <?php echo substr(strip_tags($img->texto),0,120)."...";  ?>
                                    </td>
                                    <td>
                                        $<?php echo number_format($img->precio,0,',','.'); ?>
                                    </td>
                                    <td>
                                        $<?php echo number_format($img->precio_envio); ?>
                                    </td>
                                    <td>
                                        $<?php echo number_format($img->precio_stiker); ?>
                                    </td>
                                    <td>
                                        <?php echo $img->categoria_titulo;  ?>
                                    </td>
                                    <td>
                                        <?php echo $img->disenador_nombre;  ?>
                                    </td>
