...
class _papels extends Back_Controller {
	protected $admin_area = true;
	public $model = 'papel';
	public $name = 'papels';
	public $title = 'Tipos de Papeles';
	...
	public function menu() {
		return $this->current_menu['Configuraciones']['Tipos de Papeles'] = cms_url('papels');
	}
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->inputHidden($obj->id, "id", $obj->get_rule("id","max_length"));
                ...
                $data['form_content'] .= $this->text($obj->texto, "texto", "Texto Descriptivo", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span8", false, true, $obj->get_rule("texto","max_length"),3,4);
