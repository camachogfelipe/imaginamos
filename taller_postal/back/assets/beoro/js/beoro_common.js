        ...
        if ($('.searchable').length) {
            ...
            $('.searchable').each(function(key, element){
                 $("#"+$(element).attr('id')).multiSelect({
                     selectableHeader: '<div class="search-header"><input type="text" class="span12 search_ch" data-padre_id="'+$(element).attr('id')+'" id="'+$(element).attr('id')+'-ms-search" autocomplete="off" placeholder="Buscar..."></div>',
