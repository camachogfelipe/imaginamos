...
class _banners extends Back_Controller {
	...
	public function menu() {
		return $this->current_menu['Banners'] = cms_url('banners');
	}
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->input($obj->subtitulo, "subtitulo",$obj->get_rule("subtitulo","max_length") ,"Sub Titulo", "Maximo ".$obj->get_rule("subtitulo","max_length")." caracteres", $obj->is_rule("subtitulo","required"), "span3");
		$data['form_content'] .= $this->input($obj->link, "link",$obj->get_rule("link","max_length") ,"Link", "Maximo ".$obj->get_rule("link","max_length")." caracteres", $obj->is_rule("link","required"), "span3");
