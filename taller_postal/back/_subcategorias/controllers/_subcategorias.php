...
class _subcategorias extends Back_Controller {
	...
	public function menu() {
		return $this->current_menu['Sub Categorias'] = cms_url('subcategorias');
	}
	...
	public function form_edit() {
		...
		$var_categoria_id = new categoria();
	...
	public function form_add() {
		...
		$data['form_content'] .= $this->input($obj->titulo, "titulo",$obj->get_rule("titulo","max_length") ,"Titulo", "Maximo ".$obj->get_rule("titulo","max_length")." caracteres", $obj->is_rule("titulo","required"), "span3");
		$var_categoria_id = new categoria();
		$data['form_content'] .= $this->combox($obj->categoria_id,$var_categoria_id->get_categoria_list("titulo",array('categoria_id' => NULL)),"categoria_id", "Categoria", "", $obj->is_rule("categoria_id","required"), "span3");
		$data['direct_form'] = $this->name.'/add';
		return $this->buildajax('control/form', $data);
	}
	...
	public function lista() {
		$obj = new $this->model();
		$data['datos'] =  $obj->join_related('categoria_basic')->where(array('categoria_id <>' => ''))->get(); 
