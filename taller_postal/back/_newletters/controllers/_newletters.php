...
class _newletters extends Back_Controller {
	protected $admin_area = true;
	public $model = 'newletter';
	public $name = 'newletters';
	public $title = 'Suscripciones';
	...
	public function menu() {
		return $this->current_menu['Home']['Suscripciones'] = cms_url('newletters');
	}
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->input($obj->correo, "correo",$obj->get_rule("correo","max_length") ,"Correo", "Maximo ".$obj->get_rule("correo","max_length")." caracteres", $obj->is_rule("correo","required"), "span3");
