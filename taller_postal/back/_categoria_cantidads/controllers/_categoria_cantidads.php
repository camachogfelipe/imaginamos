...
class _categoria_cantidads extends Back_Controller {
	protected $admin_area = true;
	public $model = 'categoria_cantidad';
	public $name = 'categoria_cantidads';
	public $title = 'Cantidades en Categoria';
	...
	public function menu() {
		return $this->current_menu['Configuraciones']['Cantidades en Categoria'] = cms_url('categoria_cantidads');
	}
	...
	public function form_edit() {
		...
		$var_categoria_id = new categoria_cantidad();
		...
		$var_cantidad_id = new categoria_cantidad();
		$data['form_content'] .= $this->combox($obj->cantidad_id,$var_cantidad_id->get_cantidad_list(),"cantidad_id", "Cantidad", "", $obj->is_rule("cantidad_id","required"), "span3");
	...
	public function lista() {
		$obj = new $this->model();
		$data['datos'] = $obj->join_related('categoria')->join_related('cantidad')->group_by("id")->get(); 
