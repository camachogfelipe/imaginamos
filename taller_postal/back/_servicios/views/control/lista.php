                    ...
                    <table id="dt_basic" class="dataTables_full table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Imagen Segundaria</th>
                                <th>Texto primcipal</th>
                                <th>Texto Segundario</th>
                                <th>Titulo Segundario</th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                        <tbody id='table_contet'  >
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td>
                                        <?php echo substr(strip_tags($img->texto_primcipal),0,120)."...";  ?>
                                    </td>
                                    <td>
                                        <?php echo substr(strip_tags($img->texto_segundario),0,120)."...";  ?>
                                    </td>
                                    <td><?php echo $img->titulo_segundario;  ?></td>
