        ...
        <div class="container">
            ...
            <div id="fade-menu" class="pull-left">
                <ul class="clearfix" id="mobile-nav">
                        ...
                        <li>
                            <a href="javascript:void(0)">Líneas, Productos & Categorías</a>
                            <ul>
                                
                                <li>
                                   <a href="<?php echo cms_url('lineas') ?>">Líneas</a>
                                </li>
                                <li>
                                   <a href="<?php echo cms_url('Categorías') ?>">Categorías</a>
                                </li>
                                <li>
                                   <a href="<?php echo cms_url('color_productos') ?>">Galería Producto por Color</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                   <a href="<?php echo cms_url('paletas') ?>">Catálogos de Colores</a>
                                </li>
                                 <li>
                                   <a href="<?php echo cms_url('tool_tips') ?>">Tool Tips</a>
                                </li>
                                <li>
                                   <a href="<?php echo cms_url('papels') ?>">Tipos de Papeles</a>
                                </li>
                                <li>
                                   <a href="<?php echo cms_url('configuracions') ?>">Configuraciones de Visibilidad</a>
                                </li>
                                <li>
                              ...
                              <li>
                                  <a href="javascript:void(0)">Ajustes de Categorías</a>
                                  <ul>
                                      <li>
                                          <a href="<?php echo cms_url('categoria_cantidads') ?>">Cantidades de Categorías</a>
                                      </li>
                                      <li>
                                          <a href="<?php echo cms_url('categoria_papels') ?>">Papeles de Categorías</a>
                                      </li>  
                                      <li>
                                          <a href="<?php echo cms_url('color_papels') ?>">Colores de Papeles</a>
                                      </li>
                                      <li>
                                           <a href="<?php echo cms_url('categoria_sobres') ?>">Sobres de Categorías</a>
                                      </li> 
                                  </ul>
                              </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo cms_url('generator_modules') ?>">Generador de Módulos</a>
                                    </li>
                                    <li>
