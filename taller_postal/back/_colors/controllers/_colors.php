...
class _colors extends Back_Controller {
	...
	public function menu() {
		return $this->current_menu['Configuraciones']['Colores'] = cms_url('colors');
	}
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->input($obj->titulo, "titulo",$obj->get_rule("titulo","max_length") ,"Nombre del Color", "Maximo ".$obj->get_rule("titulo","max_length")." caracteres", $obj->is_rule("titulo","required"), "span3");
		$data['form_content'] .= $this->inputColor($obj->valor, "valor" ,"Valor del Color", "Formato Hexadecimal", $obj->is_rule("valor","required"), "span3","hex");
