    ...
    <div class="clearfix">
      <div class="left_footer1 left">
        ...
        <ul class="lista_cont">
          ...
          <li class="item_tel">
            <span>Telefóno: <?php echo $contacto->telefono; ?></span>
          </li>
          <li class="item_cel">
            <span>Mobile: <?php echo $contacto->celular; ?></span>
          </li>
          <li class="item_mail">
      ...
      <div class="right">
        ...
        <ul class="redes clearfix">
          <li class="left">
            <a href="<?php echo $facebook->link_red; ?>" class="fb"></a>
          </li>
          <li class="left">
            <a href="<?php echo $twitter->link_red; ?>" class="tw"></a>
          </li>
          <li class="left">
            <a href="<?php echo $instagram->link_red; ?>" class="ins"></a>
          </li>
          <li class="left">
            <a href="<?php echo $google_plus->link_red; ?>" class="pt"></a>
          </li>
        </ul>
      </div>
    </div>
