...
<div class="content_home">
    ...
    <div class="clearfix">
      ...
      <iframe class="right" src="<?php echo "//player.vimeo.com/video/".str_replace("http://","",str_replace("vimeo.com/","",$video->link)); ?>" width="520" height="380" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
    </div>
