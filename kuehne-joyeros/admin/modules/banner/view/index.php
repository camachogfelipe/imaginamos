        ...
        <!--End External Files-->
		 <script type="text/javascript" >
			  function cargar(){
				...
				llamarasincrono('sub.php?categoria='+categoria, 'subcategoria');
				}
			function ventana(){
				llamarasincrono('sub.php', 'subcategoria');
			}				
		</script>

        </head>
        
        <body class="dashborad" onLoad="ventana();">
			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>BANNER</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_productos'",SHOW_TABLE_QUERY);
