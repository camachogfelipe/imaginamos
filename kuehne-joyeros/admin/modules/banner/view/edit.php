...
<head>
        ...
        <script type="text/javascript" >
			  function cargar(){
				...
				llamarasincrono('sub.php?categoria='+categoria+'&id=<?php echo $id; ?>', 'subcategoria');
			 }
			function ventana(){
		...
		$erno = $_GET['erno'];
			...
			else
			{
				if ($erno==1)
				{
					...
					document.getElementById('info1').innerHTML = 'Actualización correcta!<br />';
					$('#info1').show();
					})
					</script>
                    <?php
	   ...
	   ?>
        ...
        <body class="dashborad" onload="cargar();">
