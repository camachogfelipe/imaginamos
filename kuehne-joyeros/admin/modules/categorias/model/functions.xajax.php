...
{  
	...
	if($formData[desc_es] == "" or $formData[desc_en] == "")
	
		$objResponse->script("showError('Ingrese un titulo Categoria en Español e Ingles',3000);");
		...
		$db->doQuery("INSERT INTO cms_categorias (desc_categoria_es,desc_categoria_en) VALUES ('$formData[desc_es]','$formData[desc_en]')",INSERT_QUERY);
...
{  
	...
	if($formData[desc_es] == "" or $formData[desc_en] == "")
		...
		$db->doQuery("UPDATE cms_categorias SET desc_categoria_es = '$formData[desc_es]', desc_categoria_en = '$formData[desc_en]' WHERE id_categoria = '$formData[id]'",UPDATE_QUERY);
