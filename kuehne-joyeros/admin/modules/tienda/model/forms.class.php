...
function printFormNews($id, $funcionality)
		{	
			...
			case 1:
				...
				$query3 = "SELECT * FROM cms_banner WHERE tipo = 2";
						  ...
						  <fieldset>';				  
							  if($id == 4){
								$html .= '<div>
								  ...
								  <div>
									<br><p><label>Imágenes de tienda</label></p>
								 ...
								 </div><div align="left">•Tamaño : 675x461</div><br>';
							...
							$html .= '<div>';
								...
								if($results3 != ""){
									...
									$html .= '
										...
										<tr>
										<td width="18%"><a href = "../files/'.$result3[imagen].'" target="_blank"><img src ="../files/'.$result3[imagen].'" width="140px"/></a></td>
										</tr>
										<tr><td>&nbsp;&nbsp;&nbsp;
										<a class="uibutton" onclick="xajax_news('.$result3[id_banner].'); return false;">Eliminar Imagen</a>
										<td></tr>
										</table>';
										$a++;	
									}
