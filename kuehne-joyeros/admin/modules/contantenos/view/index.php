			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>CONTENIDOS</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_categorias'",SHOW_TABLE_QUERY);
					...
					if($show = $db->show)
						...
						echo $htmlFormNews->printFormNews($id,$result[0][news_config_funcionality]);
						}
					else
              ...
              <script language="javascript">$("#desc_es").cleditor(); $("#desc_en").cleditor();</script> 
