...
/********************************************************************************************/
function edit( $formData , $id_banner)
{  
	...
	for($a=0; $a < count($results2); $a++)
	{
		$db->doQuery("UPDATE cms_banner SET link_b = '".$formData['link_b'.$id_banner]."' WHERE id_banner = ".$id_banner,INSERT_QUERY);
	}
