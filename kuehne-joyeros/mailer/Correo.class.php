...
//echo "aca1";
    ...
    $mail->SMTPSecure = "secure.emailsrvr.com";
    // Servidor smtp
    $mail->Host = "smtp.emailsrvr.com";
    // Puerto de salida de envio de email
    $mail->Port = 25;
    // Usuario (Cuenta de correo)
    $mail->Username = "info@kuehnejoyeros.com";
    // Contrase�a
    $mail->Password = "kuehne724786";
    // Desde que correo quiere que se muestre
    $mail->From = "info@kuehnejoyeros.com";
    // Desde (Nombre)
    $mail->FromName = "KUEHN JOYEROS";
    // Asunto
    $mail->Subject = "KUEHN JOYEROS - " . $asunto;
