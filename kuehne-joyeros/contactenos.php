  ...
  <div class="home">    
    <div class="contact val">
      ...
      <div class="clearfix">
         ...
         <form action="mail.php" method="post" name="form12" id= "form12">
        <div class="left">  
         <div id="nom" style="color:#FF0000; display:none; ">* <?php if($_SESSION['idioma'] == "en"){ ?>Required Field<?php }else{ ?>Campo Obligatorio<?php } ?></div>
          ...
          <input type="text" name="email" id="email"  value="<?php if($_SESSION['idioma'] == "en"){ ?>E-mail<?php }else{ ?>Correo electronico<?php } ?>" onBlur="valida();">
          <div id="tel" style="color:#FF0000; display:none;">* <?php if($_SESSION['idioma'] == "en"){ ?>Required Field<?php }else{ ?>Campo Obligatorio<?php } ?></div>
          <input type="text" name="telefono" id="telefono"  value="<?php if($_SESSION['idioma'] == "en"){ ?>Phone<?php }else{ ?>Telefono<?php } ?>" onBlur="valida();" onKeyPress="return esInteger(event);">
        </div> 
