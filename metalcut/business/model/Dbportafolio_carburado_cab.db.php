<?php
/*
 * @file               : Dbportafolio_carburado_cab.db.php
 * @brief              : Clase para la interaccion con la tabla portafolio_carburado_cab
 * @version            : 3.3
 * @ultima_modificacion: 2013-08-09
 * @author             : Ruben Dario Cifuentes Torres
 * @generated          : Generador DAO vercion 1.1
 *
 * @class: Dbportafolio_carburado_cab
 * @brief: Clase para la interaccion con la tabla portafolio_carburado_cab
 */
 
class Dbportafolio_carburado_cab extends DbDAO {

  protected $idportafolio_carburado_cab = NULL;
  protected $idportafolio_carburado = NULL;
  ...
  public function setidportafolio_carburado_cab($mData = NULL) {
    if ($mData === NULL) { $this->idportafolio_carburado_cab = NULL; }
    $this->idportafolio_carburado_cab = StripHtml($mData);
  }

  public function setidportafolio_carburado($mData = NULL) {
    if ($mData === NULL) { $this->idportafolio_carburado = NULL; }
    $this->idportafolio_carburado = StripHtml($mData);
  }
