<?php
/*
 * @file               : Dbporta_portafolio_fresado_cab.db.php
 * @brief              : Clase para la interaccion con la tabla porta_portafolio_fresado_cab
 * @version            : 3.3
 * @ultima_modificacion: 2013-08-09
 * @author             : Ruben Dario Cifuentes Torres
 * @generated          : Generador DAO vercion 1.1
 *
 * @class: Dbporta_portafolio_fresado_cab
 * @brief: Clase para la interaccion con la tabla porta_portafolio_fresado_cab
 */
 
class Dbporta_portafolio_fresado_cab extends DbDAO {

  protected $idporta_portafolio_fresado_cab = NULL;
  ...
  public function setidporta_portafolio_fresado_cab($mData = NULL) {
    if ($mData === NULL) { $this->idporta_portafolio_fresado_cab = NULL; }
    $this->idporta_portafolio_fresado_cab = StripHtml($mData);
  }
