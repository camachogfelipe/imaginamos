    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
       // print_r($data);
        if ($row>1){
            ...
            $sql="select * from porta_alesado where ";
            $cadena = "INSERT INTO porta_alesado(
                         idalesado,
                         ref,
                         diam_ajugero,
                         diam_barra,	
                         ...
                         inserto,
                         valor
                         ) VALUES ( ". $idalesado.','; //Cambia los valores 'CampoX' por el nombre de tus campos de tu tabla y colócales los necesarios
            ...
            $sql.="ref='".$dato[0]."' and
                 diam_ajugero='".$dato[1]."' and
                 diam_barra='".$dato[2]."' and
                 long_barra='".$dato[3]."' and	    
                 inserto='".$dato[4]."'  ";
...
<!-- full width -->
<div class="header"><span><span class="ico gray window"></span>Carga de Porta Herramientas - Alesado</span>
</div><!-- End header -->
<div class="content">
    <a class="uibutton icon normal answer" href="index.php?seccion=porta_alesado&idalesado=<?php echo $_REQUEST["idalesado"] ?>">Porta Herramienta</a>
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                ...
                <form method="post" action="" name="forminterno3" id="forminterno3" enctype="multipart/form-data">
                   <!-- <input type="hidden" value="<?php echo $porta_alesado["idporta_alesado"] ?>" name="id" id="id">-->
                    <div class="section">                                                                                                  
                        ...
                        <a href="plantilla_porta_alesado.csv" target="_blank">Descargar</a>
