    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
       // print_r($data);
        if ($row>1){
            ...
            $sql="select * from porta_escuadrado where ";
            $cadena = "INSERT INTO porta_escuadrado(
                         idescuadrado,
                         ref,
                         diam_corte,
                         diam_espigo,	
                         ...
                         inserto,
                         valor
                         ) VALUES ( ". $idescuadrado.','; //Cambia los valores 'CampoX' por el nombre de tus campos de tu tabla y colócales los necesarios
            ...
            $sql.="ref='".$dato[0]."' and
                 ...
                 n_insertos='".$dato[2]."' and	
                 inserto='".$dato[5]."' and
                 angulo_ataque='".$dato[6]."'  ";
...
<!-- full width -->
<div class="header"><span><span class="ico gray window"></span>Carga de Porta Herramientas - Escuadrado</span>
</div><!-- End header -->
<div class="content">
    <a class="uibutton icon normal answer" href="index.php?seccion=porta_escuadrado&idescuadrado=<?php echo $_REQUEST["idescuadrado"] ?>">Porta Herramienta</a>
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                ...
                <form method="post" action="" name="forminterno3" id="forminterno3" enctype="multipart/form-data">
                   <!-- <input type="hidden" value="<?php echo $porta_escuadrado["idporta_escuadrado"] ?>" name="id" id="id">-->
                    <div class="section">                                                                                                  
                        ...
                        <a href="plantilla_porta_escuadrado.csv" target="_blank">Descargar</a>
