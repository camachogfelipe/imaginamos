...
$db->doQuery("SELECT idporta_escuadrado FROM porta_escuadrado  ORDER BY idporta_escuadrado DESC Limit 1", 1);
$limit = $db->results[0];
$img = $_POST['idporta_escuadrado'];
//echo $img.'-->ok';
$id=!empty($_REQUEST['id']) ? $_REQUEST['id'] : null;  
$idescuadrado=!empty($_POST['idescuadrado']) ? $_POST['idescuadrado'] : null; 
...
if (empty($_REQUEST['id']) && isset($_POST['tipo'])){
    if ( $_POST['ref'] == "" && $_POST['diam_corte'] == "" && $_POST['diam_espigo'] == "" && $_POST['long_total'] == "" && $_POST['n_insertos'] == "" && $_POST['inserto'] == "" && $_POST['valor'] == ""  ){
        $Erno = 2;
                    ...
                    $sql="INSERT INTO porta_escuadrado(
                         idescuadrado,
                         ref,
                         diam_corte,
                         diam_espigo,	
    ...
    if($_POST['idporta_escuadrado'] == "" && $_POST['ref'] == "" && $_POST['diam_corte'] == "" && $_POST['diam_espigo'] == "" && $_POST['long_total'] == "" && $_POST['n_insertos'] == "" && $_POST['inserto'] == "" && $_POST['valor'] == "" ) {
            $Erno = 2;
     }else{
         $sql="UPDATE porta_escuadrado SET 
             ref='".$ref."',
             ...
             valor='".$valor."' WHERE idporta_escuadrado='".$id."'";
         // echo $sql;
         $db->doQuery($sql, 4); 
    }
}
...
if (empty($id)){
    $db->doQuery("SELECT * FROM porta_escuadrado ORDER BY idporta_escuadrado ASC", 1);
    $fil = $db->rows;
}

if (!empty($id)){
 //   echo "SELECT * FROM idporta_escuadrado WHERE idporta_escuadrado=" . $id;
    $db->doQuery("SELECT * FROM porta_escuadrado WHERE idporta_escuadrado='" . $id."'", 1);
    $porta_escuadrado = $db->results[0];
}
...
<div class="content">
    ...
    <a class="uibutton icon normal answer" href="index.php?seccion=porta_escuadrado">Atras</a>
    <?php }else{ ?>
    ...
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                <legend><h1>Escuadrado y Ranurado</h1></legend>
                <form method="post" action="" name="forminterno2" id="forminterno2" enctype="multipart/form-data">
                   <input type="hidden" value="<?php echo $porta_escuadrado["idporta_escuadrado"] ?>" name="id" id="id">
                   <input type="hidden" value="<?php echo $_REQUEST['idescuadrado']?>" name="idescuadrado" id="idescuadrado">
                   <input type="hidden" value="1" name="tipo" id="tipo">
                   
                    <div class="section">                                                                                                  
                        <label>REF</label>
						<div>
                        <input type="text" name="ref" id="ref" class="medium" value="<?php echo $porta_escuadrado["ref"] ?>">
                    ...
                    <div class="section">                                                                                                  
						...
						<div>
                        <input type="text" name="diam_corte" id="diam_corte" class="medium" value="<?php echo $porta_escuadrado["diam_corte"] ?>">
                    ...
                    <div class="section">                                                                                                  
						...
						<div>
                        <input type="text" name="diam_espigo" id="diam_espigo" class="medium" value="<?php echo $porta_escuadrado["diam_espigo"] ?>">
                    ...
                    <div class="section">                                                                                                  
						...
						<div>
                        <input type="text" name="long_total" id="long_total" class="medium" value="<?php echo $porta_escuadrado["long_total"] ?>">
                    ...
                    <div class="section">                                                                                                  
						...
						<div>
                        <input type="text" name="n_insertos" id="n_insertos" class="medium" value="<?php echo $porta_escuadrado["n_insertos"] ?>">
                    ...
                    <div class="section">                                                                                                  
						...
						<div>
                        <input type="text" name="angulo_ataque" id="angulo_ataque" class="medium" value="<?php echo $porta_escuadrado["angulo_ataque"] ?>">
                    ...
                    <div class="section">                                                                                                  
                        <label>Inserto</label>
						<div>
                        <input type="text" name="inserto" id="inserto" class="medium" value="<?php echo $porta_escuadrado["inserto"] ?>">
                   ...
                   <div class="section">                                                                                                  
                    <label>Valor</label>
                    <div>
                    <input type="text" name="valor" id="valor" class="medium" value="<?php echo $porta_escuadrado["valor"] ?>">
                    ...
                    <div>
                        ...
                        <a href="index.php?seccion=archivo&idescuadrado=1" id="submitForm2"  class="uibutton large">Archivo Plano</a>
                    </div>
                </form>
            </fieldset>
        <?php// } else { 
                    ...
                    <tbody>
                        ...
                        for ($i = 0; $i < $fil; $i++) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center idporta_escuadrado" width="100px">
                                    <?php if(($i+1) != $fil){ ?>
                                    <a id="<?php echo $img["idporta_escuadrado"] ?>" class="Delete uibutton special" tableToDelete="porta_escuadrado" nameField="idporta_escuadrado">Eliminar</a> 
                                    <?php } ?>
                                    <a class="uibutton icon edit" href="index.php?seccion=porta_escuadrado&idescuadrado=<?php echo $_REQUEST['idescuadrado'] ?>&id=<?= $img["idporta_escuadrado"] ?>">Editar</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
