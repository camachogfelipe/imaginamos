...
<script type="text/javascript" language="javascript">
    $('#ref').limit('23','.ref');
    $('#diam_corte').limit('23','.diam_corte');
    $('#diam_espigo').limit('23','.diam_espigo');
    $('#long_total').limit('23','.long_total');
    $('#n_insertos').limit('23','.n_insertos');
    $('#angulo_ataque').limit('23','.angulo_ataque');
    $('#inserto').limit('23','.inserto');
    $('#valor').limit('23','.valor');
</script>
