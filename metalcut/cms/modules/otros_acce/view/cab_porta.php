...
$db->doQuery("SELECT idportafolio_cab FROM portafolio_cab  ORDER BY idportafolio_cab DESC Limit 1", 1);
$limit = $db->results[0];
...
if (empty($_REQUEST['id']) && isset($_POST['tipo']) ){
    ...
    if($_POST['col1'] == ""  && $_POST['nivel']=="" ) {
         ...
         $sql="UPDATE portafolio_cab SET col1='".$col1."', col2='".$col2."', col3='".$col3."', col4='".$col4."', col5='".$col5."',
               col6='".$col6."', col7='".$col7."', col8='".$col8."', col9='".$col9."', col10='".$col10."' WHERE idportafolio_cab=" . $id;
       // echo $sql;
         $db->doQuery($sql, 4);
         $Erno = 1;
...
if (empty($id)){
    $db->doQuery("SELECT * FROM portafolio_cab where nivel='".$nivel."' and idportafolio='".$idportafolio."'   ORDER BY idportafolio_cab ASC", 1);
    $fil = $db->rows;
}
                        ...
                        for ($i = 0; $i < $fil; $i++) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center idcol1" width="100px">
                                    ...
                                    <?php //} ?>
                                    <a class="uibutton icon edit" href="index.php?seccion=cab_porta&id=<?= $img["idportafolio_cab"] ?>&nivel=<?php echo $nivel ?>&idportafolio=<?php echo $img["idportafolio"] ?>&ncolum=<?php echo $ncolum ?>">Editar</a>
