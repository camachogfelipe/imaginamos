    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
       // print_r($data);
        if ($row>1){
            ...
            $sql="select * from porta_portafolio_cab where ";
            $cadena = "INSERT INTO porta_portafolio_cab(
                         idportafolio_cab,
                         col1,
                         col2,
                         col3,
                         ...
                         col10,
                         valor
                         ) VALUES ( ". $idportafolio_cab.','; //Cambia los valores 'CampoX' por el nombre de tus campos de tu tabla y colócales los necesarios
           // if ($num<10) $num=19;
...
<div class="content">
    <!--<a class="uibutton icon normal answer" href="index.php?seccion=porta_portafolio_cab&idportafolio_cab=<?= $idportafolio_cab ?>&nivel=<?= $nivel ?>&ncolum=<?php echo $ncolum ?>">Porta Herramienta</a>-->
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                ...
                <form method="post" action="" name="forminterno3" id="forminterno3" enctype="multipart/form-data">
                   <!-- <input type="hidden" value="<?php echo $porta_portafolio_cab["idporta_portafolio_cab"] ?>" name="id" id="id">-->
                    <div class="section">                                                                                                  
                       ...
                       <!-- <a href="plantilla_porta_portafolio_cab_<?php echo $ncolum ?>.csv" target="_blank">Descargar</a>-->
