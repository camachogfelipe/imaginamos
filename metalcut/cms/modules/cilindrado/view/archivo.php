...
if (empty($_REQUEST['id']) && isset($_POST['tipo'])){
    ...
    $idcilindrado=$_REQUEST['idcilindrado'];
    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
       // print_r($data);
        if ($row>1){
            ...
            $sql="select * from porta_cilindrado where ";
            $cadena = "INSERT INTO porta_cilindrado(
                         idcilindrado,
                         ref,
												 figura,
                         tamano,
                         ...
                         valor, 
                         idmaterial
                         ) VALUES ( ". $idcilindrado.','; //Cambia los valores 'CampoX' por el nombre de tus campos de tu tabla y col�cales los necesarios
...
<!-- full width -->
<div class="header"><span><span class="ico gray window"></span>Carga de Porta Herramientas - Cilindrado</span>
</div><!-- End header -->
<div class="content">
    <a class="uibutton icon normal answer" href="index.php?seccion=porta_cilindrado&idcilindrado=<?php echo $_REQUEST["idcilindrado"] ?>">Porta Herramienta</a>
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                ...
                <form method="post" action="" name="forminterno3" id="forminterno3" enctype="multipart/form-data">
                   <!-- <input type="hidden" value="<?php echo $porta_cilindrado["idporta_cilindrado"] ?>" name="id" id="id">-->
                    <div class="section">                                                                                                  
                        ...
                        <a href="plantilla_porta_cilindrado.csv" target="_blank">Descargar</a>
