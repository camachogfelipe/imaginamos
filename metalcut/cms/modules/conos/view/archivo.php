    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
       // print_r($data);
        if ($row>1){
            ...
            $sql="select * from porta_conos where ";
            $cadena = "INSERT INTO porta_conos(
                         idproductos_conos,
                         ref,
                         longitud,
                         diametro,	
                         tipo_boquilla,
                         valor
                         ) VALUES ( ". $idproductos_conos.','; //Cambia los valores 'CampoX' por el nombre de tus campos de tu tabla y colócales los necesarios
            ...
            $sql.="
                 idproductos_conos='".$idproductos_conos."' and
                 ref='".$dato[0]."' and
                 longitud='".$dato[1]."' and
                 diametro='".$dato[2]."' and
...
<!-- full width -->
<div class="header"><span><span class="ico gray window"></span>Carga de Porta Herramientas - Conos</span>
</div><!-- End header -->
<div class="content">
    <a class="uibutton icon normal answer" href="index.php?seccion=porta_conos&idproductos_conos=<?php echo $_REQUEST["idproductos_conos"] ?>">Porta Herramienta</a>
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                ...
                <form method="post" action="" name="forminterno3" id="forminterno3" enctype="multipart/form-data">
                   <!-- <input type="hidden" value="<?php echo $porta_conos["idporta_conos"] ?>" name="id" id="id">-->
                    <div class="section">                                                                                                  
                        ...
                        <a href="plantilla_porta_conos.csv" target="_blank">Descargar</a>
