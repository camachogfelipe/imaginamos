...
if (empty($id)){
    $retorno = ClassFile::UploadImagenFile("img", "../../../../assets/img/img_taladrado", "img_taladrado_" . $img, "960_392_img_taladrado_" . $img, 960, 392);
}else{
    $retorno = ClassFile::UploadImagenFile("img", "../../../../assets/img/img_taladrado", "img_taladrado_" . $id, "960_392_img_taladrado_" . $id, 960, 392);
}
