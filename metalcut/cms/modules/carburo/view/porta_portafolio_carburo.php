...
$idportafolio=$_REQUEST['idportafolio_carburo'];

$sql_c1="select * from portafolio_carburado_cab where idportafolio_carburado=" .$idportafolio;
//echo $sql_c1;
$db->doQuery($sql_c1,1);
    ...
    <div class="formEl_b">
            <fieldset>
                ...
                <form method="post" action="" name="forminterno2" id="forminterno2" enctype="multipart/form-data">
                    ...
                    <input type="hidden" value="<?php echo $idportafolio ?>" name="idportafolio_carburado" id="idportafolio_carburado">
...
<script>
    ...
    $(document).ready(function() {
     ...
     if (ncol>0){
         ...
         var nivel=$("#nivel").val();
         var idportafolio=$("#idportafolio_carburado").val();
