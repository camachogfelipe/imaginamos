...
$nivel_siguiente = $nivel+1; 
 ...
 $db->doQuery("SELECT * FROM portafolio_carburo WHERE idportafolio_carburo='" . $idportafoliopadre."' LIMIT 1", 1);
 $atras = $db->results[0];
...
<!-- full width -->
<div class="header"><span><span class="ico gray window"></span>Carburo Solido</span>
...
<div class="content">
    ...
    <div class="formEl_b">
        <?php if (($fil < 10) and (!empty($id) or $nivel!=0) ) { ?>
            ...
            <fieldset>
              ...
              <?php }else{ ?>
                <legend><h1><?php echo "Carburo Solido"." Nivel ".$nivel ; ?></h1></legend>
              <?php } ?>  
                        ...
                        for ($i = 0; $i < $fil; $i++) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center idtitulo" width="100px">
                                    ...
                                    <?php  } ?>
                                    <a class="uibutton icon edit" href="index.php?seccion=menu&idportafolio_carburo=<?= $img["idportafolio_carburo"] ?>&id=<?= $img["idportafolio_carburo"] ?>&nivel=<?php echo $nivel ?>&idpadre=<?= $_REQUEST['idpadre'] ?>">Editar</a>
                                    <?php if ($nivel<7){ ?>
                                        ...
                                        <?php }else{ ?>
                                                <a class="uibutton icon edit" href="index.php?seccion=nivel&nivel=<?= $nivel_siguiente ?>&name=<?= $_REQUEST['name'] ?>&idpadre=<?= $img["idportafolio_carburo"]?>">Crear SubNivel</a>
                                        <?php } ?>
                                   <?php } ?>
                                </td>
                            </tr>
