    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
       // print_r($data);
        if ($row>1){
            ...
            $sql="select * from porta_roscado_int where ";
            $cadena = "INSERT INTO porta_roscado_int(
                         idroscado,
                         ref,
                         diam_corte,
                         long_total,	
                         ...
                         n_insertos,
                         valor
                         ) VALUES ( ". $idroscado.','; //Cambia los valores 'CampoX' por el nombre de tus campos de tu tabla y colócales los necesarios
            ...
            $sql.="ref='".$dato[0]."' and
                 ...
                 diam_espigo='".$dato[2]."' and    
                 long_total='".$dato[3]."' and	
                 n_insertos='".$dato[4]."'  and
                 inserto='".$dato[5]."' ";
...
<!-- full width -->
<div class="header"><span><span class="ico gray window"></span>Carga de Porta Herramientas - Roscado</span>
</div><!-- End header -->
<div class="content">
    <a class="uibutton icon normal answer" href="index.php?seccion=porta_roscado_interno&idroscado=<?php echo $_REQUEST["idroscado"] ?>">Porta Herramienta</a>
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                <legend><h1>Ranurado y Corte</h1></legend>
                ...
                <form method="post" action="" name="forminterno3" id="forminterno3" enctype="multipart/form-data">
                   <!-- <input type="hidden" value="<?php echo $porta_roscado_int["idporta_roscado_int"] ?>" name="id" id="id">-->
                    <div class="section">                                                                                                  
                        ...
                        <a href="plantilla_porta_roscado_int.csv" target="_blank">Descargar</a>
