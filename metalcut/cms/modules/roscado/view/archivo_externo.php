    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
       // print_r($data);
        if ($row>1){
            ...
            $sql="select * from porta_roscado_ext where ";
            $cadena = "INSERT INTO porta_roscado_ext(
                         idroscado,
                         ref,
                         diam_ajugero,
                         diam_barra,	
...
<div class="content">
    <a class="uibutton icon normal answer" href="index.php?seccion=porta_roscado_ext&idroscado=<?php echo $_REQUEST["idroscado"] ?>">Porta Herramienta</a>
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                ...
                <form method="post" action="" name="forminterno3" id="forminterno3" enctype="multipart/form-data">
                   <!-- <input type="hidden" value="<?php echo $porta_roscado_ext["idporta_roscado_ext"] ?>" name="id" id="id">-->
                    <div class="section">                                                                                                  
                        ...
                        <a href="plantilla_porta_roscado_ext.csv" target="_blank">Descargar</a>
