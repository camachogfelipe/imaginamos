...
$nivel_siguiente = $nivel+1; 
 ...
 $db->doQuery("SELECT * FROM portafolio_fresado WHERE idportafolio_fresado='" . $idportafoliopadre."' LIMIT 1", 1);
 $atras = $db->results[0];
                        ...
                        for ($i = 0; $i < $fil; $i++) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center idtitulo" width="100px">
                                    ...
                                    <a class="uibutton icon edit" href="index.php?seccion=menu&idportafolio_carburo=<?= $img["idportafolio_carburo"] ?>&id=<?= $img["idportafolio_fresado"] ?>&nivel=<?php echo $nivel ?>&idpadre=<?= $_REQUEST['idpadre'] ?>">Editar</a>
                                    <?php if ($nivel<7){ ?>
                                        ...
                                        <?php }else{ ?>
                                                <a class="uibutton icon edit" href="index.php?seccion=nivel&nivel=<?= $nivel_siguiente ?>&idpadre=<?= $img["idportafolio_fresado"]?>">Crear SubNivel</a>
                                        <?php } ?>
                                   <?php } ?>
                                </td>
                            </tr>
