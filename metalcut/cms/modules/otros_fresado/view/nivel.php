...
$db->doQuery("SELECT * FROM portafolio_fresado where idportafolio_fresado='".$idportafoliopadre."' ORDER BY idportafolio_fresado ASC", 1);
$atras = $db->results[0];
$atras_id = $atras['idportafolio_fresado']; 
...
if (empty($id)){
    $sql="SELECT * FROM nivel_fresado where  nivel='".$nivel."' and idportafolio_fresado=" . $idportafoliopadre ."  ORDER BY idnivel_fresado ASC";
   // echo $sql.'ca..';
    $db->doQuery($sql, 1);
                        ...
                        for ($i = 0; $i < $fil; $i++) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center titulo" width="100px">
                                    ...
                                    <?php } ?>
                                    <a class="uibutton icon edit" href="index.php?seccion=nivel&idpadre=<?= $idportafoliopadre ?>&nivel=<?= $_REQUEST['nivel'] ?>&id=<?= $img["idnivel_fresado"] ?>">Editar</a>
