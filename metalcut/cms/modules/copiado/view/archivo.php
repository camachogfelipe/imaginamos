    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
       // print_r($data);
        if ($row>1){
            ...
            $sql="select * from porta_copiado where ";
            $cadena = "INSERT INTO porta_copiado(
                         idcopiado,
                         ref,
                         diam_corte,
                         diam_espigo,	
                         ...
                         inserto,
                         valor
                         ) VALUES ( ". $idcopiado.','; //Cambia los valores 'CampoX' por el nombre de tus campos de tu tabla y colócales los necesarios
...
<!-- full width -->
<div class="header"><span><span class="ico gray window"></span>Carga de Porta Herramientas - Copiado</span>
</div><!-- End header -->
<div class="content">
    <a class="uibutton icon normal answer" href="index.php?seccion=porta_copiado&idcopiado=<?php echo $_REQUEST["idcopiado"] ?>">Porta Herramienta</a>
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                ...
                <form method="post" action="" name="forminterno3" id="forminterno3" enctype="multipart/form-data">
                   <!-- <input type="hidden" value="<?php echo $porta_copiado["idporta_copiado"] ?>" name="id" id="id">-->
                    <div class="section">                                                                                                  
                        ...
                        <a href="plantilla_porta_copiado.csv" target="_blank">Descargar</a>
