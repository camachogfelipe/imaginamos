  ...
  <body class="dashborad">
    ...
    <div id="content">
      <div class="inner">
        ...
        <div id="footer"> &copy; Copyright <?php echo date("Y"); ?> <span class="tip"><a  href="#" title="Todos los derechos reservados" >imaginamos.com</a> </span> </div>
...
<script type="text/javascript" language="javascript">
    $('#ciudad').limit('23','.ciudad');
    $('#direccion1').limit('45','.direccion1');
    $('#direccion2').limit('45','.direccion2');
    $('#telefonos').limit('37','.telefonos');
    $('#fax').limit('33','.fax');
    $('#correos').limit('29','.correos');
</script>