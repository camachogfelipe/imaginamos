    ...
    while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) { //Lee toda una linea completa, e ingresa los datos en el array 'data'
       // print_r($data);
        if ($row>1){
            ...
            $sql="select * from porta_sujecion where ";
            $cadena = "INSERT INTO porta_sujecion(
                         idproductos_sujecion,
                         ref,
                         rango_sujecion,
                         valor
                         ) VALUES ( ". $idproductos_sujecion.','; //Cambia los valores 'CampoX' por el nombre de tus campos de tu tabla y colócales los necesarios
            ...
            $sql.=" idproductos_sujecion='".$idproductos_sujecion."' and
                   ref='".$dato[0]."' and
                   rango_sujecion='".$dato[1]."' ";
...
<!-- full width -->
<div class="header"><span><span class="ico gray window"></span>Carga de Porta Herramientas - Sujecion</span>
</div><!-- End header -->
<div class="content">
    <a class="uibutton icon normal answer" href="index.php?seccion=porta_sujecion&idproductos_sujecion=<?php echo $_REQUEST["idproductos_sujecion"] ?>">Porta Herramienta</a>
    <div class="formEl_b">
        <?php //if ($fil < 99) { ?>
            <fieldset>
                ...
                <form method="post" action="" name="forminterno3" id="forminterno3" enctype="multipart/form-data">
                   <!-- <input type="hidden" value="<?php echo $porta_sujecion["idporta_sujecion"] ?>" name="id" id="id">-->
                    <div class="section">                                                                                                  
                        ...
                        <a href="plantilla_porta_sujecion.csv" target="_blank">Descargar</a>
