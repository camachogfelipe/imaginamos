 ...
 */
define("DB_USER", 'usuariofbz_metalcut'); /* Nombre de usuario de la base de datos */
define("DB_PASSWORD", 'p&86XoI/P4Ea'); /* Clave de acceso del usuario de la base de datos */
define("DB_NAME", 'usuariofbz_metalcut'); /* Nombre de la base de datos a sacar backup */
define("DB_HOST", 'localhost'); /* Nombre del sevidor de donde sacar backup de la base de datos */
define("OUTPUT_DIR", 'DB'); /* Nombre del directorio donde se alojará el archivo de backup de la base de datos */
