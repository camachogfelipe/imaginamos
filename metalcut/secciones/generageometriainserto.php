         ...
         ?>
                 <li>
                   <div class="paso-item">
                    ...
                    <!--<a href="index.php?base&seccion=cilindrado-alesado&opciones=<?php echo $idtipo_inserto ?>&material=<?php echo $idmaterial ?>&geometria=<?php echo $datos[$j]['idgeometria'] ?>"><div class="paso-bt"></div></a>-->
