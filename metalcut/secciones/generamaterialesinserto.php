         ...
         ?>
                  <li>
                   ...
                   <?php
                    if($porta != "1"):
                   ?>
                   <a href="#va-paso-3" class="vn-nav paso-item-p2" onclick="displayGeometriaInserto('<?php echo $idtipo_inserto ?>', '<?php echo $datos[$j]['idmateriales']?>', '<?php echo $porta?>')"  data-id="con-paso-1-1-1">
