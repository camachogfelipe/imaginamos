...
$db->connect();
    $datos=""; $carimg=''; $tipo='';
    $sql="select * from nivel_portafolio where nivel='".$nivel."' and idportafolio='".$idpadre."' ";
    // echo $sql.'<br>';
    $db->doQuery($sql, 1);
    $datos1 = $db->results;
    
    $sql1="select * from portafolio where nivel='".$nivel."' and modulo='".$modulo."' and idportafoliopadre='".$idpadre."' ";
    //echo $sql1;
    $db->doQuery($sql1, 1);
    $datos = $db->results;
    $cant=count($datos);
                ...
                ?>    
                  <li>
                	<div class="paso-item">
                        ...
                        <?php if ($paso=='P'){ ?>
                        <a href="index.php?base&seccion=accesorios-per&idportfolio=<?php echo $idp ?>" class="vn-nav paso-item-p1" ><div class="paso-bt-vn"></div></a>
                        <?php }else{ ?>
