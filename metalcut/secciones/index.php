    ...
    <div class="mg-slider clearfix">
      ...
      <ul class="slider-home">
       <?php for($i = 0 ; $i < $cant ; $i++){ ?>
        <li class="slide">
          <div class="slider-img"><img src="assets/img/banner/<?php echo $banner[$i]["imagen"] ?>" width="640" height="336" alt=""></div>
      ...
      <div class="mg-section clearfix">
        <div class="destacados-fila">
          <div class="destacado-info">
            <a onclick="psq90uow(); return false;" href="<?php echo $destacados[0]['link'] ?>">
