...
<div class="detallesWrapper">
	<div class="migasVolverBox">
    	<div class="migasWrapper">
        	...
        	<div class="migasCenter"><a class="migaslink" href=<?php echo selecionOrigen() . '.php?v='.selecionOrigen(); ?> id="seccion"><?php echo  ucwords(selecionOrigen()) ; ?></a><span class="arrow"></span><a class="migaslinkS" >¿Cómo cambio la clave que registré en el celular?</a></div>
    ...
    <div class="mainContetBoxLeft">
   	  <div class="tituloWrapper">
            ...
            <div class="titulo"><strong>¿Cómo cambio la clave</strong><br /> que registré en el celular?</div>
       </div>
       <div class="textosBox">
       <span class="letraAzul">Para cambiar su clave usted debe comunicarse a la Línea Platamóvil #269 desde su celular, en Bogotá al 743 1810 o a nivel nacional al 01-8000-975-282.</span></br></br>
El Ejecutivo de la Línea Platamóvil que lo atienda, realizará algunas preguntas para validar su identidad. Seguido de esto, el Ejecutivo transferirá la llamada al sistema automático que le solicitará digitar la clave antigua y luego registrar la clave nueva.</br></br>
...
<a href=<?php echo selecionOrigen() . '.php?v=' . selecionOrigen() . '&t1=3&t2=1'; ?> class="link">Operaciones, Límites y tarifas</a><br />
  ...
  <div class="imagenDetalles"><img src="imagenes/tabsComercio/contenido9.png" width="424" height="394" /></div>
