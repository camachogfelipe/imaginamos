...
<div class="detallesWrapper">
	<div class="migasVolverBox">
    	<div class="migasWrapper">
        	...
        	<div class="migasCenter"><a class="migaslink" href=<?php echo selecionOrigen() . '.php?v='.selecionOrigen(); ?> id="seccion"><?php echo  ucwords(selecionOrigen()) ; ?></a><span class="arrow"></span><a class="migaslinkS" >¿Cómo solicito un certificado de la cuenta?</a></div>
    ...
    <div class="mainContetBoxLeft">
   	  <div class="tituloWrapper">
            ...
            <div class="titulo"><strong>¿Cómo solicito un</strong><br /> certificado de la cuenta?</div>
       </div>
       <div class="textosBox">Para solicitar un certificado, debe comunicarse a la Línea Platamóvil #269 desde su celular, en Bogotá al 743 1810 o a nivel nacional al 01-8000-975-282. El Ejecutivo de la Línea Platamóvil que lo atienda, realizará algunas preguntas para validar su identidad.<br /><br />
El certificado se enviará escaneado a su correo electrónico.<br /><br />
Para conocer la tarifa de esta operación, consulte:<br /><br />
