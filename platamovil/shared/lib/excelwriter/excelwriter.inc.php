...
EOH;
        ...
        */
        ...
        function writeLine($line_arr, $clase="impar")
        {
            if($this->state!="OPENED")
            {
                $this->error="Error : Please open the file.";
            ...
            foreach($line_arr as $col)
                fwrite($this->fp,"<td class='$clase' width=64 >$col</td>");
            fwrite($this->fp,"</tr>");
        }
        ...
        * @Return : Void
        */
        function writeCol($value, $clase="impar")
        {
            if($this->state!="OPENED")
            {
                $this->error="Error : Please open the file.";
            ...
            fwrite($this->fp,"<td class='$clase' width=64 >$value</td>");
        }
    }
?>