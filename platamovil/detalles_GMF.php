...
<div class="detallesWrapper">
	<div class="migasVolverBox">
    	<div class="migasWrapper">
        	...
        	<div class="migasCenter"><a class="migaslink" href=<?php echo selecionOrigen() . '.php?v='.selecionOrigen(); ?> id="seccion"><?php echo  ucwords(selecionOrigen()) ; ?></a><span class="arrow"></span><a class="migaslinkS" >¿Cómo marcar y desmarcar la cuenta al GMF (hoy 4 x 1000)?</a></div>
    ...
    <div class="mainContetBoxLeft">
   	  <div class="tituloWrapper">
            ...
            <div class="titulo"><strong>¿Cómo marcar y desmarcar </strong><br />la cuenta al GMF (hoy 4 x 1000)?</div>
       </div>
       <div class="textosBox">
       <span class="letraAzul">Para marcar o desmarcar su cuenta usted puede comunicarse a la Línea Platamóvil #269 desde su celular, en Bogotá al 743 1810 o a nivel nacional al 01-8000-975-282.</span>
 </div>
    </div>
  ...
  <div class="imagenDetalles"><img src="imagenes/tabsComercio/contenido9.png" width="424" height="394" /></div>
        <div class="descargarPdfBox">
            ...
            <a class="descargar" href="#">Formato GMF.pdf<br /><span>17MB</span></a>
        </div>
