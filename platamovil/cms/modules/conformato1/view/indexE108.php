...
$htmlFormconformato1 = new Forms($db);
?>
			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>SECCI&Oacute;N ¿que es un corresponsal?</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_conformato1'",SHOW_TABLE_QUERY);
					//Si recibimos TRUE como respuesta quiere decir que si existe la tabla
					if($show = $db->show)
						{
						$db->doQuery("SELECT conformato1_config_funcionality FROM cms_conformato1_config WHERE conformato1_config_id = 1",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
						echo $htmlFormconformato1->printFormE108($result[0][conformato1_config_funcionality]);
						}
					else
						//Si la tabla no existe presentamos el formulario de configuración del módulo "NEWS"
						echo $htmlFormconformato1->printFormInstall();
					?>
                    </fieldset>
