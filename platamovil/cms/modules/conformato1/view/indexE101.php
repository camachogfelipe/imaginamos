			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>SECCI&Oacute;N INTRODUCCI&Oacute;N</span>
					...
					if($show = $db->show)
						...
						echo $htmlFormconformato1->printFormE101($result[0][conformato1_config_funcionality]);
						}
					else
