...
function printFormBanners($funcionality)
		{	
			...
			case 1:
				...
				$html .= '
					<tr class="odd gradeX">
					<td class="center" width="100px"><img src="../files/middle/'.$result[banners_image].'"></td>
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
							...
							<label>T&iacute;tulo</label>
							<div>	
								<input type="text" name="titulo" id="titulo"  value="'.$results[0][banners_txt1].'" class="large" />
							</div>
							</div>
