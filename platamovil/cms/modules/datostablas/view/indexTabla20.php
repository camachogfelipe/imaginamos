			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>BANNERS </span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_datostablas'",SHOW_TABLE_QUERY);
					//Si recibimos TRUE como respuesta quiere decir que si existe la tabla
					if($show = $db->show)
						{
						$db->doQuery("SELECT datostablas_config_funcionality FROM cms_datostablas_config WHERE datostablas_config_id = 1",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
						echo $htmlFormBanners->printFormTabla20($result[0][banners_config_funcionality]);
						}
					else
