...
function printFormTabla1($funcionality)
		{	
			switch($funcionality)
			{
			case 1:
				$query = "SELECT * FROM cms_datostablas WHERE datostablas_tipo = '1' ORDER BY datostablas_id DESC";
				...
				<div>		
				<form id="formnews">        
				<legend><h1>Datos de la tabla</h1></legend>
						<p>&nbsp;</p>                  
						  <fieldset>				  
							  <div>
					   ...
					   <p>&nbsp;</p>
							   <div>
								  ...
								  <div><input type="text" name="valor" id="valor"  class="large"/></div>
							  </div>
						  </fieldset>
						  <p>&nbsp;</p>
						  <a class="uibutton" onclick="xajax_news(xajax.getFormValues(\'formnews\')); return false;">Cargar datos</a>
				...
				<thead>
					<tr>
						...
						<th><div class="th_wrapp">Valor</div></th>
				...
				$html .= '
					<tr class="odd gradeX">
					<td class="center" width="250px" >'.$result[datostablas_campo1].'</td>
					<td class="center" width="60px">'.$result[datostablas_campo2].'</td>
					<td class="center" width="100px">
					<a id="'.$result[datostablas_id].'" class="Delete uibutton special" tableToDelete="cms_datostablas" nameField="datostablas_id">Eliminar</a>
					<a  href="editTabla1.php?id='.$result[datostablas_id].'&funcionality=1" class="uibutton">Editar</a>
					</td>
					</tr>';		
				}
