			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>DATOS RED DE PUNTOS </span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_redpuntos'",SHOW_TABLE_QUERY);
					//Si recibimos TRUE como respuesta quiere decir que si existe la tabla
					if($show = $db->show)
						{
						$db->doQuery("SELECT redpuntos_config_funcionality FROM cms_redpuntos_config WHERE redpuntos_config_id = 1",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
						echo $htmlFormBanners->printFormDatos($result[0][redpuntos_config_funcionality]);
						}
					else
