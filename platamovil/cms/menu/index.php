...
echo '<li class="limenu"><a href="#"><span class="ico gray shadow '.$icono1.'" ></span><b>Empresa</b></a>
		<ul>
			<li class="limenu"><a href="#"><b>Que es?</b></a>
				<ul>
					...
					<li class="limenu"><a href="'.$result[0][config_path].'modules/conformato2/view/indexE109.php"><b>CyD abrir Platam&oacute;vil</b></a></li>	
				</ul>
			</li>
	...
	<li class="limenu"><a href="#"><span class="ico gray shadow '.$icono1.'" ></span><b>Comercio</b></a>
		<ul>
			<li class="limenu"><a href="#"><b>¿que es Platam&oacute;vil?</b></a>
				<ul>
			...
			<li class="limenu"><a href="#"><b>¿que es un punto Platam&oacute;vil?</b></a>
				<ul>
					<li class="limenu"><a href="'.$result[0][config_path].'modules/conformato1/view/indexC401.php"><b>Introducci&oacute;n</b></a></li>
					<li class="limenu"><a href="'.$result[0][config_path].'modules/conformato2/view/indexC402.php"><b>definici&oacute;n</b></a></li>
					<li class="limenu"><a href="'.$result[0][config_path].'modules/conformato2/view/indexC403.php"><b>¿que servicios presta?</b></a></li>
					<li class="limenu"><a href="'.$result[0][config_path].'modules/conformato2/view/indexC404.php"><b>red de puntos Platam&oacute;vil</b></a></li>
					<li class="limenu"><a href="'.$result[0][config_path].'modules/conformato2/view/indexC405.php"><b>¿como se identifican?</b></a></li>
					<li class="limenu"><a href="'.$result[0][config_path].'modules/conformato1/view/indexC406.php"><b>¿quien es un agente Platam&oacute;vil?</b></a></li>
					...
					<li class="limenu"><a href="'.$result[0][config_path].'modules/conformato1/view/indexC408.php"><b>¿quieres ser un punto Platam&oacute;vil?</b></a></li>
				</ul>
			</li>
			<li class="limenu"><a href="#"><b>servicio al cliente</b></a>
				<ul>
					...
					<li class="limenu"><a href="'.$result[0][config_path].'modules/conformato2/view/indexC504.php"><b>red de puntos Platam&oacute;vil</b></a></li>
			...
			<li class="limenu"><a href="#"><b>¿quien respalda a Platam&oacute;vil?</b></a>
				<ul>
	...
	<li class="limenu"><a href="#"><span class="ico gray shadow '.$icono1.'" ></span><b>Persona</b></a>
		<ul>
			<li class="limenu"><a href="#"><b>¿que es platam&oacute;vil?</b></a>
				<ul>
					<li class="limenu"><a href="#"><b>¿Cu&aacute;les son las caracter&iacute;sticas?</b></a></li>
					<li class="limenu"><a href="#"><b>¿Cu&aacute;les son los beneficios?</b></a></li>
					<li class="limenu"><a href="#"><b>¿Para que sirve?</b></a></li>
					<li class="limenu"><a href="#"><b>¿Cu&aacute;nto le cuesta?</b></a></li>
					<li class="limenu"><a href="#"><b>Tipos de cuentas</b></a>
						<ul>
							<li class="limenu"><a href="#"><b>Simplificada Platam&oacute;vil</b></a></li>
							<li class="limenu"><a href="#"><b>T&iacute;pica Platam&oacute;vil</b></a></li>
						</ul>
					</li>
					<li class="limenu"><a href="#"><b>Su plata esta segura</b></a></li>
				</ul>
			</li>
			<li class="limenu"><a href="#"><b>¿c&oacute;mo se usa?</b></a>
				<ul>
					<li class="limenu"><a href="#"><b>¿C&oacute;mo abrir una cuenta Platam&oacute;vil?</b></a>
						<ul>
							<li class="limenu"><a href="#"><b>Simplificada Platam&oacute;vil</b></a></li>
							<li class="limenu"><a href="#"><b>T&iacute;pica Platam&oacute;vil</b></a></li>
						</ul>
					</li>
					<li class="limenu"><a href="#"><b>¿C&oacute;mo activar su cuenta Platam&oacute;vil?</b></a>
						<ul>
							<li class="limenu"><a href="#"><b>Activar su celular</b></a></li>
							<li class="limenu"><a href="#"><b>Activar el Portal Web</b></a></li>
						</ul>
					</li>
					<li class="limenu"><a href="#"><b>¿C&oacute;mo utilizar su cuenta Platam&oacute;vil?</b></a>
						<ul>
							<li class="limenu"><a href="#"><b>Dep&oacute;sito en efectivo</b></a></li>
							<li class="limenu"><a href="#"><b>Dep&oacute;sito en cheque</b></a></li>
							<li class="limenu"><a href="#"><b>Dep&oacute;sito v&iacute; transferencia</b></a></li>
							<li class="limenu"><a href="#"><b>Retiro en efectivo</b></a></li>
							<li class="limenu"><a href="#"><b>Retiro en cheque</b></a></li>
							<li class="limenu"><a href="#"><b>Retiro transferencia de otra entidad</b></a></li>
							<li class="limenu"><a href="#"><b>Compra con Platam&oacute;vil</b></a></li>
						</ul>
					</li>
					<li class="limenu"><a href="#"><b>¿C&oacute;mo hacer consulta de su cuenta?</b></a>
						<ul>
							<li class="limenu"><a href="#"><b>Consultas en internet</b></a></li>					
						</ul>
					</li>
					<li class="limenu"><a href="#"><b>Otras operaciones Platam&oacute;vil</b></a>
						<ul>
							<li class="limenu"><a href="#"><b>(Datos)</b></a></li>
							<li class="limenu"><a href="#"><b>(Claves)</b></a></li>
							<li class="limenu"><a href="#"><b>(Celular)</b></a></li>
							<li class="limenu"><a href="#"><b>(Desbloqueo y certificado)</b></a></li>
							<li class="limenu"><a href="#"><b>(Terminaci&oacute;n)</b></a></li>
						</ul>
					</li>
			...
			<li class="limenu"><a href="#"><b>Operaciones, limites y tarifas</b></a>
				<ul>
					<li class="limenu"><a href="#"><b>Operaciones con Platam&oacute;vil</b></a></li>
					<li class="limenu"><a href="#"><b>Tarifas para cuenta Platam&oacute;vil Simpificada</b></a></li>
					<li class="limenu"><a href="#"><b>Tarifas para cuenta Platam&oacute;vil T&iacute;pica</b></a></li>
					<li class="limenu"><a href="#"><b>Limites de la cuenta Platam&oacute;vil Simplificada</b></a></li>
					<li class="limenu"><a href="#"><b>Limites de la cuenta Platam&oacute;vil T&iacute;pica</b></a></li>					
				</ul>
			</li>
			<li class="limenu"><a href="#"><b>¿Qu&eacute; es un punto Platam&oacute;vil?</b></a>
				<ul>
					<li class="limenu"><a href="#"><b>Definici&oacute;n</b></a></li>
					<li class="limenu"><a href="#"><b>¿Qu&eacute; servicios presta?</b></a></li>
					<li class="limenu"><a href="#"><b>¿Como se identifica?</b></a></li>
					<li class="limenu"><a href="#"><b>Red de Puntos Platam&oacute;vil</b></a></li>
					<li class="limenu"><a href="#"><b>¿Qui&eacute;n es un Agente Platam&oacute;vil?</b></a></li>
					<li class="limenu"><a href="#"><b>Operaciones, Tarifas y Limites</b></a></li>
				</ul>
			</li>
			<li class="limenu"><a href="#"><b>Servicio al Cliente Platam&oacute;vil</b></a></li>
			<li class="limenu"><a href="#"><b>¿Qui&eacute;n respalda a Platam&oacute;vil?</b></a>
				<ul>
					<li class="limenu"><a href="#"><b>Superintendencia Financiera de Colombia</b></a>
						<ul>
							<li class="limenu"><a href="#"><b>¿Qu&eacute; es una entidad vigilada?</b></a></li>					
						</ul>
					</li>
					<li class="limenu"><a href="#"><b>¿Qu&eacute; es FENALCO?</b></a></li>
					<li class="limenu"><a href="#"><b>¿Qu&eacute; es FOGAFIN?</b></a></li>
					<li class="limenu"><a href="#"><b>¿Qu&eacute; es CAF?</b></a></li>
				</ul>
			</li>
		</ul>
