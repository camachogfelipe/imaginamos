...
<div class="detallesWrapper">
	<div class="migasVolverBox">
    	<div class="migasWrapper">
        	...
        	<div class="migasCenter"><a class="migaslink" href=<?php echo selecionOrigen() . '.php?v='.selecionOrigen(); ?> id="seccion"><?php echo  ucwords(selecionOrigen()) ; ?></a><span class="arrow"></span><a class="migaslinkS" >¿Cómo desbloqueo la cuenta o el canal?</a></div>
    ...
    <div class="mainContetBoxLeft">
   	  <div class="tituloWrapper">
            ...
            <div class="titulo"><strong>¿Cómo desbloqueo</strong><br /> la cuenta o el canal?</div>
       </div>
       <div class="textosBox">Si su cuenta Platamóvil o alguno de los canales se encuentra bloqueado y quiere reactivarlo, deberá llamar a la Línea Platamóvil #269 desde su celular, en Bogotá al 743 1810 o a nivel nacional al 01-8000-975-282.<br /><br />
El Ejecutivo de la Línea Platamóvil que lo atienda, realizará algunas preguntas para validar su identidad. Seguido de esto, el Ejecutivo procederá a indicarle los requisitos para el desbloqueo o a desbloquear inmediatamente, según sea el motivo del bloqueo.<br /><br />
