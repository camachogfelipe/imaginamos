...
<div class="detallesWrapper">
	<div class="migasVolverBox">
    	<div class="migasWrapper">
        	...
        	<div class="migasCenter"><a class="migaslink" href=<?php echo selecionOrigen() . '.php?v='.selecionOrigen(); ?> id="seccion"><?php echo  ucwords(selecionOrigen()) ; ?></a><span class="arrow"></span><a class="migaslinkS" >Depósito vía transferencia desde otra entidad</a></div>
    ...
    <div class="mainContetBoxLeft" style="width:100%;">
   	  <div class="tituloWrapper">
            ...
            <div class="titulo"><strong>Depósito vía transferencia  </strong><br />desde otra entidad </div>
       </div>
       <div class="textosBox">
       *(Aplica sólo para cuentas típicas)
       <span class="letraAzul">Puede realizar una transferencia electrónica desde del portal web de otra Entidad a su cuenta Platamóvil así:</span><br />
<br />

<span class="destacado"><strong>1.	</strong>Realice la transferencia electrónica desde el portal web a la siguiente cuenta corriente a nombre de Mi Plata S.A.:<br />
<br />
...
<span class="destacado"><strong>2.	</strong>Valide y conserve toda la información que le entrega la otra Entidad como comprobante de la transferencia.</span><br />
...
Siga las recomendaciones de seguridad que le informa el Banco desde el cuál realiza la transferencia.
