...
<div class="detallesWrapper">
	<div class="migasVolverBox">
    	<div class="migasWrapper">
        	...
        	<div class="migasCenter"><a class="migaslink" href=<?php echo selecionOrigen() . '.php?v='.selecionOrigen(); ?> id="seccion"><?php echo  ucwords(selecionOrigen()) ; ?></a><span class="arrow"></span><a class="migaslinkS" >¿Cómo consultar los extractos de su cuente?</a></div>
    ...
    <div class="mainContetBoxLeft">
   	  <div class="tituloWrapper">
            ...
            <div class="titulo"><strong>¿Cómo consultar</strong><br />los extractos de su cuenta?</div>
       </div>
       <div class="textosBox">Ingrese al Portal Web Platamóvil, digite su tipo y número de identificación y clave de acceso. En el menú "Opciones de Mi Cuenta", seleccione "Extractos", luego seleccione el rango de fechas que desea consultar. Aparecerá el extracto del periodo escogido, con opción de descargar el archivo o imprimirlo (se requiere que su computador le permita visualiza archivos en formato PDF).</div>
    </div>
