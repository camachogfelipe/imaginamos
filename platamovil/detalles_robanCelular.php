...
<div class="detallesWrapper">
	<div class="migasVolverBox">
    	<div class="migasWrapper">
        	...
        	<div class="migasCenter"><a class="migaslink" href=<?php echo selecionOrigen() . '.php?v='.selecionOrigen(); ?> id="seccion"><?php echo  ucwords(selecionOrigen()) ; ?></a><span class="arrow"></span><a class="migaslinkS" >¿Qué pasa si me roban el celular?</a></div>
    ...
    <div class="mainContetBoxLeft">
   	  <div class="tituloWrapper">
            ...
            <div class="titulo"><strong>¿Qué pasa si</strong><br /> me roban el celular?</div>
       </div>
       <div class="textosBox">Si desafortunadamente, le roban o se le extravía su teléfono celular, llamé inmediatamente a la Línea Platamóvil #269, en Bogotá al 748 1810 o a nivel nacional al 01-8000-975-282, reportando la pérdida o robo de celular.<br /><br />
El Ejecutivo de la Línea Platamóvil que lo atienda, por seguridad bloqueará su cuenta con el fin de evitar posibles usos no autorizados.<br /><br />
