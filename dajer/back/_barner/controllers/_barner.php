...
class _barner extends Back_Controller {
    ...
    public function index() {
        ...
        $data['title_page'] = "Banner Princial"; 
        $data['pag'] = 1;
        $data['pag_content'] = $this->barner();
        $data['pag_content_title'] = ucwords("Banner");
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->input($obj->link, "link", $obj->get_rule("link","max_length"), "Link (ver más)", "Maximo ".$obj->get_rule("link","max_length")." caracteres",$obj->is_rule("link","required"),"span4"); 
        $data['form_content'] .= $this->text($obj->texto, "texto", "Texto", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span5", false, true, $obj->get_rule("texto","max_length"),3,4);
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->input("", "link", $obj->get_rule("link","max_length"), "Link (ver más)", "Maximo ".$obj->get_rule("link","max_length")." caracteres",$obj->is_rule("link","required"),"span4"); 
        $data['form_content'] .= $this->text("", "texto", "Texto", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span5", false, true, $obj->get_rule("texto","max_length"),3,4);
        $data['direct_form'] = $this->name.'/add'; 
        return $this->buildajax($this->name.'/form', $data);
    }
