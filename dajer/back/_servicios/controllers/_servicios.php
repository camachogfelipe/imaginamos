...
class _servicios extends Back_Controller {
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen Fondo", "702px x 400px",false,true,"span3");
        ...
        $data['form_content'] .= $this->text($obj->texto, "texto", "Texto", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span6", false, true, $obj->get_rule("texto","max_length"),3,4);
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen Fondo", "702px x 400px",false,true,"span3");
