                        ...
                        <tbody id='table_contet'  >
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td>
                                        <a class="thumbnail img_action_zoom" title="Imagen" href="<?php echo base_url() . $img->path ?>">
                                            <img style="height:50px;width:50px" src="<?php echo base_url() . $img->path ?>" alt="" />
                                        </a>
                                    </td>
                                     <td>
                                    ...
                                    <td>
                                        <?php echo strip_tags(substr($img->producto_texto,0,255))."...";  ?>
                                    </td>
