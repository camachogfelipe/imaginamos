 ...
 */
class _bienvenidos extends Back_Controller {

    protected $admin_area = true;
    public $model = 'bienvenida';
    public $name = "bienvenidos";
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "320px × 320px",false,true,"span3");
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen", "320px × 320px",false,true,"span3");
