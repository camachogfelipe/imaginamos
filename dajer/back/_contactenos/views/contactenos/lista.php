                    ...
                    <table id="dt_basic" class="dataTables_full table table-striped">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th>Horario (Temporada 1)</th>
                                <th>Horario (Temporada 2)</th>
                        ...
                        <tbody id='table_contet'  >
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td>
                                        <?php echo $img->dia_inicio." a ".$img->dia_final;  ?>
                                    </td>
                                    <td>
                                        <?php echo "de ".$img->hora_inicio_temp1." a ".$img->hora_final_temp1;  ?>
                                    </td>
                                    <td>
                                        <?php echo "de ".$img->hora_inicio_temp2." a ".$img->hora_final_temp2;  ?>
                                    </td>
