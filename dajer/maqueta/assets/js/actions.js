...
$(document).ready(function(){
  $(window).bind("load", function(){$("#preload").fadeOut("slow");});
	var slider1 = $(".main-slider").bxSlider({auto: true, controls: false, mode: "fade"}); var slider2 = $(".hight-slider").bxSlider({controls: false, mode: "fade"}); $(window).resize(function(){if($(slider1.reloadSlider).size()>0){slider1.reloadSlider({auto: true, controls: false, mode: "fade"});}; if($(slider2.reloadSlider).size()>0){slider2.reloadSlider({controls: false, mode: "fade"});};});
	 if($(".cat-slider").size()>0){$(".cat-slider").bxSlider({maxSlides: 4, pager: false});}; if($(".clients-slider").size()>0){$(".clients-slider").bxSlider({auto: true, maxSlides: 5, pager: false, slideMargin: 20, slideWidth: 300});}; if($(".pro-slider").size()>0){$(".pro-slider").bxSlider({auto: true, pager: false});}; 
