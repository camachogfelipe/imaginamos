      ...
      <div class="mg-section cfx">
        ...
        <!--Products nav device-->
            ...
            <div id="dl-menu-pro" class="dl-menuwrapper">
              ...
              <h1>Ver productos</h1>
              <ul class="dl-menu">
              	<li><a href="producto-cafe.php">Tiendas café</a></li>
              	<li><a href="producto-categoria.php">Panadería</a></li>
                <li><a href="producto-categoria.php">Cool</a></li>
                <li><a href="producto-categoria.php">Gourmet</a></li>
                <li><a href="producto-categoria.php">Automatización</a></li>
              </ul>
            </div>
          </div>
        ...
        <div class="con-pro-nav-b fl">
        	<ul class="pro-nav-b">
          	<li><a href="producto-cafe.php"><span></span>TIENDA CAFÉ</a></li>
