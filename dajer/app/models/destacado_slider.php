...
class destacado_slider extends  DataMapper {
    ...
    public $table = 'destacado_slider';

    public $model = 'destacado_slider';
    ...
    public $has_one =  array(
                'imagen' => array(
                  'class' => 'imagen',
                  'other_field' => 'destacado_slider',
                  'join_other_as' => 'imagen',
                  'join_self_as' => 'destacado_slider',
