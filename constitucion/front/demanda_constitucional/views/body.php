...
<div class="container">
  <div class="row contenedor_internas">
    ...
    <div class="span12">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="centrar_contenido"><a class="color_rojo" href="<?php echo ($logged == FALSE)?"#":base_url($demanda['link_path']); ?>">Ver</a></td>
              <td class="centrar_contenido"><a class="color_rojo" href="<?php echo ($logged == FALSE)?"#":base_url($demanda['link_path']); ?>">Ir</a></td>
              <td class="centrar_contenido"><a class="color_rojo carga_modal" href="<?php echo base_url('modal_corte/sentencia/'.$demanda['id']); ?>">Sentencia</a></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
      ...
      <div class="row">
        <?php echo form_open(base_url("demanda_constitucional/buscar")) ?>
          <fieldset>
            <div class="span2">
              <select name="anio">
            ...
            <div class="span2">
              <input type="text" name="radicacion" placeholder="Radicación">
            </div>
            <div class="span2">
            ...
            <div class="span2">
              <input type="text" name="demandante" placeholder="Demandante">
            </div>
            <div class="span2">
              <input type="text" name="norma" placeholder="Norma demandada">
            </div>
          </fieldset>
