<section  id="sec_home1" class="cont100 clearfix">
  <div class="cont">
    <div class="container">
      <div class="cont_tit">
        <h1 class="inline">CONSTITUCIÓN <span>POLÍTICA DE COLOMBIA</span></h1>
      </div>
      ...
      <div class="row clearfix">
        <a href="internageneral.php" class="span3 destacados220">
      ...
      <form class="centrar_contenido">
        ...
        <div style="display:none;"> 
         <a href="modal_newsletter.php" class="carga_modalmediana3" id="oculto_link">Click</a>
        </div>
      </form>
      <div class="clear espacio_en_blanco"></div>
      <div class="centrar_inline">
        <a class="btn inline carga_modalmediana2" href="modal_planes.php">Ver planes</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="cont">
    <div class="container">
      ...
      <div class="row clearfix">
        ...
        <div class="span9">
          <div class="row clearfix">
            <a href="blog.php" class="span3 destacados220">
              <h2 class="color_rojo">Titulo del destacado</h2>
              <h3>26/06/2013</h3>
              <img src="assets/img/destacados/1.jpg" alt="">
              <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, veritatis et quasi architecto beatae vitae dicta sunt explicabo...</p>
