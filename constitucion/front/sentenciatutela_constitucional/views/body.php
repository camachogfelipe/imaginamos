<div class="container">
  <div class="row contenedor_internas">
    ...
    <div class="span12">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="centrar_contenido"><a class="color_rojo carga_modal" href="<?php echo ($logged == FALSE)?"#":base_url('modal_corte/sentencia/'.$sentencia['demandas_tutelas_id']); ?>">Demanda</a></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
      ...
      <div class="row">
        <?php echo form_open(base_url("sentenciatutela_constitucional/buscar")); ?>
          <fieldset>
            <div class="span2">
              <select name="anio">
                ...
                <?php
								if(!empty($derechos)) :
									foreach($derechos as $derecho) :
										echo '<option value="' . $derecho['cms_tutela_derecho'] . '">' . $derecho['cms_tutela_derecho'] ."</option>\n";
									endforeach;
								endif;
                ?>
              </select>
