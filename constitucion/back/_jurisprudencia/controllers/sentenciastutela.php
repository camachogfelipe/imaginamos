 ...
 */
class sentenciastutela extends Back_Controller {

    protected $admin_area = true;
    public $model = 'sentencias';
    public $name = "sentenciastutela";
    ...
    public function sentencias() {
        ...
        $data['path_list'] = cms_url("jurisprudencia/".$this->name.'/lista');
				$data['breadcrum'] = array("Jurisprudencia", "Sentencias");
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->inputHidden($obj->id, "id", 11);
				...
				$data['form_content'] .= $this->combox($obj->magistrados_id, $datamag, "magistrados_id", "Magistrado", "Seleccione el magistrado", $obj->is_rule("magistrados_id","required"), "span3");
				...
				$data['form_content'] .= $this->input($obj->cms_tutela_expediente, "cms_tutela_expediente", $obj->get_rule("cms_tutela_expediente", "max_length"), "Expediente", "Maximo ".$obj->get_rule("cms_tutela_expediente", "max_length")." caracteres", $obj->is_rule("cms_tutela_expediente", "required"), "span3");
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->inputHidden("", "id", 11);
				...
				$data['form_content'] .= $this->input("", "cms_tutela_expediente", $obj->get_rule("cms_tutela_expediente", "max_length"), "Expediente", "Maximo ".$obj->get_rule("cms_tutela_expediente", "max_length")." caracteres", $obj->is_rule("cms_tutela_expediente", "required"), "span3");
    ...
    public function lista() {
				$obj = new  $this->model();
        $data['datos'] = $obj->join_related('demandas_tutelas')->join_related('temas')->join_related('magistrados')->get_where(array("tipo" => "T"));
