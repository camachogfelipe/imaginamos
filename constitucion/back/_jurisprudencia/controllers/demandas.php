 ...
 */
class demandas extends Back_Controller {

    protected $admin_area = true;
    public $model = 'demandas_tutelas';
    public $name = "demandas";
    ...
    public function index() {
        ...
        $data['title_page'] = "Demandas"; 
        $data['pag'] = 1;
        $data['pag_content'] = $this->demandas();
    ...
    public function demandas() {
        ...
        $data['path_list'] = cms_url("jurisprudencia/".$this->name.'/lista');
				$data['breadcrum'] = array("Constitución", "Demandas");
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->inputHidden($obj->id, "id", 11);
				...
				$data['form_content'] .= $this->input($obj->cms_numeroref, "cms_numeroref", $obj->get_rule("cms_numeroref", "max_length"), "Radicación", "Maximo ".$obj->get_rule("cms_numeroref", "max_length")." caracteres", $obj->is_rule("cms_numeroref", "required"), "span3");
				...
				$data['form_content'] .= $this->combox($obj->magistrado_id, $datatit, "magistrados_id", "Magistrado", "Seleccione el magistrado", $obj->is_rule("magistrados_id","required"), "span3");
				
				$data['form_content'] .= $this->input($obj->cms_norma_demandada, "cms_norma_demandada", $obj->get_rule("cms_norma_demandada", "max_length"), "Norma demandada", "Maximo ".$obj->get_rule("cms_norma_demandada", "max_length")." caracteres", $obj->is_rule("cms_norma_demandada", "required"), "span3");
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->inputHidden("", "id", 11);
				...
				$data['form_content'] .= $this->input("", "cms_numeroref", $obj->get_rule("cms_numeroref", "max_length"), "Radicación", "Maximo ".$obj->get_rule("cms_numeroref", "max_length")." caracteres", $obj->is_rule("cms_numeroref", "required"), "span3");
				...
				$data['form_content'] .= $this->input("", "cms_norma_demandada", $obj->get_rule("cms_norma_demandada", "max_length"), "Norma demandada", "Maximo ".$obj->get_rule("cms_norma_demandada", "max_length")." caracteres", $obj->is_rule("cms_norma_demandada", "required"), "span3");
    ...
    public function lista() {
				$obj = new  $this->model();
        $data['datos'] = $obj->join_related('magistrados')->get_where(array("tipo" => "D"));
