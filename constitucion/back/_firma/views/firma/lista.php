          ...
          <table id="dt_basic" class="dataTables_full table table-striped">
            ...
            <tbody id='table_contet'  >
              ...
              <tr class="odd gradeX parent-delete">
                ...
                <td><?php echo $img->pais." - ".$img->ciudad; ?></td>
                <td class="center" width="300px">
                <a href="<?php echo cms_url($jugadores)."/".$img->id ?>" class="btn btn-info btn-small " data-num="1" data-value="<?php echo $img->id ?>">Jugadores</a>
                <a href="<?php echo cms_url($banner)."/".$img->id ?>" class="btn btn-info btn-small " data-num="1" data-value="<?php echo $img->id ?>">Banner</a>
								<?php if($delete): ?>
