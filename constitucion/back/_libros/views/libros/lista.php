          ...
          <table id="dt_basic" class="dataTables_full table table-striped">
            ...
            <tbody id='table_contet'  >
              ...
              <tr class="odd gradeX parent-delete">
                ...
                <td><?php echo $img->cms_autor; ?></td>
                <td>$ <?php echo number_format($img->cms_preciopdf, 2); ?></td>
                <td>$ <?php echo number_format($img->cms_precioimpreso, 2); ?></td>
                <td class="center" width="300px"><?php if($delete): ?>
