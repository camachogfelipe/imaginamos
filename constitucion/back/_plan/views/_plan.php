<div class="row-fluid">
    <div class="span12">
        <div id="pageNavToolbar" class="mbox_toolbar clearfix">
           ...
           <?php if($add and $datos->result_count() < 5): ?> <li><a id="crear" class="jnav-ext1 c_datatables" href="<?php echo $path_add; ?>"><i class="icsw32-create-write"></i><span>Crear</span></a></li><?php endif; ?>
