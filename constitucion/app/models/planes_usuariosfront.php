...
class planes_usuariosfront extends  DataMapper {
    ...
    public $table = 'planes_usuariosfront';

    public $model = 'planes_usuariosfront';
    public $primarykey = 'id';
    public $_fields = array('id','usuariosfront_id','planes_id','activo');

    public $has_one =  array(
                'usuariosfront' => array(
                  'class' => 'usuariosfront',
                  'other_field' => 'planes_usuariosfront',
                  'join_other_as' => 'usuariosfront',
                  'join_self_as' => 'planes_usuariosfront',
    ...
    public function get_usuariosfront($join_retale="") {
         $model = new usuariosfront();
         if($join_retale!=""){
         	return $model->join_related($join_retale)->get_by_planes_usuariosfront_id($this->id);
         }else{
         	return $model->get_by_planes_usuariosfront_id($this->id);
         }
    }
