 ...
 */
define("DB_USER", 'usuariohf'); /* Nombre de usuario de la base de datos */
define("DB_PASSWORD", 'FRaNJ172ZC9X'); /* Clave de acceso del usuario de la base de datos */
define("DB_NAME", 'usuariohf_dark_factory'); /* Nombre de la base de datos a sacar backup */
define("DB_HOST", 'localhost'); /* Nombre del sevidor de donde sacar backup de la base de datos */
define("OUTPUT_DIR", 'SQL'); /* Nombre del directorio donde se alojará el archivo de backup de la base de datos */
