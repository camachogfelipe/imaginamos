...
class Upload extends Back_Controller {
    ...
    public function index() {
        ...
        $targetDir = UPLOADSFOLDER . $this->_datos->username;
        ...
        $save = $this->_save_relation($filePath, $thumb);
