 ...
 */
class Instruments_upload extends Back_Controller {

    const UPLOAD_FOLDER = 'build-a-band';
    ...
    public function index() {
        ...
        $save = $this->_save_relation($this->_post('id'), $filePath);
    ...
    private function _save_relation($id, $image) {
