 ...
 * @author rigobcastro
 */
class Instruments extends Back_Controller {
    ...
    public function index() {
        $datos = new Instrument();
        $datos->get();

        $save_url = cms_url('bands/instruments/save');

        $this->_data['save_url'] = $save_url;
        $this->_data['upload_url'] = cms_url('bands/instruments_upload');

        $this->_data['datos'] = $datos;
        
       
        $this->_data['delete_url'] = cms_url('bands/instruments/delete/%d/');


        return $this->build('instruments/body');
    }
    ...
    public function save($id = null) {
        ...
        $this->_data['continue_url'] = cms_url('build_a_band/instruments');
