...
<div class="widget">
    <div class="header">
        <span><span class="ico gray window"></span>Crear instrumento</span>
    </div><!-- End header -->
    <div class="content">
        <div class="formEl_b">
            <div>
                <fieldset>
                    <div class="clearfix">
                        ...
                        <div class="alertbox info">
                            <p>Se necesita de un diseño especial para beneficiarse de todos los efectos de este módulo.</p>
                        </div>
...
<div class="widget">
    <div class="header">
        <span><span class="ico gray window"></span>Todos los instrumentos</span>
    </div><!-- End header -->
    <div class="content">
                        ...
                        <?php if ($datos->exists()) : ?>
                            <?php foreach ($datos as $dato) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td class="center"><?php echo img(uploads_url($dato->image)) ?></td>

                                    <td class="center">
                                        <span class="tip">
                                            <a href="<?php echo cms_url('admin/actions/delete') ?>" class="uibutton special" data-action="special-delete" data-table="instruments" data-field="id" data-value="<?= $dato->id ?>" data-delete-files='<?= json_encode(array($dato->image)) ?>'>
                                                Eliminar
                                            </a>
