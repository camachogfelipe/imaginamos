                ...
                <fieldset>
                    <div class="clearfix">
                        ...
                        <div class="alertbox info">
                            <p>Dimensiones mínimas recomendadas para las imagenes: <strong>1000px X 510px</strong></p>
                        </div>
                        ...
                        <?php if ($datos->exists()) : ?>
                            <?php foreach ($datos as $dato) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td class="center">
                                        <span class="tip">
                                            <a href="<?php echo cms_url('admin/actions/delete') ?>" class="uibutton special" data-action="special-delete" data-table="principal_banners" data-field="id" data-value="<?= $dato->id ?>" data-delete-files='<?= json_encode(array($dato->image, $dato->thumb)) ?>'>
                                                Eliminar
                                            </a>
                                        </span>
                                    </td>
...
<script>
    ...
    $('#uploader_form').on('submit', function() {
        ...
        uploader.settings.multipart_params = { folder  : 'principal' };
