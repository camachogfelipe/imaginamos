...
class Upload extends Back_Controller {
    ...
    public function index($username = null, $directorio_code = null) {


        $targetDir = UPLOADSFOLDER . $username;
        ...
        $save = $this->_save_relation($directorio_code, $filePath, $thumb);
    ...
    private function _save_relation($code, $image, $thumb = null) {
        ...
        return $images->save_as_new($datos);
    }
