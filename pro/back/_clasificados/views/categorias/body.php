                ...
                <fieldset>
                    <div class="clearfix">
                        ...
                        <div class="section">
                            ...
                            <div><input type="text" name="nombre" id="nombre"  class="large" placeholder="Escriba el nombre acá..."></div>
                        </div>
                        
                        <div class="section">
                            <label for="descripcion">Descripción</label>
                            <div> <textarea name="descripcion" id="descripcion" class="large" placeholder="Escriba la descripción acá..."></textarea> </div>
                        </div>
                        ...
                        <?php if ($datos->exists()) : ?>
                            <?php foreach ($datos as $dato) : ?>
                                <tr class="odd gradeX parent-delete">
                                    <td class="center"><?php echo $dato->nombre ?></td>
                                    ...
                                    <td class="center">
                                        <span class="tip">
                                            ...
                                            <a href="<?php echo cms_url('admin/actions/delete') ?>" class="uibutton special" data-action="special-delete" data-table="clasificados_categorias" data-field="id" data-value="<?= $dato->id ?>">
                                                Eliminar
                                            </a>
                                        </span>
                                    </td>
