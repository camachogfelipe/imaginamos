...
(function($) { 
  ...
  var dd = function(element, options)
  {
    ...
    if(ddList) {
      options.visibleRows = $(sElement).prop("size");
    };
    ...
    var createTitleDiv = function () {
      ...
      sDiv += '>';
      sDiv += '<span id="'+arrowid+'" class="'+styles.arrow+'"></span><div class="'+styles.ddTitleText+'" id="'+titletextid+'">'+arrow + '<span class="'+styles.ddTitleText+'">'+sText+'</span></div></div>';
      return sDiv;
    };
