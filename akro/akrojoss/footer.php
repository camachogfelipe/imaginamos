  ...
  <footer class="footer_prin">
    <div class="cont_footer1">
      <div class="cont_940 footer1">
        <div class="row-fluid">
          <div class="span5 info_footer1">
            <img src="assets/img/iconos/ico_ubicacion.png" alt="">
            <p>175 SW 7th Street Suite 2101, Miami FL 33130 USA</p>
          </div>
          <div class="span4 info_footer1">
            <img src="assets/img/iconos/icono_telefono.png" alt="">
            <p><span>Teléfono:</span> 305-5236576 - 786-8717892</p>
          </div>
          <div class="span3 info_footer1">
            <img src="assets/img/iconos/icono_fax.png" alt="">
            <p><span>FAX:</span> 305-5236575</p>
          </div>
        </div>
      </div>
    </div>
    <div class="cont_footer2 clearfix">
      <div class="cont_940 footer2 clearfix">
        <div class="derechos">© 2013 <span>AKRO GROUP</span> - Todos los derechos reservados. Prohibida su reproducción parcial o total </div>
 ...
 <!-- RESIZE 
  <script type="text/javascript" src="assets/js/lib/resize/jquery.ba-resize.js"></script> -->
...
================================================== -->
  <script type="text/javascript" src="assets/js/lib/dd/jquery.dd.js"></script>
   ...
   <!-- SCROLL -->
  <script type="text/javascript" src="assets/js/lib/estilizar/jscrollpane/js/jquery.jscrollpane.min.js"></script>
...
<!-- Slider
================================================== -->
  <script type="text/javascript" src="assets/js/lib/Elastideslide/js/jquery.elastislide.js"></script>
  <script type="text/javascript" src="assets/js/lib/bxslider/js/jquery.bxslider.js"></script>

<!-- Menu
================================================== -->
<script src="assets/js/lib/sidr/js/jquery.sidr.min.js"></script>
<script src="assets/js/lib/sidr/js/jquery.touchwipe.js"></script>
