  ...
  <body class="dashborad">
    ...
    <div id="content">
      <div class="inner">
        ...
        <!-- full width -->
        <div class="widget">
          <div class="header"><span><span class="ico gray window"></span>CMS AKRO / Factores</span>
           <br />
          </div><!-- End header -->
          <div class="content">
              ...
              <div>
                <fieldset>
                  ...
                  <div style="position: absolute;float: left;height: 60px;">
                    <?php echo anchor("cms_factores/add/", "Nuevo", 'class="uibutton icon add" style="top: 100%"') ?>
                  </div>
                  <p>&nbsp;</p>
                          ...
                          foreach ($records as $item):
                            ...
                            <tr class="odd gradeX" >
                              ...
                              <td class="center" style="width: 20%">
                                <?php echo anchor("cms_factores/edit/" . $item->id, "Editar", 'class="uibutton"') ?>
                                <?php //echo anchor("galerias_factores/index/" . $item->id, "Galeria", 'class="uibutton"') ?>
                                <?php echo anchor("cms_factores/delete/" . $item->id, "Eliminar", 'class="uibutton special"') ?>
                              </td>
                            </tr>
                            <?php
                            $i++;
