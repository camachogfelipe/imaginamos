        ...
        <body class="dashborad">
            ...
            <div id="content">
                <div class="inner">
                    ...
                    <!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>CMS AKRO / Slider / Editar</span>
                                    ...
                                    <div>
                                        ...
                                        <fieldset>
                                            <div>
                                                ...
                                                <div><input type="text" name="titulo_spa" id="titulo_spa" class="small" value="<?php echo $record[0]->titulo_spa; ?>" maxlength="500" title="500 caracteres máximo" /></div>
                                            ...
                                            <div>
                                                ...
                                                <div><input type="text" name="titulo_eng" id="titulo_eng" class="small" value="<?php echo $record[0]->titulo_eng; ?>" maxlength="500" title="500 caracteres máximo" /></div>
