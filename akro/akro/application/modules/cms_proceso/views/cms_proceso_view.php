    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>CMS AKRO / Proceso </span>
                    </div><!-- End header -->
                    <div class="content">
                            ...
                            <div>
                                <fieldset>
                                    ...
                                    <div style="position: absolute;float: left;height: 60px;">
                                        <?php if($num < 5): ?>
                                        <?php echo anchor("cms_proceso/add/", "Nuevo [+5]", 'class="uibutton icon add" style="top: 100%"') ?>
                                        <?php endif; ?>
                                    </div>
                                    <p>&nbsp;</p>
                                                ...
                                                if ($records != ''):
                                                  $i=1;
                                                    foreach ($records as $item):
                                                        ?>
                                                        <tr class="odd gradeX" >
                                                            <td class="center" style="width: 20%"><?php echo $item->nombre_spa; ?></td>
                                                        
                                                            <td class="center" style="width: 20%">
                                                                <?php echo anchor("cms_proceso/edit/" . $item->id, "Editar", 'class="uibutton"') ?>
                                                                <?php echo anchor("cms_proceso/delete/" . $item->id, "Eliminar", 'class="uibutton special"') ?>
                                                            </td>
                                                        </tr>                                                        
                                                        <?php
                                                        $i++;
