                ...
                <div class="inner">
                    ...
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>CMS AKRO / Galerias / Editar</span>
                            <br /><?php echo anchor('galerias_hacemos/index/'. $record[0]->quehacemos_id, 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>
                        </div><!-- End header -->
                        <div class="content">
                            ...
                            <div class="formEl_b">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <?php echo form_open_multipart('galerias_hacemos/update/' . $record[0]->quehacemos_id) ?>
                                        <fieldset>

                                            <div>
                                                <p><label>Imagen</label></p>
                                                <a href="<?php echo base_url('application/modules/galerias_hacemos/assets/images/'.$record[0]->imagen) ?>" target="_blank"><img src="<?php echo base_url('application/modules/galerias_hacemos/assets/images/'.$record[0]->imagen) ?>" alt="imaginamos.com" width="500"></a><br/>
