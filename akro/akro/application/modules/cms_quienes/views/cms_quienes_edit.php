            ...
            <div class="formEl_b">
              ...
              <div>
                ...
                <div>
                  ...
                  <?php echo form_open_multipart('cms_quienes/update/' . $record[0]->id) ?>
                  <fieldset>
                    ...
                    <div>
                      ...
                      <a href="<?php echo base_url('application/modules/cms_quienes/assets/images/' . $record[0]->imagen) ?>" target="_blank"><img src="<?php echo base_url('application/modules/cms_quienes/assets/images/' . $record[0]->imagen) ?>" alt="imaginamos.com" width="500"></a><br/>
