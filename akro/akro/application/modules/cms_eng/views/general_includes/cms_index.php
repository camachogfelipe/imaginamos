...
foreach ($menu as $item): $url = $item->menu_url_eng;
...
<div id="sortable">
    <!-------------- Menu raiz -->
    <li class="limenu <?php if ($this->uri->segment(1) == $item->menu_url_eng) { echo 'select';} ?>" id="mod_<?php echo $item->menu_id ?>">
        <a href="<?php echo base_url() . $url ?>">
            ...
            <span class="ico gray shadow" ></span><b><?php echo $item->menu_title_eng ?></b>
        </a>
        ...
        foreach ($submenu as $sub_item):
            if ($sub_item->submenu_idmenu == $item->menu_id): $ban = true;
                ...
                ?>
            <li>
                <a href="<?php echo base_url() ?><?php echo $sub_item->submenu_url_eng ?>">
                    <span class="ico gray shadow" ></span><b><?php echo $sub_item->submenu_title_eng ?></b>
                </a>
            </li>
