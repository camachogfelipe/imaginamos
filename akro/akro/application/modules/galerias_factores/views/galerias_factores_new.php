  ...
  <body class="dashborad">
    ...
    <div id="content">
      <div class="inner">
        ...
        <!-- full width -->
        <div class="widget">
          <div class="header"><span><span class="ico gray window"></span>CMS AKRO / Galerias / Nuevo</span>
            <br /><?php echo anchor('galerias_factores/index/'.$this->uri->segment(3), 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>
          </div><!-- End header -->
          <div class="content">
            ...
            <div class="formEl_b">
              ...
              <div>
                ...
                <div>
                  ...
                  <?php echo form_open_multipart('galerias_factores/new_record/' . $this->uri->segment(3) . '/' . $this->uri->segment(4)) ?>
                  <fieldset>
