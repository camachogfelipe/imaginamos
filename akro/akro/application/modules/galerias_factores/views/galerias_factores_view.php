    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>CMS AKRO / Galeria </span>
                            ...
                            <div>
                                <fieldset>
                                    ...
                                    <div style="position: absolute;float: left;height: 60px;">
                                        ...
                                        <?php echo anchor("galerias_factores/add/". $this->uri->segment(3), "Nuevo [+5]", 'class="uibutton icon add" style="top: 100%"') ?>
                                        <?php endif; ?>
                                    </div>
                                    <p>&nbsp;</p>                                    
                                            ...
                                            <tbody>
                                                ...
                                                if ($records != ''):
                                                    foreach ($records as $item):
                                                        ?>
                                                        <tr class="odd gradeX" >
                                                            <td class="center" style="width: 20%"><a href="<?php echo base_url('application/modules/galerias_factores/assets/images/' . $item->imagen) ?>" target="_blank"><img src="<?php echo base_url('application/modules/galerias_factores/assets/images/' . $item->imagen) ?>" width="120" alt="imaginamos.com"></a></td>
                                                        
                                                            <td class="center" style="width: 20%">
                                                                <?php echo anchor("galerias_factores/edit/" . $item->id_galerias, "Editar", 'class="uibutton"') ?>
                                                                <?php echo anchor("galerias_factores/delete/". $item->factores_id."/". $item->id_galerias, "Eliminar", 'class="uibutton special"') ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    endforeach;
