  ...
  <body class="dashborad">
    ...
    <div id="content">
      <div class="inner">
        ...
        <!-- full width -->
        <div class="widget">
          <div class="header"><span><span class="ico gray window"></span>CMS AKRO / Equipo / Nuevo</span>
            <br /><?php echo anchor('cms_equipo/', 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>
          </div><!-- End header -->
          <div class="content">
            ...
            <div class="formEl_b">
              ...
              <div>
                ...
                <div>
                  ...
                  <?php echo form_open_multipart('cms_equipo/new_record/' . $this->uri->segment(3) . '/' . $this->uri->segment(4)) ?>
                  <fieldset>
                    
                    <div>
                      <p><label>Nombre<strong style="color: red">*</strong></label></p>
                      <div><input type="text" name="nombre" class="medium" value="<?php echo set_value('nombre'); ?>" maxlength="500" title="500 caracteres máximo" required /></div>
                    </div>
                    ...
                    <div>
                      ...
                      <div><input type="text" name="email" class="medium" value="<?php echo set_value('email'); ?>" maxlength="500" title="500 caracteres máximo" required /></div>
                    </div>
                    ...
                    <div>
                      ...
                      <div><input type="text" name="cargo_spa" class="medium" value="<?php echo set_value('cargo_spa'); ?>" maxlength="500" title="500 caracteres máximo" required /></div>
                    </div>
                    ...
                    <div>
                      ...
                      <div><input type="text" name="cargo_eng" class="medium" value="<?php echo set_value('cargo_eng'); ?>" maxlength="500" title="500 caracteres máximo" required /></div>
                    </div>
                    ...
                    <div>
                      ...
                      <div><textarea name="descripcion_spa" id="texto_spa" cols="60" rows="6" ><?php echo set_value('descripcion_spa'); ?></textarea></div>
                    </div>
                    ...
                    <div>
                      ...
                      <div><textarea name="descripcion_eng" id="texto_eng" cols="60" rows="6" ><?php echo set_value('descripcion_eng'); ?></textarea></div>
                    </div>
