  ...
  <body class="dashborad">
    ...
    <div id="content">
      <div class="inner">
        ...
        <!-- full width -->
        <div class="widget">
          <div class="header"><span><span class="ico gray window"></span>CMS AKRO / Que Buscamos / Editar</span>
            <br /><?php echo anchor('cms_buscamos/index/', 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>
          </div><!-- End header -->
          <div class="content">
            ...
            <div class="formEl_b">
              ...
              <div>
                ...
                <div>
                  ...
                  <?php echo form_open_multipart('cms_buscamos/update/' . $record[0]->id) ?>
                  <fieldset>
                    <div>
                      <p><label>Descripcion Español<strong style="color: red">*</strong></label></p>
                      <div><textarea name="texto_spa" id="texto_spa" cols="60" rows="6"><?php echo $record[0]->texto_spa; ?></textarea></div>
                    </div>
                    ...
                    <div>
                      ...
                      <div><textarea name="texto_eng" id="texto_eng" cols="60" rows="6"><?php echo $record[0]->texto_eng; ?></textarea></div>
                    </div>
                    ...
                    <div>
                      ...
                      <a href="<?php echo base_url('application/modules/cms_buscamos/assets/images/' . $record[0]->imagen) ?>" target="_blank"><img src="<?php echo base_url('application/modules/cms_buscamos/assets/images/' . $record[0]->imagen) ?>" alt="imaginamos.com" width="500"></a><br/>
