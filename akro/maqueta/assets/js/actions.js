...
$(".li_subnivel").hover(
	function(){
		...
		$(this).children("ul").css({'margin-left': margen_submenu - ($(this).children("ul").width()/2)});
		$(this).children("ul").slideDown().css({zIndex: 100});
	}, 
	function(){$(this).children("ul").stop(true).slideUp(400).css({zIndex: 99});
});
...
jQuery.fn.rotate = function(degrees) {
 ...
 $('.bx-next').click(function(event){
    ...
    if($(".imagen_rota").length){rotation += 72; $(this).rotate(rotation);}
	});
