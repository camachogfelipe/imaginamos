(function($, globals, undefined) {
    ...
    var MusicAll = {
        ...
        loadNotifications: function(type) {
            $.getJSON(globals.site_url + 'usuarios/perfil/load_notifications_' + type, {}, function(json) {
                if (json.tienes) {
        ...
        checkNotifications: function(type) {
            ...
            $.getJSON(globals.site_url + 'usuarios/perfil/check_notifications_' + type, {}, function(json) {
