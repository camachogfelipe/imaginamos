...
$whitelist = array('localhost', '127.0.0.1', 'rigo.local', 'rigo.gs', '192.168.0.9', 'brayanacebo.com');
$active_group = 'repo';
...
$db['default']['password'] = '';
$db['default']['database'] = 'usuarioric_musicall';
...
$db['repo']['hostname'] = 'articore1.ipowermysql.com';
$db['repo']['username'] = 'musicall';
$db['repo']['password'] = 'Musicall26032013';
$db['repo']['database'] = 'musicall';
...
$db['repo']['database'] = 'usuarioric_musicall';
$db['repo']['dbdriver'] = 'mysql';
$db['repo']['dbprefix'] = 'cms_';
$db['repo']['pconnect'] = TRUE;
$db['repo']['db_debug'] = TRUE;
