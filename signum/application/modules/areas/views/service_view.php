...
<div id="content">
    ...
    <div class="widget"> 
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                      <legend>Nuevo</legend>
                      <form enctype="multipart/form-data" action="<?php echo base_url(); ?>areas/adds" method="POST" onsubmit="return validate();" >
                <label>Titulo<strong> *</strong></label>
                <input type="text" name="service_title" id="service_title" class="large" />
                <br>
                <br>
                <label>Subtitulo<strong></strong></label>
                <input type="text" name="service_subtitle" id="service_subtitle" class="large" />
                <br>
                <br>
                ...
                <textarea name="service_text" id="service_text" ></textarea>
                <br>
                <br>
                <input type="hidden" name="service_area_id" value="<?php echo $area_id ?>" />
            ...
            <fieldset>
                ...
                <table class="display data_table2" >
                    ...
                    <tr class="odd gradeX">
                              <td class="center" width="70px"><?php echo $d->service_title; ?></td>
                              <td class="center" width="200px"><a class="uibutton" href="<?php echo base_url().'areas/views/'.$d->service_id.'/'.$area_id; ?>">Editar</a> <a class="uibutton" href="<?php echo base_url().'areas/deletes/'.$d->service_id.'/'.$area_id; ?>">Eliminar</a></td>
                            </tr>
                    <?php endforeach; ?>
                  </tbody>
                        </table>
