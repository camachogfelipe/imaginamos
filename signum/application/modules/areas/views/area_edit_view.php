    ...
    <div class="widget"> 
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                      ...
                      <form enctype="multipart/form-data" action="<?php echo base_url(); ?>areas/updatea" method="POST" onsubmit="return validate();" >
                <label>Titulo<strong> *</strong></label>
                <input type="text" name="title" id="title" class="large" value="<?php echo $data->area_title; ?>" />
                <br>
                <br>
                <img src="<?php echo base_url().'assets/area_img2/'.$data->area_icon; ?>" width="30" height="30" /> <br>
                <br>
                ...
                <textarea name="text"><?php echo $data->area_text; ?></textarea>
                <br>
                <br>
                <input type="hidden" name="id" value="<?php echo $data->area_id; ?>" />
                <input type="hidden" name="image" value="<?php echo $data->area_icon; ?>" />
