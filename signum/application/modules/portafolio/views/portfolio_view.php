...
<div id="content">
    ...
    <div class="widget"> 
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                      <legend>Nuevo</legend>
                      <form enctype="multipart/form-data" action="<?php echo base_url(); ?>portafolio/add" method="POST" onSubmit="return validate();" >
                ...
                <select style="width: 500px" class="chzn-select chzn-done">
            ...
            <fieldset>
                ...
                <table class="display data_table2" >
                    ...
                    <tr class="odd gradeX">
                              ...
                              <td class="center" width="200px"><a class="uibutton" href="<?php echo base_url().'portafolio/view/'.$d->id; ?>">Editar</a> <a class="uibutton" href="<?php echo base_url().'portafolio/delete/'.$d->id; ?>">Eliminar</a></td>
                            </tr>
                    <?php endforeach; ?>
                  </tbody>
                        </table>
