    ...
    <div class="widget"> 
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                      ...
                      <form enctype="multipart/form-data" action="<?php echo base_url(); ?>portafolio/update" method="POST" onSubmit="return validate();" >
                <label>Titulo<strong>*</strong></label>
                <input type="text" class="large" value="<?php echo $data->title; ?>" name="title" id="title" />
                <br>
                <br>
                <label>Text<strong>*</strong></label>
                <textarea name="text" id="text"><?php echo $data->text; ?></textarea>
                <br>
                <br>
                <img src="<?php echo base_url().'assets/portfolio_img/'.$data->image; ?>" width="210" /> <br>
                <br>
                <label>Imagen<strong> (293 x 148px) *</strong></label>
                ...
                <br>
                <br>
                <img src="<?php echo base_url().'assets/portfolio_img/'.$data->icon; ?>" width="30" /> <br>
                <br>
                <label>Icono<strong> (30 x 30px) *</strong></label>
                <input class="file fileupload2" placeholder="Seleccionar archivo" style="display: inline; color: rgb(102, 102, 102); font-size: 11px; width: 142px;">
                <div class="filebtn" style="width: 190px; height: 30px; background-image: url(<?php echo base_url(); ?>/alcance/edit/images/addFiles.png); display: inline; position: absolute; margin-left: -168px; background-position: 100% 50%; background-repeat: no-repeat no-repeat;">
                	<input type="file" name="userfile2" value="" title="Imagenes permitidas jpg|jpeg|png|gif" class="fileupload2" style="position: absolute; height: 30px; width: 170px; margin-left: 5px; display: inline; cursor: pointer; opacity: 0;">
                </div>
                <br>
                <br>
                <label>Servicio<strong> *</strong></label>
                <select name="idArea" style="width: 500px" class="chzn-select chzn-done">
                          <?php foreach($areas as $a): ?>
                          <option <?php if($a->area_id == $data->idArea){ echo ' selected '; } ?>  value="<?php echo $a->area_id; ?>" ><?php echo $a->area_title; ?></option>
                          <?php endforeach; ?>
                        </select>
                <br>
                <br>
                ...
                <input type="hidden" name="oldImage2" value="<?php echo $data->icon; ?>" />
