...
<div id="content">
    ...
    <div class="widget"> 
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                      <legend>Nuevo</legend>
                      <form enctype="multipart/form-data" action="<?php echo base_url(); ?>banner/add" method="POST" onSubmit="return validate();" >
                <br>
                <br>
                <label>Imagen<strong> (1425 x 340px) *</strong></label>
                ...
                <input type="text" name="title" id="titulo" maxlength="94" class="large" />
                <span class="f_help" style="margin-right: 200px;"> Límite de carácteres 94 / <span class="titulo"></span></span> <br>
                <br>
                <label>Texto<strong> *</strong></label>
                <textarea name="text" id="text"></textarea>
                <br>
                <p><span id="numero">265</span> caracteres max</p>
                <br>
                <br>
                <label>Servicio<strong> *</strong></label>
                <select name="idArea" style="width: 500px" class="chzn-select chzn-done">
                          <?php foreach($areas as $a): ?>
                          <option value="<?php echo $a->area_id; ?>" ><?php echo $a->area_title; ?></option>
                          <?php endforeach; ?>
                        </select>
                <br>
                <br>
            ...
            <fieldset>
                ...
                <table class="display data_table2" >
                    ...
                    <tr class="odd gradeX">
                              ...
                              <td class="center" width="200px"><a class="uibutton" href="<?php echo base_url().'banner/view/'.$d->id; ?>">Editar</a> <a class="uibutton" href="<?php echo base_url().'banner/delete/'.$d->id; ?>">Eliminar</a></td>
                            </tr>
                    <?php endforeach; ?>
                  </tbody>
                        </table>
...
<!--// End content -->
  ...
  $('#titulo').limit('94','.titulo');
  //$('#subtitulo').limit('30','.subtitulo');
</script>
        <script>
