...
<div id="content">
    ...
    <div class="widget"> 
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                      <legend>Nuevo</legend>
                      <form enctype="multipart/form-data" action="<?php echo base_url(); ?>banner/update" method="POST" onSubmit="return validate();" >
                <img src="<?php echo base_url().'assets/banner_img/'.$data->image; ?>" width="400" /> <br>
                <br>
                ...
                <input type="text" name="title" id="title" maxlength="94"  class="large" value="<?php echo $data->title; ?>" />
                <span class="f_help" style="margin-right: 200px;"> Límite de carácteres 94 / <span class="title"></span></span> <br>
                <br>
