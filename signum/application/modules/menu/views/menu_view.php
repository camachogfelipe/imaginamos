                                ...
                                <fieldset>
                                    ...
                                    <div class="tableName toolbar">
                                        <table class="display data_table2" >
                                            <thead>
                                                <tr>
                                                    <th><div class="th_wrapp">Nombre item del men&uacute;</div></th>	
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr class="odd gradeX" >
                                                        <td class="center" style="width: 35%"><?php echo $item->menu_title ?></td>
                                                        <td class="center" style="width: 35%"><?php if($item->menu_url == ''){echo "[Contenedor de submen&uacute;s]";}else{echo $item->menu_url;} ?></td>
                                                        <td class="center" style="width: 10%"><img src="<?php echo base_url() . 'assets/images/icons/' . $item->menu_icon ?>.png" alt="icons_imaginamos" /></td>
