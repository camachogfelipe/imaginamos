...
<div id="content">
    ...
    <div class="widget"> 
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                      <legend>Nuevo</legend>
                      <form enctype="multipart/form-data" action="<?php echo base_url(); ?>staff/add" method="POST" onsubmit="return validate();" >
                <br>
                <br>
                ...
                <input type="text" name="linkedin" id="linkedin" class="large" />
                <br>
                <br>
                <label>Twitter<strong> *</strong></label>
                <input type="text" name="twitter" id="twitter" class="large" />
                <br>
                <br>
            ...
            <fieldset>
                ...
                <table class="display data_table2" >
                    ...
                    <tr class="odd gradeX">
                              <td class="center" width="70px"><?php echo $d->name; ?></td>
                              <td class="center" width="200px"><a class="uibutton" href="<?php echo base_url().'staff/view/'.$d->id; ?>">Editar</a> <a class="uibutton" href="<?php echo base_url().'staff/delete/'.$d->id; ?>">Eliminar</a></td>
                            </tr>
                    <?php endforeach; ?>
                  </tbody>
                        </table>
