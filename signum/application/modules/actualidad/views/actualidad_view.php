...
<div id="content">
    ...
    <div class="widget"> 
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                      <legend>Nuevo</legend>
                      <form enctype="multipart/form-data" action="<?php echo base_url(); ?>actualidad/add" method="POST" onsubmit="return validate();" >
                <br>
                <br>
                ...
                <input type="text" tabindex="1" name="date" id="date" size="10">
            ...
            <fieldset>
                ...
                <table class="display data_table2" >
                    ...
                    <tr class="odd gradeX">
                              <td class="center" width="70px"><?php echo $d->title; ?>
                        <?php if($d->daily == 1){ echo ' <strong>Destacado.</strong> '; } ?></td>
                              <td class="center" width="200px"><a class="uibutton" href="<?php echo base_url().'actualidad/view/'.$d->id; ?>">Editar</a> <a class="uibutton" href="<?php echo base_url().'actualidad/delete/'.$d->id; ?>">Eliminar</a></td>
                            </tr>
                    <?php endforeach; ?>
                  </tbody>
                        </table>
