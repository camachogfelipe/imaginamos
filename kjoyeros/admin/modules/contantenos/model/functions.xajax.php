...
{  
	...
	if($formData[titulo_es] == ""){
		$objResponse->script("showError('Ingrese un Titulo Contenido en español.',3000);");
	}elseif ($formData[desc_es] == ""){
		$objResponse->script("showError('Ingrese un Contenido en español.',3000);");
	}elseif($formData[titulo_en] == "")
		$objResponse->script("showError('Ingrese un Titulo Contenido en ingles.',3000);");
	elseif ($formData[desc_en] == ""){
		$objResponse->script("showError('Ingrese un Contenido en ingles.',3000);");
	}else {
		
		//include("../../../core/class/db.class.php");
		$db = new Database();
		$db->connect();	 	 	 
		$db->doQuery("UPDATE cms_contactenos SET tituloContactenosEs = '$formData[titulo_es]', tituloContactenosEn = '$formData[titulo_en]', descripcionContactenosEs = '$formData[desc_es]', descripcionContactenosEn = '$formData[desc_en]'",UPDATE_QUERY);
