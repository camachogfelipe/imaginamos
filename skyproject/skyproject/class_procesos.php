...
//            
    ...
    public function EstadoventaAdmin() {
        $sql = $sql = " SELECT * FROM clientes, venta, plan, usuarios, tiendas " .
                ...
                " AND venta.id_Cliente = clientes.id_Cliente AND venta.id_Usuario = usuarios.id_Usuario AND tiendas.id_Tienda = usuarios.id_Tienda ORDER BY venta.id_Venta DESC";
        $mResoult = DbHandler::GetAll($sql);
        return $mResoult;
    }
    ...
    public function GetReporteVenta2() {
        $sql = " SELECT * FROM clientes, venta, plan, usuarios, tiendas " .
                " WHERE venta.id_Plan = plan.id_Plan" .
                " AND venta.id_Cliente = clientes.id_Cliente AND usuarios.id_Usuario = venta.id_Usuario AND tiendas.id_Tienda = usuarios.id_Tienda ORDER BY venta.id_Venta DESC";
        $mResoult = DbHandler::GetAll($sql);
        return $mResoult;
    }
	...
	public function SetControlSol($val) {
	 ...
	 public function Verifica() {
        $sql = "SELECT * FROM control_sol WHERE id = 1";
        $resultado = DbHandler::GetAll($sql);
        
		$valorAn = $resultado[0]['valor2'];
