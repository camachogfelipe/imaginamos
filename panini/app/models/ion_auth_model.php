...
class Ion_auth_model extends CI_Model {
     ...
     * @author Mathew
     * */
    public function login_both($identity, $password, $remember = FALSE) {
        $this->trigger_events('pre_login');
    ...
    public function update_last_login($id) {
        ...
        $this->db->update($this->tables['users'], array('last_login' => datetime_now()), array('id' => $id));
     ...
     * @return boolean
     */
     public function login_facebook($facebook_id) {
        $this->trigger_events('pre_login');
        ...
        $query = $this->db->select('facebook_id, username, email, id, password, active, last_login')
                ->where('facebook_id', $this->db->escape_str($facebook_id))
                ->limit(1)
                ->get($this->tables['users']);
