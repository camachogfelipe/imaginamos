...
class Database 
{
	...
	function Database()
	{
		...
		$this->conn = null;
		$this->results = null;
		$this->db = "usuariorar_kuehne";
		$this->user = "usuariorar";
		$this->pwd = "lk9Quuy/q0j@";
		$this->host = "localhost";
		$this->path = "";
		$this->rows = 0;
		...
		*/
		...
		$this->conn = null;
		$this->results = null;
		$this->db = "601059_mascota";
		$this->user = "601059_mascota";
		$this->pwd = "Mascota2011";
		$this->host = "mysql50-106.wc2.dfw1.stabletransit.com";
		$this->path = "https://mysql.dfw1-2.websitesettings.com";
		$this->rows = 0;
		$this->messages = array("Error en la conexion","No se pudo realizar la operacion, comuniquese con el administrador");
		...
		$this->db = "ventrevi_vv";
		$this->user = "vsoporte";
		$this->pwd = "Ventrevis2013";
		$this->host = "mysql50-77.wc2.dfw1.stabletransit.com";
		$this->path = "https://72.3.230.253";
		$this->rows = 0;
		$this->messages = array("Error en la conexion","No se pudo realizar la operacion, comuniquese con el administrador");
		*/
