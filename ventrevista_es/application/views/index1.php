    ...
    <body>
        ...
        <div class="conBgMenu">
            <div class="conTopSite">
                <div class="conLogo">
                    <a href="#primer_contenido"><img src="images/logo.png" width="260" height="82" alt="" /></a>
                </div>
                <div class="conMenu">
                    <div class="header">
                        <div class="menuSup">
                            <!--<div class="btMasInfo"><a href="#septimo_contenido">+ Info</a></div>-->
                            <div class="btContacto"><a class="formContacto fancybox.iframe" href="<?php echo base_url('site/contacto') ?>">Contacto</a></div>
                            <div class="btLogin"><a class="formLogin fancybox.iframe" href="<?php echo base_url('site/login') ?>">Log In</a></div>
                        </div>
                        <div class="menuSitio">
                            <ul class="sf-menu">
                                ...
                                <li><a href="#quinto_contenido"><div class="bt2"><p class="btMenu">PRUÉBALO GRATIS</p></div></a></li>
                                <li><a href="#sexto_contenido"><div class="bt3"><p class="btMenu">PACKS Y TARIFAS</p></div></a></li>
                            </ul>
                        </div>
                    </div>
                </div>    
                            ...
                            <div class="slider-id-1 riva-slider-holder" id="riva-slider-1">
                                ...
                                <ul class="riva-slider">
                                    <li class="rs-center slideAni">
                                        <div class="imgSlide">
                                            <img src="images/slide1.png" alt="" title="" class="rs-image" />
                                    ...
                                    <li class="rs-video rs-center">
                                        <div class="imgSlide">
                                            <a href="http://player.vimeo.com/video/37246289?title=0&amp;byline=0&amp;portrait=1&amp;autoplay=1&amp;loop=1" target="_self">
                                                <img src="images/slide2.png" alt="" title="" class="rs-image" />
                                            </a>
                                        </div>
                                    ...
                                    <li class="rs-center">
                                        <div class="imgSlide">
                                            <img src="images/slide3.png" alt="" title="" class="rs-image" />
                                    ...
                                    <div class="conNivo">
                                        <div class="slider-wrapper theme-ventrevista">
                                            <div id="slider" class="nivoSlider">
                                                <img src="images/banner1.png" width="660" height="130" alt="" title="#caption1" />
                                                <img src="images/banner2.png" width="660" height="130" alt="" title="#caption2" />
                                                <img src="images/banner3.png" width="660" height="130" alt="" title="#caption3" />
                                                <img src="images/banner4.png" width="660" height="130" alt="" title="#caption3" />
                                                <img src="images/banner5.png" width="660" height="130" alt="" title="#caption3" />
                                            </div>
                    ...
                    <div class="infoQue">
                        ...
                        <div class="conGraQue">
                            <div class="graficoQue">
                                <img src="images/graficoQue.png" width="514" height="270" alt="" />
                            </div>
                            <div class="videoQue">
                    ...
                    <div class="infoComo">
                        ...
                        <div class="conDestacadosComo">
                            <ul class="listadoComo">
                                <li class="como1">El seleccionador redacta las preguntas y en un solo clic las envía a todos los candidatos.</li>
                                <li class="como2">Los candidatos contestan a las preguntas a través de la webcam.</li>
                                <li class="como3">El seleccionador dispone de todos los videos en su panel de control para ver, puntuar y compartir en cualquier momento.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="conContenido5">
                    ...
                    <div class="infoPrueba">
                        <div class="conTPrueba">
                            <span class="tPrueba">Pruébalo <strong>Gratis</strong></span>
                        </div>
                        <div class="conSPrueba">
                            <span class="txPrueba">Si quieres recibir mas información envía un mail a  <a href="mailto:info@ventrevista.es" target="_blank">info@ventrevista.es</a> o</span><br>
                                <span class="txPrueba">llámanos al <strong>934876278</strong></span>
                        </div>
                        <div class="conFormulario">
                            <form id="formPrueba" class="formular" method="post">
                                <div class="conLabelContacto">
                                    <label>                                                                         
                                        <input value="* NOMBRE" data-validation-placeholder="* NOMBRE" class="text-input" type="text" onBlur="javascript:if(this.value=='') this.value='* NOMBRE';" onFocus="javascript:if(this.value=='* NOMBRE') this.value='';"/>
                                    </label>
                                </div>
                                <div class="conLabelContacto">
                                    <label>                                                                         
                                        <input value="* EMPRESA" data-validation-placeholder="* EMPRESA" class="text-input" type="text" onBlur="javascript:if(this.value=='') this.value='* EMPRESA';" onFocus="javascript:if(this.value=='* EMPRESA') this.value='';"/>
                                    </label>
                                </div>
                                <div class="conLabelContacto">
                                    <label>                                                                         
                                        <input value="* CARGO" data-validation-placeholder="* CARGO" class="text-input" type="text" onBlur="javascript:if(this.value=='') this.value='* CARGO';" onFocus="javascript:if(this.value=='* CARGO') this.value='';"/>
                                    </label>
                                </div>
                                <div class="conLabelContacto">
                                    <label>
                                        <input value="* E-MAIL" data-validation-placeholder="* E-MAIL" class="text-input" type="text" onBlur="javascript:if(this.value=='') this.value='* E-MAIL';" onFocus="javascript:if(this.value=='* E-MAIL') this.value='';"/>
                                    </label>
                                </div> 
                                <div class="conLabelContacto">
                                    <label>
                                        <input value="* TELÉFONO" data-validation-placeholder="* TELÉFONO" class="text-input" type="text" onBlur="javascript:if(this.value=='') this.value='* TELÉFONO';" onFocus="javascript:if(this.value=='* TELÉFONO') this.value='';"/>
                                    </label>
                                </div>                                
                            </form>
                            ...
                            <div class="conBtContacto">
                                <form>
                                    <a><input type="button" class="btContacto" value="" /></a>
                                </form>
                            </div>  
                        </div>
                        <div class="conImgPrueba">
                            <img src="images/imgPrueba.png" width="425" height="432" alt="" />
                        </div>
                    </div>
                    <div class="pieContenido"></div>
                </div>
                ...
                <div class="conContenido6">
                    <div class="infoPacks">
                        <div class="conTPacks">
                            ...
                            <div class="txPacks">
                                <span class="pPacks">Si quieres recibir mas información envía un mail a <a href="mailto:info@ventrevista.es" target="_blank">info@ventrevista.es</a> o llámanos al <strong>934876278</strong></span>
                            </div>
                        </div>
                        <div class="conPlanes">
                            ...
                            <div class="ib-container" id="ib-container">
                                <article>
                                    <a><img src="images/plan1.png" width="175" height="200" alt="" /></a>
                                </article>
                                <article>
                                    <a><img src="images/plan2.png" width="175" height="200" alt="" /></a>
                                </article>
                                <article class="active">
                                    <a><img src="images/plan3.png" width="175" height="200" alt="" /></a>
                                </article>
                                <article>
                                    <a><img src="images/plan4.png" width="175" height="200" alt="" /></a>
                                </article>    
                            </div>
                            <div class="planPay">
                                <img src="images/planPay.png" width="220" height="245" alt=""/>
                            </div>
                        </div>
                        <div class="conTxIva">
                        ...
                        <div class="conColIzq">
                            ...
                            <div class="infoColContacto">
                                <ul class="listadoContacto">
                                    <li class="contacto1"><span>934876278</span></li>
                                    <li class="contacto2">
                                        <span>Ventrevista España</span><br>
                                            <span>C/ Diputación, 279, 1º, 08007,</span><br>
                                                ...
                                                <div class="conColCen">
                                                    ...
                                                    <div class="conListadoLinks">
                                                        <ul class="listadoLinks">
                                                            <li class="linkFirst"><a href="http://www.equiposytalento.com/" target="_blank">www.equiposytalento.com</a></li>
                                                            <!--<li class="linkMed"><a href="www.imaginamos.com" target="_blank">www.imaginamos.com</a></li>
                                                            <li class="linkLast"><a href="www.imaginamos.com" target="_blank">www.com</a></li>-->
                                                        </ul>
                                                        <div class="logoLinks"><a href="#primer_contenido"><img src="images/logoFooter.png" width="258" height="82" alt="" /></a></div>
                                                    </div>
                                                </div>
                                                <div class="conColDer">
                                                    <div class="titColContacto">
                                                    ...
                                                    <div class="infoColContacto">
                                                        <a href="javascript:new_window('https://twitter.com/intent/follow?screen_name=VentrevistaEsp')"><div class="btSocial1"></div></a>
                                                        <a href="javascript:new_window('http://www.linkedin.com/groups/Ventrevista-España-3496815?gid=3496815&trk=hb_side_g')"><div class="btSocial2"></div></a>   
                                                        <a href="javascript:new_window('http://www.youtube.com/subscription_center?add_user_id=L4t7ry1FP-fchX6YpiHdNw&feature=creators_cornier-//s.ytimg.com/yt/img/creators_corner/Subscribe_to_my_videos/')"><div class="btSocial3"></div></a>
                                                    </div>
                                                </div>
                                                </div>
                                                    ...
                                                    <div class="infoFooter">
                                                        <div class="footerIzq">
                                                            <div class="conDerechos">
                                                                <span>&copy; 2012 - <strong>Ventrevista España.</strong></span>
                                                            </div>
                                                            <div class="copyHome">
                                                        ...
                                                        <div class="footerDer">
                                                            ...
                                                            <div class="mFooter"><a href="#segundo_contenido">¿Qué es Ventrevista?</a></div>
                                                ...
                                                <div id="box">
                                                    ...
                                                    <a href="javascript:new_window('http://www.linkedin.com/shareArticle?mini=true&url=http://www.ventrevista.es/&title=Ventrevista&Agilice%20sus%20procesos%20de%20seleccion%20utilizando%20Video%20entrevistas&source=Ventrevista')"><div class="red4"></div></a>    
                                                    <a href="javascript:new_window('http://twitter.com/share?url=http://www.ventrevista.es/&text=Agilice%20sus%20procesos%20de%20seleccion%20utilizando%20Video%20entrevistas')"><div class="red2"></div></a>
                                                    <a class="formMail fancybox.iframe" href="mail.html"><div class="red5"></div></a>
                                                </div>
