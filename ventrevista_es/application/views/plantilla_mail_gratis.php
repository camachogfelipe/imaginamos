...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Pruébalo Gratis Desde Página Web</title>
    ...
    <body  bgcolor="#1eb99f">
        ...
        <div style="width: auto;height: 400px;">
            <div style="background-color: white;width: 1010px;height: 500px;left: 10%;position: relative;">
                ...
                <h1 style="font-family: Arial;margin: 5px;left: 10px;position: relative;color: gray">Notificación de Prueba Gratis</h1>
                <br>
                ...
                <p style="color: white;font-size: 14px;font-family: Arial;color: gray;width: 900px;left: 50px;position: relative">
                    Alguien le interesa estar en contacto con Ventrevista, a continuaci&oacute;n sus datos.
                </p>
                
                <p style="font-size: 14px;font-family: Arial;color: gray;width: 900px;left: 50px;position: relative;text-align: left">
                    <strong>Nombre(s): </strong> <label><?php echo $nombre ?></label><br>
                    <strong>Empresa: </strong> <label><?php echo $empresa ?></label><br>
                    <strong>Cargo: </strong> <label><?php echo $cargo ?></label><br>
                    <strong>E-mail: </strong> <label><?php echo $email ?></label><br>
                    <strong>Telefono: </strong> <label><?php echo $telefono ?></label><br>
                    <strong>Boletin de noticias: </strong> <label><?php echo "1"; ?></label><br>
                </p>
