...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Notificaciones de contacto</title>
    ...
    <body bgcolor="#1eb99f">
        ...
        <div style="width: auto;height: 400px;">
            <div style="background-color: white;width: 1010px;height: 500px;left: 10%;position: relative;">
                ...
                <h1 style="font-family: Arial;margin: 5px;left: 10px;position: relative;color: gray">Notificaciones de contacto</h1>
                <br>
                ...
                <p style="font-size: 14px;font-family: Arial;color: gray;width: 900px;left: 50px;position: relative;text-align: left">
                    ...
                    <strong>Boletin de noticias: </strong> <label><?php echo $noticia ?></label><br>
