<?php /* Smarty version 2.6.24, created on 2013-12-10 19:57:31
         compiled from ciudades_oferta.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'load_presentation_object', 'ciudades_oferta.tpl', 1, false),)), $this); ?>
<?php echo smarty_function_load_presentation_object(array('filename' => 'ciudades_oferta','assign' => 'obj'), $this);?>
 ...
 ?>
      ...
      <div class="span8">
        <div class="cont_titulos inline">
          <h1 class="inline">Ciudades con <span>mayor oferta</span></h1>
          <div class="clear"></div>
        </div>
        <div class="row">
...
$this->_sections['a']['loop'] = is_array($_loop=$this->_tpl_vars['obj']->cCiudadOferta) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                <div class="campo_ofertaempleo2">
                  <span class="numero-dv"><?php echo $this->_tpl_vars['obj']->cCiudadOferta[$this->_sections['a']['index']]['num']; ?>
</span>
                  <span class="campo_ofertaempleocont3"> <a href="<?php echo $this->_tpl_vars['obj']->cOfPubli; ?>
&id_ciudad=<?php echo $this->_tpl_vars['obj']->cCiudadOferta[$this->_sections['a']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['obj']->cCiudadOferta[$this->_sections['a']['index']]['txt_nombre']; ?>
</a></span>
                </div>
                <?php endfor; endif; ?>
              </li>
