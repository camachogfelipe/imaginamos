<?php /* Smarty version 2.6.24, created on 2013-12-27 10:40:05
...
<html class="no-js ie9">
  <!--<![endif]-->
  <head>
    <title>Empleo en marcha</title>
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/images/favicon.ico" />
...
/styles/zona-franca.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/styles/internas.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/styles/style.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/styles/jScrollPane.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/lib/scrollslider/jquery.simplyscroll.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css" />

    <!-- FANCY BOX-->
    <link rel="stylesheet" type="text/css" href="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/source/jquery.fancybox.css"/>
...
/scripts/lib/jquery-1.8.3.min.js"></script>
    <!-- selectivizr -->
    <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/mootools/1.4.0/mootools-yui-compressed.js"></script>
    <!-- Mootools -->
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/lib/jquery-selectivizr-min.js"></script>
    ...
    <!-- Placeholder -->
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/lib/jquery.placeholder.js"></script>
    <!-- Custom forms -->
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/lib/jquery.formularios.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/lib/jquery.formularios-select.js"></script>
    <!-- Slider -->
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/lib/jquery.slider.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/lib/jquery.easing.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/lib/scrollslider/jquery.simplyscroll.js"></script> 
    <!-- Ahorranito -->
    <script type="text/javascript" src="http://www.imaginamos.com/footer_ahorranito/jquery.ahorranito.js"></script>
    <!-- FANCYBOX -->
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/lib/source/jquery.fancybox.js"></script>
    <!-- TABS -->
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/jquery.easytabs.js"></script>
    <!-- Scroll -->
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/jquery.jscrollpane.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/jquery.mousewheel.js"></script>
    <!-- Validador -->
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/jquery.validationEngine.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/jquery.validationEngine-es.js"></script>
    <!-- Actions -->
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/actions.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
/scripts/validCampoFranz.js"></script>
    <script type="text/javascript" src="<?php echo $this->_tpl_vars['obj']->mSiteUrl; ?>
    ...
    <div class="footer">
      <div>
        <div>
          ...
          <ul>
            <li>Tel&eacute;fono:<span><?php echo $this->_tpl_vars['obj']->cContac['txt_telefono']; ?>
</span></li>
            <li>Email:<span><?php echo $this->_tpl_vars['obj']->cContac['txt_email']; ?>
</span></li>
          </ul>
        </div>
        <div>
...
?>
              <li><a href="<?php echo $this->_tpl_vars['obj']->cMenu[$this->_sections['k']['index']]['url']; ?>
"><?php echo $this->_tpl_vars['obj']->cMenu[$this->_sections['k']['index']]['txt_nombre']; ?>
 </a></li>
              <?php endfor; endif; ?>
          </ul>
        </div>
    ...
    <?php echo '
      <script type="text/javascript">
        $(document).ready(function()
        {
          ...
          $("#registro_usuario, #registro_empresa").validationEngine();
        ...
        $(function() {
          $("#scrollerlogos").simplyScroll({pauseOnHover: true});
        });
      ...
      <div class="class_frm frmlogin ">
        ...
        <div>
          ...
          <div class="cont_olvidaste">
            ...
            <div class="cont_enviaracorreo cont_izqgris frmRecordarusuario">
              <input type="hidden" id="myFunct" class="field_frm" value="RecordarUsuario" />
              <input type="text" class="field_frm" id="env_usuario_persona" placeholder="Enviar a Correo Electrónico">
              <a href="javascript:void(0);" class="submit_frm" frmid="frmRecordarusuario">Enviar</a>
            </div>
          </div>

          <div class="cont_olvidaste">
            <p>¿Olvidaste tu contrase&ntilde;a?</p>
            <div class="cont_enviaracorreo cont_izqgris frmOlvidarContrasena" id="frmOlvidarContrasena">
              <input type="hidden" id="myFunct" class="field_frm" value="RecordarContrasena" />
              <input type="text" class="field_frm" id="env_contrasena" placeholder="Escriba su correo electrónico" />
              <a href="javascript:void(0);" class="submit_frm" frmid="frmOlvidarContrasena">Enviar</a>
            </div>
          </div>
        </div>
        <a href="javascript:void(0);" class="submit_frm boton-dv" frmid="frmlogin" >Ingresar</a>
      </div>
    </div>
    <div class="span6">
      <div>
        <p><?php echo $this->_tpl_vars['obj']->mFrmZonaSeguraUsuarios['titulo']; ?>
</p>
        <p><?php echo $this->_tpl_vars['obj']->mFrmZonaSeguraUsuarios['texto']; ?>
</p>
      </div>
      <a href="<?php echo $this->_tpl_vars['obj']->mRegUsu; ?>
">Regístrate</a>
    </div>
  </div>
</div>
...
<div id="zona_segura_empresa" class="row-fluid zona_segura fondo-zonaf">
  <div>
    <div class="span6 line_div_css">
      <div class="class_frm frmlogin2 ">
        ...
        <div>
          ...
          <div class="espacio_en_blancopeque"></div>
          <input type="password" class="field_frm" id="txt_passwd" title="Digite la contrase&ntilde;a">
          <input type="hidden" class="field_frm" id="txt_urlempresa" title="" value="">
        </div>
        <div>
          <div class="espacio_en_blancopeque"></div>
          <div class="cont_olvidaste">
    ...
    <div class="span6">
      <div>
        <p><?php echo $this->_tpl_vars['obj']->mFrmZonaSeguraEmpresas['titulo']; ?>
</p>
        <p><?php echo $this->_tpl_vars['obj']->mFrmZonaSeguraEmpresas['texto']; ?>
</p>
      </div>
      <a href="<?php echo $this->_tpl_vars['obj']->mRegEmp; ?>
">Reg&iacute;strate</a>
    </div>
  </div>
</div>
...
<div id="oferta-detalle2" style="display: none;">
  <div class="cont_emergente" id="detalle_oferta">
    ...
    <div class="row-fluid">
      <div class="span4">
        <div class="logo_empresa1"><img alt="" src=""></div>
      </div>
      <div class="span8">
        <h2>Descripci&oacute;n de la Oferta</h2>
        <div class="clear espacio_en_blanco"></div>
        <p><span class="text_naranja">Lugar:</span> </p>
        <p><span class="text_naranja">Sector:</span> </p>
        <p><span class="text_naranja">Vacantes:</span> </p>
        <p><span class="text_naranja">Fecha de publicaci&oacute;n:</span></p>
        <p></p>
      </div>
      ...
      <h2>Requisitos</h2>
      <div class="clear espacio_en_blanco"></div>
      <p><span class="text_naranja">Educaci&oacute;n:</span> </p>
      <p><span class="text_naranja">&aAcute;rea:</span> </p>
      <p><span class="text_naranja">Lugar de residencia:</span> </p>
      <p><span class="text_naranja">Edad:</span> </p>
      <p><span class="text_naranja">Experiencia laboral:</span> </p>
      <div class="sombra_division"></div>
  ...
  <div class="popup-aplicacion-exitosa" id="aplicacion-exitosa">
    ...
    <div class="sombra_division"></div>
    <h6><span>Nombre de la empresa u organizaci&oacute;n:</span> </h6>
    <div class="clear espacio_en_blancopeque"></div>
    <h6><span>Cargo:</span> </h6>
    <div class="clear espacio_en_blanco"></div>
    <p class="centrar_contenido">
    </p>
