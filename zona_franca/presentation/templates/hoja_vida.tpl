						...
						<div class="row-fluid">
							...
							<div class="span4">
								...
								<select class="select_dd priva" name="ind_privaci" id="ind_privaci" style="width:100% ;margin-top: 10px;">
									<option class="nivel_p_1" value="0" {if $obj->cInfoPer.ind_privaci=='1'}selected="selected"{/if}>Público</option>
									<option class="nivel_p_2" value="0" {if $obj->cInfoPer.ind_privaci=='0'}selected="selected"{/if}>Privado (No será listado en resultados de búsqueda)</option>
								</select>
								<div class="tooltip-priva">
									<p><b>Público:</b> Las empresas podran visualizar tu hoja de vida </p>
