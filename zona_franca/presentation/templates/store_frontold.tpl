        ...
        <div>
          ...
          <div class="cont_olvidaste">
            ...
            <div class="cont_enviaracorreo cont_izqgris">
              <input type="text" class="field_frm" id="env_usuario" title="Enviar a Correo Electrónico" placeholder="Enviar a Correo Electrónico">
              <a href="#">Enviar</a>
            </div>
          </div>
          ...
          <div class="cont_olvidaste">
            ...
            <div class="cont_enviaracorreo cont_izqgris">
              <input type="text" class="field_frm" id="env_contrasena" title="Enviar a Correo Electrónico" placeholder="Enviar a Correo Electrónico">
              <a href="#">Enviar</a>
            </div>
          </div>
        </div>
