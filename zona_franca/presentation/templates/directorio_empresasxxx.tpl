        ...
        <div class="row">
          <div class="span8 slider_directorio">
            ...
            <ul class="slider_directorio">
              {section name=k loop=$obj->cData step=16}
                <li>
                  <div class="campo-directorio">
                    <div class="row-fluid">
                      {section name=a loop=$obj->cData start=$smarty.section.k.index step=4 max=4}

                        {section name=x loop=$obj->cData start=$smarty.section.a.index step=1 max=4}
