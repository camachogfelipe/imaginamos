...
<html class="no-js ie9">
  ...
  <head>
    ...
    <link href="{$obj->mSiteUrl}/scripts/lib/scrollslider/jquery.simplyscroll.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="{$obj->mSiteUrl}/scripts/lib/scrollslider/jquery.simplyscroll.js"></script> 
    <!-- Ahorranito -->
    ...
    <!-- Validador -->
    <script type="text/javascript" src="{$obj->mSiteUrl}/scripts/jquery.validationEngine.js"></script>
    <script type="text/javascript" src="{$obj->mSiteUrl}/scripts/jquery.validationEngine-es.js"></script>
    <!-- Actions -->
    <script type="text/javascript" src="{$obj->mSiteUrl}/scripts/actions.js"></script>
    <script type="text/javascript" src="{$obj->mSiteUrl}/scripts/validCampoFranz.js"></script>
...
<div id="zona_segura_usuario" class="row-fluid zona_segura fondo-zonaf">
  <div>
    ...
    <div class="span6">
      <div>
        <p>{$obj->mFrmZonaSeguraUsuarios.titulo}</p>
        <p>{$obj->mFrmZonaSeguraUsuarios.texto}</p>
      </div>
      <a href="{$obj->mRegUsu}">Regístrate</a>
    </div>
  </div>
</div>
...
<div id="zona_segura_empresa" class="row-fluid zona_segura fondo-zonaf">
  <div>
    ...
    <div class="span6">
      <div>
        <p>{$obj->mFrmZonaSeguraEmpresas.titulo}</p>
        <p>{$obj->mFrmZonaSeguraEmpresas.texto}</p>
      </div>
