  ...
  <div class="campo-perfil" style="position: relative;">
    <div class="row-fluid">
      ...
      <div class="span10 ">
        ...
        <h2>{$obj->cInfoPer.nom_aspirante}, <span>Bienvenido</span> <em>{$obj->cInfoPer.nom_profesion} - {$obj->cInfoPer.nom_area}</em></h2>
        <div class="espacio_en_blanco"></div>
      ...
      <div class='panel-container'>
                ...
                <div class="info_ofertas-int">
                  <div class="row-fluid fluid_ofertas">
                    ...
                    <div class="span3 offset9">
                      <p class="text_peque text_naranja float_right marg20"> <a class="bt_naranja popup float_right" href="#oferta-detalle2" onclick="DetalleOfertaH( '{$obj->cOfert[k].id}' );">Ver más información</a> </p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="contcampo_oferta-int">
                ...
                <div class="info_ofertas-int">
                  <div class="row-fluid fluid_ofertas">
                    ...
                    <div class="clear"></div>
                    <div class="span3 offset9">
                      <p class="text_peque text_naranja float_right marg20"> <a class="bt_naranja popup float_right" href="#oferta-detalle2" onclick="DetalleOfertaH( '{$obj->cOferApl[k].id}' );">Ver más información</a> </p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div id="tabs4">
          <form action="{$obj->mThisUrl}" class="formulario-zonasegura" name="frm-zonasegura" id="frm-zonasegura" method="post" enctype="multipart/form-data">
            <a class="cerrar-dv" style="" href="javascript:void(0);" onclick="ElimUsuario( '{$obj->cInfoPer.id}', '{$obj->cInfoPer.id_registrado}' );">Eliminar usuario</a>
            ...
            <div class="row-fluid">
              ...
              <div class="span4">
                ...
                <select class="select_dd priva" name="ind_privaci" id="ind_privaci" style="width:100% ;margin-top: 10px;">
                  <option class="nivel_p_1" value="1" {if $obj->cInfoPer.ind_privaci=='1'}selected="selected"{/if}>Público</option>
                  <option class="nivel_p_2" value="0" {if $obj->cInfoPer.ind_privaci=='0'}selected="selected"{/if}>Privado</option>
                </select>
