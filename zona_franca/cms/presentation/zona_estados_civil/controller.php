<?php
/*
 * @file               : zona_estados_civil.db.php
...
class controller
{
  ...
  public function __construct()
  {
    ...
    $mOpciones = array( "clase" => "zona_estados_civil" );
  ...
  public function init()
  {
    ...
    switch( strtolower( $this -> mModo ) )
    {
      case "list":
      {
        $mQuery = "SELECT id, txt_nombre, ind_estado FROM zona_estados_civil WHERE ind_estado=1 ";
        ...
        $this -> mList = $lista -> generateList( "zona_estados_civilList" );
        break;
      }
      ...
      case "edit":
      {
        ...
        $cData = new Dbzona_estados_civil();
