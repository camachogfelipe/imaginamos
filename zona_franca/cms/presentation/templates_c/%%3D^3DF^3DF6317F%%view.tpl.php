<?php /* Smarty version 2.6.24, created on 2014-01-08 11:57:27
         compiled from C:%5Cxampp%5Chtdocs%5Cimaginamos%5Cjames_garcia%5Czona_franca%5Ccms/presentation/cms_secciones/view.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'load_presentation_object', 'C:\\xampp\\htdocs\\imaginamos\\james_garcia\\zona_franca\\cms/presentation/cms_secciones/view.tpl', 1, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['obj']->cPadre[$this->_sections['k']['index']]['txt_nombre']; ?>
    ...
    <?php if ($this->_tpl_vars['obj']->mData['id'] == '12'): ?>
    <div class="span5">
      <label class="label">Descripcion *</label><br />
      <textarea class="field_frm" id="txt_descripcion" name="txt_descripcion" rows="3" title="Digite la descripcion"><?php echo $this->_tpl_vars['obj']->mData['txt_descripcion']; ?>
</textarea>
    </div>
    <?php endif; ?>
