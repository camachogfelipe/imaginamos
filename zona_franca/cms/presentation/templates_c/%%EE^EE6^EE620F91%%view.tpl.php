<?php /* Smarty version 2.6.24, created on 2013-08-13 15:21:58
         compiled from /var/www/CMK/zonafranca/cms/presentation/zona_idiomas/view.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'load_presentation_object', '/var/www/CMK/zonafranca/cms/presentation/zona_idiomas/view.tpl', 1, false),)), $this); ?>
<?php echo smarty_function_load_presentation_object(array('filename' => "zona_idiomas/controller",'assign' => 'obj'), $this);?>
...
<div class="row-fluid formContainer">
  <h1>Idiomas</h1>
  <br>
  <div class="class_frm frmzona_idiomas">
    <input type="hidden" class="field_frm" id="myClass" value="AjaxInsert" />
    <input type="hidden" class="field_frm" id="clase" value="zona_idiomas" />
...
" placeholder="Nombre" title="Digite el nombre" />
    ...
    <div class="span10">
      <a href="javascript:void(0);" class="btn submit_frm" frmid="frmzona_idiomas">Guardar</a>
    </div>
  </div>
</div>
<?php endif; ?>
