{load_presentation_object filename="cms_faq_preguntas/controller" assign="obj"}
...
<div class="row-fluid formContainer">
  ...
  <div class="class_frm frmcms_faq_preguntas">
    ...
    <div class="span5">
      ...
      <input type="text" class="field_frm" id="txt_pregunta" name="txt_pregunta" value="{$obj->mData.txt_pregunta}" placeholder="Pregunta" title="Digite el pregunta" />
    </div>
