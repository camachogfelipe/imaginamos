<?php
/*
 * @file               : cms_encuesta_opciones.db.php
...
class controller
{
  ...
  public function __construct()
  {
    ...
    $mOpciones = array( "clase" => "cms_encuesta_opciones" );
  ...
  public function init()
  {
    ...
    switch( strtolower( $this -> mModo ) )
    {
      case "list":
      {
        ...
        $lista -> setHeader( "fCreaci&oacute;n", array( "dbfield" => "fec_creasi" ) );

        $lista -> setHidden( "id", array( "label" => "id_opcion" ) );
        ...
        $this -> mList = $lista -> generateList( "cms_encuesta_opcionesList" );
        break;
      }
      ...
      case "edit":
      {
        ...
        $mId = GetData( "id_opcion" );

        $cData = new Dbcms_encuesta_opciones();
