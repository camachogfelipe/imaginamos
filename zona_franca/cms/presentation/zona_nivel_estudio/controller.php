<?php
/*
 * @file               : zona_nivel_estudio.db.php
 * @brief              : Clase para la interaccion con la tabla zona_nivel_estudio
 * @version            : 3.3
...
class controller
{
  ...
  public function __construct()
  {
    ...
    $mOpciones = array( "clase" => "zona_nivel_estudio" );
  ...
  public function init()
  {
    ...
    switch( strtolower( $this -> mModo ) )
    {
      case "list":
      {
        $mQuery = "SELECT id, txt_nombre, ind_estado FROM zona_nivel_estudio WHERE ind_estado='1' ";
        ...
        $this -> mList = $lista -> generateList( "zona_nivel_estudioList" );
        break;
      }
      ...
      case "edit":
      {
        ...
        $cData = new Dbzona_nivel_estudio();
