...
class controller
{
  ...
  public function __construct()
  {
    ...
    $mOpciones = array( "clase" => "zona_idiomas" );
  ...
  public function init()
  {
    ...
    switch( strtolower( $this -> mModo ) )
    {
      case "list":
      {
        $mQuery = "SELECT id, txt_nombre, ind_estado FROM zona_idiomas WHERE ind_estado=1 ";
        ...
        $this -> mList = $lista -> generateList( "zona_idiomasList" );
        break;
      }
