 ...
 * @version            : 1.0
 * @ultima_modificacion: 20-mar-2013
...
class DbDAO {
  ...
  /*
   * Metodo Publico que retorna el ID de registro mas alto incrementable
   * @fn getMaxId
   * @brief Retorna el ID de registro mas alto incrementable
  ...
  public function deleteLogic() {
    $tabla = str_replace("Db", "", get_class($this));
    $mQuery = "UPDATE " . $tabla . " SET ind_estado='2' WHERE id='" . (int) $this->id . "'; ";
    return DbHandler::Execute($mQuery);
  }
  ...
  public function activeRegister() {
    $tabla = str_replace("Db", "", get_class($this));
    $mQuery = "UPDATE " . $tabla . " SET ind_estado='1' WHERE id='" . (int) $this->id . "'; ";
    return DbHandler::Execute($mQuery);
  }
