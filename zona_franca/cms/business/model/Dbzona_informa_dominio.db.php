<?php
/*
 * @file               : Dbzona_informa_dominio.db.php
 * @brief              : Clase para la interaccion con la tabla zona_informa_dominio
 * @version            : 3.3
 * @ultima_modificacion: 2013-07-11
 * @author             : Ruben Dario Cifuentes Torres
 * @generated          : Generador DAO version 1.1
 *
 * @class: Dbzona_informa_dominio
 * @brief: Clase para la interaccion con la tabla zona_informa_dominio
 */

class Dbzona_informa_dominio extends DbDAO {
