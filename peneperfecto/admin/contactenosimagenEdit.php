...
<tr>
<td>
    MODIFICAR CONTACTENOS IMAGEN
</td>
<td align="right">
    <a href="menuAdmin.php?s=contactenosimagen">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">CONTACTENOS IMAGEN, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">CONTACTENOS IMAGEN, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/contactenosimagenEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Imagen:</span><br />
      <img src="./..<?=$contactenosimagen->getimagen() ?>" width="240" height="353">
<br/>
        <input type="file" name="imagen"><br>
        <span style="font-size:small;">
        tama&ntilde;o recomendado 240 x 353 px
        </span>
