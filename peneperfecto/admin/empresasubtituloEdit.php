...
<tr>
<td>
    MODIFICAR EMPRESA SUBTITULO
</td>
<td align="right">
    <a href="menuAdmin.php?s=empresasubtitulo">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">EMPRESA SUBTITULO, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">EMPRESA SUBTITULO, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/empresasubtituloEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Sub-Titulo:</span><br />
        <input type="text" name="subtitulo" value="<?=$empresasubtitulo->getsubtitulo() ?>" size="40">
    </td>
</tr>
<tr>
    <td>
        ...
        <?php
            ...
            $oFCKeditor_l->Value = ''.$empresasubtitulo->getdescripcion();
            $oFCKeditor_l->Create() ;
        ?>
...
<tr>
    <td>
      ...
      <img src="./..<?=$empresasubtitulo->getimagen() ?>" width="250" height="150">
<br/>
