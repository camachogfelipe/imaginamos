...
<td align="right">
    <a href="menuAdmin.php?s=redes">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">REDES, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">REDES, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/redesEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Link:</span><br />
        <input type="text" name="link" value="<?=$redes->getlink() ?>" size="40">
        </br>
        Debe de llevar el http:// ejemplo http://facebook.com?id=03498502345n0945
    </td>
</tr>
<tr>
<td align="right">
