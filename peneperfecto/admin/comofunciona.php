...
$comofuncionas = $comofuncionaDAO->gets();
$total = $comofuncionaDAO->total();
...
<input id="filterBoxOne" value="" maxlength="30" size="30" type="text" />
    ...
    <?php if( isset($_GET['ok']) ){ ?>
        <tr>
            <td class="EstiloGreen">comofunciona eliminado</td>
        </tr>
    <?php }?>
    <?php if( isset($_GET['error']) ){ ?>
        <tr>
            <td class="EstiloRed">Error al eliminar comofunciona</td>
        </tr>
    <?php }?>
...
<tbody>
  <?php if($total>0): ?>
    <?php foreach ($comofuncionas as $comofunciona): ?>
      <tr>
          <td width="" align="center"><?=$comofunciona->gettitulo() ?></td>
        <td width="" align="center"><img src="./..<?=$comofunciona->getbanner() ?>" width="375" height="130" /></td>
        <td width="20%" align="center">
          <a href="menuAdmin.php?s=comofuncionaVer&a=<?=$comofunciona->getid() ?>" title="Ver" >Ver</a>
           | 
          <a href="menuAdmin.php?s=comofuncionaEdit&a=<?=$comofunciona->getid() ?>" title="Modificar" >Modificar</a>
        </td>
      </tr>
    <?php endforeach; ?>
  <?php endif; ?>
