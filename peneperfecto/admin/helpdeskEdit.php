...
<td align="right">
    <a href="menuAdmin.php?s=helpdesk">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">HELPDESK, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">HELPDESK, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/helpdeskEdit.php" method="post" enctype="multipart/form-data">
<table width="500">
...
<tr>
    <td>
        ...
        <?php
            ...
            $oFCKeditor_l->Value = ''.$helpdesk->gettexto();
            $oFCKeditor_l->Create() ;
        ?>
