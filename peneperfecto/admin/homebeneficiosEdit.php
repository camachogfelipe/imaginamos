...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">HOME BENEFICIOS, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">HOME BENEFICIOS, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/homebeneficiosEdit.php" method="post" enctype="multipart/form-data">
<table width="500">
...
<tr>
    <td>
        ...
        <?php
            ...
            $oFCKeditor_l->Value = ''.$homebeneficios->getdescripcion();
            $oFCKeditor_l->Create() ;
        ?>
...
<tr>
    <td>
      ...
      <img src="./..<?=$homebeneficios->geticono() ?>" width="65" height="67">
<br/>
