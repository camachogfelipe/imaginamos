...
<td align="right">
    <a href="menuAdmin.php?s=formasdepago">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">FORMAS DE PAGO, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">FORMAS DE PAGO, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/formasdepagoEdit.php" method="post" enctype="multipart/form-data">
<table width="500">
...
<tr>
    <td>
        ...
        <?php
            ...
            $oFCKeditor_l->Value = ''.$formasdepago->gettexto();
            $oFCKeditor_l->Create() ;
        ?>
...
<tr>
    <td>
      ...
      <img src="./..<?=$formasdepago->getimagen() ?>" width="250" height="150">
<br/>
