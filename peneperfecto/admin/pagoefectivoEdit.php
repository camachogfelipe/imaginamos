...
<td align="right">
    <a href="menuAdmin.php?s=pagoefectivo">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">PAGO EN EFECTIVO, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">PAGO EN EFECTIVO, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/pagoefectivoEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Titulo:</span><br />
        <input type="text" name="titulo" value="<?=$pagoefectivo->gettitulo() ?>" size="40">
    </td>
</tr>
<tr>
    <td>
        ...
        <?php
            ...
            $oFCKeditor_l->Value = ''.$pagoefectivo->getTexto();
            $oFCKeditor_l->Create() ;
        ?>
