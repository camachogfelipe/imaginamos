...
<tr>
<td>
    MODIFICAR HOME RECOMENDADO
</td>
<td align="right">
    <a href="menuAdmin.php?s=homerecomendado">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">HOMERECOMENDADO, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">HOMERECOMENDADO, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/homerecomendadoEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Imagen:</span><br />
      <img src="./..<?=$homerecomendado->getimagen() ?>" width="246" height="212">
<br/>
        <input type="file" name="imagen"><br>
        <span style="font-size:small;">
        tama&ntilde;o recomendado 246 x 212 px
        </span>
...
<tr>
    <td>
        ...
        <input type="text" name="link" value="<?=$homerecomendado->getlink() ?>" size="40">
    </td>
</tr>
<tr>
<td align="right">
