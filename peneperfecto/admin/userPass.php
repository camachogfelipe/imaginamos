    ...
    <td></td>
       ...
       <table align="center" width="750">
        <tr>
            <td>
                ...
                <form action="../php/action/userPassEdit.php" method="POST"
      ...
      <table border="0" align="left" width="400" border="0" cellspacing="4" cellpadding="4">
         ...
         <?php if( isset($_GET['error1']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">Debe llenar todos los campos</td>
            </tr>
          <?php }?>
         <?php if( isset($_GET['error2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">La contraseña actual no es correcta</td>
            </tr>
          <?php }?>
          <tr>
            <td  width="150">Nombre Usuario:</td>
            <td><input size="35" type="text" name="nombre" value="<?=$_SESSION['admin'] ?>"> </td>
          </tr>
          <tr>
            <td  width="150">Contraseña Actual:</td>
            <td><input size="35" type="password" name="pass"> </td>
          </tr>
          <tr>
            <td>Contraseña Nueva:</td>
            <td><input size="35" type="password"  name="pass1"></td>
          </tr>
          <tr>
            <td>Repita:</td>
            <td><input size="35" type="password"  name="pass2"></td>
          </tr>
          <tr>
            <td></td>
            <td></td>
