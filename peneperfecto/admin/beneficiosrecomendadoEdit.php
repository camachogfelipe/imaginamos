...
<tr>
<td>
    MODIFICAR BENEFICIOS RECOMENDADO
</td>
<td align="right">
    <a href="menuAdmin.php?s=beneficiosrecomendado">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">BENEFICIOS RECOMENDADO, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">BENEFICIOS RECOMENDADO, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/beneficiosrecomendadoEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Imagen:</span><br />
      <img src="./..<?=$beneficiosrecomendado->getimagen() ?>" width="" height="">
<br/>
...
<tr>
    <td>
        ...
        <input type="text" name="link" value="<?=$beneficiosrecomendado->getlink() ?>" size="40">
    </td>
</tr>
<tr>
<td align="right">
