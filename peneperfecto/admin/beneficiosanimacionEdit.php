...
<tr>
<td>
    MODIFICAR BENEFICIOS ANIMACION
</td>
<td align="right">
    <a href="menuAdmin.php?s=beneficiosanimacion">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">BENEFICIOS ANIMACION, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">BENEFICIOS ANIMACION, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/beneficiosanimacionEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Animacion:</span><br />
      <img src="./..<?=$beneficiosanimacion->getanimacion() ?>" width="" height="">
<br/>
