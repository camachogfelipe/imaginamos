...
<td align="right">
    <a href="menuAdmin.php?s=tecnicas">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">TECNICAS, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">TECNICAS, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/tecnicasEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Titulo:</span><br />
        <input type="text" name="titulo" value="<?=$tecnicas->gettitulo() ?>" size="40">
    </td>
</tr>
<tr>
    <td>
        ...
        <?php
            ...
            $oFCKeditor_l->Value = ''.$tecnicas->getdescripcion();
            $oFCKeditor_l->Create() ;
        ?>
...
<tr>
    <td>
      ...
      <img src="./..<?=$tecnicas->getimagen() ?>" width="250" height="150">
<br/>
