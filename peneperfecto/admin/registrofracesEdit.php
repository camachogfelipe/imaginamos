...
<tr>
<td>
    MODIFICAR REGISTRO FRACES
</td>
<td align="right">
    <a href="menuAdmin.php?s=registrofraces">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">REGISTRO FRACES, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">REGISTRO FRACES, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/registrofracesEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Texto:</span><br />
        <input type="text" name="texto" value="<?=$registrofraces->gettexto() ?>" size="40">
    </td>
</tr>
<tr>
<td align="right">
