...
<tr>
<td>
    MODIFICAR HOME BANNER DINAMICO
</td>
<td align="right">
    <a href="menuAdmin.php?s=homebannerslider">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">HOME BANNER DINAMICO, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">HOME BANNER DINAMICO, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/homebannersliderEdit.php" method="post" enctype="multipart/form-data">
<table width="500">

<tr>
    <td>
        <span class="Estilo3">Imagen:</span><br />
      <img src="./..<?=$homebannerslider->getimagen() ?>" width="460" height="231">
<br/>
        <input type="file" name="imagen"><br>
        <span style="font-size:small;">
        tama&ntilde;o recomendado 460 x 231 px
        </span>
