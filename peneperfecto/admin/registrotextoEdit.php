...
<div class="titulos">
    <div class="titulos_texto1">REGISTRO TEXTO<div class="cerrar"><a href="../php/action/logout.php"><img src="imagenes/contenido/cerrar.png" alt="Cerrar Sesi&oacute;n" border="0" /></a></div></div>
...
<tr>
<td>
    MODIFICAR REGISTRO TEXTO
</td>
<td align="right">
    <a href="menuAdmin.php?s=registrotexto">Atr&aacute;s</a>
</td>
</tr>
</table>
...
<div class="subcontenido2">
    <table border="0" align="center" width="400" cellspacing="4">
        ...
        <?php if( isset($_GET['ok']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">REGISTRO TEXTO, agregado correctamente</td>
            </tr>
        <?php }?>
        <?php if( isset($_GET['ok2']) ){ ?>
            <tr>
                <td class="EstiloGreen" colspan="2">REGISTRO TEXTO, modificado correctamente</td>
            </tr>
        <?php }?>
    </table>
...
<form action="./../php/action/registrotextoEdit.php" method="post" enctype="multipart/form-data">
<table width="500">
...
<tr>
    <td>
        ...
        <?php
            ...
            $oFCKeditor_l->Value = ''.$registrotexto->gettexto();
            $oFCKeditor_l->Create() ;
        ?>
