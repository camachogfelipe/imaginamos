<?
    ...
    $comofunciona = $comofuncionaDAO->getById(1);
  ...
  <div id="headlgomenu">
    ...
    <div id="envsearchmenu">
      ...
      <div id="envmenudest">
        ...
        <div id="bt2cur"><a href="como_funciona.php">CÓMO FUNCIONA</a></div>
    ...
    <div id="caja_centbienestar">
      <div class="cont_pperfecto" >
        ...
        <div id="envcolder_cuerpo">
            <div id="tit_barconts"><?=$comofunciona->gettitulo() ?> </div>
          <div id="env_cajonprograma">
            <div id="textoscont_pperfectointernas">
                <div id="env_imgbannerint"><img src=".<?=$comofunciona->getbanner() ?>" width="729"  height="250"/></div>
                <p><?=$comofunciona->gettexto() ?></p>
              <p> </p>
