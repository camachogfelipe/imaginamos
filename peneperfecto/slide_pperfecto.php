<?
    ...
    $homebannerslider = $homebannersliderDAO->gets();
?>
...
#slidebox, #slidebox .content{width:460px;}
#slidebox, #slidebox .container, #slidebox .content{height:231px;}
...
#slidebox .next, #slidebox .previous{position:absolute; z-index:2; display:block; width:21px; height:21px; cursor:pointer;}
...
<a href="#" onClick="Slidebox('4');return false" class="thumb">&nbsp;</a> 
	...
	<div class="container">
    	<div class="content">
            <div><img src=".<?=$homebannerslider[0]->getimagen() ?>" /></div>
        
        </div>
        <div class="content">
        		<div><img src=".<?=$homebannerslider[1]->getimagen() ?>" /></div>
        </div>
        <div class="content">
        	<div><img src=".<?=$homebannerslider[2]->getimagen() ?>" /></div>
        </div>
        <div class="content">
        	<div><img src=".<?=$homebannerslider[3]->getimagen() ?>" /></div>
        </div>
	</div>
</div>
</body>
