<?
    ...
    $empresatitulo = $empresatituloDAO->getById(1);
    
    $empresasubtituloDAO = new empresasubtituloDAO();
    $empresatitulos = $empresasubtituloDAO->gets();
...
<div id="headbarratop" class="navtop"> <div id="bttop"><?php include "login_website.php"; ?></div>
  <div id="bartop">
      <div id="menuh">
        <ul>
          <li><a href="empresa.php" id="primero">Empresa</a></li>
    ...
    <div id="caja_centbienestar">
      <div class="cont_pperfecto" >
        ...
        <div id="envcolder_cuerpo">
            <div id="tit_barconts"><?=$empresatitulo->gettitulo() ?></div>
          ...
          <div id="env_cajonprograma">
            <div id="textoscont_pperfectointernas"> 
                ...
                <? if($total>0): foreach ($empresatitulos as $empresasubtitulo): ?>
                
                <div id="subtitulos_int"><?=$empresasubtitulo->getsubtitulo() ?> </div> 

                <div id="row_beneficios">

                    <div id="img_beneficios"><img src=".<?=$empresasubtitulo->getimagen() ?>" width="250" height="150" /></div>

                    <div id="txt_beneficios">



                        <p><?=$empresasubtitulo->getdescripcion() ?></p></div>
...
<div id="subtitulos_int">Cómo se creó </div> 
...
<div id="clear_sepinterno"></div>
	...
	<div id="subtitulos_int">Misión</div>
	<div id="row_beneficios">
	...
	<div id="subtitulos_int">Visión</div>
	
	<div id="row_beneficios">
	
	<div id="img_beneficios"><img src="images/img_beneficios1.jpg" width="250" height="150" /></div>
