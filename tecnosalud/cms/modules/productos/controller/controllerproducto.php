...
if($titlesub == ""  or $textosub == ""  or count($imageUpload) == 0 )
	...
	$message = "<script>showError('Debe ingresar todos los datos del formulario',3000);</script>";
	...
	else
		{
				...
				$db->doQuery( "INSERT INTO cms_productos (productos_id, id_subcategoria, productos_title, productos_texto, productos_image) VALUES ('',".$id2.",'".mysql_real_escape_string($titlesub)."','".mysql_real_escape_string($textosub)."','".$imageUploadOk."')",INSERT_QUERY);
