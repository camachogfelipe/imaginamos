			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>DISTRIBUIDOR >> EDITAR DISTRIBUIDOR</span>
					</div><!-- End header -->	
                        <div class="content">
                    ...
                    <?php
                 //   echo "SELECT * FROM cms_pais WHERE pais_id =".$id;
                    $query = "SELECT * FROM cms_productos WHERE productos_id =".$id;
                    ...
                    <?php echo $htmlFormNews->printFormEdit2($id,$funcionality); ?>
             ...
             <script language="javascript">$("#texto").cleditor();</script> 
