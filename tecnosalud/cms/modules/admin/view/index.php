			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
                    ...
                    <div class="formEl_b" style="height: 160px;">
                    
                    <div>
                        <img src="../../../../imagenes/logo-header.png" style="float: right;margin:20px;" 
                    <?php if($_SESSION["CMSRolUser"] == "admin") {?>
                             <h3>Bienvenido administrador, seleccione una opción con la cual trabajar</h3>      
                    <?php }else{ ?>
