			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>DESTACADOS </span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_destacados'",SHOW_TABLE_QUERY);
					//Si recibimos TRUE como respuesta quiere decir que si existe la tabla
					if($show = $db->show)
						{
						$db->doQuery("SELECT destacados_config_funcionality FROM cms_destacados_config WHERE destacados_config_id = 1",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
						echo $htmlFormNews->printFormNews($result[0][destacados_config_funcionality]);
						}
					else
