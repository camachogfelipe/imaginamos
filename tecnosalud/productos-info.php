...
$obj = new Pintar();
$result = $obj->PintarProducto_info($_GET['id']);
	...
	<div class="con-general">
      ...
      <div class="info-auto">
        ...
        <div class="miga-pan">
          ...
          <a class="miga-activa">Sub-categoría</a>
        </div>
          ...
          <ul class="content_paging">
            <li>
              ...
              <div class="item-producto">
                <a href="producto.php?id=<?php echo $result[$index]['categoria_id']?>" class="mosaic-block bar">
