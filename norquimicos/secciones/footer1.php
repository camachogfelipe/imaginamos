...
<div class="footer">
    <div class="contienefooter">
        <div class="zonasegura">
            ...
            <?php if (isset($_SESSION["Nombre"])) { ?>
                <a  onclick="cambiar3(<?php echo  $ss ?>)" href="index.php?seccion=zonasegura" id="btnzona"></a>
            <?php } else { ?>
                <a  onclick="cambiar3(<?php echo  $ss ?>)" href="#zona-sec" class="zona-seguridad" id="btnzona"></a>
            <?php } ?>
                    ...
                    <div class="con-ingreso">
                        <form class="zona" id="footform" method="post" action="index.php?seccion=validar">     
                            <div class="seccion1cotiza">
                                ...
                                <div class="t-input">Contraseña</div>
                                <div id="formulario">
                                    <input value="" name="contrasena" id="passf" class="validate[required]" type="password" id="texto">
                                </div>
                                <a href="#zona-recover" class="zona-recupera"><div class="recor">¿Olvido su contraseña?</div></a>
                                <div id="btnse">
        ...
        <div class="mapa">
            <h4>Mapa de sitio</h4>
            <p>
                <span id="rojo">&#9658;</span><a  onclick="cambiar3(<?php echo  $ss ?>)" href="index.php?seccion=index" class="<?php
            if ($_GET['seccion'] == 'index') {
                echo '1';
            }
            ?>">Inicio</a><br />
                <span id="rojo">&#9658;</span><a  onclick="cambiar3(<?php echo  $ss ?>)" href="index.php?seccion=nosotros" class="<?php
                                                 if ($_GET['seccion'] == 'nosotros') {
                                                     echo '1';
                                                 }
            ?>">Quiénes somos</a><br />
                <span id="rojo">&#9658;</span><a  onclick="cambiar3(<?php echo  $ss ?>)" href="index.php?seccion=negocio" class="<?php
                                                 if ($_GET['seccion'] == 'negocio') {
                                                     echo '1';
                                                 }
            ?>">Líneas de negocio</a><br />
                <span id="rojo">&#9658;</span><a  onclick="cambiar3(<?php echo  $ss ?>)" href="index.php?seccion=contactenos" class="<?php
                                                 if ($_GET['seccion'] == 'contactenos') {
                                                     echo '1';
                                                 }
            ?>">Contáctenos</a><br />
                <span id="rojo">&#9658;</span><a  onclick="cambiar3(<?php echo  $ss ?>)" href="index.php?seccion=cotizar">Cotizaciones</a>
            </p>
        </div>
        <div class="siguenos">
            <h4>Síguenos</h4>
    ...
    <div class="pie">
        ...
        <div id="texpie">2013 <span id="rojo">NORQUIMICOS.</span> Todos los derechos reservados <div class="footer-ahorranito"  onclick="cambiar3(<?php echo  $ss ?>)" style="overflow: hidden;"></div></div>
    </div>
</div>