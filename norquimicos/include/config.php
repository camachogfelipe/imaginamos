...
define('VIRTUAL_LOCATION', '/norquimicos');

// VARIABLES DE LA BASE DE DATOS
define('DB_PERSISTENCY', 'true');
define('DB_SERVER', 'localhost');
define('DB_USERNAME', 'root'); //usuariooc        
define('DB_PASSWORD', 'camachitos'); //12NIwE6YU8V7   
define('DB_DATABASE', 'img_norquimicos'); //usuariooc_norquimicos
