...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    $mail->Username = "ruben.cifuentes@imaginamos.com.co";
    // Contraseña
    $mail->Password = "ruben123654";
    // Desde que correo quiere que se muestre
    $mail->From = "ruben.cifuentes@imaginamos.com.co";
    // Desde (Nombre)
    $mail->FromName = "Ruben Dario Cifuentes Torres";
    // Asunto
    $mail->Subject = "Kuponkis - " . $asunto;
