...
(function($, CMS, undefined) {
    ...
    CMS.Common = {
        ...
        logicDelete : function(){
            ...
            $(document).on('click', $ele, function(e){
                ...
                data = {
                    ...
                    delete_file: $this.data('delete_file') || null,
                    delete_files: $this.data('delete_files') || null
                };
        ...
        validate_form : function(){
            ...
            if($('[data-form-validation="simple"]').length) {
                var $form_ext = $('[data-form-validation="simple"]');
                $form_ext.each(function(){
