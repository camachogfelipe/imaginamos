...
$.extend($.validator, {
	...
	messages: {
		...
		dateISO: "Escriba una fecha válida (ISO).",
		number: "Escriba un numero válido.",
		digits: "Escriba solamente digitos.",
		creditcard: "Escriba un número de tarjeta de crédito válido.",
		equalTo: "Escriba el mismo valor de nuevo.",
		maxlength: $.validator.format("No debe escribir mas de {0} caracteres."),
		minlength: $.validator.format("Debe escribir al menos {0} caracteres."),
