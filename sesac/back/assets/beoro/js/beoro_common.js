...
beoro_wysiwg = {
    init: function() {
        if($('#wysiwg_editor_basic').length) { 
            CKEDITOR.replace( 'wysiwg_editor_basic', {
                toolbar: 'Basic'
            });
        }
        if($('#wysiwg_editor_standart').length) { 
            CKEDITOR.replace( 'wysiwg_editor_standart', {
                toolbar: 'Standart'
            });
        }
        if($('#wysiwg_editor_full').length) { 
            CKEDITOR.replace( 'wysiwg_editor_full', {
                toolbar: 'full'
            });
        }
    }
