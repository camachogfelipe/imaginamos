...
$(document).ready(function(){
  ...
  $(".over-bw").hover(function(){$(this).children(".icon-bw").animate({marginTop: -10}, 400, "easeOutBounce");}, function(){$(this).children(".icon-bw").animate({marginTop: 0}, 400, "easeOutBounce");}); $(".over-bt-bw").click(function(){$(this).parent().parent().parent().fadeOut(200);});
	...
	$(window).bind("load", function(){$(".slider").fractionSlider({"fullWidth": true, "controls": true, "pager": true, "responsive": true, "dimensions": "940,508", "increase": false});});
	...
	$(".globo-icon").delay(200).queue(function(next){$(this).animate({height: 42, margin: "-21px 0 0 -21px", width: 42}, 400, "easeOutBounce"); next();});
	$(".globo-icon").delay(400).queue(function(next){$(this).animate({height: 84, margin: "-42px 0 0 -42px", width: 84}, 400, "easeOutBounce"); next();});
	$(".globo-icon").delay(800).queue(function(next){$(this).animate({height: 125, margin: "-62.5px 0 0 -62.5px", width: 125}, 400, "easeOutBounce"); next();}); 
	$(".con-globo-icon .globo-icon span").delay(2200).queue(function(next){$(this).animate({opacity: 1}, 800, "easeInOutExpo"); next();});
	$(".globo h1").delay(2100).queue(function(next){$(this).animate({opacity: 1}, 800, "easeInOutExpo"); next();});
	
	
	/*$("#globo-2").delay(1600).queue(function(next){$(this).fadeIn(800); next();}); $("#globo-3").delay(2000).queue(function(next){$(this).fadeIn(800); next();}); $("#globo-4").delay(2400).queue(function(next){$(this).fadeIn(800); next();}); $("#globo-5").delay(2800).queue(function(next){$(this).fadeIn(800); next();}); $("#globo-6").delay(3200).queue(function(next){$(this).fadeIn(800); next();}); $("#globo-7").delay(3600).queue(function(next){$(this).fadeIn(800); next();});*/
	...
	$(".certs-list li:odd").children(".certs-logo").css({float: "right"}); $(".certs-list li:odd").children(".certs-tx").css({float: "left"});
