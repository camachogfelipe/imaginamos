...
mysql_select_db($database_cnn_fic, $cnn_fic);
$query_rsServicios = "SELECT * FROM t_servicios";
$rsServicios = mysql_query($query_rsServicios, $cnn_fic) or die(mysql_error());
    ...
    <div class="logInBox">
        ...
        <div class="logInFormBox">
        	<form METHOD="POST" action="<?php echo $loginFormAction; ?>" name="login">
                ...
                <div class="opt"><a href="pass.php" class="passBtn">&iquest;Olvid&oacute; su contrase&ntilde;a?</a> | <a href="registro.php" class="regBtn" > Reg&iacute;strate</a></div>
...
<div class="submenuWrap">
	<div class="submenuBox">
    	<div class="submenu">
         <?php do{ ?>
        	<a href="servicioDetalle.php?id_servicios=<?php echo $row_rsServicios['id_servicios']; ?>"><?php echo $row_rsServicios['titulo']; ?></a>
