				...
				<div class="imu_info" id="info"></div>
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
                              ...
                              <fieldset>
							    ...
							    <div>
                                      <p><label>Título</label></p>
                                      <div><input type="text" name="titulo" id="titulo" class="medium" value="'.$results[0][titulo].'"/></div>
									   <span class="f_help">Es necesario que el título tenga maximo 20 caracteres.</span>
                                  </div>
							  ...
							  <div>
                                      <p><label>Subtitulo</label></p>
                                      <div><input type="text" name="subtitulo" id="subtitulo" class="medium" value="'.$results[0][subtitulo].'"/></div>
									  <span class="f_help">Es necesario que el título tenga maximo 38 caracteres.</span>
                                  </div>
                              ...
                              <p>&nbsp;</p>
                                  ...
                                  <div>
                                      <p><label>Descripción</label></p>
                                      <div><textarea name="descripcion" id="descripcion" cols="5" class="large">'.$results[0][descripcion].'</textarea></div>
									  <span class="f_help">Es necesario que la descripción tenga maximo 1267 caracteres.</span>
                                  </div>
								  
								  <p>&nbsp;</p>
								  
								  <div><label>Imagenes</label>
                  <div><textarea name="imagen" id="imagen" cols="5" class="large">'.$results[0][imagen].'</textarea>
