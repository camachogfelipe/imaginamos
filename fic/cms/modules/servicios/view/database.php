...
<head>
        ...
        <div id="header">
			...
			<div id="shadowhead"></div>
			  ...
			  $('#finder').elfinder({url : 'http://localhost/cms/components/elfinder/connectors/php/connector-fileimport.php', docked:true,dialog : { title:'File manager',modal:true,width:700}});
			  </script> 
