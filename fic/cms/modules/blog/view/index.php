			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray pictures_folder"></span>Blogs</span>
					</div><!-- End header -->	
                        <div class="content">
                    ...
                    <fieldset>
     				...
     				<?php
						$db->doQuery("SHOW TABLES LIKE 't_blogs'",SHOW_TABLE_QUERY);
					if($show = $db->show)
						{
						$db->doQuery("SELECT * FROM t_blogs",SELECT_QUERY);					
						$result = $db->results;
