...
CKFinder.lang['es'] =
{
	...
	FileRenameExt	: '¿Está seguro que quiere cambiar la extensión del archivo? El archivo puede quedar inutilizable',
	FileRenaming	: 'Renombrando...',
	FileDelete		: '¿Está seguro que quiere borrar el archivo "%1"?',
	...
	// Basket
	BasketFolder		: 'Auxiliar',
	BasketClear			: 'Vaciar la carpeta auxiliar',
	BasketRemove		: 'Quitar de la carpeta auxiliar',
	BasketOpenFolder	: 'Abrir carpeta padre',
	BasketTruncateConfirm : '¿Está seguro que quiere quitar todos los archivos de la carpeta auxiliar?',
	BasketRemoveConfirm	: '¿Está seguro que quiere quitar el archivo "%1" de la carpeta auxiliar?',
	BasketEmpty			: 'No hay archivos en la carpeta temporal, arrastra y suelta algunos.',
	BasketCopyFilesHere	: 'Copiar archivos de la carpeta auxiliar',
	BasketMoveFilesHere	: 'Mover archivos de la carpeta auxiliar',

	BasketPasteErrorOther	: 'Archivo %s error: %e',
	BasketPasteMoveSuccess	: 'Los siguientes archivos han sido movidos: %s',
	BasketPasteCopySuccess	: 'Los siguientes archivos han sido copiados: %s',
	...
	UploadNoFileMsg		: 'Por favor, elija un archivo de su computador',
	...
	SetDisplaySize	: 'Peso del archivo',
	SetSort			: 'Ordenar:',
	...
	203 : 'Archivo inválido. El peso es demasiado grande.',
	204 : 'El archivo subido está dañado.',
	...
	300 : 'Ha fallado mover el(los) archivo(s).',
	301 : 'Ha fallado copiar el(los) archivo(s).',
	...
	ErrorMsg :
	{
		...
		FileInvChar		: 'El nombre del archivo no puede contener ninguno de los siguientes caracteres: \n\\ / : * ? " < > |',
		FolderInvChar	: 'El nombre de la carpeta no puede contener ninguno de los siguientes caracteres: \n\\ / : * ? " < > |',
