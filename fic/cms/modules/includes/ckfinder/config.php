...
*/
/*$baseUrl = 'http://elgordoautoservicios.com/';*/
$baseUrl = 'http://repositorio.imaginamos.com/SBC/fic/';
...
*/
//$baseDir = resolveUrl($baseUrl);
/*$baseDir = '/hsphere/local/home/c338529/elgordoautoservicios.com/';*/
$baseDir = '/var/www/SBC/fic/';
/*
 * ### Advanced Settings
 */
...
$config['Thumbnails'] = Array(
		...
		'directory' => $baseDir . 'images/_thumbs',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 90,
		'maxHeight' => 90,
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . 'images/slider/',
		'directory' => $baseDir . 'images/slider/',
		'maxSize' => "10M",
...
$config['ResourceType'][] = Array(
		'name' => 'Carrusel',
		'url' => $baseUrl . 'images/dest/',
		'directory' => $baseDir . 'images/dest/',
		'maxSize' => "10M",
		'allowedExtensions' => 'gif,jpeg,jpg,png',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		'name' => 'Quienes somos',
		'url' => $baseUrl . 'images/quienessomos/',
		'directory' => $baseDir . 'images/quienessomos/',
		'maxSize' => "10M",
		'allowedExtensions' => 'gif,jpeg,jpg,png',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		'name' => 'Descargas',
		'url' => $baseUrl . 'images/descargas/',
		'directory' => $baseDir . 'images/descargas/',
		'maxSize' => "10M",
...
$config['ResourceType'][] = Array(
		'name' => 'Blogs',
		'url' => $baseUrl . 'images/blogs/',
		'directory' => $baseDir . 'images/blogs/',
		'maxSize' => "10M",
		'allowedExtensions' => 'gif,jpeg,jpg,png',
		'deniedExtensions' => '');
