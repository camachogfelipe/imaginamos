			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray pictures_folder"></span>Quienes Somos</span>
					</div><!-- End header -->	
                        <div class="content">
                    ...
                    <fieldset>
     				...
     				<?php
						$db->doQuery("SHOW TABLES LIKE 't_quienes_somos'",SHOW_TABLE_QUERY);
					if($show = $db->show)
						{
						$db->doQuery("SELECT * FROM t_quienes_somos",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
                        echo $htmlFormEdit->printFormEdit($result[id_quienes_somos],'2');
						}
					?>
