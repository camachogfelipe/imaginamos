...
$htmlFormTableMenu = new Tables($db);
?>
			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray pictures_folder"></span>Solicitudes de contacto</span>
					</div><!-- End header -->	
                        <div class="content">
                    ...
                    <fieldset>
     				...
     				<?php
						...
						/*$db->doQuery("SELECT * FROM t_home_slide",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos

						echo $result[0][img];*/

                        echo $htmlFormTableMenu->printTableMenus(1); 
