...
{  
	...
	if($formData[img] == "")
		...
		$objResponse->script("showError('Ingrese banner',3000);");
		...
		$query = "INSERT INTO t_home_slide (id_img,img) VALUES ('','$formData[img]')";
...
{  
	...
	if($formData[img] == "")
		...
		$objResponse->script("showError('Ingrese bannergjgf',3000);");
		...
		$query = "UPDATE t_home_slide SET img = '$formData[img]' WHERE id_img ='$formData[id_img]'";
		$db->doQuery($query,INSERT_QUERY);
