...
{  
	...
	if($formData[archivo] == "" )
		...
		$objResponse->script("showError('Ingrese una imagen para realizar la insercion',3000);");
		...
		$query = "INSERT INTO t_imagenes (id_imagen,id_blog,img) VALUES ('','$formData[id]','$formData[archivo]')";
