var DocumentRoot = 'http://adomsaluddomiciliaria.com/chat/';
  ...
  soundManager.createSound('page',DocumentRoot+'audio/alert.mp3');
   ...
   .append(
        ...
        .append(
            ...
            .append('<br /><br />')
            .append('En el momento no estamos en línea pero puedes enviarnos un mensaje a través del siguiente formulario.')
            .append('<br /><br />')
            .append(
                $("<label></label>")
                .html('Nombre')
