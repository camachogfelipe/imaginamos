var DocumentRoot = 'http://repositorio.imaginamos.com.co/FBZ/Adom/chat/';
...
$(function(){
   ...
   .append(
        ...
        .append(
            ...
            .append(
                $("<strong></strong>")
                .html('Gracias por intentar ponerse en contactos con nosotros!')
            )
            .append('<br /><br />')
            .append('En estos momentos no estamos en línea, pero puede enviarnos un mensaje usando el siguiente formulario!')
            .append('<br /><br />')
            .append(
                $("<label></label>")
                .html('Nombre')
