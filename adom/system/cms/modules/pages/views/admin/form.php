...
<section class="item">
	<div class="content">
		...
		<div class="tabs">
			...
			<div class="form_inputs" id="page-details">
				...
				<ul>
					...
					<!--<li>
						...
						<div class="input"><?php echo form_dropdown('status', array('live'=>lang('pages:live_label')), $page->status, 'id="category_id"') ?></div>
					</li>-->
			...
			<input type="hidden" name="restricted_to[]" value="0" />
		</div>
