 ...
 */
class Field_choice_db {

    public $field_type_slug = 'choice_db';
    ...
    public function param_choice_type($value = null)
    {
        $choices = array(
            ...
            'radio' => $this->CI->lang->line('streams:choice_db.radio_buttons'),
            'checkboxes' => $this->CI->lang->line('streams:choice_db.checkboxes')
        );
