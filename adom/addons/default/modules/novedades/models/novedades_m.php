...
class novedades_m extends MY_Model {
    ...
    public function normaliza($cadena) {
        $originales = 'À�?ÂÃÄÅÆÇÈÉÊËÌ�?Î�?�?ÑÒÓÔÕÖØÙÚÛÜ�?Þ
...
bsaaaaaaaceeeeiiiidnoooooouuuyybyRr';
    ...
    public function get_all($id = NULL, $city_id = NULL) {
		...
		//$this->db->join("default_pages_novedades", "default_pages.entry_id=default_pages_novedades.id");
        if ($id > 0) {
