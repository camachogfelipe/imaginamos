...
/**
 * This is a testimonies module for PyroCMS
 *
 * @author 	Eduard Russy
 * @website     http://www.imaginamos.com
 * @package 	PyroCMS
 * @subpackage 	testimonies Module
 */
defined("BASEPATH") or exit("No direct script access allowed");

class Module_Testimonies extends Module {

    public $version = "1.0";
    private $namespace = 'testimonies';
    private $slug_stream = 'testimonies';
    private $slug_page = 'testimonios';
