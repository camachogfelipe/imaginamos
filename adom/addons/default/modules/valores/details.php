...
/**
 * This is a valores module for PyroCMS
 *
 * @author 	Eduard Russy
 * @website     http://www.imaginamos.com
 * @package 	PyroCMS
 * @subpackage 	valores Module
 */
defined("BASEPATH") or exit("No direct script access allowed");

class Module_Valores extends Module {

    public $version = "1.0";
    private $namespace = 'valores';
    private $slug_stream = 'valores';
    private $slug_page = 'valores';
    ...
    public function info() {
        $info = array(
            "name" => array(
                "en" => $this->namespace,
                "es" => "Valores Mudulo quienes somos",
            ),
            "description" => array(
    ...
    public function admin_menu(&$menu) {
        $var = '¿Quiénes Somos?';
        $menu[$var]['Valores'] = 'admin/valores';
    }
