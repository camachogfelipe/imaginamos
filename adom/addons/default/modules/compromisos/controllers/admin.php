...
class Admin extends Admin_Controller {
    ...
    protected $section = 'admin_compromisos';
    protected $namespace = 'compromisos';
    protected $slug_stream = 'compromisos';
    private $_tabs = array();
...
//            )
        ...
        $extra['columns'] = array('name', 'description', 'images', 'images', 'name_inf', 'description_inf');
