...
$(document).ready(function() {
    ...
    $('.mensajecerrar').css({
        'right': -$('.mensajecerrar').width() - 100
    }, 500);


    $('.btnclose').click(function() {
        $('.mensajecerrar').stop().animate({
            'right': -$('.mensajecerrar').width() - 50
        }, 500);

        $('.collapchat').stop().animate({
            'height': '0px'
        }, 500);
    ...
    $('.activoheader').parent('.collapsible').css({
        'height': $('.contienecollapsible').parent().children('.contienecollapsible').height() + 40
    }, 500);
    $('.headerdetalle').css({
        'max-height': $('.titulodetalle').height()
    }, 500);


    /*mostrar loguin*/
    $('.log').click(function() {
        $('.plegable').stop().animate({
            height: $('.contieneplegable').height() + 20
        }, 500);
    });
...
function addClass(id) {
    $('#' + id).parent().stop().animate({
        'height': $('#' + id).parent().children('.contienecollapsible').height() + 40
    }, 500);
    ...
    if ($('#' + id).children().children('.open').css('display', 'none')) {
        $('#' + id).children().children('.open').css({
            'display': 'none'
        });
        $('#' + id).children().children('.close').css({
            'display': 'block'
        });
    } else {
        $('#' + id).children().children('.open').css({
...
$('.contenidosNoticia .detale').on('click touchend', function(){
    $(this).siblings('.detale').animate({
        'opacity':0.3
    },200).removeClass('seleted');
    ...
    $.ajax({
        ...
        success: function(data) {
            $('.contenidosNoticia .preview').stop().animate({
                'height':0,
                'padding':0
            },200);
            setTimeout(function(){
            ...
            setTimeout(function(){
                ...
                /*setupDetails();*/
                $('.contenidosNoticia .preview').stop().animate({
                    height: $('.contenedorPreview').height()+20
                },500);
                ...
                $('.closeBtn').click(function (evento) {
                    ...
                    $('.contenidosNoticia .preview').animate({
                        'height':0
                    },500, function () {
                        $('.contenidosNoticia .preview').remove();
                    });
