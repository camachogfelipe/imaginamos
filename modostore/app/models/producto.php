...
class producto extends  DataMapper {
    ...
    public $_fields = array('id','tipo','nombre','marca','descripcion','garantia','tiempo_entrega','precio','recomendado','fecha','categoria_id');
    ...
    public $has_many =  array(
                ...
                'promociones' => array(
                  'class' => 'promociones',
                  'other_field' => 'producto',
                  'join_other_as' => 'promociones',
                  'join_self_as' => 'producto',
                  'join_table' => 'cms_promociones',
                )
            );
