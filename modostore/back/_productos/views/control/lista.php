                    ...
                    <table id="dt_basic" class="dataTables_full table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="span1 sorting_disabled" role="columnheader" rowspan="1" colspan="1" aria-label="" style="width: 5px;">Rec.</th>
                        ...
                        <tbody id='table_contet'  >
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td>
                                        <?php echo substr(strip_tags($img->descripcion),0,120)."...";  ?>
                                    </td>
                                    <td>
                                        <?php echo $img->marca;  ?>
                                    </td>
