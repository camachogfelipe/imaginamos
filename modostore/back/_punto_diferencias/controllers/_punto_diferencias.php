...
class _punto_diferencias extends Back_Controller {
	protected $admin_area = true;
	public $model = 'punto_diferencia';
	public $name = 'punto_diferencias';
	public $title = 'Puntos diferenciadores';
	...
	public function menu() {
		return $this->current_menu['Empresa']['Puntos diferenciadores'] = cms_url('punto_diferencias');
	}
