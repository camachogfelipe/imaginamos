...
class _valors extends Back_Controller {
	protected $admin_area = true;
	public $model = 'valor';
	public $name = 'valors';
	public $title = 'Valores de la Empresa';
	...
	public function menu() {
		return $this->current_menu['Empresa']['Valores de la Empresa'] = cms_url('valors');
	}
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->inputHidden($obj->id, "id", 11);
                $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "216px × 216px",false,$obj->is_rule("imagen_id","required"),"span3");
	...
	public function form_add() {
		...
		$data['form_content'] .= $this->inputHidden("","id", 11);
                $data['form_content'] .= $this->imagen("", NULL, "Imagen", "216px × 216px",false,$obj->is_rule("imagen_id","required"),"span3");
