...
class _generator_models extends Back_Controller {
    ...
    protected $enum_class = array('users_groups','users','punto_diferencia','promociones','producto_modelo','permissions','patrocinador','modelo','marca','informacion','imagen_producto','imagen','groups_permissions','groups','empresa','contacto','categoria','caracteristica','barner','redes_sociales', 'api_oauth', '_template', 'datamapperext', 'ion_auth_model', 'ion_auth_mongodb_model', 'login_attempts', 'oauth_config');
