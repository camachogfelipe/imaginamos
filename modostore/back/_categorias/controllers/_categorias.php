...
class _categorias extends Back_Controller {
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "120px × 74px", false, true, "span3");
    ...
    public function form_add() {
        ...
        $data['form_content'] .= $this->imagen("", NULL, "Imagen Fondo", "120px × 74px", false, true, "span3");
    ...
    public function lista() {
        $obj = new $this->model();
        $data['datos'] = $obj->join_related('imagen')->where('categoria_id',NULL)->get();
