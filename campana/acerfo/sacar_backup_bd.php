 ...
 */
define("DB_USER", 'JABALIES'); /* Nombre de usuario de la base de datos */
define("DB_PASSWORD", 'ByrhXK6cZwSZdxj8'); /* Clave de acceso del usuario de la base de datos */
define("DB_NAME", 'JABALIES_campana'); /* Nombre de la base de datos a sacar backup */
