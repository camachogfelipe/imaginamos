            ...
            <div>
                <fieldset>
                    ...
                    <div class="clearfix">
                        ...
                        <legend><h1>Docuemntos</h1></legend>

                        <input name="id" value="" id="id" type="hidden">
                        <input name="img" value="-1" id="img" type="hidden">
                        <input name="file" value="-1" id="file" type="hidden">
                        <div class="section">
                            <label class="req">Titulo (Fuente 1)</label>
                            <input id="titulo_funte1" class="large validate[required]" type="text" name="titulo_funte1" value="" />
                        </div>
                        <div class="section">
                            <label class="req">Titulo (Fuente 2)</label>
                            <input id="titulo_funte2" class="large" type="text" name="titulo_funte2" value="" />
                        </div>
                        <div class="section">
                            <label class="req" >Texto Descriptivo</label>
                            <textarea rows="3"  class="large"  name="texto" placeholder="Text Descriptivo..."></textarea>
                        </div>
                        ...
                        <form>              
                            <div class="section">
                                <div>
                                    <a id="bt_form" type="button" href="#" class="uibutton">Guardar Documeto</a> 
                    ...
                    <div class="tableName toolbar">
                        <table class="display data_table2" >
                            <thead>
                                <tr>
                                    <th>Imagen</th>
                                    <th>Titulo(Fuente 1)</th>
                                    <th>Titulo(Fuente 2)</th>
