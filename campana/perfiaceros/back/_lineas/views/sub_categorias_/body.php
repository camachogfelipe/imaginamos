            ...
            <div>
                <fieldset>
                    ...
                    <div class="clearfix">
                        ...
                        <legend><h1>Sub Categorías</h1></legend>

                        <input name="id" value="" id="id" type="hidden">
                        <input name="img" value="-1" id="img" type="hidden">
                        <div class="section">
                            <label class="req">Título Sub Categoria</label>
                       ...
                       <div class="section">
                            ...
                            <textarea rows="3" id="texto" class="large"  name="texto" placeholder="Text Descriptivo..." maxlength="55"></textarea>
                        </div>
                        <div class="section">
                                    <label class="req">Linea de Producción</label>
                                    <select id="s2_single" name="cms_categoria_id" id="cms_categoria_id" class="large" style="display: none;">
                                        <?php if (!empty($categ)) : ?>
                        ...
                        <form>              
                           <div>
                             <a id="bt_form" type="button" href="#" class="uibutton">Crear o Modificar Sub Categoría</a> 
                                        ...
                                        <tr class="odd gradeX parent-delete">
                                            ...
                                            <td class="center" width="100px">
                                                <span class="tip">
                                                 ...
                                                 <a id="edit_<?php echo $obj->id; ?>" href="<?php echo cms_url('lineas/sub_categorias/edit/') ?>" data-value="<?php echo $obj->id ?>" class="uibutton " >Editar</a>
                                                </span>
                                            </td>
                                        </tr>
