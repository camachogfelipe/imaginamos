<div class="cont_navprincipal clearfix cont_940">
  ...
  <ul class="nav_principal clearfix nav_principal1">
    <li class="grillatres copy_home">
      ...
      <p>somos una compañía con alma de acero que trabaja en función del bienestar de nuestros clientes, suministrándoles un gran portafolio de productos y servicios.</p>
    </li>
