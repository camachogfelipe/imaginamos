var DocumentRoot = 'http://repositorio.imaginamos.com.co/JABALIES/perfiaceros/chat/';
...
$(function(){
   ...
   .append(
        ...
        .append(
            ...
            .append(
                ...
                .attr({
                    href : "#",
                    title : "cambie su nickname."
                })
                .addClass("wheel")
                .html("Cambiar nickname")
            )
            /*.append(
                $("<a></a>")
                .attr({
   ...
   .append(
        ...
        .append(
            ...
            .append(
                $("<strong></strong>")
                .html('Gracias por intentar contactarnos!')
            )
            .append('<br /><br />')
            .append('En este momento no estamos en línea, pero nos puede enviar un mensaje usando el siguiente formulario!')
            .append('<br /><br />')
            .append(
                $("<label></label>")
                .html('Nombre')
   ...
   .append(
        ...
        .append(
            ...
            .append(
                $("<strong></strong>")
                .html('Rellene sus datos para empezar a chatear!')
            )
            .append('<br /><br />')
            .append(
                $("<label></label>")
   ...
   $(".footer_desplegable").append($content.html());
