...
<? if(count($noticias->idcms)>1){
    ...
    <h1><?=$noticias->titulo1[$i]; ?></h1>
    <h2><?=$noticias->titulo5[$i]; ?></h2>
    <p>
    </p>
    <p></div>
    <div id="colintactu_izq">
    <div id="divcol_izq"><?=substr(strip_tags($noticias->titulo2[$i]),0,215); ?></div>
    <div id="divcol_der"><?=substr(strip_tags($noticias->titulo2[$i]),216,215); ?></div>
    ...
    <div id="btleermasnot"><a href="noticia_1.php?id=<?=$noticias->idcms[$i]?>">&nbsp;</a></div>
    <br />
    <br />
    <br />
    </div>
...
<? }
    ...
    <div id="colintactu_izq">
    <div id="divcol_izq"><?=substr(strip_tags($noticias->titulo2),0,215); ?></div>
    <div id="divcol_der"><?=substr(strip_tags($noticias->titulo2),216,215); ?></div>
    <div style="clear: both; display: block; padding: 10px 0; text-align:center;"></div>
    </div>
    <div style="clear: both; display: block; padding: 3px 0; text-align:center;"></div>
    <div id="btleermasnot"><a href="noticia_1.php?id=<?=$noticias->idcms?>">&nbsp;</a></div>
    <br />
    <br />
    <br />
    </div>
