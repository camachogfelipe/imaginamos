...
<div id="env_titslideevento"><?=$noticias->titulo1[$i]; ?> </div>
<div id="env_textslideevento"><?=substr(strip_tags($noticias->titulo2[$i]),0,130); ?></div>
...
<div id="env_titslideevento"><?=$noticias->titulo1; ?> </div>
<div id="env_textslideevento"><?=substr(strip_tags($noticias->titulo2),0,130); ?></div>
