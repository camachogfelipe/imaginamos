...
<div id="logotop"><img src="images/logomba.png" /></div>
 <div id="navmenu" >
    ...
    <!-----------------BANNER MBA BRETON--------------------->
    <div id="envbannerinternas">
      <iframe width="1000"  height="398" src="banner_prodmba/demo/bann_mbabreton_eng.php" scrolling="no" frameborder="0" allowtransparency="yes" ></iframe>
    </div>
  </div>
</div>
...
<div id="subtitinternasprod">Products / Aromatic Solvents</div>
</div>

</div>
<div id="envcontinternos">  <div id="bgmenuprodsenv" >
...
<div id="envcontinternos">
  <?php include "productos_tabs1_eng.php"; ?>
</div>
