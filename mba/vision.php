...
<link href="css/stylos_mbabreton.css" rel="stylesheet" type="text/css" />
	...
	height:54px;
	margin:auto;
	background-image: url(images/imgbtvision1.png);
...
<div id="b1tab"><a href="mision.php">Misión</a></div>
<div id="b2tab"><a href="#nogo">Visión</a></div>
<div id="b2tab"><a href="politica.php">Política</a></div>
...
<div id="coltabt_izq2">
		<div id="img_derint1_2"><img src="<?=$urlvalores.$vision->imagen1 ?>" width="312" height="246" class="rounded"/></div>
		<div id="titulonqs2pol">Visión</div>
		<br/>
		...
		<div id="coltabt_izq"><?=$vision->titulo2 ?> </div>	
