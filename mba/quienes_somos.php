...
<div id="logotop"><img src="images/logomba.png" /></div>
 <div id="navmenu" >
        ...
        <li><a href="index.php">INICIO</a></li>
          <li><a href="quienes_somos.php" class="activo">QUIÉNES SOMOS</a></li>
    ...
    <!-----------------BANNER MBA BRETON--------------------->
    <div id="envbannerinternas"><img src="images/img_bannqs.jpg" width="1000" height="220" /></div>
  </div>
</div>
...
<div id="subtitinternas">Quiénes Somos</div></div>
<div id="envcontinternos" style="text-align:center">
  <iframe width="900" height="480" src="mision.php" scrolling="no" frameborder="0" allowtransparency="yes" ></iframe>
</div>
