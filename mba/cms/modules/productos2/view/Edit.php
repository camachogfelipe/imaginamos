...
<form id="formAjax" method="post" action="../controller/edit.php">
...
<div> 
   <input type="text"  name="titulo3" id="titulo3" class="large" value="<?=$query1[3]?>"  />
</div>
</div>
<div class="section">
<label>Descripcion Ingles1 </label>   
<div> 
