                ...
                <div class="inner">
                  ...
                  <div class="content">
				    ...
				    $arrayCampos[2] = 'titulo2';
                                    ...
                                    $arrayCampos[13] = 'tabla_es';
                                    $arrayCampos[14] = 'tabla_en'; 
//                                    echo TABLE_NAME;
...
<form id="formAjax" method="post" action="../controller/edit3.php">
...
<div><img src="files/<?php echo $query1[13] ?>" width="190" height="100" /><br /></div>
<div>
...
<div><img src="files/<?php echo $query1[14] ?>" width="190" height="100" /><br /></div>
...
<!--<a id="<?=$query1[0]?>"  class="Delete uibutton special">Eliminar</a>-->
