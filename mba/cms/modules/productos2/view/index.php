			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
                    ...
                    <fieldset>
                    <?php echo $htmlFormTableUser->printTableServicio($idx); ?>
                    </fieldset>
                     <div>
                     <?php 
					 $Consultas = new Consultas;
					 $total = $Consultas->total('cms_bannerup');
					 //echo $total.' total';
					// if ($total<5)
					// {
					 ?>
                                                   <a href="Add.php?id=<?=$idx?>" class="uibutton">Nuevo <?=MODULE?></a>
                     <?php
					// }
					 ?>
                     </div>  
