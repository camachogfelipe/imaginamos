...
<input type="hidden"  name="titulo5" id="titulo5" value="<?=$idx?>"  />
<!--
<div class="section">
    <label>Fecha </label>   
    <div> 
      <input type="text"  name="titulo5" id="titulo5" class="datepicker hasDatepicker"  />
    </div>
</div>
-->
<div class="section">
...
<div class="section">
<label>Descripcion Español 1</label>   
<div>
        <textarea name="titulo2" id="titulo2" class="large" ></textarea>
</div>
</div>
<div class="section">
<label>Descripcion Español 2</label>   
<div> 
    <textarea name="titulo6" id="titulo6" class="large"  cols="100" rows="20" ><?=$query1[6]?></textarea>
</div>
</div>
...
<label>Titulo Ingles </label>   
    <div> 
        <input type="text"  name="titulo3" id="titulo3" class="large"  />
    </div>
</div>
<div class="section">
<label>Descripcion Ingles 2 </label>   
<div> 
    <textarea name="titulo7" id="titulo7"   class="large"  cols="100" rows="20" ><?=$query1[7]?></textarea>
</div>
</div>
...
<label>Descripcion Ingles </label>   
    <div>
        <textarea name="titulo4" id="titulo4" class="large" ></textarea>
    </div>
</div>
