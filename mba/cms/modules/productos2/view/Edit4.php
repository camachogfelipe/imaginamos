                        ...
                        <div class="formEl_b">
                            <fieldset>
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $arrayCampos[13] = 'adjunto1';
                                    $arrayCampos[14] = 'adjunto2';
...
//                                    echo TABLE_NAME;
                                ...
                                <div>
                                    ...
                                    <form id="formAjax" method="post" action="../controller/edit4.php">
                                        <input type="hidden" name="id" id="id" value="<?= $query1[0] ?>" >
                                            <input type="Hidden"  name="titulo5" id="titulo5" class="large" value="<?= $query1[5] ?>"  />
                                            <input type="Hidden"  name="imagen1ant" id="imagen1ant" class="large" value="<?= $query1[13] ?>"  />
                                            <input type="Hidden"  name="imagen2ant" id="imagen2ant" class="large" value="<?= $query1[14] ?>"  />
                                            ...
                                            <p>
                                                ...
                                                <div class="section">
                                                    ...
                                                    <div>
                                                        <a href="files/<?= $query1[13] ?>"  target="_black"><?= $query1[13] ?></a><br></br>
                                                ...
                                                <div class="section">
                                                    <label>Tarjeta de emergencia Ingles</label>
                                                    <div>
                                                        <a href="files/<?= $query1[14] ?>" target="_black" ><?= $query1[14] ?></a><br></br>
                                        ...
                                        <tbody>
                                            ...
                                            if($res[0]['adjunto1'] != ""){?>
                                               <tr class="odd gradeX">
                                                ...
                                                <td class="center" width="100px"><?php echo $res[0]['adjunto1'];?></td>

                                                <td class="center" width="100px">
                                                    <form action="../controller/delete3.php" method="POST" id="Elim" >
                                                        <input type="submit" name="Eliminar1" class="uibutton special" value="Eliminar"/>
                                           ...
                                           <?php     
                                            ...
                                            if($res[0]['adjunto2'] != ""){ ?>
                                                ...
                                                <td class="center" width="100px"><?php echo $res[0]['adjunto2'];?></td>

                                                <td class="center" width="100px">
                                                    <form action="../controller/delete3.php" method="POST" id="Elim" >
                                                        <input type="submit" name="Eliminar2" class="uibutton special" value="Eliminar"/>
                                                        <input type="hidden" name="id" id="id" value="<?=$query1[0]?>" ></input>
                                                    </form>
