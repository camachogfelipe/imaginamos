			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
                    ...
                    <legend><h1>Url "ver sitio"</h1></legend>
                    
                    <div class="section">
                        <label>Ingrese la url para lanzar el sitio web, incluya http://</label>
                        <?php
						$query = "SELECT config_web FROM cms_configuration WHERE config_id = '1'";
						$db->doQuery($query,SELECT_QUERY);
						$result = $db->results;
						?>
                        <div><input type="text" name="web" id="web"  class="large" value="<?php echo $result[0][config_web]; ?>"  /></div>
					</div>
                  
	                    <br /><br />
                    <a class="uibutton" onclick="xajax_web(xajax.getFormValues('web')); return false;">Guardar</a> 
            		</form>
                    </fieldset>
