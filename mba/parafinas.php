...
<div id="logotop"><img src="images/logomba.png" /></div>
 <div id="navmenu" >
    ...
    <div id="envbannerinternas">
      <iframe width="1000"  height="398" src="banner_prodmba/demo/bann_mbabreton.php" scrolling="no" frameborder="0" allowtransparency="yes" ></iframe>
    </div>
  </div>
</div>
...
<div id="subtitinternasprod">Productos / Parafinas </div>
</div>



<div id="envcontinternos">  <div id="bgmenuprodsenv" style="text-align:center">



 <div style="width:1000px; height:215px; margin-left:auto; margin-right:auto;">

  <iframe width="1000" height="215" src="scrollerprods_es.php" scrolling="no" frameborder="0" allowtransparency="yes" ></iframe>
</div>
...
<div id="envcontinternos">
  <?php include "productos_tabs5.php"; ?>
</div>
