...
<form name="frmForma" class="forma">
  ...
  <div id="contcols">
    ...
    <div class="content_scroll scroll5">
      ...
      <?php foreach ($formas as $forma): ?>
                  ...
                  <input name="forma" type="radio" value="<?php echo $forma->getid() ?>" onClick="getCapacidad()"/> <?php echo $forma->getnombre_e() ?><br/>
  ...
  <div id="footcolprods1">
    <div id="bt_borrar">
      <a href="javascript:void(0)" onClick="limpiaForma()">BORRAR</a>
    </div>
  </div>
</form>
<?php } ?>