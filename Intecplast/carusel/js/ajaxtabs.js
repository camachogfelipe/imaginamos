//Change Log:
//* Updated: July 31st, 07: Fixed bug where with persistence enabled, the class="tab-selected" feature no longer works properly.
...
var loadstatustext="<img src='/images/loading.gif' /> Cargando el contenido..."
...
targetobj.parentNode.className="tab-selected"  //highlight currently clicked on tab
...
if ((enabletabpersistence==1 && persisttabindex<ulist.length && x==persisttabindex) || (enabletabpersistence==1 && persisttabindex=="" && ulist[x].className=="tab-selected") || (enabletabpersistence==0 && ulist[x].className=="tab-selected")){
