...
<div id="cajmercadosgal">
  <iframe width="965" height="320" src="alimentos.php" scrolling="no" frameborder="0" allowtransparency="yes" ></iframe>
</div>

<div id="envcargal">
     <?php include "pasarela_galeria.php"; ?>
</div>
