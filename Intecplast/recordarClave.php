...
<div id="txtcontacto1">Su clave ha sido envíada al correo:<br/><?php echo $_GET['mail'] ?></div>

<?php endif ?>

<?php if ($_GET['error']): ?>
  
<div id="txtcontacto1">La identificación ingresada no existe en nuestra base de datos</div>

<?php endif ?>
<div id="txtcontacto1"></div>
<div id="txtcontacto1">Ingrese Su Número de Identificación</div>
