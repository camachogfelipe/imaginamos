<?php
	...
	$imagen = new imagen();
	$imagenes = $imagenDAO->getBySeccionFlag(2,6);
...
<?php include "cuidado_personal.php"; ?>
		...
		<div id="mygallery" class="stepcarousel"> 
			<div class="belt">
				...
				<?php for ($i=0; $i < 4 ; $i++): ?>
						...
						<div id="contcaj_gal">
							<div id="overthumb">
								<a href="#nogo" onclick="changeImgSliderBigHome( 'http://repositorio.imaginamos.com/Pruebas/intecplast<?php echo $imagenes[$i]->getImagen_i() ?>', '<?php echo $imagenes[$i]->getDescripcion_i() ?>' );" id="enlaceajax">&nbsp;</a>
							</div>
							<img src="./..<?php echo $imagenes[$i]->getImagen_i() ?>" width="170" height="60" border="0" />
						</div>
				...
				<?php for ($i=4, $total=count($imagenes); $i<$total ; $i++): ?>
						...
						<div id="contcaj_gal">
							<div id="overthumb">
								<a href="#nogo" onclick="changeImgSliderBigHome( './..<?php echo $imagenes[$i]->getImagen_i() ?>', '<?php echo $imagenes[$i]->getDescripcion_i() ?>' );" id="enlaceajax">&nbsp;</a>
							</div>
							<img src="./..<?php echo $imagenes[$i]->getImagen_i() ?>" width="170" height="60" border="0" />
						</div>
