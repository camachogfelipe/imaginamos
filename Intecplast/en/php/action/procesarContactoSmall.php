...
$subject = 'Información de Contacto - Producto: '.$codigo;
$msg.="<html>";
$msg.="<head>";
$msg.="</head>";
$msg.="<body>";
...
$msg.="<br/><br/><label><b>E-Mail:</b></label>".$telefono;
$msg.="<br/><br/><label><b>E-Mail:</b></label>".$ciudad;
...
$location = "location: ./../../catalogo_paso3.php?id=".$codigo."&sendmail=1";
