...
<?php echo $ciudadOfPpal->getnombre_i() ?><br/>
<?php echo $puntoPpal->getDireccion() ?>

<h1>Contact us at:</h1>
Phone: <?php echo $puntoPpal->getTel() ?><br />
...
<h1>Contact us at:</h1>
Phone: <?php echo $punto->getTel() ?> PBX   <?php echo $punto->getPbx() ?><br />
<?php echo $punto->getEmail() ?>

<h1>Hours:</h1>
Monday to Friday   <?php echo $punto->getHlv() ?><br />
Saturdays   <?php echo $punto->getHs() ?><br />
</div>
</div>
</div>
<?php endforeach ?>
