...
<div class="container"> 
  ...
  <ul class="tabs"> 		  	
    ...
    <li><a href="#tab2">Quality System</a></li> 
    <li><a href="#tab3">Offices</a></li> 
...
<div id="tab1" class="tab_content">
	<div id="txtconttab1">
		...
		<div id="titulossectab"><?php echo $articulo[0]->getTitulo_i() ?></div>

    <div id="coltxtizqcontab1"><?php echo substr($articulo[0]->getDescripcion_i(), 0,-200) ?></div>
		<div id="coltxtdercontab1"><?php echo substr($articulo[0]->getDescripcion_i(), -200) ?></div>
...
<div id="txtconttab1">
  ...
  <div id="titulossectab">
  	<?php echo $articulo[1]->getTitulo_i() ?>
  </div>

  <div id="coltxtizqcontabsist2">
    <div id="imgsistint">
      <img src="./..<?php echo $articulo[1]->getImagen_i() ?>" width="350" height="180" />
    </div>
    <?php echo $articulo[1]->getDescripcion_i() ?> 
  </div>
...
<div id="tab3" class="tab_content">
	...
	<div id="txtconttab1">
		...
		<div id="titulossectab">
			<?php echo $articulo[2]->getTitulo_i() ?>
		</div>

		<div id="imgsistint">
			<img src="./..<?php echo $articulo[2]->getImagen_i() ?>" width="350" height="180" />
		</div>
			<?php echo $articulo[2]->getDescripcion_i() ?>
...
<?php 
 ...
 ?>	
		      ...
		      <?php foreach ($oficinas as $oficina): ?>
					...
					<div id="thumbfac">
						<div id="velobt">
							<a  href="./..<?php echo $oficina->getImagen_i() ?>" class="highslide" onclick="return hs.expand(this)">&nbsp;</a>
						</div>
							<img src="./..<?php echo $oficina->getImagen_i() ?>" width="90" height="71" />
					</div>
