...
<form name="frmCategoria" class="categoria">
  ...
  <div id="contcols">
    ...
    <div class="content_scroll scroll3">
      ...
      <?php foreach ($categorias as $categoria): ?>
                  ...
                  <input name="categoria" type="radio" value="<?php echo $categoria->getid() ?>" onClick="getMateriales()"/> <?php echo $categoria->getnombre_i() ?><br/>
  ...
  <div id="footcolprods1">
    <div id="bt_borrar">
      <a href="javascript:void(0)" onClick="limpiaCategoria()">ERASE</a>
    </div>
  </div>
</form>
<?php } ?>
