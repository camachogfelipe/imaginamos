...
<div id="subtit1">
	...
	<div id="envpaginacion">
		...
		<div id="btpag1"><a href="<?php echo $resultadoFinal['first'] ?>" >FIRST</a></div>
		<div id="btpag1"><a href="<?php echo $resultadoFinal['prev'] ?>">PREVIOUS</a></div>
		<?php
		...
		<div id="btpag1"><a href="<?php echo $resultadoFinal['next'] ?>">NEXT</a></div>
		<div id="btpag1"><a href="<?php echo $resultadoFinal['last'] ?>">LAST</a></div>
		<?php 
...
</div>Show <?php echo $totalResultados ?> Of <?php echo $totalProductos ?> entries</div>
</div>
...
<div id="envcontprodinf">
	...
	?>
				...
				<div id="thumb2col">
					<div id="imgthumb2">  
						<div id="btmodprodsec">
							<a href="" onclick="window.open('catalogo_paso3.php?id=<?php echo $producto->getProducto_codigo() ?>','', 'width=1084, height=780, location=no, menubar=no, status=no,toolbar=no, scrollbars=no, resizable=no'); return false">&nbsp;</a>
						</div>

						<img src="..<?php echo $producto->getProducto_imagen() ?>" width="170" height="153" />
					</div>
					<div id="textosdetalle">
						<h1><a href="" onclick="window.open('catalogo_paso3.php?id=<?php echo $producto->getProducto_codigo() ?>','', 'width=1084, height=780, location=no, menubar=no, status=no,toolbar=no, scrollbars=no, resizable=no'); return false"><?php echo $producto->getProducto_nombre_i()?></a></h1>
						Peso:&nbsp;<?php echo $producto->getProducto_peso() ?><br />
						Material:&nbsp;<?php echo $material->getnombre_i() ?><br />
					</div>
				</div>
