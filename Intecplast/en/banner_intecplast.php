			...
			<div class="sliderkit-nav">
				...
				<div class="sliderkit-nav-clip">
					...
					<?php foreach ($imagenes as $imagen): ?>
						...
						<li><a href="#" title="Photo sample"><?php echo $imagen->getTitulo_i() ?></a></li>
				...
				<div class="sliderkit-panel">
					...
					<div id="wrapelemintec">
						...
						<div id="colbann2">
							...
							<img src="./..<?php echo $imagen->getImagen_i() ?>">
						...
						<div id="colbann1">
							...
							<div id="txtbann">
								...
								<?php echo $imagen->getDescripcion_i() ?>
							...
							<div id="envbtminfo">
								...
								<div id="btminfo">
									...
									<a href="<?php echo $imagen->getEnlace_i() ?>" target="_blank">&nbsp;</a>
