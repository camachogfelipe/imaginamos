...
<div id="subtit1"><a href="productos.php" >Products: </a> <?php echo $categoria->getnombre_i() ?></div>
...
<div id="thumb2col">
  ...
  <div id="imgthumb2">
    ...
    <div id="btmodprodsec">
      ...
      <a href="" onclick="window.open('catalogo_paso3.php?id=<?php echo $producto->getProducto_codigo() ?>','', 'width=1084, height=780, location=no, menubar=no, status=no,toolbar=no, scrollbars=yes, resizable=no'); return false">&nbsp;</a>
  ...
  <div id="textosdetalle">
    ...
    <?php echo $producto->getProducto_nombre_i() ?>
