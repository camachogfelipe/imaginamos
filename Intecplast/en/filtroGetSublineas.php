...
<form name="frmSublinea" class="sublinea">
  ...
  <div id="contcols2">
    ...
    <div class="content_scroll scroll2">
        ...
        <?php foreach ($sublineas as $sublinea): ?>
                  ...
                  <input name="sublinea" type="radio" value="<?php echo $sublinea->getid() ?>" onClick="getMateriales()"/> <?php echo $sublinea->getnombre_i() ?><br/>
  ...
  <div id="footcolprods2">
    <div id="bt_borrar">
      <a href="javascript:void(0)" onClick="limpiaSublinea()">ERASE</a>
    </div>
  </div>
 </form> 
<?php } ?>