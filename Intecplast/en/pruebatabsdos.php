...
<body><div class="container"> 
    ...
    <ul class="tabs"> 
        <li style="text-align:center"><a href="#tab1">Descripción</a></li> 
        <li style="text-align:center"><a href="#tab2">Ubicación</a></li> 
        <li style="text-align:center"><a href="#tab3">Planos</a></li>
        <li style="text-align:center"><a href="#tab4">Videos</a></li>
        <li style="text-align:center"><a href="#tab5">Ventas</a></li>
    ...
    <div class="tab_container"> 
		...
		<iframe width="965" height="460" src="slide_lineatiempo.php" scrolling="no" frameborder="0" allowtransparency="yes" ></iframe>
 ...
 <div style="clear: both; display: block; padding: 10px 0; text-align:center;"></div>
    ...
    CUATRO
	          ...
	          <div id="tab5" class="tab_content">CINCO
	    ...
	    <div id="tab6" class="tab_content"> SEIS
      </div> 
