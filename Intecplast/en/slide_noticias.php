        ...
        <div id="textonoticia">
          <div id="titulonoticiasult">&nbsp;
              <div class="fechaslide"><?php echo $day," de ",$mes=convertMes($num_mes)," de ",$year ?><br/>
                  <br/>
                  <div id="imgslidenot" style="padding-left:5px; padding-top:3px;"><img src="../<?php echo $noticia->getImagen_i() ?>" align="left" width="111" height="110"/>
                      <div id="textoimgnot" style="padding-left:20px"><strong><?php echo $noticia->getTitulo_i() ?></strong><br/>
                          <?php echo $noticia->getDescripcion_i() ?>
                        <div id="btmasinfonoti"><a href="noticias.php?mes=<?php echo $num_mes?>&anio=<?php echo $year ?>">See more</a></div>
                      </div>
