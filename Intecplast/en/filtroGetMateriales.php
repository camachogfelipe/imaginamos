...
<form name="frmMaterial" class="material">
  ...
  <div id="contcols2">
    ...
    <div class="content_scroll scroll4">
      ...
      <?php foreach ($materiales as $material): ?>
                  ...
                  <input name="material" type="radio" value="<?php echo $material->getid() ?>" onClick="getFormas()"/> <?php echo $material->getnombre_i() ?><br/>
  ...
  <div id="footcolprods2">
    <div id="bt_borrar">
      <a href="javascript:void(0)" onClick="limpiaMaterial()">ERASE</a>
    </div>
  </div>
</form>
<?php } ?>