...
echo '<div id="subtit01tabs2">Cotizador </div>';
...
echo '<div id="columderprod">';
  echo '<table width="907" id="gradient-style" summary="Meeting Results">';
    echo '<thead>';
      echo '<tr>';
        echo '<th  scope="col"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Producto</strong></th>';
        echo '<th  scope="col"><strong>Nombre del producto </strong></th>';
       echo '<th  scope="col"><strong>Referencia artículo</strong></th>';
        echo '<th  scope="col"><strong>Número de muestras </strong></th>';
        echo '<th  scope="col"><strong>Cantidad a cotizar </strong></th>';
...
<div id="sepclear">&nbsp;</div><div id="envenlacecotizador">';
  ...
  if($this->num_productos!=0){ 
    ...
    echo '<div style="font-family:sans; font-weight:bold; color:#333;">No has agregado productos a la cotización, para agregar productos ingresa a el <a href="catalogo.php">catálogo de productos</a> o la sección de <a href="productos.php" >productos</a></div>';
  }
}
