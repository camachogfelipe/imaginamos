...
?>
            ...
            <div id="cajonnoticiasseccion" class="clearfix"> 
                ...
                <div id="rightcontnot" class="clearfix">
                    ...
                    <div id="envnewsmes">
                        <div id="titnewscajon">
                            <span class="fechanoticia"><?php echo $day ?> / <?php echo $mes=convertMes($num_mes) ?> </span>&nbsp;&nbsp;&nbsp;<?php echo $noticia->getTitulo_e() ?> </div>
                        <div id="contmodininews">
                            <div id="imgofemes"><img src=".<?php echo $noticia->getImagen_e() ?>" width="118" height="121" /></div>
