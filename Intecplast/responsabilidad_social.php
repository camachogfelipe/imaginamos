<?php
    ...
    $articulo = $articuloDAO->getBySeccion(4);
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.17/jquery.min.js"> </script>
...
<div id="subtit01tabs2">Responsabilidad social</div>
...
<div id="envslideing"> <div id="overimg"><img src="img/overimg.png" /></div>      <?php include "slide_caption2.php"; ?>
