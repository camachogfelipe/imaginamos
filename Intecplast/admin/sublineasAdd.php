...
<head>
  ...
  <meta name="description" content="Adición de sublineas">
...
<body>
	<div id="container">
		...
		<div id="form_add">
		<h3>Nueva Sublinea</h3>

			<form method="post" id="form1" name="form1" action="./../php/action/sublineaAdd.php" enctype="multipart/form-data">
...
<?php if ($_GET['add']==1):?>
  ...
  <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.min.js"></script>
    ...
    <script>
        jQuery.noConflict();
        jQuery('.ex1.alert').ready(function() {
           noty({"text":"Sublinea Creada Correctamente!","layout":"center","type":"success","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
...
<?php if ($_GET['edit']==1):?>
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        jQuery.noConflict();
        jQuery('.ex1.alert').ready(function() {
           noty({"text":"Sublinea Editada Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
...
<?php if ($_GET['delete']==1):?>
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        jQuery.noConflict();
        jQuery('.ex1.alert').ready(function() {
           noty({"text":"Sublinea Eliminada Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
