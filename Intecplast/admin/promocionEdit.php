...
$referencia = $promocion->getReferencia();

$precio = $promocion->getPrecio();

$unidades = $promocion->getUnidades();

$titulo = $lang=="es" ? $promocion->getTitulo_e() : $promocion->getTitulo_i() ;

$descripcion = $lang=="es" ? $promocion->getDescripcion_e() : $promocion->getDescripcion_i();

$update="./../php/action/promocionEdit.php?lang=".$lang."&s=".$recurso;
...
<head>
  ...
  <script>
   ...
   $(document).ready(function() {
	  ...
	  document.getElementById("form_add").style.height="840px";
...
<div class="contenido_fondo">
	...
	<div class="subcontenido2">
		...
		<div id="form_add">
		<h3>Editar Promociones - <?php echo $desLagn ?></h3>

			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				
				<input type="hidden" name="id" id="id" value="<?php echo $promocion_id ?>"
				...
				<input type="text" id="unidades" name="unidades" value="<?php echo $unidades ?>" />
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=promocionEdit&id=<?php echo $promocion_id ?>&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        ...
        $('.ex1.alert').ready(function() {
           noty({"text":"¨Promoción En Español Editada Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
...
<?php if ($_GET['edit']==1 &&$_GET['lang']=="en"):?>
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        ...
        $('.ex1.alert').ready(function() {
           noty({"text":"¨Promoción En Ingles Editada Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
