...
$servicioAdd="./../php/action/servicioAdd.php";
...
<!--Titulos-->
<div class="titulos">
    <div class="titulos_texto1">Servicio
      <div class="cerrar">
	...
	<div class="subcontenido2">
		<div id="container">
			<div id="form_principal">
				...
				<form method="post" id="form1" name="form1" action="<?php echo $servicioAdd ?>"  enctype="multipart/form-data">	
					<!--Columna izquierda-->
					<div class="left">
