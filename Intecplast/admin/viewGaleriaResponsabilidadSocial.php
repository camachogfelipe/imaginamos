...
<!--Titulos-->
<div class="titulos">
    <div class="titulos_texto1">Galeria (Responsabilidad Social)
    	<div class="cerrar">
		  ...
		  <div id="dashboard" role="dashboard">
			...
			<div style="width:100%; height:auto ; border-top:1px solid #333; font-family:sans-serif; font-size:12px;"> 
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=galeriaResponsabilidadSocial','_top');">Añadir Imagen</button>
