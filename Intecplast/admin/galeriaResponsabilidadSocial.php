...
$galeriaAdd="./../php/action/galeriaResponsabilidadSocialAdd.php";
			...
			<div id="form_principal">
				...
				<form method="post" id="form1" name="form1" action="<?php echo $galeriaAdd ?>"  enctype="multipart/form-data">	
					...
					<div class="actions">
						...
						<button class="red" type="button" onclick="window.open('menuAdmin.php?s=ingenieriaProductoDiseno&lang=es&id=3','_top');" >Volver</button>			
					</div>
				</form>
