...
$articulo = $articuloDAO->getById(16);
...
<div class="contenido_fondo">
	<div class="subcontenido">
		...
		<div class="subtitulos">
				Gestión de la Sección -> Responsabilidad Social
		</div>	
	...
	<div class="subcontenido2">
		...
		<div id="form_add">
		<h3>Editar Responsabilidad Social - <?php echo $desLagn ?></h3>
			...
			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=responsabilidadSocial&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>

					<button type="button" onclick="window.open('menuAdmin.php?s=viewGaleriaResponsabilidadSocial','_top');" >Galeria</button>	
