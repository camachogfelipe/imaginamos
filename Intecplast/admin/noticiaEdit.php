...
$titulo = $lang=="es" ? $noticia->getTitulo_e() : $noticia->getTitulo_i() ;

$enlace = $lang=="es" ? $noticia->getEnlace_e() : $noticia->getEnlace_i() ;

$descripcion = $lang=="es" ? $noticia->getDescripcion_e() : $noticia->getDescripcion_i();

$update="./../php/action/noticiaEdit.php?lang=".$lang."&s=".$recurso;
...
<div class="contenido_fondo">
	...
	<div class="subcontenido2">
		...
		<div id="form_add">
		<h3>Editar noticias - <?php echo $desLagn ?></h3>

			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				
				<input type="hidden" name="id" id="id" value="<?php echo $noticia_id ?>"
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=noticiaEdit&id=<?php echo $noticia_id ?>&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        ...
        $('.ex1.alert').ready(function() {
           noty({"text":"Noticia En Español Editada Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
...
<?php if ($_GET['edit']==1 &&$_GET['lang']=="en"):?>
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        ...
        $('.ex1.alert').ready(function() {
           noty({"text":"Noticia En Ingles Editada Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
