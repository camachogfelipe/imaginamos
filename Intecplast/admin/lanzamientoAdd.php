...
$lanzamientoAdd="./../php/action/lanzamientoAdd.php";
...
<head>
  ...
  <script>
   ...
   $(document).ready(function() {
	  document.getElementById("form_principal").style.height="580px";
 	});
...
<!--Titulos-->
<div class="titulos">
    <div class="titulos_texto1">Lanzamiento
      <div class="cerrar">
	...
	<div class="subcontenido2">
		<div id="container">
			<div id="form_principal">
				...
				<form method="post" id="form1" name="form1" action="<?php echo $lanzamientoAdd ?>"  enctype="multipart/form-data">	
					<!--Columna izquierda-->
					<div class="left">
