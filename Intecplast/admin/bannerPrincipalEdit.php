...
$update="./../php/action/bannerPrincipalEdit.php?lang=".$lang."&s=".$recurso;
...
<head>
  ...
  <script>
   ...
   $(document).ready(function() {
	  ...
	  document.getElementById("form_add").style.height="630px";
...
<div class="contenido_fondo">
	...
	<div class="subcontenido2">
		...
		<div id="form_add">
		<h3>Editar Banner - <?php echo $desLagn ?></h3>
			...
			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=bannerPrincipalEdit&id=<?php echo $imagen_id ?>&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
