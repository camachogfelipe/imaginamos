...
$update="./../php/action/galeriaFarmaceuticaEdit.php?lang=".$lang."&s=".$recurso;
		...
		<h3>Editar Imagen - <?php echo $desLagn ?></h3>
			...
			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=galeriaFarmaceuticaEdit&id=<?php echo $imagen_id ?>&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
			
					<button class="red" type="button" onclick="window.open('menuAdmin.php?s=viewGaleriaFarmaceutica','_top');" >Volver</button>			
