...
$cliente = new cliente(); 
$clientes = $clienteDAO->gets(); 
$totalClientes = $clienteDAO->total();
?>
	...
	<div class="subcontenido2">
		  <div id="dashboard" role="dashboard">
				...
				<div id="consultas">
					...
					<div id="txtHint">         
                        <?php $nombre_columna=array('Identificación', 'Nombres', 'E-mail', 'Ciudad', 'Empresa','');  ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $cliente->getClienteId() ?><br /></td>
                            <td><?php echo $cliente->getNombre()." ".$cliente->getApellido() ?><br /></td>
                            <td><?php echo $cliente->getEmail() ?><br /></td>
                            <td><?php echo $cliente->getCiudadId() ?><br /></td>
                            <td><?php echo $cliente->getEmpresa() ?><br /></td>
                            <td><a href="menuAdmin.php?s=viewCliente&id=<?php echo $cliente->getClienteId() ?>">Ver</a><br /></td>
