...
$articulo = $articuloDAO->getById(12);
...
<div class="contenido_fondo">
	...
	<div class="subcontenido2">
		...
		<div id="form_add">
		<h3>Editar Farmaceuticas - <?php echo $desLagn ?></h3>
			...
			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=admFarmaceutica&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
			
					<button class="red" type="button" onclick="window.open('menuAdmin.php?s=mercados&id=2','_top');" >Volver</button>			
					<button type="button" onclick="window.open('menuAdmin.php?s=viewGaleriaFarmaceutica','_top');" >Galeria</button>	
