...
$galeriaAdd="./../php/action/bCatalogoAdd.php";
...
<!--Titulos-->
<div class="titulos">
    <div class="titulos_texto1">Banner Catálogo
      <div class="cerrar">
			...
			<div id="form_principal">
				...
				<form method="post" id="form1" name="form1" action="<?php echo $galeriaAdd ?>"  enctype="multipart/form-data">	
					...
					<div class="actions">
						...
						<button class="red" type="button" onclick="window.open('menuAdmin.php?s=admBCatalogo&lang=es&id=3','_top');" >Volver</button>			
					</div>
				</form>
