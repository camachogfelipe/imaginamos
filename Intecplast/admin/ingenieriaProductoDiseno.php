...
$articulo = $articuloDAO->getById(15);
...
<!--Titulos-->
<div class="titulos">
    <div class="titulos_texto1">Ingenieria de P&D
    	<div class="cerrar">
...
<div class="contenido_fondo">
	<div class="subcontenido">
		...
		<div class="subtitulos">
				Gestión de la Sección -> Ingenieria de P&D
		</div>	
	...
	<div class="subcontenido2">
		...
		<div id="form_add">
		<h3>Editar Ingenieria de P&D - <?php echo $desLagn ?></h3>
			...
			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=ingenieriaProductoDiseno&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
					
					<button type="button" onclick="window.open('menuAdmin.php?s=viewGaleriaIngenieriaPD','_top');" >Galeria</button>	
