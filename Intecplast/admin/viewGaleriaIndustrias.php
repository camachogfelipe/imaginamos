...
<!--Titulos-->
<div class="titulos">
    <div class="titulos_texto1">Galeria (Industrias)
    	<div class="cerrar">
...
<div class="contenido_fondo">
	<div class="subcontenido">
		...
		<div class="subtitulos">
				Gestión de la Sección -> Mercados -> Industrias
		</div>	
		  ...
		  <div id="dashboard" role="dashboard">
		      ...
		      <?php foreach ($imagenes as $imagen): ?>
		      	<div style="width:134px; display:block; float:left; margin:10px;">
						...
						<?php      		
							...
							echo "<a href='menuAdmin.php?s=galeriaIndustriasEdit&lang=es&id=".$imagen->getId()."'><img style='width:20px;height:20px; margin-right:10px;' src='imagenes/iconos/iconeditar.png' align='left'/></a>";
			...
			<div style="width:100%; height:auto ; border-top:1px solid #333; font-family:sans-serif; font-size:12px;"> 
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=galeriaIndustrias','_top');">Añadir Imagen</button>
