...
$articulo = $articuloDAO->getById(11);
...
$titulo = $lang=="es" ? $articulo->getTitulo_e() : $articulo->getTitulo_i() ;

$descripcion = $lang=="es" ? $articulo->getDescripcion_e() : $articulo->getDescripcion_i();
...
<!--Titulos-->
<div class="titulos">
    <div class="titulos_texto1">Mercados
    	<div class="cerrar">
...
<div class="contenido_fondo">
	<div class="subcontenido">
		...
		<div class="subtitulos">
				Gestión de la Sección -> Acerca de Nosotros -> Mercados
		</div>	
	...
	<div class="subcontenido2">
		...
		<div id="form_add">
		<h3>Editar Cuidado Personal - <?php echo $desLagn ?></h3>

			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				
				<input type="hidden" name="id" id="id" value="<?php echo $articulo->getId() ?>"
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=admCuidadoPersonal&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
			
					<button class="red" type="button" onclick="window.open('menuAdmin.php?s=mercados&id=2','_top');" >Volver</button>			
					<button type="button" onclick="window.open('menuAdmin.php?s=viewGaleriaCuidadoPersonal','_top');" >Galeria</button>	
