...
$articulo = $articuloDAO->getById(13);
...
<div class="contenido_fondo">
	...
	<div class="subcontenido2">
		...
		<div id="form_add">
		<h3>Editar Industrias - <?php echo $desLagn ?></h3>
			...
			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=admIndustrias&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
			
					<button class="red" type="button" onclick="window.open('menuAdmin.php?s=mercados&id=2','_top');" >Volver</button>			
					<button type="button" onclick="window.open('menuAdmin.php?s=viewGaleriaIndustrias','_top');" >Galeria</button>	
