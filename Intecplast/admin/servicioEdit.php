...
$servicio = $articuloDAO->getById($servicio_id);
...
$titulo = $lang=="es" ? $servicio->getTitulo_e() : $servicio->getTitulo_i() ;

$descripcion = $lang=="es" ? $servicio->getDescripcion_e() : $servicio->getDescripcion_i();
...
<!--Titulos-->
<div class="titulos">
    <div class="titulos_texto1">Servicios
    	<div class="cerrar">
...
<div class="contenido_fondo">
	...
	<div class="subcontenido2">
		...
		<div id="form_add">
		<h3>Editar Servicio - <?php echo $desLagn ?></h3>

			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				
				<input type="hidden" name="id" id="id" value="<?php echo $servicio_id ?>"
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=servicioEdit&id=<?php echo $servicio_id ?>&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
			
					<button class="red" type="button" onclick="window.open('menuAdmin.php?s=admServicios','_top');" >Volver</button>			
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        ...
        $('.ex1.alert').ready(function() {
           noty({"text":"Servicio En Español Editado Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
...
<?php if ($_GET['edit']==1 &&$_GET['lang']=="en"):?>
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        ...
        $('.ex1.alert').ready(function() {
           noty({"text":"Servicio En Ingles Editado Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
