...
$enlace = $lang=="es" ? $imagen->getEnlace_e() : $imagen->getEnlace_i();

$update="./../php/action/galeriaCuidadoPersonalEdit.php?lang=".$lang."&s=".$recurso;
		...
		<h3>Editar Imagen - <?php echo $desLagn ?></h3>
			...
			<form method="post" id="form1" name="form1" action="<?php echo $update ?>"  enctype="multipart/form-data">	
				...
				<div class="moreActions">
					...
					<button type="button" onclick="window.open('menuAdmin.php?s=galeriaCuidadoPersonalEdit&id=<?php echo $imagen_id ?>&lang=<?php echo $otherLang ?>','_top');">Versión <?php echo $otherLang=="es" ? "Español" : "Ingles" ?></button>
			
					<button class="red" type="button" onclick="window.open('menuAdmin.php?s=viewGaleriaCuidadoPersonal','_top');" >Volver</button>			
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        ...
        $('.ex1.alert').ready(function() {
           noty({"text":"Banner En Español Editado Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
...
<?php if ($_GET['edit']==1 &&$_GET['lang']=="en"):?>
  ...
  <script type="text/javascript" src="noty/js/jquery.noty.js"></script>
    ...
    <script>
        ...
        $('.ex1.alert').ready(function() {
           noty({"text":"Banner En Ingles Editado Correctamente!","layout":"center","type":"alert","textAlign":"center","easing":"swing","animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":"500","timeout":"5000","closable":true,"closeOnSelfClick":true});
        });
    </script>
