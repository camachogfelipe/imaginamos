...
$imagen_edit_titulo = "No Title";
$imagen_edit_descripcion = $_POST['descripcion'];
$imagen_edit_enlace = "No Link";
$imagen = $_POST['imagen'];


$location = "location: ./../../admin/menuAdmin.php?s=mercados&id=1";
...
if ($lang=="es") {
    ...
    $imagen_edit->setEnlace_e($imagen_edit_enlace);
}
    ...
    $imagen_edit->setEnlace_i($imagen_edit_enlace);
