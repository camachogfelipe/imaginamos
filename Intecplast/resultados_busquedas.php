...
$buscar = accents2HTML($buscar);

// Si está vacío, lo informamos, sino realizamos la búsqueda

$con=mysql_connect("mysql51-021.wc2.dfw1.stabletransit.com","819448_intec","=N2@4KGlK7k$");

$sql = "SELECT articulos.articulo_titulo_e, articulos.articulo_descripcion_e, flags.front_file FROM articulos, flags WHERE articulos.articulo_descripcion_e like '%".$buscar."%'  AND articulos.flag_id = flags.flag_id AND articulos.flag_id!=1 ORDER BY articulos.articulo_id DESC";
...
<div id="subtit2">Resultados de búsqueda : <?php echo $buscar ?></div>
...
<div id="columderbusquedas"> 
  <h3><?php echo $fila['articulo_titulo_e'] ?></h3>
  <?php echo $fila['articulo_descripcion_e'] ?>
