<?php
  ...
  if ($totalEjemplos>0) {
	...
	$return .='
<div>
  <div class="banner_sup"><img src="images/pdf/banner_superior.png" width="813" /></div>
  <table width="100%" cellpadding="2" cellspacing="3" border="0">
      ...
      <td>
          ...
          <table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>Boca ('.strtolower($unidadBoca->getnombre()).'): </td>
              <td><strong>'.$producto->getProducto_boca().'</strong></td>
            </tr>
            <tr>
              <td>Capacidad ('.strtolower($unidadCapacidad->getnombre()).'): </td>
  ...
  <div class="title" style="color: #0085b7; margin-top:15px; clear:both">EJEMPLOS</div>
  <div class="photo round" style="width: 90%; min-height: 100px; margin: 0 40px;">'.$ejemplosPdf.'</div>
  <div class="title" style="color: #0085b7; margin-top:15px; clear:both">FAMILIA</div>
  <div class="photo round" style="width: 90%; margin: 0 30px;">'.$familiaEjemplos.'</div>
  <table align="center" width="90%" border="1" class="tabla_familia" cellspacing="0" cellpadding="5">
    <tr>
      <td class="title_table2" align="center" style="padding: 5px; border: 1px solid #8b9fa4;" width="200">Código del articulo</td>
      <td class="title_table2" align="center" style="padding: 5px; border: 1px solid #8b9fa4;">Capacidad</td>
      <td class="title_table2" align="center" style="padding: 5px; border: 1px solid #8b9fa4;">Peso (g)</td>
      <td class="title_table2" align="center" style="padding: 5px; border: 1px solid #8b9fa4;">Material</td>
    </tr>
    '.$ProductosRangoPDF.'
  </table>
  <div class="banner_inf"><img src="images/pdf/banner_inferior.png" /></div>
</div>';
	...
	if(class_exists('HTML2PDF')) :
		...
		$html2pdf->Output("Hoja_de_Producto_".$producto->getProducto_codigo()."pdf.pdf");
	else : echo "Error cargando clase HTML2PDF";
	endif;
?>