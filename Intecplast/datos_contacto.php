...
<div id="subtit01tabs2">Cotizador<br />
    <br />
...
<div id="txttitcontactpromdatos">Tienes una cuenta </div>
<div id="txtcampprom2">Identificación</div>
<div id="campprom">  <input name="identificacion2" id="identificacion2" type="text" class="transparenteprom" /></div>

<div id="txtcampprom">Contraseña</div>
<div id="campprom">
  <input name="pass" id="pass" type="password" class="transparenteprom" />
</div>
<div id="txtcampprom"><a href="recordarClave.php" class="activator" id="activator">¿Olvidó su contraseña? </a></div>
