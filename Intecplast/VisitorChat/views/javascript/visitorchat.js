...
$(function(){
   ...
   .append(
        ...
        .append(
            ...
            .append('<br /><br />')
            .append('En este momento estamos fuera de linea, pero puede envíarnos un mensaje usando el siguiente formulario')
            .append('<br /><br />')
            .append(
                $("<label></label>")
                .html('Nombre')
   ...
   .append(
        ...
        .append(
            ...
            .append(
                $("<strong></strong>")
                .html('Ingrese sus datos para iniciar el chat')
            )
            .append('<br /><br />')
            .append(
                $("<label></label>")
                        ...
                        success: function(theResponse) {
                            ...
                            if(theResponse == 1)
                            {
                               ...
                               $.ajax({
                                ...
                                alert("Fallo Cambio de Nickname!");
                            }
                        }
                });
