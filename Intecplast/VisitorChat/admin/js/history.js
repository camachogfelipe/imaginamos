    ...
    $("#search").click(function(){
    	...
    	$("#form").submit();
			...
			$(".u_options").click(function(){
				...
				$(".users").append('<div class="user_options" style="position:fixed; left:'+(position.right+240)+'px; top:'+(obj_pos.top+141)+'px;"><a href="#" alt="view"">Ver Conversación</a><a href="index.php?page=historydelete&sess='+rel[0]+'&email='+rel[1]+'">Borrar Conversación</a></div>');
