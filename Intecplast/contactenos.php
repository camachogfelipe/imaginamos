...
<div id="subtit01tabs2">Contáctenos</div>

<div id="rowmapas">

<div id="colimgcontacto">

<div id="envimgcontacto"><img src=".<?php echo $articulo->getImagen_e() ?>" /></div>
<div id="textobotcontacto"><?php echo $articulo->getDescripcion_e() ?></div>
</div>
