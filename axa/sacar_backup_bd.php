 ...
 */
define("DB_USER", '533638_axa'); /* Nombre de usuario de la base de datos */
define("DB_PASSWORD", 'IMAGINA@axa205'); /* Clave de acceso del usuario de la base de datos */
define("DB_NAME", '533638_axa'); /* Nombre de la base de datos a sacar backup */
define("DB_HOST", 'mysql51-006.wc2.dfw1.stabletransit.com'); /* Nombre del sevidor de donde sacar backup de la base de datos */
