...
<head>
<!-- NO ALMACENAR EN CACHE DE GOOGLE -->
<meta content="NOARCHIVE" name="GOOGLEBOT" />
<META content="NOSNIPPET" nanme="GOOGLEBOT" />

<!-- NO INDEXAR EN GOOGLE -->
...
<div class="cabezote">
  <div class="cabezote_interior">
   	  <div class="cabezote_logo_empresa"><img src="../images/layout/logo.png?<?php echo time()?>" alt="Logo Empresarial" width="120" height="80" /></div>
            ...
            <div class="contenido_fondo_index">
                <div class="subcontenido">
                  <div class="subcontenido2">
                    <?php //echo $msg; ?>
                    <form action="../php/action/loginAdminchat.php"  method="post" name="form_login" class="jqtransform" id="form_login">
