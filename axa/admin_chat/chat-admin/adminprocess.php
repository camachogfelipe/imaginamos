        ...
        case('users'):
            ...
            if(mysql_num_rows($result) > 0){
                ...
                while($row_query = mysql_fetch_assoc($result)){
                    ...
                    echo "  <li>
                                $imagen
                                <a href='Adminindex.php?a=".$row_query['archivo']."'>
                                        ". utf8_decode($row_query['login']) . " (".(count($lines)-$row_query['estado']).")
                                </a>
                                <img src='images/Delete-32.png' width='12' title='Eliminar' alt='Eliminar' style='cursor: pointer;' onclick='chat.deleteChat(\"". $row_query['login']."\",". $cat .")'/>
                            </li>";
                }
                echo "</ul>";
            } else {
