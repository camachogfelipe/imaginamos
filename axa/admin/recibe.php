...
/*$venta1 = new venta2DAO();
$venta2 = $venta1->getVenta2();
...
for($i=0;$i < sizeof($venta2);$i++){
    ...
    echo $venta2[$i]["nombretbl_pasajeros"];
    echo $venta2[$i]["apellidostbl_pasajeros"];
    echo $venta2[$i]["descripciontbl_plan"];
    echo utf8_encode($venta2[$i]["descripciontbl_destino"]);
    echo $venta2[$i]["canalventatbl_ventas"];
    echo $venta2[$i]["fechaventatbl_ventas"];
    echo $venta2[$i]["fechasalidatbl_ventas"];
    echo $venta2[$i]["fecharegresotbl_ventas"];
    echo $venta2[$i]["pagoonlinetbl_ventas"];
}
*/
?>
<?php 
...
for($i=0;$i < sizeof($array);$i++){
	...
	*/
	...
	//$usuario_id=$venta2[0]["nombretbl_pasajeros"];
...
//}
             ...
             $mail->Host = 'mail.tarjetasdeasistencia-axa.com';  // Specify main and backup server
                ...
                $mail->Password = 'zte1014202099'; 
                // SMTP password
                $mail->Host = "smtp.gmail.com";
                $mail->SMTPAuth = true;    
                $mail->Username = 'jocamilourimg@gmail.com'; 
                $mail->Password = 'zte1014202099';
		$mail->From = "jocamilourimg@gmail.com";
		...
		//$mail->AddBCC('marketing@axa-assistance.com.co');
                ...
                $mail->AddBCC('jocamilourimg@gmail.com');
