...
?>
                    <div class="titulos">
                      <div class="titulos_texto1">Secciones<div class="cerrar"><a href="../php/action/logout.php"><img src="imagenes/contenido/cerrar.png" alt="Cerrar Sesi&oacute;n" border="0" /></a></div></div>
...
<table border="0" align="center" width="400" border="0" cellspacing="4" cellpadding="4">
  ...
  <?php }?>
      ...
      <table border="0" align="center" width="700" border="0" cellspacing="4" cellpadding="4">
          <tr>
            <td>
                <form action="./../php/action/addTerminos.php" method="post" enctype="multipart/form-data">
                <table width="500">
