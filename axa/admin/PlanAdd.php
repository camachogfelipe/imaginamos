...
<table border="0" align="center" width="400" border="0" cellspacing="4" cellpadding="4">
  ...
  <?php if( isset($_GET['error2']) ){ ?>
        <tr>
            <td class="EstiloRed" colspan="2">No se ha realizado la grabación del plan.</td>
        </tr>
  <?php }?>
  <?php if( isset($_GET['error3']) ){ ?>
        <tr>
            <td class="EstiloRed" colspan="2">Esta ciudad ya tiene un plan asignado</td>
        </tr>
  <?php }?>
  </table>
	  <div id="buscador">
      ...
      <table border="0" align="center" width="700" border="0" cellspacing="4" cellpadding="4">
          <tr>
            <td>
                <form action="./../php/action/addPlan.php" method="post" enctype="multipart/form-data">
                <table width="500">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="numeric" name="diasmax" >
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="numeric" name="edadmin" >
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="numeric" name="edadmax">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="numeric" name="valordia">
