...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    $mail->SMTPSecure = "ssl";
    // Servidor smtp
    $mail->Host = "mail.tarjetasdeasistencia-axa.com";
    // Puerto de salida de envio de email
    $mail->Port = 465;
    // Usuario (Cuenta de correo)
    $mail->Username = "planes@tarjetasdeasistencia-axa.com";
    // Contrase�a
    $mail->Password = "Usuario2011";
    // Desde que correo quiere que se muestre
    $mail->From = "planes@tarjetasdeasistencia-axa.com";
    // Desde (Nombre)
    $mail->FromName = "Axa Assitance";
    // Asunto
    $mail->Subject = $asunto;
