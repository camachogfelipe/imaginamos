...
$location = "location: ./../../admin/menuAdmin.php?s=valorcostoplanDAOAdd";

if($valortbl_valorcosto == "" ){/*|| $texto1 == "" /*|| $imagen1 == ""*/ //|| $texto2 == "" || /*$imagen2 == ""||*/ $texto3 == "" ||/* $imagen3 == ""||*/ $texto4 == "" || /*$imagen4 == ""||*/ $texto5 == "" || /*$imagen5 == "" || */$textodescripciongeneral == "" ){
...
$valorcostoplan = new valorcostoplan;
...
$save = $valorcostoplanDAO->savvalorcostoplan($valorcostoplan);


if ($save == 1)
{
	$id = $valorcostoplanDAO->getLastId();
	$location = "location: ./../../admin/menuAdmin.php?s=valorcostoplanVer&ok2&id=".$id;
	header($location.'&ok');
	exit;
}
if ($save == 2)
