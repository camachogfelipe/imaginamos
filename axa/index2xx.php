    ...
    <ul id="acordeon">
    	<li id="acordeon1">
            ...
            <div class="contenido_acordeon">
				...
				?>
                <?php 
				if ($idplan ==  6 || $idplan== 2 || $idplan== 3 || $idplan== 9 || $idplan== 8)
				{
				?>
                <div class="contenedor_banderas" style="margin-left:0">
                	<div class="contenedor_banderas_grande">
                ...
                <div class="contenedor_banderas">
                	<div class="contenedor_banderas_grande">
                		<div class="contenedor_banderas_peque">
                    		<div class="bandera"><img src="images/layout/Banderas/colombia.png" /></div>
                    	</div>
                	</div>	
                    <p>Colombia</p>
                </div>
                ...
                <div class="contenedor_banderas">
                	<div class="contenedor_banderas_grande">
                		<div class="contenedor_banderas_peque">
                    		<div class="bandera"><img src="images/layout/Banderas/china.png" /></div>
                    	</div>
                	</div>	
                    <p>China</p>
                </div>
                <div class="contenedor_banderas" style="float:right">
                	<div class="contenedor_banderas_grande">
                		<div class="contenedor_banderas_peque">
                    		<div class="bandera"><img src="images/layout/Banderas/peru.png" /></div>
                    	</div>
                	</div>	
                    <p>Per&uacute;</p>
                </div>
...
cuando se haya confirmado la transacci&oacute;n.</p>   
    ...
    <div class="acepto_los_terminos" id="customP">
		...
		<label style="float:left; margin-top:8px" for="Acepto">Acepto los <a href="docpdf/<?php echo $listaPDF->getPdf(); ?>" class="link_peque" target="_blank"> t&eacute;rminos y condiciones propuestos.</a></label>
    </div>
    
    <a class="link_grande" href="#" id="comprar" onClick="enviar_pago()">Comprar</a> 
    <form name="guarda_compra" id="guarda_compra" style="display:none" >
...
$llave_encripcion = "1111111111111111";//"137e5c042e4"; //llave de encripción que se usa para generar la fima
$usuarioId = "2";//"85902"; //código único del cliente
...
$url_respuesta = "http://nuevascaras.com/axa_desarrollo/respuesta.php";
...
<form  name='form_pagos' id='form_pagos' method="post" action="https://gateway2.pagosonline.net/apps/gateway/index.html" target="_self">
    ...
    <input name="baseDevolucionIva" id="baseDevolucionIva" type="text" value="<?php echo $baseDevolucionIva ?>" >
    <input name="firma" id="firma" type="hidden" value="">
    <input name="emailComprador" id="emailComprador" type="hidden" value="" >
    <input name="prueba" id="prueba" type="hidden" value="1">
