                            ...
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <?php echo substr($img->texto_intro,0,155)."...";  ?>
                                    </td>
                                    <td>
                                        <?php echo number_format($img->precio_cliente); ?>
                                    </td>
                                    <td>
                                      <?php echo number_format($img->precio_provedor); ?>
                                    </td>
                                    <td class="center" width="100px">
                                        <a href="<?php echo cms_url('servicios/delete') ?>" class="btn btn-danger btn-small logic-delete" data-value="<?php echo $img->id ?>">Eliminar</a>
                                    </td> 
                                </tr>
                            <?php endforeach; ?>
