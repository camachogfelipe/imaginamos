...
<?php echo form_open_multipart(cms_url('categoria_tecnico/add'), array("id" => "validate_field_types", "novalidate" => "novalidate")) ?>
<div class="row-fluid">
    ...
    <div class="span6">
        ...
        <input type="text" id="categoria" name="categoria" readonly="true" value="<?php echo $obj->categoria; ?>" class="span12" maxlength="32">
    </div>
