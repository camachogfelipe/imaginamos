                            ...
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td class="center" width="100px">
                                        <a href="<?php echo cms_url('casos_exitos/delete_clientes') ?>" class="btn btn-danger btn-small logic-delete" data-related_value="<?php echo $img->caso_exito_id; ?>" data-value="<?php echo $img->id ?>">Eliminar</a>
                                    </td> 
                                </tr>
                            <?php endforeach; ?>
