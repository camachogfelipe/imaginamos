                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="span2" >Imagen</th>
                                 ...
                                 <th>Descripcion</th>
                                  <th class="span3">Caso de Exito</th>
                            ...
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <?php echo $img->parrafo_titulo; ?>
                                    </td>
                                    <td style="text-align: justify;">
                                        <?php echo substr($img->parrafo_texto, 0, 250) ?>
                                    </td>
                                     <td>
                                        <?php echo $img->caso_exito_titulo; ?>
                                    </td>
                                     <td class="center" width="100px">
                                        <a href="<?php echo cms_url('casos_exitos/delete_noticias') ?>" class="btn btn-danger btn-small logic-delete" data-related_value="<?php echo $img->caso_exito_id; ?>" data-value="<?php echo $img->id; ?>">Eliminar</a>
                                    </td> 
                                </tr>
                            <?php endforeach; ?>
