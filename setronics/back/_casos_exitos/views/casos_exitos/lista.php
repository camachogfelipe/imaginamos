                            ...
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td style="text-align: justify;">
                                        <?php echo substr($img->texto, 0, 250)."..."; ?>
                                    </td>
                                     <td>
                                        <?php echo $img->sublinea_titulo; ?>
                                    </td>                                    
                                    <td class="center" width="100px">
                                        <a href="<?php echo cms_url('casos_exitos/delete_casos_exitos') ?>" class="btn btn-danger btn-small logic-delete" data-value="<?php echo $img->id;  ?>">Eliminar</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
