    ...
    <div class="span12">
        <div class="w-box w-box-blue">
            <div class="w-box-content cnt_a">
                <?php echo form_open_multipart(cms_url('home/barners/add_der_up'), array("id" => "validate_field_types", "novalidate" => "novalidate")) ?>
                <div class="row-fluid">
                                            ...
                                            <?php foreach ($datos as $img) : ?>
                                                <tr class="odd gradeX parent-delete">
                                                    ...
                                                    <td class="center" width="100px">
                                                        <a href="<?php echo cms_url('home/barners/delete_der_up') ?>" class="btn btn-danger btn-small logic-delete" data-value="<?php echo $img->id ?>">Eliminar</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
