                            ...
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <?php echo substr($img->texto,0,155)."...";  ?>
                                    </td>
                                    <td >
                                         <?php if(!empty($img->path_certificado)){ ?>
                                                  <a class="link" target="_blank" title="link" href="<?php echo base_url() . $img->path_certificado; ?>">
                                                            Link Certificado
                                                   </a>
                                         <?php }  ?>
                                    ...
                                    <td class="center" width="100px">
                                        <a href="<?php echo cms_url('certificaciones/delete') ?>" class="btn btn-danger btn-small logic-delete" data-value="<?php echo $img->id ?>">Eliminar</a>
                                    </td> 
                                </tr>
                            <?php endforeach; ?>
