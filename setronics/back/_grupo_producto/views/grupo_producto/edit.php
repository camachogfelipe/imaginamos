<?php foreach ($datos as $obj) : ?>
    <?php echo form_open_multipart(cms_url('grupo_producto/add'), array("id" => "validate_field_types", "novalidate" => "novalidate")) ?>
    <div class="row-fluid">
        ...
        <div class="span6">
            ...
            <input type="text" id="grupo" name="grupo" value="<?php echo $obj->grupo; ?>" class="span12" maxlength="32">
        </div>
            ...
            <select name="categoria_id" class="span10">
                <?php if (!empty($categorias)) : ?>
                    <?php foreach ($categorias as $line) : ?>
                        <option value="<?php echo $line->id; ?>" <?php ($line->id == $obj->categoria_id)?"selected='selected'":"";  ?> ><?php echo $line->categoria; ?></option>
                    <?php endforeach; ?>
                <?php endif; ?>
            </select>
        </div>
        <div class="span8">
            ...
            <textarea class="span12" name="texto" id="count-textarea2" data-count="350" cols="30" rows="3"><?php echo $obj->texto; ?></textarea>
        </div>
