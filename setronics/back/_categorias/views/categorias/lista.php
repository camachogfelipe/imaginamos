                            ...
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <?php echo substr($img->descripcion,0,155)."...";  ?>
                                    </td>
                                    <td class="center" width="100px">.
                                        <a href="<?php echo cms_url('categorias/delete') ?>" class="btn btn-danger btn-small logic-delete" data-value="<?php echo $img->id ?>">Eliminar</a>
                                    </td>
