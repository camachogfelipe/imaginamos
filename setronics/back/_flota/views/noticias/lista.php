                            ...
                            <?php foreach ($datos as $img) : ?>
                                <tr class="odd gradeX parent-delete">
                                    ...
                                    <td style="text-align: justify;">
                                        <?php echo substr($img->parrafo_texto, 0, 400) ?>
                                    </td>
                                     <td class="center" width="100px">
                                        <a href="<?php echo cms_url('flota/delete_noticias') ?>" class="btn btn-danger btn-small logic-delete" data-related_value="<?php echo $img->gestion_flota_id ?>" data-value="<?php echo $img->id ?>">Eliminar</a>
                                    </td> 
                                </tr>
                            <?php endforeach; ?>
