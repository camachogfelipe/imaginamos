...
<?php echo form_open_multipart(cms_url('productos/add_accesorios'), array("id" => "validate_field_types", "novalidate" => "novalidate")) ?>
<div class="row-fluid">
    ...
    <div class="span3">
        ...
        <input type="text" id="titulio" name="titulo" value="<?php echo $obj->titulo; ?>" class="span12" maxlength="44">
    </div>
        ...
        <select name="producto_id" class="span10">
            <?php if (!empty($prod)) : ?>
                <?php foreach ($prod as $line) : ?>
                    <option value="<?php echo $line->id; ?>" <?php echo ($obj->producto_id == $line->id)?"selected='selected'":""; ?> ><?php echo $line->titulo; ?></option>
                <?php endforeach; ?>
            <?php endif; ?>
        </select>
    </div>
    ...
    <div class="span6">
        ...
        <textarea class="span12" name="descripcion" id="count-textarea2" data-count="100" cols="30" rows="3"><?php echo $obj->descripcion; ?></textarea>
    </div>
