    ...
    <header>
      <div class="con-header">
        <div class="header-top">
            ...
            <a href="<?php echo site_url('contactos') ?>"><div class="top-bt top-bt-2"><span></span>Contáctenos</div></a>
          </div>
        </div>
        <div class="mg-header cfx">
            ...
            <div class="con-info-header-nav">
              ...
              <?php if(isset($current_user['username'])) { ?>
                <div class="login-tx"><div class="span4"><img src="http://localhost/setronics/back/assets/images/default_avatar.gif" alt="" width="20px" style="display: inline" > Bienvenido, <?php echo isset($current_user['username'])?$current_user['username']:""; ?> - <a href="<?php echo base_url()."login/logout" ?>">Salir</a></div>
              <?php }else{ ?>
          ...
          <nav>
              ...
              <ul class="nav-main">
                ...
                <li class="con-nav-sub" id="nav-bt-3">
                  <a href="<?php echo site_url('seguridad') ?>">SISTEMAS ELECTRÓNICOS DE SEGURIDAD</a>
                  <ul class="nav-sub">
                ...
                <li class="nav-sep"></li>
                <li id="nav-bt-4"><a href="<?php echo site_url('integracion') ?>">INTEGRACIÓN</a><span class="nav-arrow-t4"></span></li>
                <li class="nav-sep"></li>
                <li class="con-nav-sub" id="nav-bt-5">
                  <a href="<?php echo site_url('tecnico') ?>">SERVICIO TÉCNICO</a>
                  <ul class="nav-sub">
                    <div class="sub-nav-arrow-3"></div>
                    <li><a href="certificados">Certificaciones</a></li>
                    <li><a href="propuestas">Propuestas de valor</a></li>
                    <li><a href="servicios">Servicios</a></li>
                  </ul>
                </li>
                <li class="nav-sep"></li>
                <li class="nav-last" id="nav-bt-6"><a href="<?php echo site_url('gestion') ?>">GESTIÓN DE FLOTA</a><span class="nav-arrow-t6"></span></li>
              </ul>
            </div>
          </nav>
        </div>
