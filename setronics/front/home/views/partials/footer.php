    ...
    <div class="con-modals">
        ...
        <form class="modal-form" action="<?php echo base_url().'home/add' ?>" method="post">
          <fieldset>
      ...
      <div id="modal-login">
        ...
        <form class="modal-form" action="<?php echo base_url()."login/ingreso"; ?>" method="post">
        	<fieldset>
                    <div class="input-modal"><input name="email" type="text" placeholder="Email..." class="validate[required]"></div>
          </fieldset>
          <fieldset>
          	<div class="input-modal"><input name="password" type="password" placeholder="Contraseña..." class="validate[required]"></div>
          </fieldset>
      ...
      <div id="modal-rec">
        ...
        <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested.</p>
        <form class="modal-form" action="<?php base_url()."login/recovery_password"; ?>" method="get">
        	<fieldset>
          	<div class="input-modal"><input type="text" name="email_recovery" placeholder="Correo electrónico..." class="validate[required, custom[email]]"></div>
          </fieldset>
          <input type="submit" class="submit-bt" value="Enviar">
        </form>
      </div>
