 ...
 * @author Jose Fonseca
 */
class certificados extends Front_Controller {
    ...
    public function index() {
        $obj = new certificado(); 
        $this->_data['certificaciones'] = $obj->join_related('categoria')->join_related('imagen')->get(); 
        return $this->build('certificaciones.php');
    }
