      ...
      <div class="mg-section cfx">
        <div class="con-miga">
          <ul class="miga-site">
            ...
            <li><a href="integracion-info.php">Caso</a></li>
          </ul>
        </div>
        <div class="con-logo-section">
          <img src="assets/img/logo-t5.png" height="74" width="204" alt="">
        </div>
        ...
        <div class="integra-col integra-col-c1">
          <div class="con-integra-img">
            <img src="assets/img/integracion-img-b.jpg" height="200" width="280" alt="">
          </div>
