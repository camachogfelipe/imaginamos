    ...
    <header>
      <div class="con-header">
        ...
        <div class="mg-header cfx">
            ...
            <div class="header-logo"><a href="index.php"><img src="assets/img/header-logo.png" width="204" height="92" alt=""></a></div>
            <div class="con-info-header-nav">
              ...
              <a href="https://twitter.com/" target="_blank"><div class="header-red"><span><img src="assets/img/header-red-tw.png"></span></div></a>
              <a href="https://es-la.facebook.com/" target="_blank"><div class="header-red"><span><img src="assets/img/header-red-fb.png"></span></div></a>
            </div>
          </div>
          <nav>
          	<div class="con-nav">
              <ul class="nav-main">
              	<li class="nav-first" id="nav-bt-1"><a href="empresa.php">NOSOTROS</a><span class="nav-arrow-t1"></span></li>
                <li class="nav-sep"></li>
