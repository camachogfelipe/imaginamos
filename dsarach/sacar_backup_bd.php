 ...
 */
define("DB_USER", 'usuarioabe'); /* Nombre de usuario de la base de datos */
define("DB_PASSWORD", 'O_Tx_aa-/fsh'); /* Clave de acceso del usuario de la base de datos */
define("DB_NAME", 'usuarioabe_dsarach'); /* Nombre de la base de datos a sacar backup */
