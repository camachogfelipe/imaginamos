<div class="widget">
    <div class="header"><span><span class="ico gray window"></span><?php echo $nombremodulo ?></span>
        <br /><?php echo anchor('cms/empresa/imagenes', 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>                 
    </div><!-- End header -->
    <div class="content">
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php echo form_open_multipart('cms/empresa/new_recordImg/', 'id="form"') ?>
                    <div>
                        <div><p><label>Imagen</label><p/>
                            ...
                            <p> Las im&aacute;genes se redimensionar&aacute;n a 248 X 223</p>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        /*$("#fileUpload1").uploadify({
            ...
            'script': '<?php echo base_url()?>cms/empresa/uploadImg/',
            'folder': '',
            'multi': false,
            'auto': false,
            'buttonText': 'Imagen.',
