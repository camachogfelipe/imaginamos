        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php 
                    if ($count < 6){
                        echo anchor("cms/beneficios/add/", "Nuevo", 'class="uibutton icon add" style="top: 100%"') ;
                    }
                    ?>
                    </div>
                    <p>&nbsp;</p>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" > 
                                    ...
                                    <td width="25%" class="center">
                                        <?php echo anchor("cms/beneficios/edit/".$d->id, "Editar", "class='uibutton'"); ?> 
                                        <?php 
                                        if ($count>1){
                                        echo anchor("cms/beneficios/delete/".$d->id, "Eliminar", "class='uibutton  special'"); 
                                        }?>
                                    </td> 
                                </tr>
                                <?php 
