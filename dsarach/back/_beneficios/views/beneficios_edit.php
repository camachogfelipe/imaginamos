        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php echo form_open_multipart('cms/beneficios/update_record/', 'id="form"') ?>
                    <div>
                        <p><label>T&iacute;tulo </label></p>
                        <div><input style="width:250px" type="text"  id="titulo" name="titulo" class="small" value="<?php echo $info->titulo?>" maxlength="48" title="48 caracteres máximo" /> </div>
                    </div>
                    <div>
                        <p><label>Texto </label></p>
                        <div><textarea style="width:350px;height:130px;" type="text"  id="texto" name="descripcion" maxlength="100" title="110 caracteres máximo"   /><?php echo $info->descripcion?></textarea></div>
                    </div>
                    <div>
