        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php echo form_open_multipart('cms/comolohacemos/update_imagenes/', 'id="form"') ?>
                    <div>
                    ...
                    <div>
                        ...
                        <div><textarea style="width:350px;height:130px;" type="text"  id="texto" name="descripcion" maxlength="137" title="137 caracteres máximo"   /><?php echo $info->descripcion?></textarea></div>
                    </div>
