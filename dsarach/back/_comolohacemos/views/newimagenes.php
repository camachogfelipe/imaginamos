<div class="widget">
    <div class="header"><span><span class="ico gray window"></span><?php echo $nombremodulo ?></span>
        <br /><?php echo anchor('cms/comolohacemos/imagenes/'.$comolohacemos_id, 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>                 
    </div><!-- End header -->
    <div class="content">
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php echo form_open_multipart('cms/comolohacemos/new_imagenes/', 'id="form"') ?>
                    <div>
                        <div><p><label>Imagen</label><p/>
                          <div>
                          <input type="file" name="nombre" id="fileUpload1" />    
                          <input type="hidden" name="imagen" id="imagen" />
                          <input type="hidden" name="comolohacemos_id" id="comolohacemos_id" value="<?= $comolohacemos_id ?>" />
                          </div>
                          <p>Las im&aacute;genes se redimensionar&aacute;n a 500 X 306</p>
                        </div>
                    </div>
                    <div>
                        <p><label>Texto </label></p>
                        <div><textarea style="width:350px;height:130px;" type="text"  id="texto" name="descripcion" maxlength="137" title="137 caracteres máximo"   /></textarea></div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        /*$("#fileUpload1").uploadify({
            ...
            'script': '<?php echo base_url()?>cms/comolohacemos/upload/',
            'folder': '',
            'multi': false,
            'auto': false,
            'buttonText': 'Imagen.',
