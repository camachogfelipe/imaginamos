        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php echo form_open_multipart('cms/quehacemos/new_bulletsuno/', 'id="form"') ?>
                    <div>
                        <p><label>T&iacute;tulo </label></p>
                        <div>
                            <input style="width:250px" type="text"  id="titulo" name="titulo" class="small" value="" maxlength="92" title="92  caracteres máximo" /> 
