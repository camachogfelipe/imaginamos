        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php echo form_open_multipart('cms/quehacemos/update_titulobulletsuno/', 'id="form"') ?>
                    <div>
        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php 
                    if ($count < 6){
                        echo anchor("cms/quehacemos/addbulletsuno/".$quehacemos_id, "Nuevo", 'class="uibutton icon add" style="top: 100%"') ;
                    }
                    ?>
                    </div>
                    <p>&nbsp;</p>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" > 
                                    ...
                                    <td width="25%" class="center">
                                        <?php echo anchor("cms/quehacemos/editbulletsuno/".$d->id."/".$quehacemos_id , "Editar", "class='uibutton'"); ?> 
                                        <?php 
                                        if ($count>1){
                                        echo anchor("cms/quehacemos/deletebulletsuno/".$d->id."/".$quehacemos_id, "Eliminar", "class='uibutton  special'"); 
                                        }?>
                                    </td> 
                                </tr>
                                <?php 
