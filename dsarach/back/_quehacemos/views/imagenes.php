        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php 
                    if ($count < 5){
                        echo anchor("cms/quehacemos/addimagenes/".$quehacemos_id, "Nuevo", 'class="uibutton icon add" style="top: 100%"') ;
                    }
                    ?>
                    </div>
                    <p>&nbsp;</p>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" > 
                                    ...
                                    <td width="25%" class="center">
                                        <?php echo anchor("cms/quehacemos/editimagenes/".$d->id."/".$quehacemos_id, "Editar", "class='uibutton'"); ?> 
                                        <?php 
                                        if ($count>1){
                                        echo anchor("cms/quehacemos/deleteimagenes/".$d->id."/".$quehacemos_id, "Eliminar", "class='uibutton  special'"); 
                                        }?>
                                    </td> 
                                </tr>
                                <?php 
