 ...
 * @author Jose Fonseca
 */
class Aplica extends Front_Controller {
    ...
    public function index() {
        ...
        foreach ($info as $i) {
            $arra[$s]["id"] = $i->id;
            $arra[$s]["imagen"] = $i->imagen;
            $arra[$s]["titulo"] = $i->titulo;
            $arra[$s]["descripcion"] = $i->descripcion;
            $arra[$s]["archivo"] = $i->archivo;
            $s++;
        }
        $this->_data["arra"] = $arra;
