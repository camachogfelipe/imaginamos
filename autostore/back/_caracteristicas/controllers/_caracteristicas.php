...
class _caracteristicas extends Back_Controller {
    ...
    public $title = 'Caracteristicas de Producto';
    ...
    public function menu() {
        return $this->current_menu['Productos & Categorias']['Productos']['Caracteristicas de Producto'] = cms_url('caracteristicas');
    }
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->input($obj->tipo, "tipo", $obj->get_rule("tipo", "max_length"), "Tipo Caracteristica", "Maximo " . $obj->get_rule("tipo", "max_length") . " caracteres", $obj->is_rule("tipo", "required"), "span3");
        $data['form_content'] .= $this->input($obj->valor, "valor", $obj->get_rule("valor", "max_length"), "Valor Caracteristica", "Maximo " . $obj->get_rule("valor", "max_length") . " caracteres", $obj->is_rule("valor", "required"), "span3");
        $var_producto_id = new caracteristica();
        $data['form_content'] .= $this->combox($obj->producto_id, $var_producto_id->get_producto_list('nombre'), "producto_id", "Producto", "Seleccione un producto", $obj->is_rule("producto_id", "required"), "span3");
