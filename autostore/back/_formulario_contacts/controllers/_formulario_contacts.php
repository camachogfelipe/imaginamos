 ...
 * @date 2-050050
 */
class _formulario_contacts extends Back_Controller {

    protected $admin_area = true;
    public $model = 'formulario_contact';
    public $name = 'formulario_contacts';
    ...
    public function menu() {
        return $this->current_menu['Home']['Contacto']['Formulario de Contacto'] = cms_url('formulario_contacts');
    }
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen", "320px × 294px", false, $obj->is_rule("imagen_id", "required"), "span3");
        $data['form_content'] .= $this->text($obj->texto, "texto", "Descripción", "Maximo " . $obj->get_rule("texto", "max_length") . " caracteres", $obj->is_rule("texto", "required"), "span7", true, false, $obj->get_rule("texto", "max_length"), 3, 4);
