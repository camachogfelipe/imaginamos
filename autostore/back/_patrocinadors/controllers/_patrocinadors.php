 ...
 * @date 2-050050
 */
class _patrocinadors extends Back_Controller {

    protected $admin_area = true;
    public $model = 'patrocinador';
    public $name = 'patrocinadors';
    public $title = 'Aliados';
    ...
    public function menu() {
        return $this->current_menu['Home']['Aliados'] = cms_url('patrocinadors');
    }
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen Logo", "220px × 121px", false, $obj->is_rule("imagen_id", "required"), "span3");
        $data['form_content'] .= $this->input($obj->titulo, "titulo", $obj->get_rule("titulo", "max_length"), "Aliado", "Maximo " . $obj->get_rule("titulo", "max_length") . " caracteres", $obj->is_rule("titulo", "required"), "span3");
