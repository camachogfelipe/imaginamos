...
class _venta_productos extends Back_Controller {
    ...
    public $title = 'Productos Vendidos';
    ...
    public function menu() {
        return $this->current_menu['Categorias & Productos']['Registro de Ventas'] = cms_url('venta_productos');
    }
    ...
    public function form_edit() {
        $obj = new producto();
        $id = $this->_post('id');
        $data['datos'] = $obj->join_related('venta')->get_by_related_venta('id', $id);
    ...
    public function get_chart() {
        ...
        $datos = $obj->join_related('registro_compra')->get();
        $envios = array(); 
        foreach ($datos as $data) {
             $date = new DateTime($data->registro_compra_fecha);
    ...
    public function lista() {
        $obj = new $this->model();
        $data['datos'] = $obj->join_related('registro_compra')->get();
