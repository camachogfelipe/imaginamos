...
class _imagen_productos extends Back_Controller {
    ...
    public function menu() {
        return $this->current_menu['Productos & Categorias']['Productos']['Galeria de Productos'] = cms_url('imagen_productos');
    }
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->imagen($obj->imagen_id, $obj->imagen_path, "Imagen de Producto", "460px × 368px", false, $obj->is_rule("imagen_id", "required"), "span3");
        $var_producto_id = new imagen_producto();
        $data['form_content'] .= $this->combox($obj->producto_id, $var_producto_id->get_producto_list('nombre'), "producto_id", "Producto", "Seleccionar un producto", $obj->is_rule("producto_id", "required"), "span3");
    ...
    public function lista() {
        $obj = new $this->model();
        $data['datos'] = $obj->join_related('producto')->join_related('imagen')->get();
