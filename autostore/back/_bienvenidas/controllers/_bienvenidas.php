...
class _bienvenidas extends Back_Controller {
	protected $admin_area = true;
	public $model = 'bienvenida';
	public $name = 'bienvenidas';
	public $title = 'Bienvenida';
	...
	public function menu() {
		return $this->current_menu['Home']['Bienvenida'] = cms_url('bienvenidas');
	}
	...
	public function form_edit() {
		...
		$data['form_content'] .= $this->inputHidden($obj->id, "id", $obj->get_rule("id","max_length"));
                $data['form_content'] .= $this->text($obj->texto, "texto", "Parrfo de Bienvenida", "Maximo ".$obj->get_rule("texto","max_length")." caracteres", $obj->is_rule("texto","required"), "span10", true, false, $obj->get_rule("texto","max_length"),3,4);
