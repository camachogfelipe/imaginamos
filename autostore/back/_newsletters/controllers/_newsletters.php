 ...
 * @date 2-050050
 */
class _newsletters extends Back_Controller {
    ...
    public function menu() {
        return $this->current_menu['Suscripciones'] = cms_url('newsletters');
    }
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->input($obj->interes, "interes", $obj->get_rule("interes", "max_length"), "Interes General", "Maximo " . $obj->get_rule("interes", "max_length") . " caracteres", $obj->is_rule("interes", "required"), "span3");
