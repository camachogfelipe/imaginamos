...
class _categorias extends Back_Controller {
    ...
    public function menu() {
        return $this->current_menu['Productos & Categorias']['Categorias'] = cms_url('categorias');
    }
    ...
    public function form_edit() {
        ...
        $data['form_content'] .= $this->input($obj->titulo, "titulo", $obj->get_rule("titulo", "max_length"), "Nombre", "Maximo " . $obj->get_rule("titulo", "max_length") . " caracteres", $obj->is_rule("titulo", "required"), "span3");
    ...
    public function lista() {
        $obj = new $this->model();
        $data['datos'] = $obj->where(array('categoria_id'=>NULL))->get(); /*  $obj->join_related('imagen')->get(); */
