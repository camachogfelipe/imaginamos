$(window).load(function() {
                        ...
                        "success: function(js) {"+
                            ...
                            "return  false; });<\/script>"; 
                                ...
                                if($('.n'+js.id).length){
                                      ...
                                      $('#rows_data .n'+js.id).find('.price').html('$'+js.price);
                                }else{ 
    ...
    $("ul.pagination").quickPagination({pagerLocation:"both",pageSize:"12"});
