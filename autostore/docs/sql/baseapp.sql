...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-09-2013 a las 18:17:02
...
--
-- Estructura de tabla para la tabla `cms_oauth_providers`
--

CREATE TABLE IF NOT EXISTS `cms_oauth_providers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `cms_oauth_providers`
--

INSERT INTO `cms_oauth_providers` (`id`, `name`, `provider`, `strategy`, `api_key`, `api_secret`, `active`, `active_oauth`) VALUES
(1, 'Facebook', 'facebook', 'oauth2', '', '', 0, 1),
(2, 'Twitter', 'twitter', 'oauth1', '', '', 0, 1),
(3, 'Google', 'google', 'oauth2', '', '', 0, 1),
(4, 'GitHub', 'github', 'oauth2', '', '', 0, 1);
...
INSERT INTO `cms_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `address`) VALUES
(5, '7f000001', 'administrator', '092e624ccaf41c1b9c0dd32a1041043a82507bc7', 'e0efe63787', 'cms@imaginamos.com', NULL, NULL, NULL, '1218e83c71363e71c292b071dace76d3f56b47af', 1343253917, 2013, 1, 'Administrador', NULL, NULL, NULL, NULL);
