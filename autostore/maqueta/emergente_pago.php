        ...
        <form>
          ...
          <fieldset>
              <div class="span6">
                ...
                <a class="bt_anadir bt_formapago" href="#">Pagar en efectivo</a>
                <a class="bt_anadir bt_formapago" href="#">Pagar con datafóno</a>
              </div>
              <div class="span6">
                <p class="tit_form">Pago en línea</p>
                <a class="bt_anadir bt_formapago" href="#">Pago en línea</a>
              </div>
          </fieldset>
        </form>
      </div>
