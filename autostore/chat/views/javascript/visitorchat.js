var DocumentRoot = SITE_BASE+'/chat/';
...
$(document).ready(function(){
	...
	$("#user_register").click(function(event){
            ...
            if(re_name.length == 0) {
                    $("#re_name").effect("highlight", {"color":"#ffc8c8"}, 2000); 
            }

            if( !isValidEmailAddress( re_email ) ) {$("#re_email").effect("highlight", {"color":"#ffc8c8"}, 2000);}
    ...
    $("#send_email_btn").click(function(){
    	...
    	if(sm_name.length == 0) $("#sm_name").effect("highlight", {"color":"#ffc8c8"}, 2000);
    	if( !isValidEmailAddress( sm_email ) ) {$("#sm_email").effect("highlight", {"color":"#ffc8c8"}, 2000);}
    	if(sm_msg.length == 0) $("#sm_msg").effect("highlight", {"color":"#ffc8c8"}, 2000);
