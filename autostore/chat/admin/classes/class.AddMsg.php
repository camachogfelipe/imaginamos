...
class AddMsg
{
    ...
    public function InsertMessage()
    {
            ...
            $sth = DB::prep("INSERT INTO cms_messaging (msg,user,to_user,type) VALUES(:msg,:from,:user,'admin')");
	...
	*/
    ...
    function GetNick($user, $admin) {
		...
		$sth = DB::prep("SELECT nick, email, sess, (SELECT username FROM cms_messaging_admin WHERE id = :this_admin) as admin FROM cms_messaging_users WHERE user_id = :id");
