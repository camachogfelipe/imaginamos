...
<body>
  ...
  <div class="info-general">
  	<div class="con-info-general">
        ...
        <div class="con-info-d1">
        	<div class="img-d1">
                    <img src="<?php echo Link::Build() ?>/img/productos/<?php echo str_replace('original','redimension',$details[0]['imagen2']); ?>" width="410" height="292" alt="">
            <div class="img-d1-bg"><img src="<?php echo Link::Build() ?>/imagenes/info-sol-d1-bg.png" width="515" height="445" alt=""></div>
          </div>
          <div class="tx-d1">
          	<div class="scroll-sol">
            	<h1><?php echo $details[0]['nombre']; ?></h1>
              <h2>Ref: <?php echo $details[0]['referencia']; ?></h2>
              <p><?php echo nl2br($details[0]['texto_descripcion']); ?></p>
            </div>
          </div>
        </div>
        <div class="con-info-d2">
        	<div class="img-d2">
            <img src="<?php echo Link::Build() ?>/img/productos/<?php echo str_replace('original','redimension',$details[0]['imagen3']); ?>" width="288" height="362" alt="">
            <div class="img-d2-bg"><img src="<?php echo Link::Build() ?>/imagenes/info-sol-d2-bg.png" width="460" height="452" alt=""></div>
          ...
          <div class="tx-d2">
              ...
              <ul>
                  ...
                  for($i=0; $i<$contadorEsp; $i++):
                      ?><li><p><strong><?php echo $especificaciones[$i]['titulo']; ?>:</strong> <?php echo $especificaciones[$i]['texto_contenido']; ?></p></li><?php
                  endfor;
                  ?>
              </ul>
            	<p><?php echo nl2br($details[0]['texto_descripcion2']); ?></p>
            </div>
          </div>
        </div>
      </div>
  ...
  <script type="text/javascript" src="<?php echo Link::Build() ?>/js/jInfo.js"></script>
