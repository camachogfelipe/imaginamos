        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php $url = 'cms/servicios_linea/editarServicios_linea/'.$servicios_linea->id?>
                    <?php echo form_open_multipart($url); ?>
                    
                    <div class="section">
                        <label> Texto <small>Ingrese texto.</small></label>   
                        <div><textarea class="full" name="texto" ><?php echo set_value('texto', $servicios_linea->texto) ?></textarea></div>
                    </div>
