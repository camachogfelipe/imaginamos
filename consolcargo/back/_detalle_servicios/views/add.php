<div class="widget">
    <div class="header"><span><span class="ico gray window"></span>Adicionar detalle servicios</span>
        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php $url = 'cms/detalle_servicios/guardarDetalle_servicios/'.$idServicio?>
                    <?php echo form_open_multipart($url); ?>
                    
                    <div class="section">
                        <label> T&iacute;tulo <small>Ingrese t&iacute;tulo</small></label>   
                        <div><input type="text" name="titulo" class="full" value="<?php echo set_value('titulo') ?>"></div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div><textarea name="texto_contactenos" class="full"><?php echo set_value('texto_contactenos') ?></textarea></div>
                    </div>
