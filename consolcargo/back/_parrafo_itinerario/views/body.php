                    ...
                    <div class="tableName toolbar">
                        <table class="display data_table2" >
                            <thead>
                                <tr>
                                    <th>TEXTO</th>
                                    <th>Archivo de Itinerarios Impo</th>
                                    <th>Archivo de Itinerarios Expo</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if ($parrafo_itinerario != false): ?>
                                    <?php foreach ($parrafo_itinerario as $dato): ?>
                                        <tr class="odd gradeX parent-delete">
                                            ...
                                            <td style="text-align:justify;"><a href="<?php echo !empty($dato->archivo)?base_url().$dato->archivo:"#" ?>" >Archivo Itinerarios Impo</a> </td>
                                            <td style="text-align:justify;"><a href="<?php echo !empty($dato->archivo1)?base_url().$dato->archivo1:"#" ?>" >Archivo Itinerarios Expo</a> </td>
                                            <td>
