        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <div class="section">
                        <label> Archivo Impo<small>Seleccione el archivo de itinerarios tipo Impo, formato excel 97-2007 (.xls)</small></label>   
                        <div><input type="file" name="archivo" <?php echo set_value('archivo', $parrafo_itinerario->archivo) ?> class="full" /></div>
                    </div>
                    <br>
                    <div class="section">
                        <label> Archivo Expo<small>Seleccione el archivo de itinerarios tipo Expo, formato excel 97-2007 (.xls)</small></label>   
