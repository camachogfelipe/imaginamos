<div class="widget">
    <div class="header"><span><span class="ico gray window"></span>Editar cont&aacute;ctenos</span>
        ...
        <div class="formEl_b">
            <div>
                <fieldset>
                    ...
                    <?php $url = 'cms/contactar/editarContactar/'.$contactar->id?>
                    <?php echo form_open_multipart($url); ?>
                    
                    <div class="section">
                        <label> Texto <small>Ingrese texto.</small></label>   
                        <div><textarea name="texto" class="full"><?php echo set_value('texto', $contactar->texto) ?></textarea></div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div><img  width="50%" src="<?php echo base_url('uploads/front/contactenos/'.$contactar->imagen) ?>" /></div>
                    </div>
