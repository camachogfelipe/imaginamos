...
if(!isset($_REQUEST['ad'])){
   if(getModeratorOnline() === 0) {
    echo "<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01 Transitional//EN' 'http://www.w3.org/TR/html4/loose.dtd'>
          <html> 
          <head> 
          <link type='text/css' rel='stylesheet' href='templates/".$CONFIG['template']."/style.css'>
          <title>-- Chat ConsolCargo --</title>
          </head>
          <body id='body' class='body' style='text-align: center; margin-top:180px;'>
          <H1>En estos momentos estamos fuera de servicios.<br />Favor diríjase al formulario de contacto del sitio web, si desea contactarnos.</h1>
          <h3>Nuestro horario de atención es de 8 a.m. a 12:30 a.m. y 1:30 p.m. a 5:30 p.m. </h3>
          </body></html>";
         session_destroy();
	  exit(); 
   } 
