...
$db['default']['username'] = 'consol_imagina';
$db['default']['password'] = 'Imaginamos.2013';
$db['default']['database'] = 'consol_imaginamos';
...
$db['testing']['username'] = 'consol_imagina';
$db['testing']['password'] = 'Imaginamos.2013';
$db['testing']['database'] = 'consol_imaginamos';
$db['testing']['dbdriver'] = 'mysql';
$db['testing']['dbprefix'] = 'cms_';
