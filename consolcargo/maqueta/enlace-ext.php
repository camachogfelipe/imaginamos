<!DOCTYPE html>
  ...
  <!--[if (gte IE 9)|!(IE)]><!--> <html lang="es" class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div id="header-bar">
   		<div class="close-header"><a id="close-button" title="Cerrar marco | volver a consolcargo.com" class="close" href="../Consolcargo/">X</a></div>
     	<p class="meta-data"><a class="close" href="../Consolcargo/">Remover Marco</a> | Consolcargo S.A. no se hace responsable por el contenido de los sitios aquí visualizados </p>
   	...
   	<iframe id="preview-frame" src="http://www.marinetraffic.com/" name="preview-frame" frameborder="0" noresize="noresize"></iframe>  
