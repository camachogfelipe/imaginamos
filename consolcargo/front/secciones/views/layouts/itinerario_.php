    ...
    <div class="con-map">
        <div class="map-form cfx">
            <div class="map-form-col ovt">
                <div class="tool-p1 tool" >
                    <strong>1.</strong> Seleccione el lugar de <strong>ORIGEN</strong>, lo más especifico posible, ya que puede existir más de un resultado para su búsqueda...
                    <br>
                    <br>
            ...
            <div class="map-form-col ovt">
                <div class="tool-p2 tool">
                    <strong>2.</strong> Seleccione el lugar de <strong>DESTINO</strong>, no olvide que debe ser lo más especifico posible...
                    <br>
                    <br>
                    Ej: Manhattan, New york, USA...
                    <div class="tool-arrow"></div>
                </div>
                <form onsubmit="return false" class="form-clr">
                    <div class="con-ing-form">
        ...
        showAddress('1');">
                    ...
                    <div class="tool-p3 tool">
                        <strong>3.</strong> <strong>Clic</strong>, para seleccionar el punto de origen y destino...
                        <div class="tool-arrow"></div>
                    </div>
                </a>
                <a id="mostrar" class="an-din bt-form-2 bt-info-tabla ovt" href="#tabla-info">
                  <div class="map-bt"><!--<span class="icon-tb"></span>--><p>Itinerario</p></div>
                    <div class="tool-p4 tool">
                        <strong>4.</strong> <strong>Clic</strong>, para ver la información relacionada al itinerario...
                        <div class="tool-arrow"></div>
                    </div>
                </a>
            </div>
