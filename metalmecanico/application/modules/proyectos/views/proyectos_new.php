  ...
  <body class="dashborad">
    ...
    <div id="content">
      <div class="inner">
        ...
        <!-- full width -->
        <div class="widget">
          <div class="header"><span><span class="ico gray window"></span>CMS Metalmecanico / Proyectos / Nuevo</span>
            <br /><?php echo anchor('proyectos/', 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>
          </div><!-- End header -->
          <div class="content">
            ...
            <div class="formEl_b">
              ...
              <div>
                ...
                <div>
                  ...
                  <?php echo form_open_multipart('proyectos/new_record/' . $this->uri->segment(3) . '/' . $this->uri->segment(4)) ?>
                  <fieldset>
                    <div>
                    ...
                    <div>
                      ...
                      <div><textarea name="texto" id="texto" cols="62" rows="8" class="small" maxlength="900" title="900 caracteres máximo" ><?php echo set_value('texto'); ?></textarea></div>
                    </div>
