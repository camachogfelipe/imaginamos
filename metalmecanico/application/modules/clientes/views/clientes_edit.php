        ...
        <body class="dashborad">
            ...
            <div id="content">
                <div class="inner">
                    ...
                    <!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>CMS Metalmecanico / Clientes / Editar</span>
                            <br /><?php echo anchor('clientes/index/', 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>
                        </div><!-- End header -->
                        <div class="content">
                            ...
                            <div class="formEl_b">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <?php echo form_open_multipart('clientes/update/' . $record[0]->id) ?>
                                        <fieldset>

                                            <div>
                                                <p><label>Imagen</label></p>
                                                <a href="<?php echo base_url('application/modules/clientes/assets/images/'.$record[0]->imagen) ?>" target="_blank"><img src="<?php echo base_url('application/modules/clientes/assets/images/'.$record[0]->imagen) ?>" alt="imaginamos.com" width="500"></a><br/>
