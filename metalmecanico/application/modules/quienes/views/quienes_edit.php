  ...
  <body class="dashborad">
    ...
    <div id="content">
      <div class="inner">
        ...
        <!-- full width -->
        <div class="widget">
          <div class="header"><span><span class="ico gray window"></span>CMS Metalmecanico / Quienes Somos (<?php echo $record[0]->nombre; ?>) / Editar</span>
            <br /><?php echo anchor('quienes/index/', 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>
          </div><!-- End header -->
          <div class="content">
            ...
            <div class="formEl_b">
              ...
              <div>
                ...
                <div>
                  ...
                  <?php echo form_open_multipart('quienes/update/' . $record[0]->id) ?>
                  <fieldset>

                    <div>
                      <p><label>Descripcion<strong style="color: red">*</strong></label></p>
                      <div><textarea name="texto" id="texto" class="small"><?php echo $record[0]->texto; ?></textarea></div>
                    </div>
                    ...
                    <div>
                      ...
                      <div><textarea name="texto_d" id="texto_d" class="small"><?php echo $record[0]->texto_detallado; ?></textarea></div>
                    </div>
                    ...
                    <div>
                      ...
                      <a href="<?php echo base_url('application/modules/quienes/assets/images/' . $record[0]->imagen) ?>" target="_blank"><img src="<?php echo base_url('application/modules/quienes/assets/images/' . $record[0]->imagen) ?>" alt="imaginamos.com" width="500"></a><br/>
