    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>CMS Metalmecanico / Quienes Somos </span>
                    </div><!-- End header -->
                    <div class="content">
                                                ...
                                                if ($records != ''):
                                                    foreach ($records as $item):
                                                        ...
                                                        <tr class="odd gradeX" >
                                                            ...
                                                            <td class="center" style="width: 20%"><a href="<?php echo base_url('application/modules/quienes/assets/images/' . $item->imagen) ?>" target="_blank"><img src="<?php echo base_url('application/modules/quienes/assets/images/' . $item->imagen) ?>" width="120" alt="imaginamos.com"></a></td>
                                                        
                                                            <td class="center" style="width: 20%">
                                                                <?php echo anchor("quienes/edit/" . $item->id, "Editar", 'class="uibutton"') ?>                                                                
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    endforeach;
