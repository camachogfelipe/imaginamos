                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div>
                                            <p><label>Nombre del men&uacute; [Ingles] </label></p>
                                            <div><input type="text" name="title_eng" class="small" value="<?php echo $record[0]->menu_title_eng ?>" maxlength="30" title="30 caracteres maxímo" /></div>
                                        ...
                                        <div>
                                            ...
                                            <div><input type="text" name="url_eng" class="small" value="<?php echo $record[0]->menu_url_eng ?>" maxlength="50" title="50 caracteres maxímo" /></div>
                                            <small>En caso de tener submenus dejar vacio</small>
