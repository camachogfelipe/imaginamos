                                ...
                                <div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div>
                                            ...
                                            <div><input type="text" name="title_eng" class="small" value="<?php echo set_value('title_eng'); ?>" maxlength="30" title="30 caracteres maxímo" /></div>
                                        ...
                                        <div>
                                            ...
                                            <div><input type="text" name="url_eng" class="small" value="<?php echo set_value('url_eng'); ?>" maxlength="50" title="50 caracteres maxímo" /></div>
