                                            ...
                                            <tbody>
                                                ...
                                                if ($records != ''):
                                                    foreach ($records as $item):
                                                        ?>
                                                        <tr class="odd gradeX" >
                                                            <td class="center" style="width: 20%"><?php echo $item->submenu_title ?></td>
                                                            <td class="center" style="width: 20%"><?php echo $item->submenu_title_eng ?></td>
                                                            <td class="center" style="width: 20%"><?php echo $item->submenu_url ?></td>
                                                            <td class="center" style="width: 20%"><?php echo $item->submenu_url_eng ?></td>
