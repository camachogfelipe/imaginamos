  ...
  <body class="dashborad">
    ...
    <div id="content">
      <div class="inner">
        ...
        <!-- full width -->
        <div class="widget">
          <div class="header"><span><span class="ico gray window"></span>CMS Metalmecanico / Alcance / Nuevo</span>
            <br /><?php echo anchor('alcance/', 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>
          </div><!-- End header -->
          <div class="content">
            ...
            <div class="formEl_b">
              ...
              <div>
                ...
                <div>
                  ...
                  <?php echo form_open_multipart('alcance/new_record/' . $this->uri->segment(3) . '/' . $this->uri->segment(4)) ?>
                  <fieldset>                                        
                    <div>
                    ...
                    <div>
                      ...
                      <div><textarea name="texto_corto" id="texto_corto" class="small" required><?php echo set_value('texto_corto'); ?></textarea></div>
                    ...
                    <div>
                      ...
                      <div><textarea name="texto_detallado" id="texto_detallado" class="small" ><?php echo set_value('texto_detallado'); ?></textarea></div>                      
                    </div>
                    ...
                    <div>
                      ...
                      <?php //echo form_upload('userfile', '', ' title="Imagenes permitidas jpg|jpeg|png|gif" class="fileupload2" style="position: absolute; height: 30px; width: 170px; margin-left: 5px; display: inline; cursor: pointer; opacity: 0; "') ?>
