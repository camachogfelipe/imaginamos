        ...
        <body class="dashborad">
            ...
            <div id="content">
                <div class="inner">
                    ...
                    <!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>CMS Metalmecanico / Slider / Editar</span>
                            <br /><?php echo anchor('slider/index/', 'Volver', 'class="uibutton icon special answer" style="float:right;position: relative;top: -5px"') ?>
                        </div><!-- End header -->
                        <div class="content">
                            ...
                            <div class="formEl_b">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <?php echo form_open_multipart('slider/update/' . $record[0]->id) ?>
                                        <fieldset>                                          
                                            <div>
                                                <p><label>Título<strong style="color: red">*</strong></label></p>
                                                <div><input type="text" name="titulo" class="small" value="<?php echo $record[0]->titulo; ?>" maxlength="500" title="500 caracteres máximo" required /></div>
                                            </div>

                                            <br>

                                            <div>
                                                <p><label>Subtítulo<strong style="color: red">*</strong></label></p>
                                                <div><input type="text" name="subtitulo" class="small" value="<?php echo $record[0]->subtitulo; ?>" maxlength="500" title="500 caracteres máximo" required /></div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <a href="<?php echo base_url('application/modules/slider/assets/images/'.$record[0]->imagen) ?>" target="_blank"><img src="<?php echo base_url('application/modules/slider/assets/images/'.$record[0]->imagen) ?>" alt="imaginamos.com" width="500"></a><br/>
