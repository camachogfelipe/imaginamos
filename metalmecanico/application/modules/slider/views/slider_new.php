  ...
  <body class="dashborad">
    ...
    <div id="content">
      <div class="inner">
        ...
        <!-- full width -->
        <div class="widget">
          <div class="header"><span><span class="ico gray window"></span>CMS Metalmecanico / Slider / Nuevo</span>
                ...
                <div>
                  ...
                  <fieldset>                                        
                    ...
                    <div>
                      ...
                      <div><input type="text" name="subtitulo" class="medium" value="<?php echo set_value('subtitulo'); ?>" maxlength="500" title="500 caracteres máximo" required /></div>
                    </div>
