    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>CMS Metalmecanico / Destacados </span>
                    </div><!-- End header -->
                    <div class="content">
                            ...
                            <div>
                                <fieldset>
                                    ...
                                    <div style="position: absolute;float: left;height: 60px;">
                                        <?php if($num < 3): ?>
                                        <?php echo anchor("destacados/add/", "Nuevo [+3]", 'class="uibutton icon add" style="top: 100%"') ?>
                                        <?php endif; ?>
                                    </div>
                                    <p>&nbsp;</p>
                                                    ...
                                                    foreach ($records as $item):
                                                        ...
                                                        <tr class="odd gradeX" >
                                                            ...
                                                            <td class="center" style="width: 20%">
                                                                <?php echo anchor("destacados/edit/" . $item->id, "Editar", 'class="uibutton"') ?>
                                                                <?php echo anchor("destacados/delete/" . $item->id, "Eliminar", 'class="uibutton special"') ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    endforeach;
