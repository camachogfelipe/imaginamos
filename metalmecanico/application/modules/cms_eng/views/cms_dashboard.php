                        ...
                        <div class="formEl_b">
                            ...
                            <div>
                                <fieldset>
                                    ...
                                    <form action="<?php echo base_url(); ?>cms_eng/chagePass" method="post">
                                        <label>Current key<strong style="color:red"> *</strong></label>
                                        <input type="text" class="medium" name="oldpass" />
                                        <br/><br/>

                                        <label>New key<strong style="color:red"> *</strong></label>
