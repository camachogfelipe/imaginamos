...
<head>
        ...
        <!--<link href="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/css/all.css" rel="stylesheet" type="text/css" />
        <link href="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/css/reset.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/css/tabs_style.css" type="text/css" media="screen">
            <link rel="Stylesheet" type="text/css" href="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/css/carousel.css" />
            <link href="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/css/jquery.selectbox.css" type="text/css" rel="stylesheet" />-->
        ...
        <meta name="Description" lang="es" content="Los usuarios en bioempak.com podrán encontrar noticias y últimas novedades de nuestra empresa, información oportuna y actualizada de toda nuestra línea de productos, podrán encontrar un medio abierto de información en donde podrá interactuar dejándonos sus comentarios y/o sugerencias, una página dinámica y moderna, que le permitirá tanto a los usuarios como a Bioempak estar en contacto con sus clientes. ¿Que esperan los usuarios? Los usuarios que hagan parte de Bioempak, esperan tener información a tiempo y respuesta oportuna a sus sugerencias y comentarios, esperan noticias actualizadas e información que sea útil en sus desarrollos, esperan estar informados de todos los cambios y proyectos que tenga Bioempak." />
            ...
            <!--<script type="text/javascript" src="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/js/jquery.selectbox-0.1.3.js"></script>
            <script type="text/javascript">document.documentElement.className += " js";</script>
            <script type="text/javascript" src="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/js/jquery.mousewheel.min.js"></script>
            <script type="text/javascript" src="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/js/jquery.carousel-1.1.js"></script>
            <script type="text/javascript" src="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/js/jquery.slider.js"></script>
            <script src="http://repositorio.imaginamos.com.co/FBZ/bioempak2/assets/js/jquery.tabs.js" type="text/javascript" charset="utf-8"></script>-->
                				...
                				fxspeed:null
										...
										<?php
											foreach($productos as $producto) :
												if($producto->clasificacion == "alimentos") :
													$products['alimentos'][] = $producto;
												endif;
											endforeach;
										?>
										<?php
											$i=2;
											foreach($products['alimentos'] as $producto) :
												foreach($imagenes as $imagen) :
													if($imagen->id_producto == $producto->id) :
										...
										$("#contentProducto1").children(".clearfix").children(".img_productos_right").children(".slider-produc").bxSlider({
											mode: 'horizontal',
											captions: true,
											auto: false,
											controls: true,
    	...
    	<?php require_once("header.php"); ?>
            ...
            <div class="content">
                <!--div class="tabs"-->
                		...
                		<div class="con-tabs">
                    	<a href="<?php echo base_url() ?>site/productos"><h2>Farmacéuticos y Cosméticos</h2></a>
                    	<h2>Alimentos</h2>
                    </div>
