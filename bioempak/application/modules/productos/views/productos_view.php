          ...
          <div>
            <fieldset>
              ...
              <div class="tableName toolbar">
              	<a class="uibutton" href="<?php echo base_url().'productos/nuevo'; ?>">Nuevo</a>
                <table class="display data_table2" >
                  <thead>
                    <tr>
                      <th><div class="th_wrapp">No</div></th>
                      <th><div class="th_wrapp">Título</div></th>
                      <th><div class="th_wrapp">Imagen principal</div></th>
                      <th><div class="th_wrapp">Accion</div></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $i=1; foreach($data['productos'] as $d): ?>
                    <tr class="odd gradeX">
                      <td class="center" width="30"><?php echo $i; $i++; ?></td>
                      <td class="center" width="30"><?php echo $d->titulo; ?></td>
                      <td class="center" width="70px">
                      	<?php
													$imagenp = NULL;
                        	foreach($data['imagenes'] as $imagen) :
														if($imagen->id_producto == $d->id) : $imagenp = $imagen->url; break; endif;
													endforeach;
													if(!empty($imagenp)) :
												?>
                      		<img src="<?php echo base_url()."assets/prod_img/".$imagenp; ?>" width="215" />
                        <?php endif; ?>
                      </td>
                      <td class="center" width="200px">
                      	<a class="uibutton" href="<?php echo base_url().'productos/view/'.$d->id; ?>">Editar</a>
                        <a id="eliminar" class="uibutton special" href="<?php echo base_url().'productos/delete/'.$d->id; ?>">Eliminar</a>
                        <br>
                        <a class="uibutton" href="<?php echo base_url().'productos/imagenes/'.$d->id; ?>">Imagenes</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
