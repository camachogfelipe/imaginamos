          ...
          <div>
            <fieldset>
              ...
              <div class="tableName toolbar">
                <a class="uibutton special" href="<?php echo base_url().'usuarios/excel'; ?>">Descarga archivo Excel</a>
                <table class="display data_table2" >
                  ...
                  <tbody>
                    <?php $i=1; foreach($data['usuarios'] as $d): ?>
                    <tr class="odd gradeX">
                      <td class="center" width="30"><?php echo $i; $i++; ?></td>
                      <td class="center" width="30"><?php echo $d->nombre; ?></td>
                      <td class="center" width="30"><?php echo $d->email; ?></td>
                      <td class="center" width="200px">
                        <a id="eliminarusuario" class="uibutton special" href="<?php echo base_url().'usuarios/delete/'.$d->id; ?>">Eliminar</a>
                        <br>
                        <a class="uibutton" href="<?php echo base_url().'usuarios/comentarios/'.$d->id; ?>">Comentarios</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
...
jQuery(document).ready(function(){
	jQuery("#eliminarusuario").click(function(){
		if(confirm("¿Seguro desea eliminar este usuario y sus comentarios?") == true) return true;
		else return false;
	});
});
</script>
