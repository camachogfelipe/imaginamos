          ...
          <div>
            <fieldset>
              ...
              <div class="tableName toolbar">
              	<a class="uibutton icon answer" href="<?php echo base_url().'usuarios'; ?>">Volver</a>
                <a class="uibutton special" href="<?php echo base_url().'usuarios/excelcomments/'.$data['usuario']; ?>">Archivo Excel</a>
                <table class="display data_table2" >
                  <thead>
                    <tr>
                      <th><div class="th_wrapp">No</div></th>
                      <th width="50%"><div class="th_wrapp">comentairo</div></th>
                  ...
                  <tbody>
                    <?php $i=1; foreach($data['comentarios'] as $comentario): ?>
                    <tr class="odd gradeX">
                      ...
                      <td class="center" width="70px"><?= $comentario->titulo ?></td>
                      <td class="center" width="200px">
                        <a class="uibutton special" id="eliminar" href="<?php echo base_url().'productos/delcomment/'.$comentario->id; ?>">Eliminar</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
