                        ...
                        <div class="formEl_b">
                            <div>
                                <fieldset>
                                    ...
                                    <form enctype="multipart/form-data" action="<?php echo base_url(); ?>customers/update" method="POST" onsubmit="return validate();" >
                                        <img src="<?php echo base_url().'assets/customers_img/'.$data->bigimage; ?>" width="150" />
                                        <br><br>
                                        <label>Imagen 1<strong> (210 x 170px) </strong></label>
                                        <input type="file" name="userfile" id="userfile1" class="fileupload" />
                                        <br><br>
                                        <img src="<?php echo base_url().'assets/customers_img/'.$data->smallimage; ?>" width="150" />
                                        <br><br>
                                        <label>Imagen 2<strong> (185 x 180px) </strong></label>
                                        <input type="file" name="userfile2" id="userfile2" class="fileupload" />
                                        <br><br>
                                        <input type="hidden" name="oldImage" value="<?php echo $data->bigimage; ?>" />
                                        <input type="hidden" name="oldImage2" value="<?php echo $data->smallimage; ?>" />
