                    ...
                    <div class="content">
                        ...
                        <div class="formEl_b">
                            <div>
                                <fieldset>
                                    <legend>Crear</legend>
                                    <form enctype="multipart/form-data" action="<?php echo base_url(); ?>tech/add" method="POST" onsubmit="return validate();" >
                                        ...
                                        <br><br>
                                        <input type="submit" class="uibutton" value="Crear" name="send" />
                                    </form>
                                </fieldset>
                            </div>
