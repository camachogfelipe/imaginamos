        ...
        <div class="formEl_b">
          <div>
            <fieldset>
              ...
              <a class="uibutton" href="<?php echo base_url().'tech/nuevo'; ?>">Nuevo</a>
                ...
                <table class="display data_table2" >
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="center" width="70px"><img src="<?php echo base_url()."assets/tech_img/".$d->image; ?>" width="215" /></td>
                      <td class="center" width="200px">
                      	<a class="uibutton" href="<?php echo base_url().'tech/view/'.$d->id; ?>">Editar</a><br>
                        <a class="uibutton special eliminar" href="<?php echo base_url().'tech/delete/'.$d->id; ?>">Eliminar</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
...
jQuery(document).ready(function(){
	...
	jQuery(".eliminar").click(function(){
		if(confirm("¿Seguro desea eliminar este árticulo?")) {
			return true;
		}
		else {
