 ...
 */
define("DB_USER", 'pagina_web'); /* Nombre de usuario de la base de datos */
define("DB_PASSWORD", '1PWa0a!.'); /* Clave de acceso del usuario de la base de datos */
define("DB_NAME", 'www'); /* Nombre de la base de datos a sacar backup */
