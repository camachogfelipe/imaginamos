...
if(isset($_POST["id"])){
  ...
  if( (int)$_POST["id"]>0 ){
    $update=$db->doQuery("UPDATE destacados SET  titulo='".$titulo_c."', texto='".$texto_c."' WHERE id=".(int)$_POST["id"], UPDATE_QUERY);
    ...
    $insert=$db->doQuery("INSERT INTO destacados ( titulo,texto) VALUES ( '".$titulo_c."','".$texto_c."');", INSERT_QUERY);
    ...
    $retorno = ClassFIle::UploadImagenFile("img", "../../../../img/destacados/", "original_" . $idinsertado, "redimension_" . $idinsertado, 220, 177);
    ...
    $retorno = ClassFIle::UploadImagenFile("img2", "../../../../img/destacados/", "original2_" . $idinsertado, "redimension2_" . $idinsertado, 220, 117);
    if ($retorno["Status"]=="Uploader"){
    $db->doQuery("UPDATE destacados SET imagen_2='".$retorno["NameFile"]."' WHERE id=".$idinsertado, UPDATE_QUERY);
        // echo "<script type='text/javascript'>setTimeout(function(){showSuccess('Inserci&oacute;n de Imagen Realizada',3000) }, 1500);</script>";
    }
...
//                CKEDITOR.replace( "texto" );
                ...
                <label>Imagen</label>
                        <div>
                        <?php if($id>0){
                        ?> <img src="../../../../img/destacados/<?= str_replace("original","redimension",$imagen); ?>?<?php echo substr(md5(uniqid(rand())), 0, 6); ?>" width="200"><?php
                        } ?>
                        <?php
                        if ($id>0){
                        ?>
                        ...
                        ?>
                          <br/><span style="color: blueviolet;">Tama&ntilde;o de la Imagen: <i>220 x 177</i></span>
                        </div>
                    </div>
                ...
                <label>Imagen 2</label>
                        <div>
                        <?php if($id>0){
                        ?> <img src="../../../../img/destacados/<?= str_replace("original","redimension",$imagen_2); ?>?<?php echo substr(md5(uniqid(rand())), 0, 6); ?>" width="200"><?php
                        } ?>
                        <?php
                        if ($id>0){
                        ?>
                        ...
                        ?>
                          <br/><span style="color: blueviolet;">Tama&ntilde;o de la Imagen 2: <i>220 x 177</i></span>
                        </div>
                    </div>
        ...
        <table class="display data_table2">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td class="center" width="70px"><img src="../../../../img/destacados/<?= str_replace("original","redimension",$data[$i]["imagen"])?>?<?php echo substr(md5(uniqid(rand())), 0, 6); ?>" width="100" ></td>
              <td class="center" width="70px"><img src="../../../../img/destacados/<?= str_replace("original","redimension",$data[$i]["imagen_2"])?>?<?php echo substr(md5(uniqid(rand())), 0, 6); ?>" width="100" ></td>
