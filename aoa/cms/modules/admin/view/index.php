			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray home"></span>Project Masters</span>
					</div><!-- End header -->	
                        <div class="content">
                    ...
                    <?php if($_SESSION["CMSRolUser"] == "admin") {?>
                        Bienvenido administrador, seleccione una opci&oacute;n con la cual trabajar.
                                        
                                        CMS B&aacute;sico para desarrolladores/project managers de Project Masters.
                    <?php }else{ ?>
					<h3>Acceso restringido solo para administradores del sistema</h3>
                    <?php } ?>
			        </div>
