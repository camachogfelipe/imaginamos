...
class ClassFile {
  ...
  // Funciopn para subir un archivo al servidor
  ...
  // Funciopn para subir un archivo pdf al servidor
  public static function UploadFilePdf($name_input_file = "", $carpeta = "", $raiz_nuevo_nombre = "") {
    $path = $carpeta;
