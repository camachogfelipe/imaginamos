...
<div class="content_int content_940">
  <p class="texto_pqr">
    <?php echo $pqr_front['texto_principal']; ?>
  </p>
  <div class="clearfix">
    <form class="form_pqr1 left" action="controllers/insertpqr.php" method="post">
      ...
      <input name='cedula' class="validate[required, custom[number]]" type="text" placeholder="C&eacute;dula" />
      <input name='dir' class="validate[required]" type="text" placeholder="Direcci&oacute;n" />
      <input name='email' class="validate[required, custom[email]]" type="text" placeholder="E-mail" />
      <div class="clearfix middle_inputs">
        <input name='placa' type="text" class="left" class="validate[required, custom[number]]" placeholder="Placa del veh&iacute;culo" />
        <select name='aseguradora' class="right validate[required]">
          <option value="NA">Aseguradora</option>
          <?php
    ...
    <div class="right">
      ...
      <form class="form_pqr1" action="index.php?base&seccion=solicitud" method="post">
        <h3><?php echo $pqr_front['titulo']; ?></h3>
        <p>
        <?php echo $pqr_front['texto_descriptivo']; ?>
        </p>
        <input name='cedula'class="validate[custom[number]]" type="text" placeholder="C&eacute;dula" />
