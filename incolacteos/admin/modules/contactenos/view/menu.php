            ...
            <fieldset>
                ...
                <form method="post" action="" name="forminterno" id="forminterno" enctype="multipart/form-data">
                    ...
                    <div style="margin-top: 36px;">
                        <label>Texto</label>
                        <div>
                            <textarea style="margin-left: 200px;margin-top: -25px;height: 127px;" class=" large validate[required]" data-validation-placeholder=""  PlaceHolder="Agregar texto" name="texto" id="texto" style="width: 325px; margin-left: 200px; margin-top: -25px;"><?php echo $oficina["texto"]; ?></textarea>
                        </div>
                    </div>
                    <p>&nbsp;</p>                        
                </form>        
