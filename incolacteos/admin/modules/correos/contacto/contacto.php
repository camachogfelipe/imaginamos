...
$db->doQuery("SELECT * FROM correo1 WHERE id=" . $id, 1);
...
<div class="widget">
    <div class="header">
        <span>
            ...
            ENV&Iacute;O DE CORREOS ELECTR&Oacute;NICOS>> SITIO PRINCIPAL>> CONFIGURACI&Oacute;N
        </span>
    </div>
