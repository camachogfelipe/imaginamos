...
if (isset($_POST["id"])) {
    ...
    if ($id == 0) {
        ...
        if ($_FILES['img']['type'] != "image/jpeg" && $_FILES['img']['type'] != "image/png") {
            ...
            $retorno = ClassFile::UploadImagenFile("img", "../../../../img/productos/importados", "productos_" . $id, "144_136_productos_" . $id, 144, 136);
                        ...
                        <?php if ($oficina["img"] != "") { ?>
                            <div>
                                ...
                                <div  style="margin-left: 200px">
                                    <br><br>
                                    <img src="../../../../img/productos/importados/144_136_<?php echo $oficina["img"] . "?" . rand(0, 9999999); ?>" width="144" height="136" />
                                </div>
                            </div>  
                            <?php
                        }
