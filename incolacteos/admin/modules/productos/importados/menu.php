    ...
    <div class="content">
        ...
        <div class="formEl_b">
            ...
            <table class="display" >
                ...
                <tbody>
                    <?php
                    $db->doQuery("SELECT * FROM productos WHERE posicion=3 ORDER BY id DESC", SELECT_QUERY);
                    $dataAll = $db->results;
                    for ($i = 0, $tot = count($dataAll); $i < $tot; $i++) {
                        ...
                        <tr class="odd gradeX">
                            <td class="center" width="100px">
                                <img src="../../../../img/productos/importados/144_136_<?php echo $data["img"] . "?" . rand(0, 9999999); ?>" width="144" height="136" />
                            </td>                                                      
