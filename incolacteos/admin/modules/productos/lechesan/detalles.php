...
if (isset($_POST["id"])) {
    ...
    if ($id == 0) {
        ...
        $db->doQuery("UPDATE productos_detalles SET             
                    ...
                    texto='" . $texto . "'                             
                    WHERE id=" . $id, 4);
        $retorno = ClassFile::UploadImagenFile("img", "../../../../img/productos/lechesan", "productos_" . $id, "520_300_productos_" . $id, 520, 300);
...
<div class="widget">
    <div class="header">
        <span>
            ...
            PRODUCTOS LECHESAN >> PRODUCTOS >> DETALLES
        </span>
    </div>
    <div class="content">
        <div class="formEl_b">
                        ...
                        <?php if ($oficina["img"] != "") { ?>
                            <div>
                                ...
                                <div  style="margin-left: 200px">
                                    <br><br>
                                    <img src="../../../../img/productos/lechesan/520_300_<?php echo $oficina["img"] . "?" . rand(0, 9999999); ?>" width="520" height="300" />
                                </div>
                            </div>  
                            <?php
                        }
