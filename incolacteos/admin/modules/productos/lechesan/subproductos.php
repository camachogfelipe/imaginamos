...
<!-- full width -->
<div class="widget">
    <div class="header"><span><span class="ico gray window"></span>PRODUCTOS LECHESAN  >> SUBPRODUCTOS</span>
    </div><!-- End header -->
    <div class="content">

        <div class="formEl_b">
            <a class="uibutton confirm" href="index.php?seccion=menu">Atr&aacute;s</a><br><br>
            <h3>AGREGANDO SUBPRODUCTOS PARA " <?php echo utf8_encode($mas1[0]["titulo"]) ?> "</h3><br><br>
