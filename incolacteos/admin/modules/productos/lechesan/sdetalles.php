...
if (isset($_POST["id"])) {
    ...
    if ($id == 0) {
        ...
        $retorno = ClassFile::UploadImagenFile("img", "../../../../img/subproductos/lechesan", "productos_" . $id, "520_300_productos_" . $id, 520, 300);
                    ...
                    <?php if ($id > 0) { ?>
                        <?php if ($oficina["img"] != "") { ?>
                            <div>
                                ...
                                <div  style="margin-left: 200px">
                                    <br><br>
                                    <img src="../../../../img/subproductos/lechesan/520_300_<?php echo $oficina["img"] . "?" . rand(0, 9999999); ?>" width="520" height="300" />
                                </div>
                            </div>  
                            <?php
                        }
