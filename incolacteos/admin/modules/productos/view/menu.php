...
<!-- full width -->
<div class="widget">
    <div class="header"><span><span class="ico gray window"></span>PRODUCTOS CALIFORNIA</span>
    </div><!-- End header -->
    <div class="content">

        <div class="formEl_b">

            <a class="uibutton normal" href="index.php?seccion=productos&id=0">Agregar nuevo producto california</a>
            ...
            <table class="display" >
                ...
                <tbody>
                    <?php
                    $db->doQuery("SELECT * FROM productos WHERE posicion=1 ORDER BY id DESC", SELECT_QUERY);
                    $dataAll = $db->results;
                    for ($i = 0, $tot = count($dataAll); $i < $tot; $i++) {
                        ...
                        <tr class="odd gradeX">
                            <td class="center" width="100px">
                                <img src="../../../../img/productos/california/144_136_<?php echo $data["img"] . "?" . rand(0, 9999999); ?>" width="144" height="136" />
                            </td>                                                      
