...
<a id="sec-com-1"></a>
<?php
include("header-lechesan.php");
$var=$_GET["ids"];
if (!isset($_GET["idp"])) {
    echo "<script>window.location.href='index.php?seccion=productos-lechesan'</script>";
    exit;
}
    ...
    <div class="con-section">
        <div class="mg-section-other clearfix">
            ...
            <div class="con-info-pro">
                <div class="info-pro-img"><img src="img/subproductos/lechesan/520_300_<?php echo $detalle["img"] ?>" width="520" height="300" alt=""></div>
        ...
        if ($detalle["receta"] != 0) {
            ...
            if (count($receta) > 0) {
                ...
                <div class="mg-section-other clearfix">
                    ...
                    <div class="more-rec">
                        <a class="fx-nav" href="index.php?seccion=recetas-lechesan"><div class="receta-mas-vn"><div class="receta-mas-bt"></div><span></span></div></a>
                    </div>
                </div> 
                <?php
            }
