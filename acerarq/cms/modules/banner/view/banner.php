...
if (isset($_POST["id"])) {
    ...
    if($titulo == ""){
        ...
        $titulo = str_replace('"', "&quot;", $titulo);
    $db->doQuery("UPDATE banner SET titulo='" . $titulo . "' WHERE idbanner=" . $id, 4);

    $retorno = ClassFile::UploadImagenFile("img", "../../../../assets/img/banner", "banner_" . $id, "960_392_banner_" . $id, 960, 392);
    if ($retorno["Status"] == "Uploader") {
        $db->doQuery("UPDATE banner SET imagen='" . $retorno["NameFile"] . "' WHERE idbanner=" . $id, 4);
        $Erno = 1;
    } else {
    ...
    <div class="formEl_b">
        ...
        <fieldset>
            ...
            <form method="post" action="" name="forminterno" id="forminterno" enctype="multipart/form-data">
                <input type="hidden" value="<?= $banner["idbanner"] ?>" name="id" id="id">
                <div class="section">                                                                                                  
                    <label>Titulo</label>
                    <div>
                ...
                <div class="section">
                    ...
                    <br />
                    <div>
                        <label>Subir nueva imagen (550px x 392px)(.png, .jpg)</label><br />
