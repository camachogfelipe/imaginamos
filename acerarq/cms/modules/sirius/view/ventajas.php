...
if (isset($_POST["id"])) {
    ...
    if ($texto == "") {
        $Erno = 2;
            ...
            $texto = str_replace('"', "&quot;", $texto);
            $db->doQuery("INSERT INTO ventajas_sirius(texto) VALUES ('".$texto."')", 2);
            $Erno = 1;        
    }
}
$cData = "SELECT * FROM ventajas_sirius ORDER BY idventajas_sirius ASC ";
$db->doQuery($cData, 1);
...
<div class="header">
    <span>
        <span class="ico gray window"></span>Ventajas</span>
</div>
                    ...
                    <tbody>
                            ...
                            <tr class="odd gradeX">                                
                                ...
                                <td class="center" width="100px">
                                    <a class="uibutton"   href="index.php?seccion=editventajas&id=<?php echo $data["idventajas_sirius"] ?>">Editar</a>
                                    <?php if($fil > 1){ ?>
                                    <a id="<?php echo $data["idventajas_sirius"] ?>" class="Delete uibutton special" tableToDelete="ventajas_sirius" nameField="idventajas_sirius">Eliminar</a>
                                    <?php } ?>
                                </td>  
                            </tr>
<?php } ?>
