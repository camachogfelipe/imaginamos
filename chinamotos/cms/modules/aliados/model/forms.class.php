			...
			case 1:
				...
				foreach ($results as $result)
				{
					$html .= '
						...
						<a  href="edit.php?id='.$result[aliados_id].'&funcionality='.$conta.'" class="uibutton">Editar</a>
						</td>
						</tr>';		
					$conta++;	
				}
...
function printFormEdit($id,$funcionality)
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
                    ...
                    <legend><h1>Edición de Banner Apoyo</h1></legend>
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
						...
						<label>Imagen dimensiones 78px ancho x 82px alto</label>
						<fieldset>
						<div>
						<div>
						
							<img src="../files/big/'.$results[0][aliados_image].'"><br><br>
							<input class="CMS" type="file" path="files/" multi="false" startOn="onSubmit:form" ajax="true" ajaxInfoId="info" ajaxLoaderId="loader" button="../images/buttonSingle.jpg" thumbnails="70x70,78x70,78x82" thumbnailsFolders="files/small/,files/middle/,files/big/" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)" allowRemove="true" />
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
						...
						<label>Imagen dimensiones 206px ancho x 82px alto</label>
						<fieldset>
						<div>
						<div>
						
							<img src="../files/big/'.$results[0][aliados_image].'"><br><br>
							<input class="CMS" type="file" path="files/" multi="false" startOn="onSubmit:form" ajax="true" ajaxInfoId="info" ajaxLoaderId="loader" button="../images/buttonSingle.jpg" thumbnails="70x70,100x70,206x82" thumbnailsFolders="files/small/,files/middle/,files/big/" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)" allowRemove="true" />
