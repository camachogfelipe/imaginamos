...
function printFormDatos($funcionality)
		{	
			...
			case 1:
				...
				$query4 = "SELECT * FROM cms_redpuntos_sector order by redpuntos_sector_id ";
				...
				<div>
					<p><label>Ciudad</label></p>
					<div>
						<select name="ciudad" size="1" id="tselectCity">
				';			
				...
				<div>
					...
					<div>
						<select name="localidad" size="1" id="tselectSector">
				';			
						foreach ($results4 as $result4)
						{
							$html .= "<option value='".$result4['redpuntos_sector_id']."'>".trim($result4['redpuntos_sector_nombre'])."</option>";
						}
				$html .= '		
						</select>
					</div>
				...
				foreach ($results as $result)
				{
					...
					$idsector = $result[redpuntos_campo2];	
					$queryThree = "SELECT * FROM cms_redpuntos_sector where redpuntos_sector_id = '$idsector' ";
				...
				$html .= '
					...
					<td class="center"   >'.$resultsThree[0][redpuntos_sector_nombre].'</td>
