...
function printFormNews($funcionality)
		{	
			...
			case 2:
				...
				<div>
				<label>Resumen:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*Obligatorio</label>
				<div>	
				<div><textarea name="resumen" id="resumen" style="resize: none;" cols="5" rows="10" class="large"></textarea></div>
				</div>
				</div>
				<p>&nbsp;</p>
				<div>
				...
				<div>	
				<div><textarea name="article" id="article" style="resize: none;" cols="5" rows="10" class="large"></textarea></div>
				</div>
				</div>
				...
				<fieldset>
				<div>
					<label>Imagen:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*Obligatorio (tama&ntilde;o: 220px de ancho x 300px de alto, formatos: jpg,jpeg,png &oacute; gif)</label>
					<p>&nbsp;</p>
				<div>
				
				<input class="CMS" type="file" path="files/" multi="false" startOn="onSubmit:form" ajax="true" ajaxInfoId="info" ajaxLoaderId="loader" button="../images/buttonSingle.jpg" thumbnails="90x90,124x124,220x300" thumbnailsFolders="files/small/,files/middle/,files/big/" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)" allowRemove="true" />
				...
				$html .= '
					<tr class="odd gradeX">
					<td class="center" width="90px"><img src="../files/small/'.$result[news_image].'"></td>
					<td class="center" width="200px">'.$result[news_title].'</td>
					<td class="center" width="100px">
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
                                  ...
                                  <div>
                                      <p><label>Título:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*Obligatorio</label></p>
                                      <div><input type="text" name="title" id="title" class="large" value="'.$results[0][news_title].'"/></div>
                                  </div>
                              ...
                              <p>&nbsp;</p>
                                  ...
                                  <div>
                                      <p><label>Resumen:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*Obligatorio</label></p>
                                      <div><textarea name="resumen" id="resumen" style="resize: none;" cols="5" rows="10" class="large">'.strip_tags($results[0][news_resumen]).'</textarea></div>
                                  </div>
							   ...
							   <p>&nbsp;</p>
                                  ...
                                  <div>
                                      <p><label>Contenido:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*Obligatorio</label></p>
                                      <div><textarea name="article" id="article" style="resize: none;" cols="5" rows="10" class="large">'.strip_tags($results[0][news_article]).'</textarea></div>
                                  </div>
							  ...
							  <fieldset>
								<div>
									<label>Imagen (tama&ntilde;o: 220px de ancho x 300px de alto, formatos: jpg,jpeg,png &oacute; gif)</label>
									<p>&nbsp;</p>
									<div>
										<input class="CMS" type="file" path="files/" multi="false" startOn="onSubmit:form" ajax="true" ajaxInfoId="info" ajaxLoaderId="loader" thumbnails="90x90,124x124,220x300" button="../images/buttonSingleChange.jpg" thumbnailsFolders="files/small/,files/middle/,files/big/" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)" allowRemove="true" />
									</div>
								</div>
							  </fieldset>
