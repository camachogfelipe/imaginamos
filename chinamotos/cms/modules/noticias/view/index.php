			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>ACTUALIDAD </span>
              ...
              <script language="javascript">$("#article222").cleditor(); $("#resumen222").cleditor();</script>              
