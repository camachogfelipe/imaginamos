		...
		self.uploadify({
			...
			'onAllComplete' : function(event, data){
				if(typeof(self.attr("afterUpload"))!="undefined" && self.attr("afterUpload")!="link" && self.attr("afterUpload")!="filename" && self.attr("afterUpload")!="image" && self.attr("afterUpload")!="none")
				{
					...
					message = message.replace("IMGR1totalSizeKB", roundNumber(data.allBytesLoaded/1024, 2));
					message = message.replace("IMGR1totalSizeMB", roundNumber(data.allBytesLoaded/1024/1024, 2));
					message = message.replace("IMGR1totalSizeGB", roundNumber(data.allBytesLoaded/1024/1024/1024, 2));
					message = message.replace("IMGR1speedB", roundNumber(Math.round(data.speed*1024), 2));
					message = message.replace("IMGR1speedKB", roundNumber(Math.round(data.speed), 2));
					message = message.replace("IMGR1speedMB", roundNumber(Math.round(data.speed/1024), 2));
					message = message.replace("IMGR1speedGB", roundNumber(Math.round(data.speed/1024/1024), 2));
