			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>INFORMACI&Oacute;N CONT&Aacute;CTENOS</span>
					</div><!-- End header -->	
                        <div class="content">
             ...
             <script language="javascript">$("#contenido5").cleditor(); $("#contenido2").cleditor();</script> 
