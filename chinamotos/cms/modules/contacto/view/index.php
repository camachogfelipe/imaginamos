			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>INFORMACI&Oacute;N CONT&Aacute;CTENOS</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_contacto'",SHOW_TABLE_QUERY);
					//Si recibimos TRUE como respuesta quiere decir que si existe la tabla
					if($show = $db->show)
						{
						$db->doQuery("SELECT contacto_config_funcionality FROM cms_contacto_config WHERE contacto_config_id = 1",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
						echo $htmlFormFoodService->printFormContacto($result[0][contacto_config_funcionality]);
						}
					else
