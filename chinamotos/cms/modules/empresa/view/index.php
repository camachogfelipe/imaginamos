			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>LO QUE HACEMOS</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_empresa'",SHOW_TABLE_QUERY);
					//Si recibimos TRUE como respuesta quiere decir que si existe la tabla
					if($show = $db->show)
						{
						$db->doQuery("SELECT empresa_config_funcionality FROM cms_empresa_config WHERE empresa_config_id = 1",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
						echo $htmlFormFoodService->printFormEmpresa($result[0][empresa_config_funcionality]);
						}
					else
