...
function printFormBanners($funcionality)
		{	
			...
			case 1:
				...
				<div>	
					<input type="text" name="titulo1" id="titulo1" maxlength="15" class="large" />
				</div>
				</div>
				...
				<div>	
					<input type="text" name="titulo2" id="titulo2" maxlength="12" class="large" />
				</div>
				</div>
				...
				<div>	
					<input type="text" name="titulo3" id="titulo3" maxlength="7" class="large" />
				</div>
				</div>
