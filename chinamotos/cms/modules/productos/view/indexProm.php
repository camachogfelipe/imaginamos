			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>INFORMACI&Oacute;N DE PRODUCTOS PROMOCIONES</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_vendemos_config'",SHOW_TABLE_QUERY);
					//Si recibimos TRUE como respuesta quiere decir que si existe la tabla
					if($show = $db->show)
						{
						$db->doQuery("SELECT vendemos_config_funcionality FROM cms_vendemos_config WHERE vendemos_config_id = 1",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
						echo $htmlFormBanners->printFormProm(1);
						}
					else
						//Si la tabla no existe presentamos el formulario de configuración del módulo "NEWS"
						echo $htmlFormBanners->printFormInstall();
					?>
                    </fieldset>
              ...
              <script language="javascript">$("#carac").cleditor();</script>
