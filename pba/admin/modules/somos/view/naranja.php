...
if(isset($_REQUEST["idcontenido"])){
  ...
  if( (int)$_REQUEST["idcontenido"]>0 ){  
    $update=$db->doQuery("UPDATE contenido_somos SET  texto1='".$titulo."', texto2='".$nombre_c."' WHERE idcontenido=".(int)$_REQUEST["idcontenido"], UPDATE_QUERY);
...
if(isset($_REQUEST["bullet"])){
    $bullet = GetData("bullet", "");
    $insert=$db->doQuery("INSERT INTO bullets_somos ( nombre) VALUES ( '".$bullet."');", INSERT_QUERY);
    ...
    <div class ="content">
        ...
        <div class="formEl_b">
            ...
            <div >
              ...
              <span class="f_help"> L&iacute;mite de car&aacute;cteres: 672 / <span class="texto"></span></span>
              <script type="text/javascript">
           ...
           <div class="section">
            ...
            <div>
              ...
              <span class="f_help"> L&iacute;mite de car&aacute;cteres: <span class="bullet"></span></span>
              <script type="text/javascript">
              $("#bullet").limit("140",".bullet");
              </script>
            </div>
          </div><br/>
