<?PHP 
	require_once("includes/clase_parametros_personal.php");
?>
...
<body>
	...
	<?php include 'header.php';?><!--contiene todo el footer-->
        <?php $foundation = ParametrosFoundation::getContenidoFoundation();?>
        
    <div id="imagen"><!--imagen estatica-->    	
        <div id="imgfundation" style="background-image: url(cms/modules/foundation/files/big/<?php echo str_replace(" ","%20",trim($foundation[0]['imagen']));?>) !important;"></div>
    ...
    <div class="contenidometing"> <!--contenido--> 
    	...
    	<div id="contenido">
        	...
        	<div id="titulocentro">FOUNDATION:</div>
            <div id="subtitulotex"><?php echo utf8_encode(nl2br(($foundation[0]['texto'])));?>
