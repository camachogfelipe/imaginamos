...
if($texto1 == "" or $enlace == "" or $texto2 == "")
	...
	$message = "<script>showError('Ingrese t&iacute;tulo 1, t&iacute;tulo 2 , el enlace y la imagen',3000);</script>";
	...
	else
		{
				...
				$db->doQuery("INSERT INTO cms_banners(banners_id, banners_txt1, banners_txt2, banners_url, banners_image)VALUES('','$texto1','$texto2','$enlace','$imageUploadOk')",INSERT_QUERY);
