<?PHP
	...
	class Parametros {
		...
		static function getImgBanner() {
			...
			$sql = "select * from cms_banners_img order by idbanners_img;"; 
		 ...
		 /* Titulo Banner */
		static function getTituloBanner() {
		...
		static function getContenido() {
			...
			return $row;
                ...
                // consulta titulos en tabla cms:aboutus_titulo
                static function getTitulo(){
                    ...
                    $sql = "select * from cms_aboutus_titulo;";
                    $dbRs = $conexion->query($sql);
                    $row = $dbRs->fetchAll();
                  ...
                  static function getItem($id){
                    ...
                    $sql = "select * from cms_aboutus_item where id_titulo = '$id';";
                    $dbRs = $conexion->query($sql);
                    $row = $dbRs->fetchAll();
