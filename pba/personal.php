...
<body>
	...
	<?php include 'header.php';?><!--contiene todo el footer-->
        <?php $personal = ParametrosPersonal::getContenidoPersonal();?>
        
    <div id="imagen"><!--imagen estatica-->    	
        <div id="imgfundation" style="background-image: url(cms/modules/personal/files/big/<?php echo str_replace(" ","%20",trim($personal[0]['imagen']));?>) !important;"></div>
    ...
    <div class="contenidometing"> <!--contenido--> 
    	...
    	<div id="contenido">
        	...
        	<div id="titulocentro">PERSONAL CONCIERGE:</div>
            <div id="subtitulotex"><?php echo utf8_encode(nl2br(($personal[0]['texto'])));?>
