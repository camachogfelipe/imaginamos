			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>Destination Contenido</span>
					...
					if($show = $db->show)
						...
						echo $htmlFormBanners->edit_contenido_destination($result[0][banners_config_funcionality]);
						}
					else
