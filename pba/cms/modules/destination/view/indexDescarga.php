...
include("../model/forms.class1.php");
			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>DESTINATION DESCARGAS</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_banners'",SHOW_TABLE_QUERY);
					//Si recibimos TRUE como respuesta quiere decir que si existe la tabla
					if($show = $db->show)
						{
						$db->doQuery("SELECT banners_config_funcionality FROM cms_banners_config WHERE banners_config_id = 1",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
						echo $htmlFormBanners->printFormBanners($result[0][banners_config_funcionality]);
						}
					else
