			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>DESING AGREGAR ITEM</span>
					...
					if($show = $db->show)
						...
						echo $htmlFormBanners->printFormItemDatos($result[0][banners_config_funcionality]);
						}
					else
