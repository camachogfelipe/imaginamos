...
{  
	...
	if($formData[item] == "")
		...
		$db->doQuery("UPDATE cms_destination_desing_items SET item = '$item' WHERE id_items = '$formData[id]'",UPDATE_QUERY);
...
{  
	...
	if($formData[item] == "" )
		...
		$db->doQuery("INSERT INTO cms_destination_desing_items (id_items,id_desing,item) VALUES ('','1','$item')",INSERT_QUERY);
...
//        htmlentities($nombreBloque);
        ...
        htmlentities($texto);
        $titulo2 = str_replace("'","&#39",$formData[titulo2]);
        htmlentities($titulo2);
...
//		include("../../../core/class/db.class.php");
		...
		$db->doQuery("UPDATE cms_destination_desing SET titulo = '$titulo',texto = '$texto',subtitulo = '$titulo2'",UPDATE_QUERY);
