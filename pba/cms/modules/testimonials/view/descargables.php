			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>Testimonials Descargables Contenido</span>
					...
					if($show = $db->show)
						...
						echo $htmlFormBanners->edit_contenido_testimonials(2);
						}
					else
