			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>Testimonials Contenido</span>
					...
					if($show = $db->show)
						...
						echo $htmlFormBanners->edit_contenido_testimonials($result[0][banners_config_funcionality]);
						}
					else
