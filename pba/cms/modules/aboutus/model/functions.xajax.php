...
{  
	...
	if($formData[titulo] == "")
		...
		$db->doQuery("UPDATE cms_aboutus_titulo SET titulo = '$titulo' WHERE id_titulo = '$formData[id]'",UPDATE_QUERY);
...
{  
	...
	if($formData[item] == "")
		...
		$db->doQuery("UPDATE cms_aboutus_item SET item = '$item' WHERE id_item = '$formData[id]'",UPDATE_QUERY);
...
{  
	...
	if($formData[titulo] == "" )
		...
		$db->doQuery("INSERT INTO cms_aboutus_titulo (id_titulo,titulo) VALUES ('','$titulo]')",INSERT_QUERY);
...
{  
	...
	if($formData[item] == "" )
		...
		$db->doQuery("INSERT INTO cms_aboutus_item (id_item,id_titulo,item) VALUES ('','$titulo','$item')",INSERT_QUERY);
...
//		include("../../../core/class/db.class.php");
		...
		$db->doQuery("UPDATE cms_aboutus SET titulo = '$titulo',texto = '$texto'",UPDATE_QUERY);
