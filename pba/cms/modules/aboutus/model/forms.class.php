...
function printFormBanners($funcionality)
		{	
			...
			{
			case 1:
				$query = "SELECT * FROM cms_aboutus ORDER BY id DESC";
...
function printFormEdit($id,$funcionality)
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
                    ...
                    <legend><h1>About us Edición Imagen</h1></legend>
		...
		return $html;
                  ...
                  function edit_contenido_aboutus(){
                    
                      $query2 = "SELECT * FROM cms_aboutus";
				$this->db->doQuery($query2,SELECT_QUERY);
				$results = $this->db->results;
