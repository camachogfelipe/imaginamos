			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>ABOUT PANAMA IMAGEN</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_aboutpan_cont'",SHOW_TABLE_QUERY);
					...
					if($show = $db->show)
						...
						echo $htmlFormBanners->printFormCont($result[0][banners_config_funcionality]);
						}
					else
