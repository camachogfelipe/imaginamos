			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>CONTENIDO</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_aboutpan_imagen'",SHOW_TABLE_QUERY);
					...
					if($show = $db->show)
						...
						echo $htmlFormBanners->PrintFormImg($result[0][banners_config_funcionality]);
						}
					else
