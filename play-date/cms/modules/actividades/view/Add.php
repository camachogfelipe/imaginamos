        ...
        if (isset($_GET['erno'])) {
            ...
            if (!intval($erno)) {
                ...
                if ($erno == 1) {
                    ...
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info').innerHTML = 'El banner se agrego correctammente !<br />';
                            $('#info').show();
                        })
                    </script>
                    <?php
            ...
            <div class="inner">
                ...
                <div class="widget">
                    ...
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
                                <legend><h1>Nueva Actividad</h1></legend>
                                <form id="formAjax" method="post" action="../controller/add.php">
                                    <p>
                                        ...
                                        <div class="section">
                                            ...
                                            <div>
                                                <input type="text"  name="subtitulo" id="subtitulo" class="large validate[required]" data-validation-placeholder="subtitulo"  />
                                        ...
                                        <div class="section">
                                            ...
                                            <div> 
                                                <input type="text"  name="subtitulo2" id="subtitulo2" class="large validate[required]" data-validation-placeholder="subtitulo2"  />
                                                <span class="f_help" style="margin-right: 200px;"> Límite de carácteres 48 / <span class="subtitulo"></span></span>
                                            </div>
                                        </div>
                                        <div class="section">
                                            ...
                                            <div> 
                                                <textarea name="descriptivo" id="descript" class="large validate[required]" data-validation-placeholder="descriptivo" rows="15" ></textarea>
                                                <span class="f_help" style="margin-right: 200px;"> Límite de carácteres 505 / <span class="descript"></span></span>
                                            </div>
                                        </div>
                                        <div class="section">
                                            <label>Texto completo </label>   
                                            <div> 
                                                <textarea type="text"  name="completo" id="completo" class="validate[required]" data-validation-placeholder="completo"  class="large"></textarea> 
                                                <span class="f_help" style="margin-right: 200px;"> Límite de carácteres 48 / <span class="subtitulo"></span></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="section">
                                            ...
                                            <div>
                                                <input class="IMU" type="file" path="files/" startOn='onSubmit:formAjax' ajax='false' ajaxInfoId='info' ajaxLoaderId='loader' multi='false' afterUpload='filename' fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)" thumbnails="420x400" thumbnailsFolders="files/" />
                                            </div>
                                        </div>
                                        <div class="section">
                                            ...
                                            <div>
                                                <input class="IMU1" type="file" path="files/" startOn='onSubmit:formAjax' ajax='false' ajaxInfoId='info' ajaxLoaderId='loader' multi='true' afterUpload='filename' fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)" thumbnails="450x300,550x400" thumbnailsFolders="files/" />
                                            </div>
                                        </div>
