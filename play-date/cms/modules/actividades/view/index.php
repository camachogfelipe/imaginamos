			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray shadow sphere"></span>Actividades</span>
					</div><!-- End header -->	
                        <div class="content">
                    ...
                    <div>
					 ...
					 $total = $Consultas->total('cms_actividades');
					 //echo $total.' total';
                                if ($total<9)
                                {
                                ?>
                                <a href="Add.php" class="uibutton">Agregar Actividad</a>
                                <?php
                                }
                                ?>
                     </div> 
