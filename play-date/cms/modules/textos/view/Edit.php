		...
		$erno = $_GET['erno'];
			...
			else
			{
				if ($erno==1)
				{
					...
					document.getElementById('info1').innerHTML = 'El texto ha sido editado correctamente!<br />';
					$('#info1').show();
					})
					</script>
                    <?php
			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray list"></span>EDICI&Oacute;N</span>
					</div><!-- End header -->	
                  <div class="content">
                    <div class="formEl_b">
                        <fieldset>
                        ...
                        if (isset($_GET['id']))
                        {
							...
							$arrayCampos[0] = 'id_textos';
							$arrayCampos[1] = 'seccion_textos';
							$arrayCampos[2] = 'texto_textos';
                                                        
							$query1 = $Consultas->Byid('cms_textos',$id,'id_textos',$arrayCampos);
                        }
                        ?>
                        <div>
                            <legend><h1>Editar Texto de Bienvenida </h1></legend>
                                ...
                                <p>
                                    ...
                                    <div>
                                        <div class="section">
                                            ...
                                            <div>
                                            <input type="text" class="large"  name="sec" id="titulo1" value="<?php echo $query1[1] ?>" disabled />
                                            <input type="hidden" class="large" maxlength="45" name="id" id="id" value="<?php echo $id ?>" />
                                            </div>
                               		</div>
                                        ...
                                        <div class="section">
                                            ...
                                            <span class="f_help"> Límite de carácteres: <span class="texto">300</span></span>
                                            </div>
                               		</div>
                                        <div class="section">
                                            <input type="submit" id="button" value="Guardar" class="uibutton" />
