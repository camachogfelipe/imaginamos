...
function printTableUsers()
		...
		if($numOfResults>0)
		{
			...
			{
                            $titulos = explode('/-/--', $result[titulo_banner_superior]);
				...
				$html .= '
					...
					<td class="center" width="300px">'.$titulo.'</td>
                                        ...
                                        <td class="center" width="300px"><img width="150" src="../../../../imagenes/'.$result[imagen_banner_superior].'" title="'.$result[imagen_banner_superior].'" /></td>
