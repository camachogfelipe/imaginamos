			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray clip"></span>EDICI&Oacute;N Destacados </span>
					</div><!-- End header -->	
                  <div class="content">
                    <div class="formEl_b">
                        ...
                        if (isset($_GET['id']))
                        {
							...
							$arrayCampos[0] = 'id_destacados';
							$arrayCampos[1] = 'titulo_destacados';
							$arrayCampos[2] = 'texto_destacados';
							$arrayCampos[3] = 'imagen_destacados';
                                                        
							$query1 = $Consultas->Byid('cms_destacados',$id,'id_destacados',$arrayCampos);
                                                        
                                                        $titulos= explode('/-/--', $query1[1]); 
                        }
                        ?>
                            
                        <div>
                            <legend><h1>Editar Secci&oacute;n de Destacados</h1></legend>
                                ...
                                <p>
                                    ...
                                    <div>
                                        <div class="section">
                                            ...
                                            <div>
                                            <input style="border-radius: 5px;" type="text" class="large"  name="titulo" id="titulo" value="<?php echo $titulos[0]; ?>" />
                                            <span class="f_help"> L&iacute;mite de car&aacute;cteres <span class="titulo">12</span>/12</span>
                                            </div>
                               		</div>
                                        ...
                                        <label>Texto </label>
                                        <div>
                                        <textarea id="texto" name="texto" cols="65" rows="12" ><?php echo $query1[2]; ?></textarea>
					<span class="f_help"> L&iacute;mite de car&aacute;cteres: <span class="texto">160</span></span>
                                        ...
                                        <div class="section">
                                            <label>Imagen</label>
                                            <div>
                                            <div><img src="../../../../imagenes/<?php echo $query1[3]; ?>" width="200"/><br /></div>
                                            <input class="IMU" type="file" path="../../../../imagenes/" thumbnails="200x205" thumbnailsFolders="../../../../imagenes/" multi="false" startOn="onSubmit:form" afterUpload="filename" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)"/>
                                            <label>Tama&ntilde;o de imagen (200x205)px <small>Redimensi&oacute;n</small></label>
