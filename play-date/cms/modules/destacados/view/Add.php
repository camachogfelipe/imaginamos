			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray shadow"></span>Destacados</span>
					</div><!-- End header -->	
                  <div class="content">
					<div class="formEl_b">
					...
					<span class="f_help"> L&iacute;mite de car&aacute;cteres: <span class="titulo">12</span></span>
                                    ...
                                    <div class="section">
                                        <label>Texto </label>
                                        <div>
                                        <textarea id="texto" name="texto" cols="65" rows="12" ></textarea>
					<span class="f_help"> L&iacute;mite de car&aacute;cteres: <span class="texto">160</span></span>
                                    ...
                                    <div class="section">
                                        <label>Imagen</label>
                                        <div>
                                        <input id="IMU"  class="IMU" type="file" path="../../../../imagenes/" thumbnails="200x205" thumbnailsFolders="../../../../imagenes/" startOn='onSubmit:formAjax' ajaxInfoId='info' ajaxLoaderId='loader' multi='false' afterUpload='filename'  fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)"/>
                                        <label>Tama&ntilde;o final de imagen (200x205)px Redimensionada <small>Redimensi&oacute;n</small></label>
