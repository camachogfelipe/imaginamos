                ...
                <div class="widget">
                    ...
                    <div class="content">
                        <div class="formEl_b">
                            ...
                            $id = $_GET['id'];
                            $id = base64_decode($id);
                            $result = $obj->PintarEditGaleria($id);
                            ...
                            <fieldset>
                                ...
                                <div>
                                    <legend><h1>Editar Galeria</h1></legend>
                                    <form id="form" method="post" action="../controller/edit.php">
                                        
                                            <input type="Hidden"  name="titulo5" id="titulo5"  value="<?= $query1[5] ?>"  />
                                            ...
                                            <p>
                                                ...
                                                <div class="section">
                                                    <label>Titulo </label>   
                                                    <div> 
                                                        <input type="text"  name="titulo" id="titulo1" class="large validate[required]" data-validation-placeholder="titulo1" value="<?php echo $result[0][titulo_galeria]; ?>"  />
                                                    </div>
                                                </div>
                                            ...
                                            <div>
                                            <div><img src="../../../../imagenes/<?php echo $result[0][imagen_galeria]; ?>" width="505"/><br /></div>
                                            <input class="IMU" type="file" path="../../../../imagenes/" thumbnails="550x400" thumbnailsFolders="../../../../imagenes/" multi="false" startOn="onSubmit:form" afterUpload="filename" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)"/>
                                            <label>Tama&ntilde;o de imagen (550x400)px <small>Redimensi&oacute;n</small></label>
                                            <input type="hidden" class="large" maxlength="45" name="imagenant" id="imagenant" value="<?php echo $result[0][imagen_galeria]; ?>" />
