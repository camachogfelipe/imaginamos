        ...
        if (isset($_GET['erno'])) {
            ...
            if (!intval($erno)) {
                ...
                if ($erno == 1) {
                    ...
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info').innerHTML = 'Las imagenes se agregaron correctamente !<br />';
                            $('#info').show();
                        })
                    </script>
                    <?php
                ...
                if ($erno == 3) {
                    ...
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info').innerHTML = 'Ingrese el texto !';
                            $('#info').show();
                        })
                    </script>
                    <?php
                ...
                if ($erno == 4) {
                    ...
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info').innerHTML = 'Seleccione una imagen porfavor !';
                            $('#info').show();
                        })
                    </script>
                    <?php
                ...
                <div class="widget">
                    ...
                    <div class="content">
                                ...
                                <form id="formAjax" method="post" action="../controller/add_1.php">
                                    <p>
                                        ...
                                        <div class="section">
                                            ...
                                            <input class="IMU" type="file" path="../../../../imagenes/" thumbnails="800x700" multi="true" startOn='onSubmit:formAjax' afterUpload='filename' button="custom_button.png" bwidth="128" bheight="128" allowRemove="false" maxSize="20480000" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)" />
                        ...
                        <br />
                            ...
                            $sebas = $_GET['id'];
                            echo $htmlFormTableUser->printSubcategoria(base64_decode($sebas)); ?>
