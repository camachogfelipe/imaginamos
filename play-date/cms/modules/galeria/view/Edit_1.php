    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>Galeria - Sucategoria</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <?php
                            ...
                            $id = $_GET['id'];
                            $id = base64_decode($id);
                            $result = $obj->PintarEditSubcategoria($id);
                            ...
                            <fieldset>
                                ...
                                <div>
                                    <legend><h1>Editar Sucategoria</h1></legend>
                                    <form id="form" method="post" action="../controller/edit_1.php">
                                            ...
                                            <p>
                                                ...
                                                <div class="section">
                                                    ...
                                                    <div> 
                                                        ...
                                                        <textarea  style="resize: none;"  name="texto" id="texto" class="large validate[required]" data-validation-placeholder="texto"><?php echo $result[0][texto_subcategoria]; ?></textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div>
                                            <div><img src="../../../../imagenes/<?php echo $result[0][imagen_subcategoria]; ?>" width="505"/><br /></div>
                                            <input class="IMU" type="file" path="../../../../imagenes/" thumbnails="800x700" thumbnailsFolders="../../../../imagenes/" multi="false" startOn="onSubmit:form" afterUpload="filename" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)"/>
                                            <label>Tama&ntilde;o de imagen (550x400)px <small>Redimensi&oacute;n</small></label>
                                            <input type="hidden" class="large" maxlength="45" name="imagenant" id="imagenant" value="<?php echo $result[0][imagen_subcategoria]; ?>" />
                                            <input type="hidden" class="large" maxlength="45" name="foren" id="foren" value="<?php echo $id; ?>" />
                                            </div> 
