    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>Tema </span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <?php
                            ...
                            <fieldset>
                                ...
                                <div>
                                    <legend><h1>Editar Tema</h1></legend>
                                    <form id="form" method="post" action="../controller/edit.php">
                                            ...
                                            <p>
                                                ...
                                                <div class="section">
                                                    <label>Titulo </label>   
                                                    <div> 
                                                        <input type="text"  name="titulo" id="titulo1" class="large validate[required]" data-validation-placeholder="titulo" value="<?php echo $result[0][title_blog]; ?>"  />
                                                    </div>
                                                </div>
                                                ...
                                                <br>
                                                   <div class="section">
                                                    ...
                                                    <div> 
                                                        <textarea  name="texto" style="resize: none;" rows="12" id="titulo1" class="large validate[required]" data-validation-placeholder="titulo1"><?php echo $result[0][texto_blog]; ?></textarea>
                                                    </div>
                                                </div> 
