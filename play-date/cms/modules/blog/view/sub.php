        ...
        if (isset($_GET['erno'])) {
            ...
            if (!intval($erno)) {
                ...
                if ($erno == 4) {
                    ...
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info').innerHTML = 'Ingrese la imagen !';
                            $('#info').show();
                        })
                    </script>
                    <?php
                                ...
                                <form id="formAjax" method="post" action="../controller/add_1.php">
                                    <p>
                                        ...
                                        <div class="section">
                                            ...
                                            <div>
                                                <input id="IMU"  class="IMU" type="file" path="../../../../imagenes/" thumbnails="800x700" thumbnailsFolders="../../../../imagenes/" startOn='onSubmit:formAjax' ajaxInfoId='info' ajaxLoaderId='loader' multi='false' afterUpload='filename'  fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)"/></div>
                                        </div>
