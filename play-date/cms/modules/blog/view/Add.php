    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>Blog</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
                                <legend><h1>Nuevo Tema</h1></legend>
                                <form id="formAjax" method="post" action="../controller/add.php">
                                    <p>
                                        ...
                                        <div class="section">
                                            <label>Titulo </label>   
                                            <div> 
                                                <input type="text"  name="titulo" id="titulo1" class="large validate[required]" data-validation-placeholder="titulo"  />
                                            </div>
                                        </div>
