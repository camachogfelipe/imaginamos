...
//var_dump($id);
  ...
  if( (int)$_REQUEST["idcontenido"]>0 ){  
    $update=$db->doQuery("UPDATE contenido_herramientas SET  texto1='".mysql_real_escape_string($texto)."', link='".mysql_real_escape_string($link)."' WHERE idcontenido=".(int)$_REQUEST["idcontenido"], UPDATE_QUERY);
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                ...
                <?php 
                    echo "<h3>Edicion</h3>";
                 ?>
                <form class="forminterno" enctype="multipart/form-data" id="forminterno" name="forminterno" action="index.php?seccion=seccion2&idcontenido=2.php" method="post" style="width: 900px;">
