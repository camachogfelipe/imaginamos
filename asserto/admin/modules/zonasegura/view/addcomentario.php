...
<div class="widget">
	<div class ="content">
  	<div class="formEl_b">
        ...
        <form class="forminterno" enctype="multipart/form-data" id="forminterno" name="forminterno" action="index.php?seccion=comentarios&add=1&id=<?php echo $id ?>" method="post" style="width: 900px;">
