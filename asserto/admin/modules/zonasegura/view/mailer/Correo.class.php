...
//echo "aca1";
    ...
    $mail->Username = "felipe.camacho@imaginamos.com";
    // Contrase�a
    $mail->Password = "Sabiduria.0702";
    // Desde que correo quiere que se muestre
    $mail->From = "felipe.camacho@imaginamos.com";
    // Desde (Nombre)
    $mail->FromName = "ASSERTO ";
    // Asunto
    $mail->Subject = "ASSERTO - " . $asunto;
