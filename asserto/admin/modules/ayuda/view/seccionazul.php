        ...
        <div class="formEl_b">
            ...
            <fieldset>
                ...
                <?php 
                    echo "<h3>Edicion</h3>";
                 ?>
                <form class="forminterno" enctype="multipart/form-data" id="forminterno" name="forminterno" action="index.php?seccion=seccionazul&idcontenido=10.php" method="post" style="width: 900px;">
...
<!--                            <img src="../imagenes/<?php // echo $imagen; ?>" width="80"><br><br> -->
            ...
            <div style="margin-left:0% !important">
              ...
              <span class="f_help"> L&iacute;mite de car&aacute;cteres: 700 / <span class="texto"></span></span>
              <script type="text/javascript">
              $("#texto").limit("700",".texto");
              </script>
            </div>
          </div><br/>
