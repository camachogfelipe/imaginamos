        ...
        <div class="formEl_b">
            ...
            <fieldset>
                ...
                <?php 
                    echo "<h3>Edicion</h3>";
                 ?>
                <form class="forminterno" enctype="multipart/form-data" id="forminterno" name="forminterno" action="index.php?seccion=seccion_d&idcontenido=8.php" method="post" style="width: 900px;">
