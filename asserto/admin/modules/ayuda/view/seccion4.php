...
//Actualizar
  ...
  //Codigo Para Subir Imagen1
    $retorno = ClassFIle::UploadImagenFile("img", "../imagenes", "original1_" . $idinsertado, "redimension_" . $idinsertado, 210, 140);
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                ...
                <?php 
                    echo "<h3>Edicion</h3>";
                 ?>
                <form class="forminterno" enctype="multipart/form-data" id="forminterno" name="forminterno" action="index.php?seccion=seccion4&idcontenido=4" method="post" style="width: 900px;">
            ...
            <div style="margin-left:0% !important">
              ...
              <span class="f_help"> L&iacute;mite de car&aacute;cteres: 63 / <span class="texto"></span></span>
              <script type="text/javascript">
              $("#texto").limit("63",".texto");
              </script>
            </div>          
          </div>
          ...
          <label class="cabinet">Imagen</label><br>
                      ...
                      <br/><span style="color: black;">Tama&ntilde;o de la Imagen: <i>210 x 140</i></span><br><br>        
          </div>
          <div>
