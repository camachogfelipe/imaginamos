...
//var_dump($id);
    if(isset($_REQUEST["id_edit"])){
      $texto = GetData("texto1", "");
      $texto_b = GetData("texto2", "");

  if( (int)$_REQUEST["idcontenido"]>0 ){  
    $update=$db->doQuery("UPDATE contenido_ayuda SET  texto1='".mysql_real_escape_string($texto)."', texto2='".mysql_real_escape_string($texto_b)."' WHERE idcontenido=".(int)$_REQUEST["idcontenido"], UPDATE_QUERY);
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                ...
                <form class="forminterno" enctype="multipart/form-data" id="forminterno" name="forminterno" action="index.php?seccion=seccion1&idcontenido=1.php" method="post" style="width: 900px;">
                    <input type="hidden" name="id_edit" id="id" value="<?php echo $id?>" />
...
<!--                            <img src="../imagenes/<?php // echo $imagen; ?>" width="80"><br><br> -->
            ...
            <div style="margin-left:0% !important">
              ...
              <span class="f_help"> L&iacute;mite de car&aacute;cteres: 217 / <span class="texto"></span></span>
              <script type="text/javascript">
              $("#texto").limit("217",".texto");
              </script>
            </div>
          </div><br/>
          ...
          <div class="section">
            ...
            <div style="margin-left:0% !important">
              ...
              <textarea style="border-radius: 5px; width: 500px; height: 200px ; " class="validate[required] large" name="texto2" id="texto"><?php echo $texto2?></textarea>
              <span class="f_help"> L&iacute;mite de car&aacute;cteres: 217 / <span class="texto"></span></span>
              <script type="text/javascript">
              $("#texto").limit("217",".texto");
              </script>
