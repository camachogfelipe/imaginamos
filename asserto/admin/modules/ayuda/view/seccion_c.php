...
//Actualizar
  if( (int)$_REQUEST["idcontenido"]>0 ){  
    $update=$db->doQuery("UPDATE contenido_ayuda SET  texto1='".mysql_real_escape_string($texto_c)."' WHERE idcontenido=".(int)$_REQUEST["idcontenido"], UPDATE_QUERY);
  ...
  //Codigo Para Subir Imagen1
    $retorno = ClassFIle::UploadImagenFile("img", "../imagenes", "original1_" . $idinsertado, "redimension_" . $idinsertado, 220, 260);
    if ($retorno["Status"]=="Uploader"){
    $db->doQuery("UPDATE contenido_ayuda SET imagen='".$retorno["NameFile"]."' WHERE idcontenido=".$idinsertado, UPDATE_QUERY);
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                ...
                <?php 
                    echo "<h3>Edicion</h3>";
                 ?>
                <form class="forminterno" enctype="multipart/form-data" id="forminterno" name="forminterno" action="index.php?seccion=seccion_c&idcontenido=7" method="post" style="width: 900px;">
            ...
            <div style="margin-left:0% !important">
              ...
              <span class="f_help"> L&iacute;mite de car&aacute;cteres: 181 / <span class="texto"></span></span>
              <script type="text/javascript">
              $("#texto").limit("181",".texto");
              </script>
            </div>          
          </div>
          ...
          <label class="cabinet">Imagen</label><br>
                       ...
                       <br/><span style="color: black;">Tama&ntilde;o de la Imagen: <i>220 x 260</i></span><br><br>       
          </div>
          <div>
