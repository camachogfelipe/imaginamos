...
//Actualizar
  ...
  //Codigo Para Subir Imagen1
    $retorno = ClassFIle::UploadImagenFile("img", "../imagenes", "original1_" . $idinsertado, "redimension_" . $idinsertado, 470, 110);
    ...
    <div class ="content">
        ...
        <div class="formEl_b">
            ...
            <div style="margin-left:0% !important">
              ...
              <span class="f_help"> L&iacute;mite de car&aacute;cteres: 100 / <span class="texto"></span></span>
              <script type="text/javascript">
              $("#texto").limit("100",".texto");
              </script>
            </div>          
          </div>
          ...
          <label class="cabinet">Imagen</label><br><br>
                         ...
                         <br/><span style="color: black;">Tama&ntilde;o de la Imagen: <i>470 x 110</i></span><br><br>     
          </div>
          <div>
