...
//var_dump($id);
  ...
  if( (int)$_REQUEST["idcontenido"]>0 ){  
    $update=$db->doQuery("UPDATE contenido_sabemos SET  texto1='".mysql_real_escape_string($texto)."' WHERE idcontenido=".(int)$_REQUEST["idcontenido"], UPDATE_QUERY);
        ...
        <div class="formEl_b">
            ...
            <fieldset>
                ...
                <?php 
                    echo "<h3>Edicion</h3>";
                 ?>
                <form class="forminterno" enctype="multipart/form-data" id="forminterno" name="forminterno" action="index.php?seccion=seccion3&idcontenido=3.php" method="post" style="width: 900px;">
...
<!--                            <img src="../imagenes/<?php // echo $imagen; ?>" width="80"><br><br> -->
            ...
            <div style="margin-left:0% !important">
              ...
              <span class="f_help"> L&iacute;mite de car&aacute;cteres: 230 / <span class="texto"></span></span>
              <script type="text/javascript">
              $("#texto").limit("230",".texto");
              </script>
            </div>
          </div><br/>
