<?php
/*
 * @file               : Dbseccion_herramientas.db.php
 * @brief              : Clase para la interaccion con la tabla seccion_herramientas
 * @version            : 3.3
 * @ultima_modificacion: 2013-06-12
 * @author             : Ruben Dario Cifuentes Torres
 * @generated          : Generador DAO vercion 1.1
 *
 * @class: Dbseccion_herramientas
 * @brief: Clase para la interaccion con la tabla seccion_herramientas
 */
 
class Dbseccion_herramientas extends DbDAO {
