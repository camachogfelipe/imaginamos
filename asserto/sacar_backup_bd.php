 ...
 */
define("DB_USER", 'usuariojcu'); /* Nombre de usuario de la base de datos */
define("DB_PASSWORD", 'E7mZN?53Q3ST'); /* Clave de acceso del usuario de la base de datos */
define("DB_NAME", 'usuariojcu_asserto'); /* Nombre de la base de datos a sacar backup */
