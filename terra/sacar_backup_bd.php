 ...
 */
define("DB_USER", 'usuariooc'); /* Nombre de usuario de la base de datos */
define("DB_PASSWORD", '12NIwE6YU8V7'); /* Clave de acceso del usuario de la base de datos */
define("DB_NAME", 'usuariooc_terra'); /* Nombre de la base de datos a sacar backup */
