...
if (isset($_POST["id"])) {
    ...
    if ($id == 0) {
        $db->doQuery("INSERT INTO bullet_contactenos (id,posicion) VALUES (NULL,1)", INSERT_QUERY);
        $id = $db->getLastId();
...
<div class="widget">
    ...
    <div class="content">
        <div class="formEl_b">
            ...
            <fieldset>
                <a class="uibutton confirm" href="index.php?seccion=lista">Atr&aacute;s</a><br><br>
