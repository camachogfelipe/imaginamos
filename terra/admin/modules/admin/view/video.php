			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
                    ...
                    <legend><h1>Video </h1></legend>
                    
                    <div class="section">
                        <label>Ingrese el código embebido para el video del Dashboard</label>
                        <?php
						$query = "SELECT config_video FROM cms_configuration WHERE config_id = '1'";
						$db->doQuery($query,SELECT_QUERY);
						$result = $db->results;
						?>
                        <div><textarea name="video" id="video" cols="45" rows="5"><?php echo $result[0][config_video]; ?></textarea></div>
					</div>
                  
	                    <br /><br />
                    <a class="uibutton" onclick="xajax_video(xajax.getFormValues('video')); return false;">Guardar</a> 
            		</form>
                    </fieldset>
