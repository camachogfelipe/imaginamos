...
if (isset($_GET["id_del"])) {
    ...
    if ($_GET["confirm"] == base64_encode(md5($_GET["id_del"]))) {
          ...
          $db->doQuery("SELECT * FROM servicios_imagenes WHERE id_servicios=2 ORDER BY id DESC", SELECT_QUERY);
    $re = $db->results;
    if(count($re)>1){
...
<!-- full width -->
<div class="widget">
    <div class="header"><span><span class="ico gray window"></span>PRODUCTOS Y SERVICIOS >> PISCICULTURA >> CONTENIDO</span>
    </div><!-- End header -->
    <div class="content">
