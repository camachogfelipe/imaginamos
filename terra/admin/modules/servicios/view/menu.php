...
if (isset($_POST["id"])) {
    ...
    if ($id == 0) {
        ...
        $imagen= ClassFile::UploadImagenFile("img1", "../../../../img/servicios/equinos", "equinos1_" . $id, "434_374_equinos_" . $id, 434, 374);
...
<div class="widget">
    <div class="header">
        <span>
            ...
            PRODUCTOS Y SERVICIOS >> GANADR&Iacute;A Y EQUINOS 
        </span>
    </div>
    <div class="content">
        <div class="formEl_b">
            ...
            <fieldset>
                ...
                <form method="post" action="" name="forminterno" id="forminterno" enctype="multipart/form-data">
                    ...
                    <div style="margin-left: 200px;margin-top: 44px;">
                        <label style="position: absolute;margin-left: -201px;">Imagen General</label>
                    ...
                    <p>&nbsp;</p>      
                    <div style="margin-left: 200px;margin-top: 44px;">
                        <label style="position: absolute;margin-left: -201px;">Imagen Detalle</label>
                    ...
                    <?php if ($id > 0) { ?>
                        <?php if ($oficina["img"] != "") { ?>
                            <div>
                                ...
                                <div>
                                    <br><br>
                                    <img src="../../../../img/servicios/equinos/434_374_<?php echo $oficina["img"] . "?" . rand(0, 9999999); ?>" width="434" height="374" />
                                </div>
                            </div>  
                            <?php
                        }
