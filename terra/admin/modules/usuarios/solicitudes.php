...
//    $sql = "SELECT * FROM usuarios WHERE 1=1";
    $sql = "SELECT * FROM usuarios as u INNER JOIN forgot_pass as f on u.id=f.id";
        ...
        <table>
            <thead>
                <tr>                        
                    ...
                    <th style="width: 100px"><span>Empresa</span></th>                                   
                    <th style="width: 200px"><span>Email</span></th>
                    <th style="width: 150px"><span>Telefono</span></th>
                    <th style="width: 150px"><span>Mensaje</span></th>
                    <th style="width: 150px"><span>Estado</span></th>
                    <th style="width: 150px"><span>Contraseña</span></th>
            ...
            <tbody>       
                ...
                for ($i = 0, $tot = count($row); $i < $tot; $i++) {
                    ...
                    ?>
                    <tr>
                        <td style="text-align: center;"  width="100px"><?php echo $data["id"] ?></td>                 
                        <td style="text-align: center;" width="100px"><?php echo  utf8_decode(utf8_encode($data["nombres"])) ?></td>                 
                        <td style="text-align: center;"  width="100px"><?php echo utf8_decode($data["empresa"]) ?></td>                            
                        <td style="text-align: center;" width="200px"><?php echo utf8_decode($data["correo"]) ?></td>                            
                        ...
                        ?></td> 
                        <td style="text-align: center;"  width="100px"><?php echo utf8_encode($data["pass"]) ?></td>  
