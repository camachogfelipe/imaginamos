...
class ClassFile1 {
  ...
  public static function UploadFile1($name_input_file = "", $carpeta = "", $raiz_nuevo_nombre = "") {
    $path = $carpeta;
  ...
  public static function UploadImagenFile1($name_input_file = "", $carpeta = "", $raiz_nuevo_nombre = "", $th_img_imagen = "", $width = 0, $height = 0) {
    //$path = "../$carpeta";
    $path = $carpeta;
