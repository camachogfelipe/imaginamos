...
if ($_GET['seccion'] == 'servicios'|| $_GET['seccion'] == 'servicios-1' || $_GET['seccion'] == 'servicios-2' || $_GET['seccion'] == 'servicios-3') {
    echo 'nav-act';
}
?>" id="serv-id"><a href="index.php?seccion=servicios" class="first-nav-v">PRODUCTOS Y SERVICIOS<span>+</span></a>
                            <ul class="nav-sub">
