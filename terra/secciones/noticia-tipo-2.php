...
<head>
  ...
  <body class="body-modal">
    ...
    <div class="con-modal-news-t2">
      <div class="con-modal-img">
      	<div class="modal-img"><img src="assets/img/news-img-modal-t2.jpg" width="430" height="266" alt=""></div>
        <div class="modal-head modal-h2">
        	<div class="modal-title">NOTICIA</div>
          <div class="modal-date">01/06/2.013</div>
        </div>
      </div>
      <div class="con-modal-tx">
      	<h1>Etiam quis mi eu elit</h1>
        <div class="modal-tx tx-t2">
