...
<section>
    <div class="con-section section-int-ct3">
        <div class="mg-section section-info clearfix">
            ...
            <div class="con-info-b">
                 <div class="info-services">
                    ...
                    <div class="info-b info-b1">
                        <div class="con-service-img con-service-img-3">
                            <div class="service-head"><h1>AGROINDUSTRIA</h1></div>
                    ...
                    <?php
                    $img_ser = DbHandler::GetAll("SELECT * FROM servicios_imagenes WHERE id_servicios =3");
                    if (count($img_ser) > 0) {
                        $bandera = 2;
                    ...
                    <li class="slide">
                        <a href="#anchor-top" class="anchor-ct">
                            <div class="con-item-car">
                                <div class="item-small-3 sev-active-3" data-id="info-b1"><div class="item-info"><strong>i</strong></div></div>
                    ...
                    if (count($img_ser) > 0) {
                        ...
                        for ($a = 0, $b = count($img_ser); $a < $b; $a++) {
                            ...
                            <li class="slide">
                                <a href="#anchor-top" class="anchor-ct">
                                    <div class="con-item-car">
                                        <div class="item-small-3" data-id="info-b<?php echo $bande2 ?>"><div class="item-info"><?php echo $bande2 - 1; ?></div></div>
            ...
            <div class="con-back-bt">
                <a href="index.php?seccion=servicio-1#anchor-top"><div class="bt-next bt-next-3"></div></a>
                <a href="javascript:history.back()"><div class="bt-back bt-back-3"></div></a>
            </div>
        </div>
    </div>
</section>
