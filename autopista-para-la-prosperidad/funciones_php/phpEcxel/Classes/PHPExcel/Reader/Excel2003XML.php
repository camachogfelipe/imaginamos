...
class PHPExcel_Reader_Excel2003XML implements PHPExcel_Reader_IReader
{
	...
	public function canRead($pFilename)
	{
		...
		//	Excel					xmlns:x="urn:schemas-microsoft-com:office:excel.php"
...
//		echo 'Character Set is ',$this->_charSet,'<br />';
	...
	private static function identifyFixedStyleValue($styleList,&$styleAttributeValue) {
 	...
 	/**
 	 * pixel units to excel.php width units(units of 1/256th of a character width)
 	 * @param pxs
 	 * @return
 	 */
	...
	/**
	 * excel.php width units(units of 1/256th of a character width) to pixel units
	 * @param widthUnits
	 * @return
	 */
