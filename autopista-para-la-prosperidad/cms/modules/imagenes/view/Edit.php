		...
		$erno = $_GET['erno'];
			...
			else
			{
				if ($erno==1)
				{
					...
					document.getElementById('info1').innerHTML = 'Imagen editada correctamente!<br />';
					$('#info1').show();
					})
					</script>
                    <?php
			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>EDICIÓN IMÁGENES</span>
					</div><!-- End header -->	
                  <div class="content">
                    <div class="formEl_b">
                        <fieldset>
                        ...
                        if (isset($_GET['id']))
                        {
							...
							$arrayCampos[0] = 'id';
							$arrayCampos[1] = 'imagen';;
                                                        
							$query1 = $Consultas->Byid('imagenes',$id,'id',$arrayCampos);
                        }
                        ?>
                            
                        <div>
                            <legend><h1>Editar imagen</h1></legend>
                                ...
                                <p>
                                    ...
                                    <div>
                                          ...
                                          <div class="section">
                                            <label>Imagen</label>
                                            <div>
                                            <div><img src="files/<?php echo $query1[1]; ?>" width="490"/><br /></div>
