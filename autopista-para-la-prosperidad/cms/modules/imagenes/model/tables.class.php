			...
			foreach($results as $result)
			{
				$html .= '
					<tr class="odd gradeX">
                                        ...
                                        <td class="center" width="300px"><img width="150" src="files/'.$result[imagen].'"/></td>
					<td class="center" width="100px">
                                        <a id="'.$result[id].'" class="uibutton"   href="Edit.php?id='.base64_encode($result[id]).'">Editar</a>
					<a id="'.$result[id].'" class="Delete uibutton special" tableToDelete="imagenes" nameField="id">Eliminar</a>
                                            </td>
					</tr>';		
			}
