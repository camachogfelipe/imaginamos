                ...
                if ($erno == 1) {
                    ...
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info1').innerHTML = 'Enlace editado correctamente!<br />';
                            $('#info1').show();
                        })
                    </script>
                    <?php
    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>EDICIÓN ENLACES</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $arrayCampos[0] = 'id';
                                    $arrayCampos[1] = 'enlace';;

                                    $query1 = $Consultas->Byid('cronograma', $id, 'id', $arrayCampos);
                                }
                                ?>

                                <div>
                                    <legend><h1>Editar Enlace Cronograma</h1></legend>
                                        ...
                                        <p>
                                            ...
                                            <div>
                                                <div class="section">
                                                    <label>Enlace</label>
                                                    <div>
                                                        <input type="text" class="large"  name="enlace" id="titulo" value="<?php echo $query1[1]; ?>" />
