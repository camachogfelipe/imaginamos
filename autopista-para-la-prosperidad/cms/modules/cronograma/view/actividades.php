            ...
            ?>
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info').innerHTML = 'Presentacion creada correctamente!<br />';
...
<?php include("../../../menu/icons.php"); ?>
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray shadow access_point"></span>Actividades</span>
                    </div><!-- End header -->	
                    <div class="content">
...
<?php echo $htmlFormTableUser->printTableUsers($_GET[idService]); ?>
                            ...
                            <div>
                                ...
                                <a href="Add.php?id=<?php echo base64_encode($id); ?>" class="uibutton">Agregar Nuevo</a>
