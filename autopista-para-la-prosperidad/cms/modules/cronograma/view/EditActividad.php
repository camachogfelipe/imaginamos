...
$htmlFormTableUser = new Tables2($db, $id="");
?>
                ...
                if ($erno == 1) {
                    ...
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info1').innerHTML = 'Actividad editada correctamente!<br />';
                            $('#info1').show();
                        })
                    </script>
                    <?php
    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>EDICIÓN ACTIVIDADES</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $arrayCampos[0] = 'id';
                                    $arrayCampos[2] = 'actividad';
                                    $arrayCampos[3] = 'fecha';

                                    $query1 = $Consultas->Byid('actividad', $id, 'id', $arrayCampos);
                                }
                                ?>

                                <div>
                                    <legend><h1>Editar Actividad</h1></legend>
                                    <form id="form" method="post" action="../controller/editActividad.php">
                                        <p>
                                            ...
                                            <div>
                                                ...
                                                <div class="section">
                                                    <label>Texto</label>
                                                    <div>
                                                        <textarea name="actividad" id="texto" class="large" cols="" rows=""><?php echo $query1[2]; ?></textarea>
                                                ...
                                                <div class="section">
                                                    <label>Fecha</label>
                                                    <input name="fecha" value="<?php echo $query1[3]; ?>" id="datepicker" type="text" tabindex="1" class="hasDatepicker" size="10">
                                                    <span class="ui-datepicker-append">(Año - Mes - Día)</span>
