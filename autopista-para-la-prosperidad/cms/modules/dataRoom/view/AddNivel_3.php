...
$htmlFormTableUser = new Tables4($db);
?>
    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>SUBNIVELES</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
                                <div>
                                    <legend><h1>Nuevo Subnivel</h1></legend>
                                    <form id="formAjax" method="post" action="../controller/addNivel.php">
                                        <p>
                                            <div class="imu_info" id="info"></div>
                                                    ...
                                                    <label>Nombre</label>
                                                    <div>
                                                        <input name="nombre" id="texto" class="large" />
                                                        <input type="hidden" class="large"  name="id" id="id" value="<?php echo $_GET["id"] ?>" />
                                                        <input type="hidden" class="large"  name="tabla" id="id" value="nivel_3"/>
                                                        <input type="hidden" class="large"  name="llave" id="id" value="nivel_2_id"/>
                                                        <input type="hidden" class="large"  name="ant" id="id" value="<?php echo $_GET["ant"] ?>"/>
                                                        <input type="hidden" class="large"  name="antt" id="id" value="<?php echo $_GET["antt"] ?>"/>
                                            ...
                                            <a href="nivel_3.php?id=<?php echo $_GET["id"];?>&ant=<?php echo $_GET["ant"];?>&idt=<?php echo $_GET["idt"]?>&antt=<?php echo $_GET["antt"]?>" class="uibutton" />Regresar</a>
