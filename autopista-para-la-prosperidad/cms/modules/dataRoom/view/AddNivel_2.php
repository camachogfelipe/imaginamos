...
include("../model/tables.class3.php");
$htmlFormTableUser = new Tables3($db);
?>
                                        ...
                                        <p>
                                            <div class="imu_info" id="info"></div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="hidden" class="large"  name="tabla" id="id" value="nivel_2"/>
                                                        <input type="hidden" class="large"  name="llave" id="id" value="nivel_1_id"/>
                                            ...
                                            <a href="nivel_2.php?id=<?php echo $_GET["id"];?>&ant=<?php echo $_GET["ant"];?>" class="uibutton" />Regresar</a>
