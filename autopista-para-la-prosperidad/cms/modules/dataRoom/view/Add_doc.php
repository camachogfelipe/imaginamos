...
include("../model/tables.class2.php");
$htmlFormTableUser = new Tables2($db);
?>
    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>Documentos</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
                                <div>
                                    <legend><h1>Nuevo Documento </h1></legend>
                                    <form id="formAjax" method="post" enctype="multipart/form-data" action="../controller/add_doc.php">
                                        <p>
                                            <div class="imu_info" id="info"></div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="hidden" class="large"  name="categoria" id="id" value="<?php echo $_GET["cat"] ?>" />
                                                        <input type="hidden" class="large"  name="nivel" id="id" value="<?php echo $_GET["n"] ?>"/>
                                                        <input type="hidden" class="large"  name="llave" id="id" value="caetgoria_id"/>
                                                    </div>
                                                </div>
                                            ...
                                            <a href="documentos.php?<?php echo $_SESSION["var2"];?>" class="uibutton" />Regresar</a>
