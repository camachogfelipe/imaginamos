...
include("../model/tables.class_5.php");
$_SESSION["var2"] = $_SERVER['QUERY_STRING'];
$_SESSION["actual"] = base64_decode($_GET['id']);

$id=$_GET["id"];
$id = base64_decode($id);
$nivel=$_GET["n"];
$htmlFormTableUser = new Tables5($db, $id, $nivel);
?>
            ...
            ?>
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info').innerHTML = 'Subnivel creado correctamente!<br />';
...
<?php include("../../../menu/icons.php"); ?>
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray shadow access_point"></span>Documentos</span>
                    </div><!-- End header -->	
                    <div class="content">
...
<?php echo $htmlFormTableUser->printTableUsers($_GET[idService]); ?>
                            ...
                            <div>
                                ...
                                <a href="Add_doc.php?id=<?php echo $_GET["id"]; ?>&n=<?php echo $_GET["n"]; ?>" class="uibutton">Agregar Nuevo</a>
        ...
        <div class="section">
            <a href="<?php echo $_GET["n"];?>.php?<?php echo $_SESSION["var"];?>" class="uibutton" />Regresar</a>
