...
$_SESSION["var"] = $_SERVER['QUERY_STRING'];
$id=$_GET["id"];
$id = base64_decode($id);
...
<?php include("../../../menu/icons.php"); ?>
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray shadow access_point"></span>Subniveles</span>
                    </div><!-- End header -->	
                    <div class="content">
...
<?php echo $htmlFormTableUser->printTableUsers($_GET[idService]); ?>
                            ...
                            <div>
                                ...
                                <a href="AddNivel_3.php?id=<?php echo $_GET["id"]?>&ant=<?php echo $_GET["ant"];?>&idt=<?php echo $_GET["idt"]?>&antt=<?php echo $_GET["antt"]?>" class="uibutton">Agregar Nuevo</a>
        ...
        <div class="section">
            <a href="nivel_2.php?id=<?php echo $_GET["idt"]?>&ant=<?php echo $_GET["antt"]?>" class="uibutton" />Regresar</a>
