...
$id=$_GET["id"];
$id = base64_decode($id);
$htmlFormTableUser = new Tables3($db, $id);
?>
...
<?php echo $htmlFormTableUser->printTableUsers($_GET[idService]); ?>
                            ...
                            <div>
                                ...
                                <a href="AddNivel_2.php?id=<?php echo $_GET["id"]?>&ant=<?php echo $_GET["ant"];?>" class="uibutton">Agregar Nuevo</a>
        ...
        <div class="section">
            <a href="nivel_1.php?id=<?php echo $_GET["ant"]?>" class="uibutton" />Regresar</a>
