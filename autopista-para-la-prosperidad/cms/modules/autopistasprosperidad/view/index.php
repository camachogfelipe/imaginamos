...
<?php include("../../../menu/icons.php"); ?>
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>EDICI&Oacute;N Autopistas para la Prosperidad</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
<?php
    ...
    $arrayCampos[0] = 'id';
    $arrayCampos[1] = 'texto';
    $arrayCampos[2] = 'imagen';

    $query1 = $Consultas->Byid('proyecto', $id, 'id', $arrayCampos);
?>

                                <div>
                                    <legend><h1>Editar Autopistas para la Prosperidad</h1></legend>
