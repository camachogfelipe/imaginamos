...
//IMPRIME FORMULARIO PARA LOS ADMINISTRADORES
    function printTableUsers() {
        $query = "SELECT * FROM presentaciones ORDER BY id ASC";
		...
		<legend><h1>Presentaciones</h1></legend>
        ...
        if ($numOfResults > 0) {
            ...
            foreach ($results as $result) {
                $html .= '
					...
					<a id="' . $result[id] . '" class="Delete uibutton special" tableToDelete="presentaciones" nameField="id">Eliminar</a>
                                            </td>
					</tr>';
            }
        }
