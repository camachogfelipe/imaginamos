...
//IMPRIME FORMULARIO PARA LOS ADMINISTRADORES
    function printTableUsers() {
        $query = "SELECT * FROM documentosjuridicos ORDER BY id ASC";
		...
		<legend><h1>Documentos Jurídicos</h1></legend>
        ...
        if ($numOfResults > 0) {
            ...
            foreach ($results as $result) {
                $html .= '
					...
					<a id="' . $result[id] . '" class="Delete uibutton special" tableToDelete="documentosjuridicos" nameField="id">Eliminar</a>
                                            </td>
					</tr>';
            }
        }
