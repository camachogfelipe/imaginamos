                ...
                if ($erno == 1) {
                    ...
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info1').innerHTML = 'Documento editado correctamente!<br />';
                            $('#info1').show();
                        })
                    </script>
                    <?php
    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>EDICIÓN DOCUMENTOS</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $query1 = $Consultas->Byid('documentosjuridicos', $id, 'id', $arrayCampos);
                                }
                                ?>

                                <div>
                                    <legend><h1>Editar documento</h1></legend>
