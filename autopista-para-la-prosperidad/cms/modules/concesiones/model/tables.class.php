...
//IMPRIME FORMULARIO PARA LOS ADMINISTRADORES
    function printTableUsers() {
        $query = "SELECT * FROM concesiones ORDER BY id ASC";
		...
		<legend><h1>concesiones</h1></legend>
        ...
        if ($numOfResults > 0) {
            ...
            foreach ($results as $result) {
                $html .= '
					...
					<a id="' . $result[id] . '" class="Delete uibutton special" tableToDelete="concesiones" nameField="id">Eliminar</a>
                                            </td>
					</tr>';
            }
        }
