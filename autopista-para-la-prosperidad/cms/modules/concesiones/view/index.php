            ...
            ?>
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info').innerHTML = 'Concesión creada correctamente!<br />';
...
<?php include("../../../menu/icons.php"); ?>
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray shadow access_point"></span>CONCESIONES</span>
                    </div><!-- End header -->	
                    <div class="content">
...
<?php echo $htmlFormTableUser->printTableUsers($_GET[idService]); ?>
					 ...
					 $total = $Consultas->total('concesiones');
					 //echo $total.' total';
                                if ($total<7)
                                {
                                ?>
