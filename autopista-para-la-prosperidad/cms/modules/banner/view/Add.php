			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>Banner Superior</span>
					</div><!-- End header -->	
                  <div class="content">
					<div class="formEl_b">
        				<fieldset>
                            <div>
                            <legend><h1>Nuevo Banner Superior</h1></legend>
                            <form id="formAjax" method="post" action="../controller/add.php">
                                ...
                                <div class="imu_info" id="info"></div>
                                    ...
                                    <div class="section">
                                        <label>Imagen</label>
                                        <div>
                                        <input id="IMU"  class="IMU" type="file" path="files/" thumbnails="700x200" thumbnailsFolders="files/thumb/" startOn='onSubmit:formAjax' ajax='true' ajaxInfoId='info' ajaxLoaderId='loader' multi='false' afterUpload='filename'  fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)"/>
