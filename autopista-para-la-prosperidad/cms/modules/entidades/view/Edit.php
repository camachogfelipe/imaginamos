		...
		$erno = $_GET['erno'];
			...
			else
			{
				if ($erno==1)
				{
					...
					document.getElementById('info1').innerHTML = 'ELa entidad ha sido editada correctamente!<br />';
					$('#info1').show();
					})
					</script>
                    <?php
			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>EDICIÓN ENTIDADES</span>
					</div><!-- End header -->	
                  <div class="content">
                    <div class="formEl_b">
                        <fieldset>
                        ...
                        if (isset($_GET['id']))
                        {
							...
							$arrayCampos[0] = 'id';
							$arrayCampos[1] = 'entidad';
							$arrayCampos[2] = 'web_entidad';
							$arrayCampos[3] = 'imagen';
                                                        
							$query1 = $Consultas->Byid('entidades',$id,'id',$arrayCampos);
                        }
                        ?>
                            
                        <div>
                            <legend><h1>Editar Entidad</h1></legend>
                                ...
                                <p>
                                    ...
                                    <div>
                                        ...
                                        <div class="section">
                                            ...
                                            <input class="IMU" type="file" path="files/" thumbnails="221x106" thumbnailsFolders="files/" multi="false" startOn="onSubmit:form" afterUpload="filename" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)"/>
