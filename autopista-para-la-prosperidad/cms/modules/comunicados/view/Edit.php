                ...
                if ($erno == 1) {
                    ...
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info1').innerHTML = 'comunicado editado correctamente!<br />';
                            $('#info1').show();
                        })
                    </script>
                    <?php
    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>EDICIÓN COMUNICADOS DE PRENSA</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
                                ...
                                if (isset($_GET['id'])) {
                                    ...
                                    $arrayCampos[3] = 'texto';
                                    $arrayCampos[5] = 'archivo';

                                    $query1 = $Consultas->Byid('comunicados', $id, 'id', $arrayCampos);
                                }
                                ?>

                                <div>
                                    <legend><h1>Editar Comunicado</h1></legend>
                                        ...
                                        <p>
                                            ...
                                            <div>
                                                ...
                                                <div class="section">
                                                    ...
                                                    <div>
                                                        <input type="text" class="large"  name="subtitulo" id="titulo2" value="<?php echo $query1[2]; ?>" />
                                                ...
                                                <div class="section">
                                                    <label>Link</label>
                                                    <div>
                                                        <input type="text" name="link" id="link" value="<?php echo $query1[5]; ?>"/>
                                                    </div>
