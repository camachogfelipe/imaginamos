    ...
    <body class="dashborad">
        ...
        <div id="content">
            <div class="inner">
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>COMUNICADOS DE PRENSA</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
                                <div>
                                    <legend><h1>Nuevo Comunicado</h1></legend>
                                        ...
                                        <p>
                                            ...
                                            <div class="section">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="f_help"> L&iacute;mite de car&aacute;cteres 25/ <span class="titulo2"></span></span>
                                            ...
                                            <div class="section">
                                                <label>Texto</label>
                                                <div>
                                                    <textarea name="texto" class="large" cols="" rows=""></textarea>
