            ...
            ?>
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info').innerHTML = 'Comunicado creado correctamente!<br />';
...
<?php include("../../../menu/icons.php"); ?>
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray shadow access_point"></span>COMUNICADOS DE PRENSA</span>
                    </div><!-- End header -->	
                    <div class="content">
