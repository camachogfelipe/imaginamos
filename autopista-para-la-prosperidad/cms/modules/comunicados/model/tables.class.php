...
//IMPRIME FORMULARIO PARA LOS ADMINISTRADORES
    function printTableUsers() {
        $query = "SELECT * FROM comunicados ORDER BY id ASC";
		...
		<legend><h1>Comunicados de Prensa</h1></legend>
        ...
        if ($numOfResults > 0) {
            ...
            foreach ($results as $result) {
                $html .= '
					...
					<a id="' . $result[id] . '" class="Delete uibutton special" tableToDelete="comunicados" nameField="id">Eliminar</a>
                                            </td>
					</tr>';
            }
        }
