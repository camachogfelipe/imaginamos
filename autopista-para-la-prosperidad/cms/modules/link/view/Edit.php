		...
		$erno = $_GET['erno'];
			...
			else
			{
				if ($erno==1)
				{
					...
					document.getElementById('info1').innerHTML = 'El Item ha sido editado correctamente!<br />';
					$('#info1').show();
					})
					</script>
                    <?php
			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray window"></span>EDICI&Oacute;N Link</span>
					</div><!-- End header -->	
                  <div class="content">
                    <div class="formEl_b">
                        <fieldset>
                        ...
                        if (isset($_GET['id']))
                        {
							...
							$arrayCampos[1] = 'texto';
							$arrayCampos[2] = 'link';
							$arrayCampos[3] = 'destacado';
                                                        
							$query1 = $Consultas->Byid('link',$id,'id',$arrayCampos);
                        }
                        ?>
                            
                        <div>
                            <legend><h1>Editar link</h1></legend>
                                ...
                                <p>
                                    ...
                                    <div>
                                        <div class="section">
                                            <label>Link</label>
                                            <div>
                                            <input type="text" class="large"  name="link" id="link" value="<?php echo $query1[2]; ?>" />
                                        ...
                                        <div class="section">
                                            <label>Texto</label>
                                            <div>
                                            <textarea name="texto" id="texto" class="large" cols="" rows=""><?php echo $query1[1]; ?></textarea>
                                            <span class="f_help"> L&iacute;mite de car&aacute;cteres 45 / <span class="texto"></span></span>
                                            </div>
                               		</div>
                                       
                                        <div class="section">
                                         <input type="hidden"  name="id" id="id" value="<?php echo $query1[0]; ?>" />
