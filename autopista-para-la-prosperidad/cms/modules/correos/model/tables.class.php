...
function printTableLinks()
		{
		$query = "SELECT * FROM correos ORDER BY id ASC";
		...
		<legend><h1>Correos CONTACTO OFICIAL</h1></legend>
			...
			foreach($results as $result)
			{
				...
				$html .= '
					<tr class="odd gradeX">
                                        ...
                                        <td class="center" width="300px">'.$result[email].'</td>
                                              <td class="center" width="300px">
                                        '.$button.'
                                        </td>
					<td class="center" width="100px">
                                        
					<a id="'.$result[id].'" class="Delete uibutton special" tableToDelete="correos" nameField="id">Eliminar</a>
                                            </td>
					</tr>';		
			}
