			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget">
                        <div class="header"><span><span class="ico gray shadow access_point"></span>Correos</span>
					</div><!-- End header -->	
                        <div class="content">
...
function destacar(idp){
    $.post('../controller/destacar.php', { id: idp } , function(datos) {
            if(datos=='No puedes destacar m&aacute;s de 5 correos'){
