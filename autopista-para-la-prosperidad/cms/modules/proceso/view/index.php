...
<?php include("../../../menu/icons.php"); ?>
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>EDICI&Oacute;N Proceso de Precalificación</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
...
?>
                                ...
                                <div>
                                    <legend><h1>Editar Proceso de Precalificación</h1></legend>
