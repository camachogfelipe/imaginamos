            ...
            ?>
                    <script language="javascript" type="text/javascript">
                        $(document).ready(function(){
                            document.getElementById('info1').innerHTML = 'El Video ha sido editado correctamente!<br />';
                            $('#info1').show();
                        })
                    </script>
            <?php
...
<?php include("../../../menu/icons.php"); ?>
                ...
                <!-- full width -->
                <div class="widget">
                    <div class="header"><span><span class="ico gray window"></span>EDICI&Oacute;N VIDEOS</span>
                    </div><!-- End header -->	
                    <div class="content">
                        <div class="formEl_b">
                            <fieldset>
...
if (isset($_GET['id'])) {
    ...
    $arrayCampos[2] = 'subtitulo';
    $arrayCampos[3] = 'texto';
    $arrayCampos[4] = 'textodetalle';
    $arrayCampos[5] = 'video';

    $query1 = $Consultas->Byid('video', $id, 'id', $arrayCampos);
}
?>

                                <div>
                                    <legend><h1>Editar video</h1></legend>
                                        ...
                                        <p>
                                            ...
                                            <div>
                                                ...
                                                <div class="section">
                                                    ...
                                                    <div>
                                                        <input type="text" class="large"  name="subtitulo" id="titulo" value="<?php echo $query1[2]; ?>" />
                                                        <span class="f_help"> L&iacute;mite de car&aacute;cteres 20/ <span class="titulo"></span></span>
                                                ...
                                                <div class="section">
                                                    <label>Texto</label>
                                                    <div>
                                                        <textarea name="texto" id="texto" class="large" cols="" rows=""><?php echo $query1[3]; ?></textarea>
                                                ...
                                                <div class="section">
                                                    ...
                                                    <div>
                                                        <textarea name="textoDetalle" id="texto" class="large" cols="" rows=""><?php echo $query1[4]; ?></textarea>
                                                        <script type="text/javascript">
                                                            CKEDITOR.replace('textoDetalle');
                                                        </script>
                                                ...
                                                <div class="section">
                                                    <label>Video</label>
                                                    <div>
                                                        <iframe title="YouTube video player" class="youtube-player" type="text/html" width="500" height="311" src="http://www.youtube.com/embed/<?php echo $query1[5]; ?>" frameborder="0" allowFullScreen></iframe>
                                                        <br/>
                                                        <input type="text" name="video" id="titulo" value="<?php echo $query1[5]; ?>" />                             
