...
{  
	...
	if($funcionality == "" or $funcionality == "sel" or $formData[dataExample] == "")
		...
		{		
			...
			$db->doQuery("INSERT INTO cms_aliadosImgIndex_config(aliadosImgIndex_config_id, aliadosImgIndex_config_funcionality, aliadosImgIndex_config_date)VALUES(1,'$funcionality','$dateTime')",INSERT_QUERY);
