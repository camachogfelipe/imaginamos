...
{  
	...
	if($funcionality == "" or $funcionality == "sel" or $formData[dataExample] == "")
		...
		{		
			...
			$db->doQuery("INSERT INTO cms_headhunter_config(headhunter_config_id, headhunter_config_funcionality, headhunter_config_date)VALUES(1,'$funcionality','$dateTime')",INSERT_QUERY);
