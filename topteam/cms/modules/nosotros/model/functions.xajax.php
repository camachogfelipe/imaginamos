...
{  
	...
	if($funcionality == "" or $funcionality == "sel" or $formData[dataExample] == "")
		...
		{		
			...
			$db->doQuery("INSERT INTO cms_nosotros_config(nosotros_config_id, nosotros_config_funcionality, nosotros_config_date)VALUES(1,'$funcionality','$dateTime')",INSERT_QUERY);
