...
function printFormgestionh($funcionality)
		{	
			switch($funcionality)
			{
			case 1:
				$query = "SELECT * FROM cms_gestionh ORDER BY gestionh_id DESC";
				...
				';	
					...
					foreach ($results as $result)
					{
						$html .= '
							...
							<fieldset>
								<div>'.$result[gestionh_contenido].'</div>
							</fieldset>
							<p>&nbsp;</p>
							
							<label>Contenido parte 2:</label>
							<fieldset>
								<div>'.$result[gestionh_contenido2].'</div>
							</fieldset>
							<p>&nbsp;</p>

							<label>Imagen:</label>
							<fieldset>
								<div><img src="../files/big/'.$result[gestionh_imagenInt].'"></div>
							</fieldset>
							<p>&nbsp;</p>	
							
							<label>Ruta Video:</label>
							<fieldset>
								<div>'.$result[gestionh_rutavideo].'</div>
							</fieldset>
							<p>&nbsp;</p>
							
							<fieldset>
								<div><a  href="editTXT.php?id='.$result[gestionh_id].'&funcionality=1" class="uibutton">Editar Texto</a></div>
								<div><a  href="editIMG.php?id='.$result[gestionh_id].'&funcionality=1" class="uibutton">Editar Imagen</a></div>
							</fieldset>
							<p>&nbsp;</p>
						';
					}
...
function printFormEdit($id,$funcionality)
		...
		$query = "SELECT * FROM cms_gestionh WHERE gestionh_id = '$id'";
		$this->db->doQuery($query,SELECT_QUERY);
		$results = $this->db->results;
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
						...
						<div>
						<label>Contenido parte 1</label>
						<div><textarea name="contenido" id="contenido" cols="5" class="large">'.$results[0][gestionh_contenido].'</textarea></div>
						</div>
						...
						<div>
						<label>Contenido parte 2</label>
						<div><textarea name="contenido2" id="contenido2" cols="5" class="large">'.$results[0][gestionh_contenido2].'</textarea></div>
						</div>
						...
						<div>
						<div>
							<img src="../files/big/'.$results[0][gestionh_imagenInt].'"><br><br>
						...
						<div>	
							<input type="text" name="rutavideo" id="rutavideo" value="'.$results[0][gestionh_rutavideo].'" class="large" />
						</div>
						</div>
		...
		$html = '
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
                              ...
                              <fieldset>
                                  ...
                                  <div>
                                      ...
                                      <div><input type="text" name="title" id="title" class="large" value="'.$results[0][gestionh_title].'"/></div>
                                  </div>
                              ...
                              <p>&nbsp;</p>
                                  ...
                                  <div>
                                      ...
                                      <div><textarea name="article" id="article" cols="5" class="large">'.$results[0][gestionh_article].'</textarea></div>
                                  </div>
				...
				<img src="../files/big/'.$results[0][gestionh_image].'"><br><br>
		...
		case 3:
				...
				$queryTwo = "SELECT * FROM cms_gestionh_pics WHERE gestionh_id = '$id' ORDER BY gestionh_id DESC";
		...
		$html = '
				...
				$html .= '
					<tr class="odd gradeX">
					<td class="center" width="70px"><img src="../files/big/'.$resultTwo[gestionh_pics_path].'"></td>
					<td class="center" width="100px">
					<a id="'.$resultTwo[gestionh_pics_id].'" class="Delete uibutton special" tableToDelete="cms_gestionh_pics" nameField="gestionh_pics_id">Eliminar</a>
					</td>
					</tr>';		
				}	
				$html .= '
...
function printFormEditIMG($id,$funcionality)
		...
		$html = '
                ...
                <form id="form" method="post" action="../controller/controllerEditIMG.php">
                    ...
                    <legend><h1>Edición de la imagen</h1></legend>
                              
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
						<br><br>
                        <div>
						<label>Imagen tama&ntilde;o 356px de ancho por 250px de alto</label>
						<div>
						<br><br>
						<fieldset>
							<div>
...
function printFormEditTXT($id,$funcionality)
		...
		case 1:
			...
			<div class="imu_info" id="info"></div>
                    ...
                    <legend><h1>Edición del texto</h1></legend>
