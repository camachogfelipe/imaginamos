...
{  
	...
	if($funcionality == "" or $funcionality == "sel" or $formData[dataExample] == "")
		...
		{		
			...
			$db->doQuery("INSERT INTO cms_gestionh_config(gestionh_config_id, gestionh_config_funcionality, gestionh_config_date)VALUES(1,'$funcionality','$dateTime')",INSERT_QUERY);
...
{  
	...
	if($contenido == "" or $contenido2 == "")
		...
		$db->doQuery("UPDATE cms_gestionh SET gestionh_contenido = '$contenido', gestionh_contenido2 = '$contenido2', gestionh_rutavideo = '$rutavideo' WHERE gestionh_id = '$formData[id]'",UPDATE_QUERY);
...
$xajax->registerFunction("editTXT");
