...
{  
	...
	if($funcionality == "" or $funcionality == "sel" or $formData[dataExample] == "")
		...
		{		
			...
			$db->doQuery("INSERT INTO cms_soluciones_config(soluciones_config_id, soluciones_config_funcionality, soluciones_config_date)VALUES(1,'$funcionality','$dateTime')",INSERT_QUERY);
