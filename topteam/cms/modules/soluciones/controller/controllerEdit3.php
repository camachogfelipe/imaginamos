...
if($titulo == "" or $contenido == "")
	...
	{
		if($imageUpload == 0)
		$db->doQuery("UPDATE cms_soluciones SET soluciones_titulo2 = '$titulo', soluciones_contenido2 = '$contenido', soluciones_enlace2 = '$enlace' WHERE soluciones_id = '$id'",UPDATE_QUERY);
		else{
		$nameImageUpload = $_POST["CMSFiles"][0];
		$db->doQuery("UPDATE cms_soluciones SET soluciones_titulo2 = '$titulo', soluciones_contenido2 = '$contenido', soluciones_enlace2 = '$enlace', soluciones_imagenInt2 = '$nameImageUpload' WHERE soluciones_id = '$id'",UPDATE_QUERY);
		}
