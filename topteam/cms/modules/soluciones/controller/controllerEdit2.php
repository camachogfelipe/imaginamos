...
if($titulo == "" or $contenido == "")
	...
	{
		if($imageUpload == 0)
		$db->doQuery("UPDATE cms_soluciones SET soluciones_titulo1 = '$titulo', soluciones_contenido1 = '$contenido', soluciones_enlace1 = '$enlace' WHERE soluciones_id = '$id'",UPDATE_QUERY);
		else{
		$nameImageUpload = $_POST["CMSFiles"][0];
		$db->doQuery("UPDATE cms_soluciones SET soluciones_titulo1 = '$titulo', soluciones_contenido1 = '$contenido', soluciones_enlace1 = '$enlace', soluciones_imagenInt1 = '$nameImageUpload' WHERE soluciones_id = '$id'",UPDATE_QUERY);
		}
