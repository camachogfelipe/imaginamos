...
/**/
//IMPRIME FORMULARIO DE aliados
/**/

function printFormaliados($funcionality)
		{	
			switch($funcionality)
			{
			case 1:
				$query = "SELECT * FROM cms_aliados ORDER BY aliados_id DESC";
				...
				<label>Imagen tama&ntilde;o 240px de ancho x 141px de alto</label>
				<fieldset>
				<div>
				<div>
				...
				$html .= '
					<tr class="odd gradeX">
					<td class="center" width="90px"><img src="../files/middle/'.$result[aliados_image].'"></td>
					<td class="center" width="100px">'.$result[aliados_titulo].'</td>
					<td class="center" width="150px">'.$result[aliados_url].'</td>
					<td class="center" width="100px">
					<a id="'.$result[aliados_id].'" class="Delete uibutton special" tableToDelete="cms_aliados" nameField="aliados_id">Eliminar</a>
					<a  href="edit.php?id='.$result[aliados_id].'&funcionality=1" class="uibutton">Editar</a>
					</td>
					</tr>';		
				}
...
function printFormEdit($id,$funcionality)
		...
		$query = "SELECT * FROM cms_aliados WHERE aliados_id = '$id'";
		$this->db->doQuery($query,SELECT_QUERY);
		$results = $this->db->results;
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
                    ...
                    <legend><h1>Edición de Banner Aliados</h1></legend>
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
						...
						<label>Titulo</label>
						<div>	
							<input type="text" name="titulo" id="titulo"  value="'.$results[0][aliados_titulo].'" class="large" />
						</div>
						</div>
						...
						<label>Enlace</label>
						<div>	
							<input type="text" name="enlace" id="enlace" value="'.$results[0][aliados_url].'" class="large" />
						</div>
						</div>
						...
						<div>
							...
							<img src="../files/big/'.$results[0][aliados_image].'"><br><br>
							<input class="CMS" type="file" path="files/" multi="false" startOn="onSubmit:form" ajax="true" ajaxInfoId="info" ajaxLoaderId="loader" button="../images/buttonSingle.jpg" thumbnails="90x90,191x69,240x141" thumbnailsFolders="files/small/,files/middle/,files/big/" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)" allowRemove="true" />
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
                              ...
                              <fieldset>
                                  ...
                                  <div>
                                      ...
                                      <div><input type="text" name="title" id="title" class="large" value="'.$results[0][aliados_title].'"/></div>
                                  </div>
                              ...
                              <p>&nbsp;</p>
                                  ...
                                  <div>
                                      ...
                                      <div><textarea name="article" id="article" cols="5" class="large">'.$results[0][aliados_article].'</textarea></div>
                                  </div>
		...
		case 3:
				...
				$queryTwo = "SELECT * FROM cms_aliados_pics WHERE aliados_id = '$id' ORDER BY aliados_id DESC";
		...
		$html = '
				...
				$html .= '
					<tr class="odd gradeX">
					<td class="center" width="70px"><img src="../files/big/'.$resultTwo[aliados_pics_path].'"></td>
					<td class="center" width="100px">
					<a id="'.$resultTwo[aliados_pics_id].'" class="Delete uibutton special" tableToDelete="cms_aliados_pics" nameField="aliados_pics_id">Eliminar</a>
					</td>
					</tr>';		
				}	
				$html .= '
