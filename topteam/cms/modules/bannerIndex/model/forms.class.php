...
function printFormBanners($funcionality)
		{	
			...
			case 1:
				...
				<label>Texto 1</label>
				<div>	
					<input type="text" name="texto1" id="texto1" class="large" />
				</div>
				</div>
				...
				<label>Texto 2</label>
				<div>	
					<input type="text" name="texto2" id="texto2" class="large" />
				</div>
				</div>
				...
				<thead>
					<tr>
						...
						<th><div class="th_wrapp">Texto1</div></th>
						<th><div class="th_wrapp">Texto2</div></th>
				...
				$html .= '
					<tr class="odd gradeX">
					<td class="center" width="70px"><img src="../files/middle/'.$result[banners_image].'"></td>
					<td class="center" width="70px">'.$result[banners_txt1].'</td>
					<td class="center" width="70px">'.$result[banners_txt2].'</td>
					<td class="center" width="60px">'.$result[banners_url].'</td>
