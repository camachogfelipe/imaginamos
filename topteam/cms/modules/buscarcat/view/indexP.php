			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
					...
					<!-- full width -->
                    <div class="widget" >
                        <div class="header"><span ><span class="ico gray pictures_folder"></span>CATEGORIA PROFESI&Oacute;N</span>
					...
					$db->doQuery("SHOW TABLES LIKE 'cms_buscar_cat_config'",SHOW_TABLE_QUERY);
					//Si recibimos TRUE como respuesta quiere decir que si existe la tabla
					if($show = $db->show)
						{
						$db->doQuery("SELECT buscar_cat_config_funcionality FROM cms_buscar_cat_config WHERE buscar_cat_config_id = 1",SELECT_QUERY);					
						$result = $db->results;
						//Imprimimos el formulario que necesitamos
						echo $htmlFormBanners->printFormCatP(1);
						}
					else
