...
if($contenido == "" or $contenido2 == "")
	...
	{
		if($imageUpload == 0)
		$db->doQuery("UPDATE cms_consulting SET consulting_contenido = '$contenido', consulting_contenido2 = '$contenido2', consulting_rutavideo = '$rutavideo' WHERE consulting_id = '$id'",UPDATE_QUERY);
		else{
		$nameImageUpload = $_POST["CMSFiles"][0];
		$db->doQuery("UPDATE cms_consulting SET consulting_contenido = '$contenido', consulting_contenido2 = '$contenido2', consulting_imagenInt = '$nameImageUpload', consulting_rutavideo = '$rutavideo' WHERE consulting_id = '$id'",UPDATE_QUERY);
		}
