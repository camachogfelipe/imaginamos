...
if($contenido == "" or $contenido2 == "" )
	...
	$message = "<script>showError('Ingrese todos los campos del formulario',3000);</script>";
	...
	else
		{
				...
				$db->doQuery("INSERT INTO cms_consulting(consulting_id, consulting_contenido, consulting_contenido2, consulting_imagenInt, consulting_rutavideo)VALUES('','$contenido','$contenido2','$imageUploadOk1','$rutavideo')",INSERT_QUERY);
