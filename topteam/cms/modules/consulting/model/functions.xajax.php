...
{  
	...
	if($funcionality == "" or $funcionality == "sel" or $formData[dataExample] == "")
		...
		{		
			...
			$db->doQuery("INSERT INTO cms_consulting_config(consulting_config_id, consulting_config_funcionality, consulting_config_date)VALUES(1,'$funcionality','$dateTime')",INSERT_QUERY);
