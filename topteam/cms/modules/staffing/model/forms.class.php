...
function printFormstaffing($funcionality)
		{	
			switch($funcionality)
			{
			case 1:
				$query = "SELECT * FROM cms_staffing ORDER BY staffing_id DESC";
				...
				<div class="tableName toolbar">
					...
					$html .= '
						<tr class="odd gradeX">
						<td class="center" width="70px"><img src="../files/middle/'.$result[staffing_imagen].'"></td>
						<td class="center" >'.$result[staffing_contenido].'</td>
						<td class="center" width="60px">'.$result[staffing_enlace].'</td>
						<td class="center" width="50px">
						<a  href="edit.php?id='.$result[staffing_id].'&funcionality=1" class="uibutton">Editar</a>
						</td>
						</tr>';		
					}
...
function printFormEdit($id,$funcionality)
		...
		$query = "SELECT * FROM cms_staffing WHERE staffing_id = '$id'";
		$this->db->doQuery($query,SELECT_QUERY);
		$results = $this->db->results;
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
					...
					<div><textarea name="contenido" id="contenido" cols="5" class="large">'.$results[0][staffing_contenido].'</textarea></div>
					</div>
					...
					<label>Enlace</label>
					<div>	
						<input type="text" name="enlace" id="enlace" value="'.$results[0][staffing_enlace].'" class="large" />
					</div>
					</div>
					
					<p>&nbsp;</p>
					
					<img src="../files/big/'.$results[0][staffing_imagen].'"><br><br>
					...
					<p>&nbsp;</p>
							...
							<fieldset>
							<div>
								<label>Imagen tama&ntilde;o 143px de ancho x 85px de alto</label>
								<p>&nbsp;</p>
							<div>
								<input class="CMS" type="file" path="files/" multi="false" startOn="onSubmit:form" ajax="true" ajaxInfoId="info" ajaxLoaderId="loader" thumbnails="90x90,100x,143x85" button="../images/buttonSingleChange.jpg" thumbnailsFolders="files/small/,files/middle/,files/big/" fileExt="jpg,jpeg,png,gif" fileDesc="Images (*.jpg, *.jpeg, *.png, *.gif)" allowRemove="true" />
		...
		$html = '
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
                              ...
                              <fieldset>
                                  ...
                                  <div>
                                      ...
                                      <div><input type="text" name="title" id="title" class="large" value="'.$results[0][staffing_title].'"/></div>
                                  </div>
                              ...
                              <p>&nbsp;</p>
                                  ...
                                  <div>
                                      ...
                                      <div><textarea name="article" id="article" cols="5" class="large">'.$results[0][staffing_article].'</textarea></div>
                                  </div>
				...
				<img src="../files/big/'.$results[0][staffing_image].'"><br><br>
		...
		case 3:
				...
				$queryTwo = "SELECT * FROM cms_staffing_pics WHERE staffing_id = '$id' ORDER BY staffing_id DESC";
		...
		$html = '
				...
				$html .= '
					<tr class="odd gradeX">
					<td class="center" width="70px"><img src="../files/big/'.$resultTwo[staffing_pics_path].'"></td>
					<td class="center" width="100px">
					<a id="'.$resultTwo[staffing_pics_id].'" class="Delete uibutton special" tableToDelete="cms_staffing_pics" nameField="staffing_pics_id">Eliminar</a>
					</td>
					</tr>';		
				}	
				$html .= '
