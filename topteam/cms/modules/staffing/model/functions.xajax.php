...
{  
	...
	if($funcionality == "" or $funcionality == "sel" or $formData[dataExample] == "")
		...
		{		
			...
			$db->doQuery("INSERT INTO cms_staffing_config(staffing_config_id, staffing_config_funcionality, staffing_config_date)VALUES(1,'$funcionality','$dateTime')",INSERT_QUERY);
