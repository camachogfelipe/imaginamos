		...
		$html = '
			...
			<script type="text/javascript" src="../js/upload.min.js"></script>
				...
				<div class="imu_info" id="info"></div>
                    ...
                    <legend><h1>Edición del Mapa</h1></legend>
                              
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
						
							<div>
							<label>Enlace GoogleMap</label>
							<div><textarea name="enlace" id="enlace" cols="5" class="large">'.$results[0][mapa_enlace].'</textarea></div>
							</div>
				...
				<div>	
				<br><br>
				<input type="submit" value="Editar mapa" class="uibutton submit_form" />
