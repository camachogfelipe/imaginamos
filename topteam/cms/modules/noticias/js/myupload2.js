		...
		self.uploadify({
			...
			'onAllComplete' : function(event, data){
				if(typeof(self.attr("afterUpload"))!="undefined" && self.attr("afterUpload")!="link" && self.attr("afterUpload")!="filename" && self.attr("afterUpload")!="image" && self.attr("afterUpload")!="none")
				{
					...
					message = message.replace("IMGtotalSizeKB", roundNumber1(data.allBytesLoaded/1024, 2));
					message = message.replace("IMGtotalSizeMB", roundNumber1(data.allBytesLoaded/1024/1024, 2));
					message = message.replace("IMGtotalSizeGB", roundNumber1(data.allBytesLoaded/1024/1024/1024, 2));
					message = message.replace("IMGspeedB", roundNumber1(Math.round(data.speed*1024), 2));
					message = message.replace("IMGspeedKB", roundNumber1(Math.round(data.speed), 2));
					message = message.replace("IMGspeedMB", roundNumber1(Math.round(data.speed/1024), 2));
					message = message.replace("IMGspeedGB", roundNumber1(Math.round(data.speed/1024/1024), 2));
