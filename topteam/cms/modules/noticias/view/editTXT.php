...
<head>
        ...
        <!-- <script type="text/javascript" src="../../../js/generalCMS.js"></script>--> 
        <!--End External Files-->
			...
			<div id="shadowhead"></div>
              ...
              <div id="content">
                <div class="inner">
                    ...
                    <?php echo $htmlFormNews->printFormEditTXT($id,$funcionality); ?>
             ...
             <script language="javascript">$("#resumen").cleditor(); $("#article").cleditor();</script> 
