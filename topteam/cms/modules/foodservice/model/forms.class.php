...
function printFormFoodservice($funcionality)
		{	
			switch($funcionality)
			{
			case 1:
				$query = "SELECT * FROM cms_foodservice ORDER BY foodservice_id DESC";
				...
				';	
					...
					foreach ($results as $result)
					{
						$html .= '
							...
							<fieldset>
								<div>'.$result[foodservice_contenido].'</div>
							</fieldset>
							<p>&nbsp;</p>
							
							<label>Contenido parte 2:</label>
							<fieldset>
								<div>'.$result[foodservice_contenido2].'</div>
							</fieldset>
							<p>&nbsp;</p>

							<label>Imagen:</label>
							<fieldset>
								<div><img src="../files/big/'.$result[foodservice_imagenInt].'"></div>
							</fieldset>
							<p>&nbsp;</p>	
							
							<label>Ruta Video:</label>
							<fieldset>
								<div>'.$result[foodservice_rutavideo].'</div>
							</fieldset>
							<p>&nbsp;</p>
							
							<fieldset>
								<div><a  href="edit.php?id='.$result[foodservice_id].'&funcionality=1" class="uibutton">Editar</a></div>
							</fieldset>
							<p>&nbsp;</p>
						';
					}
		...
		$html = '
				...
				<div class="imu_info" id="info"></div>
					...
					<br /><a class="uibutton icon special answer" href="javascript:history.back();">Volver</a>
                        ...
                        <div>
						<label>Contenido parte 1</label>
						<div><textarea name="contenido" id="contenido" cols="5" class="large">'.$results[0][foodservice_contenido].'</textarea></div>
						</div>
						...
						<div>
						<label>Contenido parte 2</label>
						<div><textarea name="contenido2" id="contenido2" cols="5" class="large">'.$results[0][foodservice_contenido2].'</textarea></div>
						</div>
						...
						<div>
						<div>
							<img src="../files/big/'.$results[0][foodservice_imagenInt].'"><br><br>
						...
						<div>	
							<input type="text" name="rutavideo" id="rutavideo" value="'.$results[0][foodservice_rutavideo].'" class="large" />
						</div>
						</div>
