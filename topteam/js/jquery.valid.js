		...
		*/
		_calculatePosition: function (field, promptElmt, options) {
			...
			switch (positionType) {
				default:
				case "centerLeft":
					promptleftPosition = fieldLeft - (promptElmt.width() - 140);
					promptTopPosition = fieldTop - 35;
					marginTopSize = 0;
			};
        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": {
                    ...
                    "alertText": "* Email no valido"
                },
								"phone": {
                    "regex": /^([\+][0-9]{1,3}[\ \.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9\ \.\-\/]{3,20})((x|ext|extension)[\ ]?[0-9]{1,4})?$/,
                    "alertText": "* Teléfono no valido"
                },
							"cedula": {
                    "regex": /^([\+][0-9]{1,3}[\ \.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9\ \.\-\/]{3,20})((x|ext|extension)[\ ]?[0-9]{1,4})?$/,
                    "alertText": "* Cédula no valido"
                },
								"celular": {
                    "regex": /^([\+][0-9]{1,3}[\ \.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9\ \.\-\/]{3,20})((x|ext|extension)[\ ]?[0-9]{1,4})?$/,
                    "alertText": "* Celular no valido"
                }
            };     
        }
    };
