...
$resumConsulting = Parametros::getTxtGenConsulting();
?>

<div id="cajondestacados">

<div id="envcontentnosotros">
<div id="tituloseccion">CONSULTING</div>
<div id="sepclear2"></div>
<div id="envtxtcontnosotros">
  
  
  <div id="colnosder">
	<?PHP echo trim($resumConsulting[0]['consulting_contenido']); ?>
  
  </div>
  <div id="colicosecs" style="text-align:center"><img src="cms/modules/consulting/files/big/<?PHP echo $resumConsulting[0]['consulting_imagenInt']; ?>" width="356" height="250" /></div>
  ...
  <div id="envimgsecint">
	...
	<div id="colicosecs">
		<?PHP echo trim($resumConsulting[0]['consulting_contenido2']); ?>
	</div>
...
<div id="menuv">
        ...
        <ul>
                ...
                <li><a href="consulting.php" style="color:#fecc00">consulting</a></li>
