...
<div class="belt">
	...
	?>
			<div id="caj_imgpanel" style="text-align:center"><img src="cms/modules/aliados/files/middle/<?PHP echo trim($datos[$i]['aliados_image']); ?>" width="191" height="69" border="0" /></div>				
			
		<?PHP
					
			if($conta == 4){
		?>
				</div></div><div class="panel"><div id="fila_panel2">
		<?PHP
				$conta = 0;
			}
			$conta++;		
