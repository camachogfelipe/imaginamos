...
<?PHP
$resumFoodService = Parametros::getTxtGenFoodservice();
?>

<div id="cajondestacados">

<div id="envcontentnosotros">
<div id="tituloseccion">FOODSERVICE</div>
<div id="sepclear2"></div>
<div id="envtxtcontnosotros">
  ...
  <?PHP echo trim($resumFoodService[0]['foodservice_contenido']); ?>
</div>
  <div id="colicosecs" style="text-align:center"><img src="cms/modules/foodservice/files/big/<?PHP echo $resumFoodService[0]['foodservice_imagenInt']; ?>" width="356" height="250" /></div>
  ...
  <div id="colicosecs">
	<?PHP echo trim($resumFoodService[0]['foodservice_contenido2']); ?>
  </div>
...
<div id="menuv">
        ...
        <ul>
<li><a href="foodservice.php" style="color:#fecc00">foodservice</a></li>
